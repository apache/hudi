...
public class HoodieDataSourceHelpers {
  ...
  /**
   * Checks if the Hoodie table has new data since given timestamp. This can be subsequently fed to an incremental view
   * read, to perform incremental processing.
   */
