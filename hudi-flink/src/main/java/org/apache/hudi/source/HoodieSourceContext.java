...
public class HoodieSourceContext implements Serializable {
  private static final Logger LOG = LoggerFactory.getLogger(HoodieSourceContext.class);
  ...
  public HoodieSourceContext(ResolvedSchema schema,
                             Path path,
  ...
  public HoodieSourceContext(
    ...
    this.maxCompactionMemoryInBytes = HoodieRealtimeRecordReaderUtils.getMaxCompactionMemoryInBytes(new JobConf(this.hadoopConf));
  }
  ...
  public List<Map<String, String>> getRequiredPartitions() {
    return requiredPartitions;
  }

  public int[] getRequiredPos() {
    return requiredPos;
  }
  ...
  public void setRequiredPartitions(List<Map<String, String>> requiredPartitions) {
    this.requiredPartitions = requiredPartitions;
  }
  ...
  public void setRequiredPos(int[] requiredPos) {
  ...
  String getSourceOperatorName(String operatorName) {
    String[] schemaFieldNames = this.schema.getColumnNames().toArray(new String[0]);
  ...
  @Nullable
  Set<String> getRequiredPartitionPaths() {
  ...
  public void applyPartitions(List<Map<String, String>> partitions) {
    this.setRequiredPartitions(partitions);
  }
  ...
  static class Builder {
    ...
    Builder tableSchema(ResolvedSchema newSchema) {
      this.schema = newSchema;
      return this;
    }

    Builder path(Path newPath) {
      this.path = newPath;
      return this;
    }

    Builder partitionKeys(List<String> newPartitionKeys) {
      this.partitionKeys = newPartitionKeys;
      return this;
    }

    Builder defaultPartName(String newDefaultPartName) {
      this.defaultPartName = newDefaultPartName;
      return this;
    }

    Builder conf(Configuration newConf) {
      this.conf = newConf;
      return this;
    }

    Builder requiredPartitions(List<Map<String, String>> newRequiredPartitions) {
      this.requiredPartitions = newRequiredPartitions;
      return this;
    }

    Builder requiredPos(int[] newRequiredPos) {
      this.requiredPos = newRequiredPos;
      return this;
    }
    ...
    public HoodieSourceContext build() {
      return new HoodieSourceContext(schema, path, partitionKeys,
