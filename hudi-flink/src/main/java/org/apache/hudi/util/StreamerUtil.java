    ...
    HoodieWriteConfig.Builder builder =
        HoodieWriteConfig.newBuilder()
            ...
            .withStorageConfig(HoodieStorageConfig.newBuilder()
                ...
                .parquetBlockSize(conf.getInteger(FlinkWriteOptions.WRITE_PARQUET_BLOCK_SIZE) * 1024 * 1024)
                .parquetPageSize(conf.getInteger(FlinkWriteOptions.WRITE_PARQUET_PAGE_SIZE) * 1024 * 1024)
                .parquetMaxFileSize(conf.getInteger(FlinkWriteOptions.WRITE_PARQUET_MAX_FILE_SIZE) * 1024 * 1024L)
                .build())
