...
public class FormatUtils {
  ...
  public static RowKind getRowKind(IndexedRecord record, int index) {
    ...
    if (HoodieOperation.isInsert(flag)) {
      return RowKind.INSERT;
    } else if (HoodieOperation.isUpdateBefore(flag)) {
      return RowKind.UPDATE_BEFORE;
    } else if (HoodieOperation.isUpdateAfter(flag)) {
      return RowKind.UPDATE_AFTER;
    } else if (HoodieOperation.isDelete(flag)) {
