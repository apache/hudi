...
The original approach proposed naming files using a template such as: <COLUMN_NAME>-<PREFIX>_<WRITE_TOKEN>_<COMMIT_TIME>.hfile

However, this approach is fragile because column names may contain characters like '_' or '-', which complicate filename parsing and create edge cases.
...
```
vectors-<COLUMN_ID>-<FILE_PREFIX>_<WRITE_TOKEN>_<COMMIT_TIME>
```
