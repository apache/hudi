...
Note that the request_cancel and execute_cancel APIs are responsible for ensuring that already-completed instants aren't cancelled and that ongoing writers aren't concurrently executed for cancellation.

Archival will also be updated to delete instants transitioned to .aborted state
