...
public class HoodieWriteConfig extends DefaultHoodieConfig {
  ...
  private static final String FAIL_ON_SINGLE_ARCHIVING_ENABLED_PROP = "hoodie.fail.on.single.archiving";
  private static final String DEFAULT_FAIL_ON_SINGLE_ARCHIVING_ENABLED = "true";
  ...
  public boolean isFailOnArchivingEnabled() {
    return Boolean.parseBoolean(props.getProperty(FAIL_ON_SINGLE_ARCHIVING_ENABLED_PROP));
  }
  ...
  public static class Builder {
    ...
    public HoodieWriteConfig build() {
      ...
      setDefaultOnCondition(props, !props.containsKey(FAIL_ON_SINGLE_ARCHIVING_ENABLED_PROP),
              FAIL_ON_SINGLE_ARCHIVING_ENABLED_PROP, DEFAULT_FAIL_ON_SINGLE_ARCHIVING_ENABLED);
