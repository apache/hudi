...
public class HoodieCompactionConfig extends DefaultHoodieConfig {
  ...
  public static final String MAX_SIZE_IN_MEMORY_PER_COMPACTION_IN_BYTES_PROP =
      "hoodie.compaction" + ".spill.threshold";
  // Default memory size per compaction, excess spills to disk
  public static final String DEFAULT_MAX_SIZE_IN_MEMORY_PER_COMPACTION_IN_BYTES = String
      .valueOf(1024 * 1024 * 1024L); //1GB
  ...
  public static class Builder {
    ...
    public HoodieCompactionConfig build() {
      ...
      setDefaultOnCondition(props, !props.containsKey(PAYLOAD_CLASS), PAYLOAD_CLASS,
      ...
      setDefaultOnCondition(props,
          !props.containsKey(MAX_SIZE_IN_MEMORY_PER_COMPACTION_IN_BYTES_PROP),
          MAX_SIZE_IN_MEMORY_PER_COMPACTION_IN_BYTES_PROP,
          DEFAULT_MAX_SIZE_IN_MEMORY_PER_COMPACTION_IN_BYTES);
