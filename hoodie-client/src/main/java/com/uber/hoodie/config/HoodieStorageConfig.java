...
public class HoodieStorageConfig extends DefaultHoodieConfig {
  ...
  public static final String LOGFILE_DATA_BLOCK_SIZE_MAX_BYTES =
      "hoodie.logfile.data.block.max" + ".size";
  public static final String DEFAULT_LOGFILE_DATA_BLOCK_SIZE_MAX_BYTES = String
      .valueOf(256 * 1024 * 1024); // 256 MB
