...
/**
  * Hoodie's Implementation of {@link SupportsWrite}. This is used in data source
...
class HoodieDataSourceInternalTable implements SupportsWrite {
    ...
    public HoodieDataSourceInternalTable(
            String instantTime,
    ...
    public WriteBuilder newWriteBuilder(LogicalWriteInfo logicalWriteInfo) {
        return new HoodieDataSourceInternalBatchWriteBuilder(
                instantTime,
                writeConfig,
                structType,
                jss,
