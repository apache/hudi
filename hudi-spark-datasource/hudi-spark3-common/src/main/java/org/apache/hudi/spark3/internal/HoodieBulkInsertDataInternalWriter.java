...
/**
  * Hoodie's Implementation of {@link DataWriter<InternalRow>}. This is used in data source
  * "hudi.spark3.internal" implementation for bulk insert.
  */
public class HoodieBulkInsertDataInternalWriter implements DataWriter<InternalRow> {
    ...
    public HoodieBulkInsertDataInternalWriter(
