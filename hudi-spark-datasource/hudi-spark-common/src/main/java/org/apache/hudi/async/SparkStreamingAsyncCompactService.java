...
/**
  * Async Compaction Service used by Structured Streaming. Here, async compaction is run in daemon
...
public class SparkStreamingAsyncCompactService extends AsyncCompactService {
    ...
    public SparkStreamingAsyncCompactService(
            HoodieEngineContext context, BaseHoodieWriteClient client) {
