...
/**
  * Async clustering service for Spark structured streaming. Here, async clustering is run in daemon
  * mode to prevent blocking shutting down the Spark application.
  */
public class SparkStreamingAsyncClusteringService extends AsyncClusteringService {

    private static final long serialVersionUID = 1L;

    public SparkStreamingAsyncClusteringService(
            HoodieEngineContext context, BaseHoodieWriteClient writeClient) {
