...
public class DataSourceInternalWriterHelper {
    ...
    public DataSourceInternalWriterHelper(
            String instantTime,
        ...
        this.writeClient =
                new SparkRDDWriteClient<>(
                        new HoodieSparkEngineContext(new JavaSparkContext(sparkSession.sparkContext())),
                        writeConfig);
        ...
        this.metaClient =
                HoodieTableMetaClient.builder()
                        ...
                        .setBasePath(writeConfig.getBasePath())
                        .build();
    ...
    public void commit(List<WriteStatus> writeStatuses) {
        try {
            ...
            writeClient.commitStats(
                    instantTime,
                    writeClient.getEngineContext().parallelize(writeStatuses),
                    writeStatList,
