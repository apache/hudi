 ...
 */
public class Spark34VectorizedParquetRecordReader extends Spark34SpecificParquetRecordReaderBase<Object> {
  ...
  public Spark34VectorizedParquetRecordReader(
      ZoneId convertTz,
  ...
  // For test only.
  public Spark34VectorizedParquetRecordReader(boolean useOffHeap, int capacity) {
    this(
        null,
        "CORRECTED",
        "UTC",
