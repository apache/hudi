 ...
 */
class Spark34ParquetReadSupport(
  ...
  override def init(context: InitContext): ReadContext = {
    ...
    val parquetRequestedSchema = Spark34ParquetReadSupport.getRequestedSchema(
  ...
  override def prepareForRead(
    ...
    new ParquetRecordMaterializer(
      ...
      Spark34ParquetReadSupport.expandUDT(catalystRequestedSchema),
...
object Spark34ParquetReadSupport extends Logging {
  ...
  def getRequestedSchema(
    ...
    val parquetClippedSchema = Spark34ParquetReadSupport.clipParquetSchema(parquetFileSchema,
    ...
    val parquetRequestedSchema = if (schemaPruningEnabled && !enableVectorizedReader) {
      ...
      Spark34ParquetReadSupport.intersectParquetGroups(parquetClippedSchema, parquetFileSchema)
