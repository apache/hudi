...
import org.apache.spark.sql.execution.datasources.parquet.{ParquetFileFormat, Spark34HoodieParquetReader, Spark34LegacyHoodieParquetFileFormat, SparkHoodieParquetReaderProperties}
...
class Spark3_4Adapter extends BaseSpark3Adapter {
  ...
  override def getPropsForReadingParquet(vectorized: Boolean,
    ...
    Spark34HoodieParquetReader.getPropsForReadingParquet(vectorized, sqlConf, options, hadoopConf)
  }
  ...
  override def readParquetFile(file: PartitionedFile,
    ...
    Spark34HoodieParquetReader.readParquetFile(file, requiredSchema, partitionSchema, filters,
