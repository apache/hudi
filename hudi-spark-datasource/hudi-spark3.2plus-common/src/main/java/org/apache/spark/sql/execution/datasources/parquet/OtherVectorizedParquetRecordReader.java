 ...
 */
public class OtherVectorizedParquetRecordReader extends OtherSpecificParquetRecordReaderBase<Object> {
  ...
  public OtherVectorizedParquetRecordReader(
      ZoneId convertTz,
  ...
  // For test only.
  public OtherVectorizedParquetRecordReader(boolean useOffHeap, int capacity) {
    this(
        null,
        "CORRECTED",
        "UTC",
