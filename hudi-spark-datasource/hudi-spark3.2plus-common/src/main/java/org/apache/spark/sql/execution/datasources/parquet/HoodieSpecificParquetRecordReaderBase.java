 ...
 */
public abstract class HoodieSpecificParquetRecordReaderBase<T> extends RecordReader<Void, T> {
  protected Path file;
  ...
  protected HoodieParquetFileReader reader;
  ...
  public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext)
    ...
    ParquetReadOptions options = HadoopReadOptions
        ...
        .build();
    this.reader = new HoodieParquetFileReader(HadoopInputFile.fromPath(file, configuration), options);
  ...
  protected void initialize(String path, List<String> columns) throws IOException {
    ...
    ParquetReadOptions options = HadoopReadOptions
        ...
        .withRange(0, length)
        .build();
    this.reader = HoodieParquetFileReader.open(HadoopInputFile.fromPath(file, config), options);
