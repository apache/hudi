 ...
 * to work, this custom resolution rule [[HoodieSpark42ResolveColumnsForInsertInto]] is added
 ...
 */
case class HoodieSpark42ResolveColumnsForInsertInto() extends ResolveInsertionBase {
