...
/**
 * Implementation of [[SparkAdapter]] for Spark 4.2.x branch
 */
class Spark4_2Adapter extends BaseSpark4Adapter {
  ...
  override def getCatalystPlanUtils: HoodieCatalystPlansUtils = HoodieSpark42CatalystPlanUtils
  ...
  override def createPartitionCDCFileGroupMapping(partitionValues: InternalRow,
    ...
    new Spark42HoodiePartitionCDCFileGroupMapping(partitionValues, fileSplits)
  }
