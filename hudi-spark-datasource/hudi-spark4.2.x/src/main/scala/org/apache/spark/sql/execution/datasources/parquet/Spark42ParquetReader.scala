...
import org.apache.spark.sql.execution.datasources.parquet.Spark42ParquetReader.repairFooterSchema
...
class Spark42ParquetReader(enableVectorizedReader: Boolean,
...
object Spark42ParquetReader extends SparkParquetReaderBuilder {
  /**
