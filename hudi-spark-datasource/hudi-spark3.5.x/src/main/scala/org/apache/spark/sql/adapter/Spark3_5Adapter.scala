...
import org.apache.spark.sql.execution.datasources.parquet.{ParquetFileFormat, Spark35HoodieParquetReader, Spark35LegacyHoodieParquetFileFormat, SparkHoodieParquetReaderProperties}
...
class Spark3_5Adapter extends BaseSpark3Adapter {
  ...
  override def getPropsForReadingParquet(vectorized: Boolean,
    ...
    Spark35HoodieParquetReader.getPropsForReadingParquet(vectorized, sqlConf, options, hadoopConf)
  }
  ...
  override def readParquetFile(file: PartitionedFile,
    ...
    Spark35HoodieParquetReader.readParquetFile(file, requiredSchema, partitionSchema, filters,
