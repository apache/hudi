...
/**
 * Spark 3.5 concrete implementation of [[Spark3LegacyHoodieParquetFileFormat]]. It only overrides
 * the version-specific hooks; the shared reader logic lives in the base class.
 */
class Spark35LegacyHoodieParquetFileFormat(appendPartitionValues: Boolean)
