 ...
 */
class Spark30ParquetReadSupport(
  ...
  def this(readerType: String) {
    ...
    this(None, enableVectorizedReader = true, datetimeRebaseMode = LegacyBehaviorPolicy.CORRECTED, readerType)
  }
  ...
  override def init(context: InitContext): ReadContext = {
    ...
    val parquetClippedSchema = Spark30ParquetReadSupport.clipParquetSchema(parquetFileSchema,
    ...
    val parquetRequestedSchema = if (schemaPruningEnabled && !enableVectorizedReader) {
      ...
      Spark30ParquetReadSupport.intersectParquetGroups(parquetClippedSchema, parquetFileSchema)
  ...
  override def prepareForRead(
    ...
    new ParquetRecordMaterializer(
      parquetRequestedSchema,
      Spark30ParquetReadSupport.expandUDT(catalystRequestedSchema),
...
object Spark30ParquetReadSupport {
