...
class MORBootstrap30FileFormat(shouldAppendPartitionValues: Boolean,
                               ...
                               isMOR: Boolean,
                               isBootstrap: Boolean) extends Spark30HoodieParquetFileFormat(shouldAppendPartitionValues) with MORBootstrapFileFormat {
