 ...
 */
public class Spark30VectorizedParquetRecordReader extends Spark30SpecificParquetRecordReaderBase<Object> {
  ...
  public Spark30VectorizedParquetRecordReader(
      ZoneId convertTz, String datetimeRebaseMode, boolean useOffHeap, int capacity, String readerType) {
  ...
  // For test only.
  public Spark30VectorizedParquetRecordReader(boolean useOffHeap, int capacity) {
