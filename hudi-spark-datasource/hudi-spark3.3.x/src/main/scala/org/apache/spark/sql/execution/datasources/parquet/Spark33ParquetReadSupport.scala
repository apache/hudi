 ...
 */
class Spark33ParquetReadSupport(
  ...
  override def init(context: InitContext): ReadContext = {
    ...
    val parquetRequestedSchema = Spark33ParquetReadSupport.getRequestedSchema(
  ...
  override def prepareForRead(
    ...
    new ParquetRecordMaterializer(
      ...
      Spark33ParquetReadSupport.expandUDT(catalystRequestedSchema),
...
object Spark33ParquetReadSupport extends Logging {
  ...
  def getRequestedSchema(
    ...
    val parquetClippedSchema = Spark33ParquetReadSupport.clipParquetSchema(parquetFileSchema,
    ...
    val parquetRequestedSchema = if (schemaPruningEnabled && !enableVectorizedReader) {
      ...
      Spark33ParquetReadSupport.intersectParquetGroups(parquetClippedSchema, parquetFileSchema)
