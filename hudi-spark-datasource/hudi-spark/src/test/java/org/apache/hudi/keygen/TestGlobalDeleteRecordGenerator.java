...
public class TestGlobalDeleteRecordGenerator extends KeyGeneratorTestUtilities {
    ...
    public void testNullRecordKeyFields() {
        ...
        Assertions.assertThrows(
                HoodieKeyException.class,
                () -> {
                    BaseKeyGenerator keyGenerator =
                            new GlobalDeleteKeyGenerator(getPropertiesWithoutRecordKeyProp());
    ...
    public void testWrongRecordKeyField() {
        GlobalDeleteKeyGenerator keyGenerator =
                new GlobalDeleteKeyGenerator(getWrongRecordKeyFieldProps());
