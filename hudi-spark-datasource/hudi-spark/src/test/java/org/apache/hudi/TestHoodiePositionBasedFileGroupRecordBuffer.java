...
public class TestHoodiePositionBasedFileGroupRecordBuffer extends TestHoodieFileGroupReaderOnSpark {
    ...
    public void prepareBuffer(RecordMergeMode mergeMode) throws Exception {
        ...
        writeConfigs.put(
                ...
                mergeMode.equals(RecordMergeMode.OVERWRITE_WITH_LATEST) ? "" : "timestamp");
        ...
        writeConfigs.put(
                HoodieWriteConfig.WRITE_PAYLOAD_CLASS_NAME.key(), getRecordPayloadForMergeMode(mergeMode));
        commitToTable(
        ...
        ctx.setSchemaHandler(
                new HoodiePositionBasedSchemaHandler<>(
                        ctx, avroSchema, avroSchema, Option.empty(), metaClient.getTableConfig()));
        ...
        buffer =
                new HoodiePositionBasedFileGroupRecordBuffer<>(
                        ctx, metaClient, partitionNameOpt, partitionFields, ctx.getRecordMerger(), props);
    }
