...
public class TestTimestampBasedKeyGenerator {
    ...
    private Row genericRecordToRow(GenericRecord baseRecord) {
        Function1<GenericRecord, Row> convertor =
                AvroConversionUtils.createConverterToRow(baseRecord.getSchema(), structType);
    ...
    private TypedProperties getBaseKeyConfig(
        ...
        if (scalarType != null) {
            properties.setProperty(
                    "hoodie.deltastreamer.keygen.timebased.timestamp.scalar.time.unit", scalarType);
        }
    ...
    private TypedProperties getBaseKeyConfig(
        ...
        if (inputFormatDelimiterRegex != null) {
            properties.setProperty(
                    TIMESTAMP_INPUT_DATE_FORMAT_LIST_DELIMITER_REGEX.key(), inputFormatDelimiterRegex);
        }
    ...
    public void testTimestampBasedKeyGenerator() throws IOException {
        ...
        properties =
                getBaseKeyConfig("createTime", "EPOCHMILLISECONDS", "yyyy-MM-dd hh", "GMT+8:00", null);
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("2020-01-06 12"),
        ...
        Schema resolvedNullableSchema =
                AvroSchemaUtils.resolveNullableSchema(schema.getField("createTimeDecimal").schema());
        GenericFixed avroDecimal =
                conversion.toFixed(decimal, resolvedNullableSchema, LogicalTypes.decimal(20, 4));
        baseRecord.put("createTimeDecimal", avroDecimal);
        properties =
                getBaseKeyConfig(
                        "createTimeDecimal", "EPOCHMILLISECONDS", "yyyy-MM-dd hh", "GMT+8:00", null);
        ...
        properties =
                getBaseKeyConfig("createTimeString", "DATE_STRING", "yyyy-MM-dd hh", "GMT+8:00", null);
        properties.setProperty(
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("1970-01-01 08"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("1970-01-01 12:00:00"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
    }
    ...
    public void testScalar() throws IOException {
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("2024-10-04 12"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("1970-01-02 12"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
    ...
    public void testScalarWithLogicalType() throws IOException {
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("2021/12/03"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
        ...
        internalRow = KeyGeneratorTestUtilities.getInternalRow(baseRow);
        assertEquals(
                UTF8String.fromString("1970/01/01"),
                keyGen.getPartitionPath(internalRow, baseRow.schema()));
    }
    ...
    public void test_Throws_MultipleInputFormats_InputDateNotMatchingFormats() throws IOException {
        ...
        Assertions.assertThrows(
                HoodieKeyGeneratorException.class, () -> keyGen.getPartitionPath(baseRow));
    }
