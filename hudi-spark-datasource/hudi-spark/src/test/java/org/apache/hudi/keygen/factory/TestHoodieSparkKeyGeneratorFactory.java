...
/**
  ...
  *
  * <p>The functional test of KeyGenerator is left to other unit tests. {@link
  * TestComplexKeyGenerator etc.}.
  */
public class TestHoodieSparkKeyGeneratorFactory {
    ...
    public void testKeyGeneratorFactory() {
        ...
        assertThrows(
                HoodieException.class, () -> HoodieSparkKeyGeneratorFactory.createKeyGenerator(props2));
        ...
        assertThrows(
                ...
                () -> HoodieSparkKeyGeneratorFactory.createKeyGenerator(props3));
