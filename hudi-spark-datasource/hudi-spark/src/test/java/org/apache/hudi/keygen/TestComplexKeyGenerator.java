...
public class TestComplexKeyGenerator extends KeyGeneratorTestUtilities {
    ...
    public void testHappyFlow() {
        ...
        Assertions.assertEquals(
                keyGenerator.getPartitionPath(row), "timestamp=4357686/ts_ms=2020-03-21");

        InternalRow internalRow = KeyGeneratorTestUtilities.getInternalRow(row);
        Assertions.assertEquals(
                UTF8String.fromString("timestamp=4357686/ts_ms=2020-03-21"),
    ...
    public void testSingleValueKeyGenerator() {
        ...
        Row row =
                KeyGeneratorTestUtilities.getRow(
                        record,
    ...
    public void testMultipleValueKeyGenerator() {
        ...
        String rowKey =
                "_row_key"
                        + ComplexAvroKeyGenerator.DEFAULT_RECORD_KEY_SEPARATOR
