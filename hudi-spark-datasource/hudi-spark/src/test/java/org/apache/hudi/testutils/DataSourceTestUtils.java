...
public class DataSourceTestUtils {
    ...
    public static Schema getStructTypeExampleSchema() throws IOException {
        return new Schema.Parser()
                .parse(
                        FileIOUtils.readAsUTFString(
                                DataSourceTestUtils.class.getResourceAsStream("/exampleSchema.txt")));
    }
    ...
    public static Schema getStructTypeExampleEvolvedSchema() throws IOException {
        return new Schema.Parser()
                .parse(
                        FileIOUtils.readAsUTFString(
                                DataSourceTestUtils.class.getResourceAsStream("/exampleEvolvedSchema.txt")));
    }
    ...
    public static boolean isLogFileOnly(String basePath) throws IOException {
        ...
        while (files.hasNext()) {
            ...
            if (file.isFile()
                    && !file.getPath()
                            .toString()
                            .contains(HoodieTableMetaClient.METAFOLDER_NAME + StoragePath.SEPARATOR)) {
