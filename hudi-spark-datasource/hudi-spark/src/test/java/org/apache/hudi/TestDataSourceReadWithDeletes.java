...
public class TestDataSourceReadWithDeletes extends SparkClientFunctionalTestHarness {
    ...
    public void test() throws Exception {
        ...
        String[] expected = new String[] {"[id1,Danny,30,2,par1]", "[id3,Julian,40,2,par1]"};
    ...
    private List<WriteStatus> writeData(
            SparkRDDWriteClient client, String instant, String[] records) {
                ...
                .map(
                        rawRecordStr -> {
                            ...
                            OverwriteWithLatestAvroPayload payload =
                                    new OverwriteWithLatestAvroPayload(record, (Long) record.get("ts"));
