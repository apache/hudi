...
public class KeyGeneratorTestUtilities {
    ...
    public static final String NESTED_COL_SCHEMA =
            "{\"type\":\"record\", \"name\":\"nested_col\",\"fields\": ["
    ...
    public static GenericRecord getNestedColRecord(String prop1Value, Long prop2Value) {
        GenericRecord nestedColRecord =
                new GenericData.Record(new Schema.Parser().parse(NESTED_COL_SCHEMA));
    ...
    public static Row getRow(GenericRecord record, Schema schema, StructType structType) {
        Function1<GenericRecord, Row> converterFn =
    ...
    public static InternalRow getInternalRow(Row row, ExpressionEncoder<Row> encoder)
