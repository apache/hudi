...
public class TestDataSourceUtils {
  ...
  public void testCreateUserDefinedBulkInsertPartitionerRowsWithValidPartitioner() throws HoodieException {
    writeConfig = HoodieWriteConfig.newBuilder()
        .withPath("/")
        .withUserDefinedBulkInsertPartitionerClass(NoOpBulkInsertPartitionerRows.class.getName())
        .build();
  ...
  @Test
  public void testCreateUserDefinedBulkInsertPartitionerRowsWithLegacyCtor() throws HoodieException {
    writeConfig = HoodieWriteConfig.newBuilder()
        .withPath("/")
        .withUserDefinedBulkInsertPartitionerClass(LegacyBulkInsertPartitionerRows.class.getName())
        .build();
  ...
  public static class LegacyBulkInsertPartitionerRows
      implements BulkInsertPartitioner<Dataset<Row>> {

    // NOTE: This partitioner only bears legacy ctor
    public LegacyBulkInsertPartitionerRows(HoodieWriteConfig config) {}
