...
class TestPartitionStatsPruning extends ColumnStatIndexTestBase {
  ...
  def testMetadataColumnStatsIndexInitializationWithUpserts(): Unit = {
    // tableType: HoodieTableType, partitionCol : String
    ...
    doWriteAndValidateColumnStats(ColumnStatsTestParams(testCase, metadataOpts0, commonOpts,
      ...
      expectedColStatsSourcePath = "index/colstats/cow-bootstrap_minus1-partition-stats-index-table.json",
      operation = DataSourceWriteOptions.UPSERT_OPERATION_OPT_VAL,
      saveMode = SaveMode.Append,
      numPartitions =  1,
      parquetMaxFileSize = 100 * 1024 * 1024,
    ...
    doWriteAndValidateColumnStats(ColumnStatsTestParams(testCase, metadataOpts0, commonOpts,
      ...
      expectedColStatsSourcePath = "index/colstats/cow-bootstrap0-partition-stats-index-table.json",
    ...
    doWriteAndValidateColumnStats(ColumnStatsTestParams(testCase, metadataOpts1, commonOpts,
      ...
      expectedColStatsSourcePath = "index/colstats/mor-bootstrap1-partition-stats-index-table.json",
      operation = DataSourceWriteOptions.UPSERT_OPERATION_OPT_VAL,
      saveMode = SaveMode.Append,
    ...
    doWriteAndValidateColumnStats(ColumnStatsTestParams(testCase, metadataOpts1, commonOpts,
      ...
      expectedColStatsSourcePath = "index/colstats/mor-bootstrap2-partition-stats-index-table.json",
      operation = DataSourceWriteOptions.UPSERT_OPERATION_OPT_VAL,
      saveMode = SaveMode.Append,
      latestCompletedCommit = latestCompletedCommit,
      numPartitions =  1,
  ...
  //@MethodSource(Array("testTableTypePartitionTypeParams"))
  //@Test
  def testMetadataColumnStatsIndexInitializationWithRollbacks(): Unit = {
    // tableType: HoodieTableType, partitionCol : String
    val tableType: HoodieTableType = HoodieTableType.MERGE_ON_READ
    val partitionCol : String ="c8"
    val testCase = ColumnStatsTestCase(tableType, shouldReadInMemory = true)
