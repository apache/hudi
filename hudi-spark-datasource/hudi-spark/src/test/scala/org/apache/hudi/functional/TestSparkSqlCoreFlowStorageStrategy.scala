...
@SparkSQLCoreFlow
class TestSparkSqlCoreFlowStorageStrategy extends HoodieSparkSqlTestBase {
  ...
  def testCoreFlows(basePath: File, tableType: String, isMetadataEnabledOnWrite: Boolean, isMetadataEnabledOnRead: Boolean, keyGenClass: String, indexType: String): Unit = {
    ...
    val storagePath = basePath.getCanonicalPath + "/storage"
    val writeOptions = getWriteOptions(tableName, tableType, isMetadataEnabledOnWrite, keyGenClass, indexType, storagePath)
  ...
  def doSnapshotRead(tableName: String, isMetadataEnabledOnRead: Boolean): sql.DataFrame = {
    ...
    spark.sql("set hoodie.storage.strategy.class=\"org.apache.hudi.common.storage.HoodieObjectStoreStorageStrategy\"")
  ...
  def getWriteOptions(tableName: String, tableType: String, isMetadataEnabledOnWrite: Boolean,
                      keyGenClass: String, indexType: String, storagePath: String): String = {
    ...
    s"""
       ...
       |  hoodie.storage.strategy.class = "org.apache.hudi.common.storage.HoodieObjectStoreStorageStrategy",
       |  hoodie.storage.path = "$storagePath"
       | )""".stripMargin
  }
