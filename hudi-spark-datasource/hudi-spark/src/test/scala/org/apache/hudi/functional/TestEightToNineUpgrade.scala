...
class TestEightToNineUpgrade extends RecordLevelIndexTestBase {
  ...
  @CsvSource(value = Array(
    "MERGE_ON_READ," + classOf[PartialUpdateAvroPayload].getName,
    "MERGE_ON_READ," + classOf[OverwriteNonDefaultsWithLatestAvroPayload].getName,
    "MERGE_ON_READ," + classOf[PostgresDebeziumAvroPayload].getName,
    "MERGE_ON_READ," + classOf[AWSDmsAvroPayload].getName
  ))
