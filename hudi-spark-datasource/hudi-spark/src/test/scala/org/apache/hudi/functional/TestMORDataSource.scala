...
import org.apache.hudi.{DataSourceReadOptions, DataSourceWriteOptions, HoodieDataSourceHelpers, HoodieSparkRecord, HoodieSparkRecordCombiningEngine, SparkDatasetMixin}
...
class TestMORDataSource extends HoodieClientTestBase with SparkDatasetMixin {
  ...
  @Test def testCount1() {
    ...
    inputDF1.write.format("org.apache.hudi")
      .options(commonOpts)
      .option(HoodieCompactionConfig.COMBINE_ENGINE_CLASS_NAME.key(), classOf[HoodieSparkRecordCombiningEngine].getName)
