...
import org.apache.hudi.common.config.TimestampKeyGeneratorConfig._
...
class TestMORDataSource extends HoodieSparkClientTestBase with SparkDatasetMixin {
  ...
  def testPrunePartitionForTimestampBasedKeyGeneratorWithInformationLoss(enableFileIndex: Boolean,
    ...
    assertEquals(id600 + id615 + id630, spark.sql(
    ...
    assertEquals(id600 + id615 + id630, spark.sql(
      s"""select * from firstwrite where to_timestamp("$fiveFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") < firstwrite.extra_partition_field"""
    ...
    assertEquals(id545 + id600 + id615 + id630 + id645, spark.sql(
      s"""select * from firstwrite where firstwrite.extra_partition_field > to_timestamp("$fiveFourFourTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") """
    ...
    assertEquals(id545 + id600 + id615 + id630 + id645, spark.sql(
      s"""select * from firstwrite where to_timestamp("$fiveFourFourTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") < firstwrite.extra_partition_field"""
    ...
    assertEquals(id600 + id615 + id630, spark.sql(
      s"""select * from secondwrite where secondwrite.extra_partition_field > to_timestamp("$fiveFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") """
    ...
    assertEquals(id600 + id615 + id630, spark.sql(
      s"""select * from secondwrite where to_timestamp("$fiveFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") < secondwrite.extra_partition_field"""
    ...
    assertEquals(id545 + id600 + id615 + id630 + id645, spark.sql(
      s"""select * from secondwrite where secondwrite.extra_partition_field > to_timestamp("$fiveFourFourTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") """
    ...
    assertEquals(id545 + id600 + id615 + id630 + id645, spark.sql(
      s"""select * from secondwrite where to_timestamp("$fiveFourFourTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") < secondwrite.extra_partition_field"""
    ...
    assertEquals(id600 + id630, spark.sql(
      s"""select * from secondwrite where secondwrite.driver = 'driver-002' and secondwrite.extra_partition_field > to_timestamp("$fiveFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") """
        + s""" and secondwrite.extra_partition_field < to_timestamp("$sixFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ")""").agg(sum("dateid")).first.get(0))

    assertEquals(id600 + id630, spark.sql(
      s"""select * from secondwrite where secondwrite.driver = 'driver-002' and  to_timestamp("$fiveFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") < secondwrite.extra_partition_field"""
        + s""" and to_timestamp("$sixFourFiveTS", "yyyy-MM-dd'T'HH:mm:ss.SSSSSSZ") > secondwrite.extra_partition_field""").agg(sum("dateid")).first.get(0))
  }
}
