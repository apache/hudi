    ...
    java.util.Arrays.asList(
      ...
      Arguments.of(
        ...
        Map(
          ...
          HoodieTableConfig.RECORD_MERGE_STRATEGY_ID.key() -> HoodieRecordMerger.COMMIT_TIME_BASED_MERGE_STRATEGY_UUID),
          HoodieTableConfig.MERGE_CUSTOM_PROPERTY_PREFIX + DefaultHoodieRecordPayload.DELETE_KEY -> "Op",
          HoodieTableConfig.MERGE_CUSTOM_PROPERTY_PREFIX + DefaultHoodieRecordPayload.DELETE_MARKER -> "D"),
      Arguments.of(
        "MERGE_ON_READ",
