...
public class TestHoodieBulkInsertDataInternalWriter extends HoodieBulkInsertInternalWriterTestBase {
    ...
    public void testDataInternalWriter(boolean sorted, boolean populateMetaFields) throws Exception {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            HoodieBulkInsertDataInternalWriter writer =
                    new HoodieBulkInsertDataInternalWriter(
                            table,
                            cfg,
                            instantTime,
            ...
            // write N rows to partition1, N rows to partition2 and N rows to partition3 ... Each
            // batch should create a new RowCreateHandle and a new file
            int batches = 3;
            ...
            assertWriteStatuses(
                    commitMetadata.getWriteStatuses(), batches, size, sorted, fileAbsPaths, fileNames, false);
    ...
    /**
      * Issue some corrupted or wrong schematized InternalRow after few valid InternalRows so that
      * global error is thrown. write batch 1 of valid records write batch2 of invalid records which is
      * expected to throw Global Error. Verify global error is set appropriately and only first batch
      * of records are written to disk.
      */
    @Test
