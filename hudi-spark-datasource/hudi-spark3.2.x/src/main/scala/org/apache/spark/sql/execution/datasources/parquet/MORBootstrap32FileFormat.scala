...
class MORBootstrap32FileFormat(shouldAppendPartitionValues: Boolean,
                               ...
                               isMOR: Boolean,
                               isBootstrap: Boolean) extends Spark32HoodieParquetFileFormat(shouldAppendPartitionValues) with MORBootstrapFileFormat {
