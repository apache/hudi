 ...
 */
public abstract class Spark32SpecificParquetRecordReaderBase<T> extends RecordReader<Void, T> {
  protected Path file;
  ...
  public void initialize(InputSplit inputSplit, TaskAttemptContext taskAttemptContext)
    ...
    String sparkRequestedSchemaString = configuration.get(Spark32ParquetReadSupport.getSchemaConfig(readerType));
