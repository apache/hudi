 ...
 */
public class Spark32VectorizedParquetRecordReader extends Spark32SpecificParquetRecordReaderBase<Object> {
  ...
  public Spark32VectorizedParquetRecordReader(
      ZoneId convertTz,
  ...
  // For test only.
  public Spark32VectorizedParquetRecordReader(boolean useOffHeap, int capacity) {
    this(
        null,
        "CORRECTED",
        "UTC",
