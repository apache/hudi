 ...
 */
public class HoodieVectorizedParquetRecordReader extends HoodieSpecificParquetRecordReaderBase<Object> {
  ...
  // For test only.
  public HoodieVectorizedParquetRecordReader(boolean useOffHeap, int capacity) {
    this(
        null,
        "CORRECTED",
        "UTC",
