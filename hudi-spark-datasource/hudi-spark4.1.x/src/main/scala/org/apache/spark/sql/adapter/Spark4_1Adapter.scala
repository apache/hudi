...
import org.apache.hudi.io.storage.{Spark41VariantProjectedRow, VariantProjectedRow}
...
import org.apache.spark.sql.catalyst.expressions.{AttributeReference, BoundReference, CreateNamedStruct, Expression, GenericInternalRow, Literal, SpecializedGetters, UnsafeProjection}
...
class Spark4_1Adapter extends BaseSpark4Adapter {
  ...
  override def createVariantProjectedRow(
    ...
    new Spark41VariantProjectedRow(numFields, variantStructByOrdinal, extractorByOrdinal)
  }
