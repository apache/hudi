 ...
 */
public class Spark24VectorizedParquetRecordReader extends Spark24SpecificParquetRecordReaderBase<Object> {
  ...
  public Spark24VectorizedParquetRecordReader(TimeZone convertTz, boolean useOffHeap, int capacity, String readerType) {
