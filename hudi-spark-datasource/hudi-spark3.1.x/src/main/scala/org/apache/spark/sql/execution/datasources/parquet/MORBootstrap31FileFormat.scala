...
class MORBootstrap31FileFormat(shouldAppendPartitionValues: Boolean,
                               ...
                               isMOR: Boolean,
                               isBootstrap: Boolean) extends Spark31HoodieParquetFileFormat(shouldAppendPartitionValues) with MORBootstrapFileFormat {
