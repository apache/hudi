...
import org.apache.spark.sql.execution.datasources.parquet.Spark31ParquetReadSupport.getSchemaConfig
 ...
 */
class Spark31ParquetReadSupport(
  ...
  override def init(context: InitContext): ReadContext = {
    ...
    val parquetClippedSchema = Spark31ParquetReadSupport.clipParquetSchema(parquetFileSchema,
    ...
    val parquetRequestedSchema = if (schemaPruningEnabled && !enableVectorizedReader) {
      ...
      Spark31ParquetReadSupport.intersectParquetGroups(parquetClippedSchema, parquetFileSchema)
  ...
  override def prepareForRead(
    ...
    new ParquetRecordMaterializer(
      parquetRequestedSchema,
      Spark31ParquetReadSupport.expandUDT(catalystRequestedSchema),
...
object Spark31ParquetReadSupport {
