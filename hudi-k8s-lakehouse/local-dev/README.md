...
./hudi-k8s-lakehouse/scripts/build-jars.sh              # spark bundle (JDK 11/17) + trino plugin (JDK 23)
minikube start --cpus 4 --memory 10g
eval "$(minikube docker-env)"
./hudi-k8s-lakehouse/scripts/build-images.sh

# 2. bring up the stack
./hudi-k8s-lakehouse/local-dev/scripts/up.sh
...
./hudi-k8s-lakehouse/local-dev/scripts/smoke-test.sh
