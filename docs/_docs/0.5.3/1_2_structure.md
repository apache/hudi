...
permalink: /docs/0.5.3-structure.html
...
Hudi broadly consists of a self contained Spark library to build tables and integrations with existing query engines for data access. See [quickstart](/docs/0.5.3-quick-start-guide) for a demo.
