...
permalink: /docs/0.8.0-deployment.html
...
For more details, refer to the detailed [migration guide](/docs/0.8.0-migration_guide.html). In the future, we will be supporting seamless zero-copy bootstrap of existing tables with all the upsert/incremental query capabilities fully supported.
...
First of all, please confirm if you do indeed have duplicates **AFTER** ensuring the query is accessing the Hudi table [properly](/docs/0.8.0-sql_queries.html) .
