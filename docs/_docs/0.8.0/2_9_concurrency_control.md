...
permalink: /docs/0.8.0-concurrency_control.html
...
It may be helpful to understand the different guarantees provided by [write operations](/docs/0.8.0-writing_data.html#write-operations) via Hudi datasource or the delta streamer.

## Single Writer Guarantees

 - *UPSERT Guarantee*: The target table will NEVER show duplicates.
 - *INSERT Guarantee*: The target table wilL NEVER have duplicates if [dedup](/docs/0.8.0-configurations.html#INSERT_DROP_DUPS_OPT_KEY) is enabled.
 - *BULK_INSERT Guarantee*: The target table will NEVER have duplicates if [dedup](/docs/0.8.0-configurations.html#INSERT_DROP_DUPS_OPT_KEY) is enabled.
...
- *UPSERT Guarantee*: The target table will NEVER show duplicates.
- *INSERT Guarantee*: The target table MIGHT have duplicates even if [dedup](/docs/0.8.0-configurations.html#INSERT_DROP_DUPS_OPT_KEY) is enabled.
- *BULK_INSERT Guarantee*: The target table MIGHT have duplicates even if [dedup](/docs/0.8.0-configurations.html#INSERT_DROP_DUPS_OPT_KEY) is enabled.
