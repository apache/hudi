...
permalink: /docs/0.7.0-quick-start-guide.html
toc: true
...
[Copy on Write](/docs/0.7.0-concepts.html#copy-on-write-table). 
...
and for info on ways to ingest data into Hudi, refer to [Writing Hudi Tables](/docs/0.7.0-writing_data.html).
Here we are using the default write operation : `upsert`. If you have a workload without updates, you can also issue 
`insert` or `bulk_insert` operations which could be faster. To know more, refer to [Write operations](/docs/0.7.0-writing_data#write-operations)
{: .notice--info}
...
Refer to [Table types and queries](/docs/0.7.0-concepts#table-types--queries) for more info on all table types and query types supported.
{: .notice--info}
...
[Querying](#query-data) the data again will now show updated trips. Each write operation generates a new [commit](/docs/0.7.0-concepts.html) 
...
See the [deletion section](/docs/0.7.0-writing_data.html#deletes) of the writing data page for more details.
...
steps [here](/docs/0.7.0-docker_demo.html) to get a taste for it. Also, if you are looking for ways to migrate your existing data 
to Hudi, refer to [migration guide](/docs/0.7.0-migration_guide.html). 
