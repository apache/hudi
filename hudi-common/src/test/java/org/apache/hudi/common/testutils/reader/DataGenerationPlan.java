...
/**
  * The blueprint of records that will be generated by the data generator.
  *
  * <p>Current limitations: 1. One plan generates one file, either a base file, or a log file. 2. One
  * file contains one operation, e.g., insert, delete, or update.
  */
    ...
    public static class Builder {
        ...
        public DataGenerationPlan build() {
            return new DataGenerationPlan(
                    recordKeys, partitionPath, timestamp, operationType, instantTime, writePositions);
        }
    }
}
