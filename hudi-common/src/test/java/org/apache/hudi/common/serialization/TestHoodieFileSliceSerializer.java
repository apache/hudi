...
class TestHoodieFileSliceSerializer {
  ...
  void testSerDe() throws IOException {
    ...
    HoodieBaseFile baseFile1 = new HoodieBaseFile(new FileStatus(100, false, 3, 1024, 0, new Path("fileId-1/baseFilepath.parquet")));
    HoodieLogFile logFile1 =  new HoodieLogFile(new FileStatus(100, false, 3, 1024, 0, new Path(String.format(LOG_FILE_PATH_FORMAT, "1", "0"))));
    HoodieLogFile logFile2 =  new HoodieLogFile("/dummy/base/" + FSUtils.makeLogFileName(
        "fileId-1", HoodieLogFile.DELTA_EXTENSION, "001", 2, "1-0-1"));
    HoodieBaseFile baseFile2 = new HoodieBaseFile(new FileStatus(100, false, 3, 1024, 0, new Path("fileId-2/baseFilepath.parquet")));
    HoodieLogFile logFile3 =  new HoodieLogFile(new FileStatus(100, false, 3, 1024, 0, new Path(String.format(LOG_FILE_PATH_FORMAT, "2", "2"))));
    HoodieLogFile logFile4 =  new HoodieLogFile("/dummy/base/" + FSUtils.makeLogFileName(
        "fileId-2", HoodieLogFile.DELTA_EXTENSION, "002", 2, "1-0-1"));
