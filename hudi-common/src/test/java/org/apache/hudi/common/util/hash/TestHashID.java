...
public class TestHashID {
    ...
    public void testHashValues() {
        Map<HashID.Size, Map<String, String>> expectedValuesMap =
                new HashMap<HashID.Size, Map<String, String>>();
        Map<String, String> hash32ExpectedValues =
        ...
        Map<String, String> hash64ExpectedValues =
                new HashMap<String, String>() {
                    {
        ...
        Map<String, String> hash128ExpectedValues =
                new HashMap<String, String>() {
                    {
        ...
        for (Map.Entry<HashID.Size, Map<String, String>> allSizeEntries :
                expectedValuesMap.entrySet()) {
