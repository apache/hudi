...
/**
 * Unit tests {@link PartialUpdateWithLatestAvroPayload}.
 */
public class TestPartialUpdateWithLatestAvroPayload {
  ...
  public void setUp() throws Exception {
    schema = Schema.createRecord(Arrays.asList(
        ...
        new Schema.Field("city", Schema.createUnion(Schema.create(Schema.Type.NULL), Schema.create(Schema.Type.STRING)), "", null),
  ...
  public void testActiveRecords() throws IOException {
    ...
    PartialUpdateWithLatestAvroPayload payload1 = new PartialUpdateWithLatestAvroPayload(record1, 1);
    PartialUpdateWithLatestAvroPayload payload2 = new PartialUpdateWithLatestAvroPayload(record2, 2);
    ...
    assertEquals(payload2.combineAndGetUpdateValue(record1, schema, props).get(), record3);
  }
  ...
  public void testDeletedRecord() throws IOException {
    ...
    PartialUpdateWithLatestAvroPayload payload1 = new PartialUpdateWithLatestAvroPayload(record1, 1);
    PartialUpdateWithLatestAvroPayload payload2 = new PartialUpdateWithLatestAvroPayload(delRecord1, 2);
