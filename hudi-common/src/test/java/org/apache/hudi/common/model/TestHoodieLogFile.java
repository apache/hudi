...
public class TestHoodieLogFile {
  ...
  private void assertFileGetters(StoragePathInfo fileInfo, HoodieLogFile hoodieLogFile,
                                 long fileLength) {
    assertFileGetters(pathStr, fileInfo, hoodieLogFile, fileLength, "");
  }

  private void assertFileGetters(String pathStr, StoragePathInfo fileInfo,
    ...
    assertEquals(new StoragePath(pathStr), hoodieLogFile.getLocation());
