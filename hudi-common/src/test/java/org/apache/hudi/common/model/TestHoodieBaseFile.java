...
public class TestHoodieBaseFile {
  ...
  void createFromHoodieBaseFile() {
    StoragePathInfo fileInfo = new StoragePathInfo(new StoragePath(pathStr), length, false, blockReplication, blockSize, 0);
  ...
  void createFromExternalFileStatus() {
    ...
    StoragePathInfo inputFileStatus = new StoragePathInfo(
        new StoragePath(storedPathString), length, false, blockReplication, blockSize, 0);
    StoragePathInfo expectedFileInfo = new StoragePathInfo(
  ...
  private void assertFileGetters(StoragePathInfo fileInfo, HoodieBaseFile hoodieBaseFile,
  ...
  private void assertFileGetters(StoragePathInfo fileStatus, HoodieBaseFile hoodieBaseFile,
                                 long fileLength, Option<HoodieBaseFile> bootstrapBaseFile,
    ...
    assertEquals(new StoragePath(pathStr), hoodieBaseFile.getLocation());
