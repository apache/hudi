...
public class TestHoodieBaseFile {
    ...
    void createFromHoodieBaseFile() {
        StoragePathInfo pathInfo =
                new StoragePathInfo(
                        new StoragePath(pathStr), length, false, blockReplication, blockSize, 0);
    ...
    private void assertFileGetters(
            StoragePathInfo pathInfo,
            HoodieBaseFile hoodieBaseFile,
            long fileLength,
            Option<HoodieBaseFile> bootstrapBaseFile) {
        assertFileGetters(
                pathInfo, hoodieBaseFile, fileLength, bootstrapBaseFile, fileId, pathStr, fileName);
    }
