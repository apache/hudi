...
public class SampleTestRecord implements Serializable {
    ...
    public SampleTestRecord(
            String instantTime, int recordNumber, String fileId, boolean populateMetaFields) {
        ...
        this.stringArray =
                new String[] {"stringArray0" + commitTimeSuffix, "stringArray1" + commitTimeSuffix};
    }
