...
public class TestBinaryUtil {
    ...
    public void testIntConvert() {
        ...
        Collections.sort(
                convertResultWrappers,
                ((o1, o2) ->
                        BinaryUtil.compareTo(o1.result, 0, o1.result.length, o2.result, 0, o2.result.length)));
    ...
    public void testLongConvert() {
        // test Long
        long[] testLong =
                new long[] {-1L, 1L, -2L, 10000L, -100000L, 2L, Long.MAX_VALUE, Long.MIN_VALUE};
        ...
        for (int i = 0; i < testLong.length; i++) {
            ...
            convertResultWrappers.add(
                    new ConvertResultWrapper<>((long) i, BinaryUtil.longTo8Byte(testLong[i])));
        }
    ...
    public void testDoubleConvert() {
        // test Long
        double[] testDouble =
                new double[] {-1.00d, 1.05d, -2.3d, 10000.002d, -100000.7d, 2.9d, Double.MAX_VALUE};
        ...
        for (int i = 0; i < testDouble.length; i++) {
            ...
            convertResultWrappers.add(
                    new ConvertResultWrapper<>((Double) (i * 1.0), BinaryUtil.doubleTo8Byte(testDouble[i])));
        }
    ...
    public void testFloatConvert() {
        ...
        float[] testDouble =
                new float[] {
                    -1.00f, 1.05f, -2.3f, 10000.002f, -100000.7f, 2.9f, Float.MAX_VALUE, Float.MIN_VALUE
                };
        ...
        for (int i = 0; i < testDouble.length; i++) {
            ...
            convertResultWrappers.add(
                    new ConvertResultWrapper<>(
                            (float) (i * 1.0), BinaryUtil.doubleTo8Byte((double) testDouble[i])));
        }
