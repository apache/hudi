...
public class PreCombineTestUtils {
    private static String[] preCombineConfigs =
            new String[] {
    ...
    public static Stream<Arguments> configurePreCombine() {
        return Stream.of(Arrays.stream(preCombineConfigs).map(Arguments::of).toArray(Arguments[]::new));
    }

    /**
      * Sets specified key to the value provided. The other preCombine related configs are removed from
      * properties.
      */
