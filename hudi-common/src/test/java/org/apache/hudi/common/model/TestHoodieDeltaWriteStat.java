...
public class TestHoodieDeltaWriteStat {
    ...
    public void testBaseFileAndLogFiles() {
        ...
        String baseFile =
                "file1" + HoodieTableConfig.BASE_FILE_FORMAT.defaultValue().getFileExtension();
    ...
    void testGetHoodieDeltaWriteStatFromPreviousStat() {
        HoodieDeltaWriteStat prevStat =
                createDeltaWriteStat("part", "fileId", "888", "base", Collections.singletonList("log1"));
    ...
    private HoodieDeltaWriteStat createDeltaWriteStat(
            String partition, String fileId, String prevCommit, String baseFile, List<String> logFiles) {
