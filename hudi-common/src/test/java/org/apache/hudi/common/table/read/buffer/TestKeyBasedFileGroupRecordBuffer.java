...
class TestKeyBasedFileGroupRecordBuffer extends BaseFileGroupRecordBuffer {
  ...
  private static KeyBasedFileGroupRecordBuffer<IndexedRecord> buildKeyBasedFileGroupRecordBuffer(HoodieReaderContext<IndexedRecord> readerContext,
    ...
    return buildKeyBasedFileGroupRecordBuffer(readerContext, tableConfig, readStats, recordMerger, recordMergeMode, orderingFieldNames, new TypedProperties());
  }
