...
public class TestHoodieConfig {
    ...
    public void testHoodieConfig() {
        ...
        HoodieTestFakeConfig config2 =
                HoodieTestFakeConfig.newBuilder().withFakeString("value1").build();
        ...
        // FAKE_STRING_CONFIG_NO_DEFAULT_WITH_INFER, and
        // FAKE_STRING_CONFIG_NO_DEFAULT_WITH_INFER_EMPTY are inferred
        HoodieTestFakeConfig config3 = HoodieTestFakeConfig.newBuilder().withFakeString("5").build();
        ...
        HoodieTestFakeConfig config4 =
                HoodieTestFakeConfig.newBuilder()
                        .withFakeString("5")
                        .withFakeInteger(200)
                        .withFakeStringNoDefaultWithInfer("xyz")
                        .withFakeStringNoDefaultWithInferEmpty("uvw")
                        .build();
