...
public class TestLSMTimeline {
    ...
    void testParseMinInstantTime() {
        ...
        assertThrows(
                HoodieException.class, () -> LSMTimeline.getMinInstantTime("invalid_file_name.parquet"));
    }
    ...
    void testParseMaxInstantTime() {
        ...
        assertThrows(
                HoodieException.class, () -> LSMTimeline.getMaxInstantTime("invalid_file_name.parquet"));
    }
    ...
    void testParseFileLayer() {
        ...
        assertThat(
                "for invalid file name, returns 0",
                LSMTimeline.getFileLayer("invalid_file_name.parquet"),
                is(0));
    }
}
