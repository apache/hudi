...
/**
  ...
  *
  * <p>This class was ripped from MiniZooKeeperCluster from the HBase tests. Changes made include:
  *
  * <p>1. It will now only launch 1 zookeeper server.
  *
  * <p>2. It will only attempt to bind to the port specified, and will fail if it can't.
  *
  * <p>3. The startup method now takes a bindAddress, which allows us to configure which IP the ZK
  * server binds to. This was not configurable in the original class.
  *
  * <p>4. The ZK cluster will re-use a data dir on the local filesystem if it already exists instead
  * of blowing it away.
  */
