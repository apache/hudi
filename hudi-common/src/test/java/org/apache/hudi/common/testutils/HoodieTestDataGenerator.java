...
public class HoodieTestDataGenerator implements AutoCloseable {
  ...
  public static final String TRIP_HIVE_COLUMN_TYPES = "bigint,string,string,string,string,string,double,double,double,double,date,bigint,float,binary,int,bigint,decimal(10,6),"
