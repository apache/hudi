...
public class HoodieTestDataGenerator implements AutoCloseable {
  ...
  public static final String TRIP_HIVE_COLUMN_TYPES = "bigint,string,string,string,string,string,"
      + "double,double,double,double,int,bigint,float,binary,struct<name:string>,int,bigint,"
      + "decimal(10,6),map<string,string>,struct<amount:double,currency:string>,"
      + "array<struct<amount:double,currency:string>>,boolean";
