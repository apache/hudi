...
public class TestMergeSchema {
    ...
    public void testPrimitiveMerge() {
        ...
        Pair<InternalSchema, Map<String, String>> mergeSchemaWithRenamedField =
                new InternalSchemaMerger(oldSchema, finalSchema, true, false, false)
                ...
                new InternalSchema(
                        Types.RecordType.get(
                                Arrays.asList(
                                        ...
                                        Types.Field.get(
                                                6, true, "col1suffix", Types.BooleanType.get(), "add new col1"))));
        ...
        InternalSchema mergeSchema1 =
                new InternalSchemaMerger(oldSchema, finalSchema, true, true).mergeSchema();
        InternalSchema checkedSchema1 =
                new InternalSchema(
                        Types.RecordType.get(
                                Arrays.asList(
                                        Types.Field.get(4, true, "c1", Types.BooleanType.get(), "add c1 after col1"),
