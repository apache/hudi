...
public class TestTableChanges {
    ...
    public void testNestAdd() {
        ...
        InternalSchema newSchema = SchemaChangeUtils.applyTableChanges2Schema(oldSchema, addChange);
        Types.RecordType expectedRecordType =
                Types.RecordType.get(
    ...
    public void testNestDelete() {
                ...
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                ...
                                Types.MapType.get(
                                        ...
                                        Types.StringType.get(),
                                        Types.RecordType.get(
                                                Types.Field.get(9, false, "lat", Types.FloatType.get()),
                                                Types.Field.get(10, false, "long", Types.FloatType.get())),
                                        false)),
                        Types.Field.get(
                                4,
                                true,
                                ...
                                Types.ArrayType.get(
                                        ...
                                        true,
                                        Types.RecordType.get(
                                                Types.Field.get(12, false, "x", Types.LongType.get()),
                                                Types.Field.get(13, false, "y", Types.LongType.get())))));
        InternalSchema oldSchema = new InternalSchema(recordType);
        TableChanges.ColumnDeleteChange deleteChange = TableChanges.ColumnDeleteChange.get(oldSchema);
        ...
        InternalSchema newSchema = SchemaChangeUtils.applyTableChanges2Schema(oldSchema, deleteChange);
        Types.RecordType checkedRecordType =
                Types.RecordType.get(
                        Types.Field.get(0, false, "id", Types.IntType.get()),
                        Types.Field.get(
                                2,
                        ...
                        Types.Field.get(
                                ...
                                Types.MapType.get(
                                        ...
                                        8,
                                        Types.StringType.get(),
                                        Types.RecordType.get(Types.Field.get(10, false, "long", Types.FloatType.get())),
                                        false)),
                        Types.Field.get(
                                4,
                                true,
    ...
    public void testPrimitiveUpdate() {
        ...
        updateChange
                .updateColumnType("col2", Types.LongType.get())
                .updateColumnComment("col2", "alter col2 comments")
                .renameColumn("col2", "colx")
        ...
        Types.RecordType expectedRecordType =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                ...
                                Types.RecordType.get(
                                        Types.Field.get(
                                                5, false, "f1", Types.BooleanType.get(), "add feature1 comment"),
                                        Types.Field.get(6, true, "feature2", Types.BooleanType.get()))),
                        Types.Field.get(
                                3,
                                false,
                                ...
                                Types.MapType.get(
                                        ...
                                        Types.StringType.get(),
                                        Types.RecordType.get(
                                                Types.Field.get(9, false, "lax", Types.FloatType.get(), "add lat comment"),
                                                Types.Field.get(10, false, "long", Types.FloatType.get())),
                                        false)),
                        Types.Field.get(
                                4,
                                ...
                                Types.ArrayType.get(
                                        ...
                                        Types.RecordType.get(
                                                Types.Field.get(13, false, "y", Types.LongType.get()),
                                                Types.Field.get(12, false, "z", Types.LongType.get())))),
                        Types.Field.get(1, true, "data", Types.StringType.get()));
        Assertions.assertEquals(expectedRecordType, newSchema.getRecord());
    }
    ...
    public void testChangeApplier() {
        ...
        Types.RecordType recordType =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                ...
                                true,
                                "properties",
                                Types.MapType.get(17, 18, StringType.get(), StringType.get())));
        InternalSchema oldSchema = new InternalSchema(recordType);

        // add c1 first
        InternalSchema newSchema =
                addOperationForSchemaChangeApplier(
                        oldSchema, "c1", StringType.get(), "add c1 first", "id", ColumnPositionType.BEFORE);
        // add preferences.cx before preferences.feature2
        newSchema =
                addOperationForSchemaChangeApplier(
                        newSchema,
        ...
        newSchema =
                addOperationForSchemaChangeApplier(
                        ...
                        "add locations.value.lax before locations.value.long");
        newSchema =
                reOrderOperationForSchemaChangeApplier(
                        newSchema, "locations.value.lax", "locations.value.long", ColumnPositionType.BEFORE);
        //
        // add points.element.z after points.element.y
        newSchema =
                addOperationForSchemaChangeApplier(
    ...
    private static InternalSchema addOperationForSchemaChangeApplier(
            InternalSchema schema, String colName, Type colType, String doc) {
        return addOperationForSchemaChangeApplier(
                schema, colName, colType, doc, "", ColumnPositionType.NO_OPERATION);
    }
}
