...
public class TestAvroSchemaEvolutionUtils {
    ...
    String schemaStr =
            "{\"type\":\"record\",\"name\":\"newTableName\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"data\","
    ...
    public void testRecordAndPrimitiveTypes() {
        ...
        Schema schema =
                create(
                        ...
                        new Schema.Field(
                                "float",
                                AvroInternalSchemaConverter.nullableSchema(Schema.create(Schema.Type.FLOAT)),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                                "double",
                                AvroInternalSchemaConverter.nullableSchema(Schema.create(Schema.Type.DOUBLE)),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                                "date",
                                AvroInternalSchemaConverter.nullableSchema(
                                        LogicalTypes.date().addToSchema(Schema.create(Schema.Type.INT))),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                        ...
                        new Schema.Field(
                                ...
                                AvroInternalSchemaConverter.nullableSchema(
                                        LogicalTypes.uuid()
                                                .addToSchema(Schema.createFixed("t1.uuid.fixed", null, null, 16))),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                                "fixed",
                                AvroInternalSchemaConverter.nullableSchema(
                                        Schema.createFixed("t1.fixed.fixed", null, null, 10)),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                                "binary",
                                AvroInternalSchemaConverter.nullableSchema(Schema.create(Schema.Type.BYTES)),
                                null,
                                JsonProperties.NULL_VALUE),
                        new Schema.Field(
                                "decimal",
                                AvroInternalSchemaConverter.nullableSchema(
                                        LogicalTypes.decimal(10, 2)
                                                .addToSchema(Schema.createFixed("t1.decimal.fixed", null, null, 5))),
                                null,
                                JsonProperties.NULL_VALUE));
    ...
    public void testArrayType() {
        Type arrayNestRecordType =
                Types.ArrayType.get(
                        0,
                        false,
                        Types.RecordType.get(
                                Arrays.asList(
                                        Types.Field.get(1, false, "a", Types.FloatType.get()),
        ...
        Assertions.assertEquals(convertedSchema, schema);
        Types.ArrayType convertedRecord =
                (Types.ArrayType) AvroInternalSchemaConverter.convertToField(schema);
    ...
    public void testComplexConvert() {
        ...
        Types.RecordType recordType =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                ...
                                "preferences",
                                Types.RecordType.get(
                                        Types.Field.get(7, false, "feature1", Types.BooleanType.get()),
                        ...
                        Types.Field.get(
                                ...
                                Types.MapType.get(
                                        ...
                                        Types.StringType.get(),
                                        Types.RecordType.get(
                                                Types.Field.get(11, false, "lat", Types.FloatType.get()),
                                                Types.Field.get(12, false, "long", Types.FloatType.get())),
                                        false)),
                        Types.Field.get(
                                4,
                                true,
                                ...
                                Types.ArrayType.get(
                                        ...
                                        true,
                                        Types.RecordType.get(
                                                Types.Field.get(14, false, "x", Types.LongType.get()),
                                                Types.Field.get(15, false, "y", Types.LongType.get())))),
                        Types.Field.get(
                                5, false, "doubles", Types.ArrayType.get(16, false, Types.DoubleType.get())),
                        Types.Field.get(
                                6,
                                true,
                                "properties",
                                Types.MapType.get(17, 18, Types.StringType.get(), Types.StringType.get())));
        ...
        Assertions.assertEquals(
                schema, AvroInternalSchemaConverter.convert(internalSchema, "newTableName"));
    }
    ...
    public void testNullFieldType() {
        Schema schema =
                create(
                        "t1",
                        new Schema.Field(
                                "nullField", Schema.create(Schema.Type.NULL), null, JsonProperties.NULL_VALUE));
        Throwable t =
                assertThrows(
                        HoodieNullSchemaTypeException.class, () -> AvroInternalSchemaConverter.convert(schema));
        ...
        Schema schemaArray =
                create(
                        "t2",
                        new Schema.Field(
                                "nullArray", Schema.createArray(Schema.create(Schema.Type.NULL)), null, null));
        t =
                assertThrows(
                        HoodieNullSchemaTypeException.class,
        ...
        Schema schemaMap =
                create(
                        "t3",
                        new Schema.Field(
                                "nullMap", Schema.createMap(Schema.create(Schema.Type.NULL)), null, null));
        t =
                assertThrows(
                        HoodieNullSchemaTypeException.class,
        ...
        Types.RecordType record =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                ...
                                "preferences",
                                Types.RecordType.get(
                                        Types.Field.get(4, false, "feature1", Types.BooleanType.get()),
                                        Types.Field.get(5, true, "feature2", Types.BooleanType.get()))),
                        Types.Field.get(
                                3,
                                false,
                                "locations",
                                Types.MapType.get(
                                        ...
                                        Types.StringType.get(),
                                        Types.RecordType.get(
                                                Types.Field.get(8, false, "lat", Types.FloatType.get()),
                                                Types.Field.get(9, false, "long", Types.FloatType.get())),
                                        false)));
        AtomicInteger newId = new AtomicInteger(100);
        Types.RecordType recordWithNewId =
                (Types.RecordType) InternalSchemaBuilder.getBuilder().refreshNewId(record, newId);

        Types.RecordType newRecord =
                Types.RecordType.get(
                        Types.Field.get(100, false, "id", Types.IntType.get()),
                        ...
                        Types.Field.get(
                                ...
                                "preferences",
                                Types.RecordType.get(
                                        Types.Field.get(104, false, "feature1", Types.BooleanType.get()),
                                        Types.Field.get(105, true, "feature2", Types.BooleanType.get()))),
                        Types.Field.get(
                                103,
                                false,
                                "locations",
                                Types.MapType.get(
                                        ...
                                        Types.StringType.get(),
                                        Types.RecordType.get(
                                                Types.Field.get(108, false, "lat", Types.FloatType.get()),
                                                Types.Field.get(109, false, "long", Types.FloatType.get())),
                                        false)));
    ...
    public void testFixNullOrdering() {
        Schema schema =
                SchemaTestUtil.getSchemaFromResource(TestAvroSchemaEvolutionUtils.class, "/nullWrong.avsc");
        Schema expectedSchema =
                SchemaTestUtil.getSchemaFromResource(TestAvroSchemaEvolutionUtils.class, "/nullRight.avsc");
        Assertions.assertEquals(expectedSchema, AvroInternalSchemaConverter.fixNullOrdering(schema));
        Assertions.assertEquals(
                expectedSchema, AvroInternalSchemaConverter.fixNullOrdering(expectedSchema));
    }
    ...
    public void testFixNullOrderingSameSchemaCheck() {
        Schema schema =
                SchemaTestUtil.getSchemaFromResource(
                        TestAvroSchemaEvolutionUtils.class, "/source_evolved.avsc");
    ...
    /**
      * test record data type changes. int => long/float/double/string long => float/double/string
      * float => double/String double => String/Decimal Decimal => Decimal/String String =>
      * date/decimal date => String enum => String
      */
    @Test
    public void testReWriteRecordWithTypeChanged() {
        String enumSchema =
                "{\"type\":\"enum\",\"name\":\"Enum\",\"namespace\":\"org.apache.hudi.internal.schema.utils.TestAvroSchemaEvolutionUtils$\",\"symbols\":[\"ENUM1\",\"ENUM2\"]}";
        Schema avroSchema =
                new Schema.Parser()
                        .parse(
        ...
        BigDecimal bd =
                new BigDecimal("123.456")
                        .setScale(((LogicalTypes.Decimal) currentDecimalType.getLogicalType()).getScale());
        avroRecord.put(
                "col4",
                HoodieAvroUtils.DECIMAL_CONVERSION.toFixed(
                        bd, currentDecimalType, currentDecimalType.getLogicalType()));
        Schema currentDecimalType1 = avroSchema.getField("col41").schema().getTypes().get(1);
        BigDecimal bd1 =
                new BigDecimal("7890.456")
                        .setScale(((LogicalTypes.Decimal) currentDecimalType1.getLogicalType()).getScale());
        avroRecord.put(
                "col41",
                HoodieAvroUtils.DECIMAL_CONVERSION.toFixed(
                        bd1, currentDecimalType1, currentDecimalType1.getLogicalType()));
        ...
        avroRecord.put(
                "enum", new GenericData.EnumSymbol(new Schema.Parser().parse(enumSchema), Enum.ENUM1));
        ...
        GenericRecord newRecord =
                HoodieAvroUtils.rewriteRecordWithNewSchema(
                        avroRecord, newAvroSchema, Collections.emptyMap());
    ...
    public void testReWriteNestRecord() {
        Types.RecordType record =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                3, false, "doubles", Types.ArrayType.get(7, false, Types.DoubleType.get())),
                        Types.Field.get(
                                4,
                                false,
                                "locations",
                                Types.MapType.get(
                                        ...
                                        Types.RecordType.get(
                                                ...
                                                Types.Field.get(11, false, "long", Types.FloatType.get())),
                                        false)));
        ...
        // fill record type
        GenericData.Record preferencesRecord =
                new GenericData.Record(
                        AvroInternalSchemaConverter.convert(
                                record.fieldType("preferences"), "test1.preferences"));
        ...
        Schema mapSchema =
                AvroInternalSchemaConverter.convert(
                        ((Types.MapType) record.fieldByNameCaseInsensitive("locations").type()).valueType(),
                        "test1.locations");
        ...
        InternalSchema internalSchemaRename =
                SchemaChangeUtils.applyTableChanges2Schema(internalSchema, updateChange);
        Schema avroSchemaRename =
                AvroInternalSchemaConverter.convert(internalSchemaRename, schema.getFullName());
        Map<String, String> renameCols =
                InternalSchemaUtils.collectRenameCols(internalSchema, internalSchemaRename);
        GenericRecord avroRecordRename =
                HoodieAvroUtils.rewriteRecordWithNewSchema(avroRecord, avroSchemaRename, renameCols);
        // test the correctly of rewrite
    ...
    public void testEvolutionSchemaFromNewAvroSchema() {
        Types.RecordType oldRecord =
                Types.RecordType.get(
                        ...
                        Types.Field.get(
                                3, false, "doubles", Types.ArrayType.get(8, false, Types.DoubleType.get())),
                        Types.Field.get(
                                4,
                                false,
                                "locations",
        ...
        evolvedRecord =
                (Types.RecordType)
                        InternalSchemaBuilder.getBuilder().refreshNewId(evolvedRecord, new AtomicInteger(0));
        Schema evolvedAvroSchema = AvroInternalSchemaConverter.convert(evolvedRecord, "test1");
        InternalSchema result =
                AvroSchemaEvolutionUtils.reconcileSchema(evolvedAvroSchema, oldSchema, false);
        Types.RecordType checkedRecord =
                Types.RecordType.get(
                        Types.Field.get(0, false, "id", Types.IntType.get()),
                        Types.Field.get(1, true, "data", Types.StringType.get()),
                        Types.Field.get(
    ...
    public void testReconcileSchema() {
        ...
        Schema simpleCheckSchema =
                new Schema.Parser()
                        .parse(
                                "{\"type\":\"record\",\"name\":\"simple\",\"fields\":[{\"name\":\"a\",\"type\":[\"null\",\"boolean\"],\"default\":null},"
        ...
        Schema simpleReconcileSchema =
                AvroInternalSchemaConverter.convert(
                        AvroSchemaEvolutionUtils.reconcileSchema(
                                incomingSchema, AvroInternalSchemaConverter.convert(schema), false),
                        "schemaNameFallback");
