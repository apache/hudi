...
final class SecondaryIndexTestUtils {
  ...
  static LinkedHashMap<String, Map<String, String>> singleColumn(String columnName) {
    LinkedHashMap<String, Map<String, String>> columns = new LinkedHashMap<>();
    columns.put(columnName, Collections.emptyMap());
    return columns;
  }

  static HoodieSecondaryIndex newLuceneIndex(String indexName, String columnName) {
    return newLuceneIndex(indexName, columnName, Collections.emptyMap());
  }

  static HoodieSecondaryIndex newLuceneIndex(String indexName, String columnName, Map<String, String> options) {
