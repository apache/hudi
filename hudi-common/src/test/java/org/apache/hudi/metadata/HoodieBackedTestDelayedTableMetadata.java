...
/**
  * Table metadata provided by an internal DFS backed Hudi metadata table, with an intentional delay
  * in `reset()` to test concurrent reads and writes.
  */
public class HoodieBackedTestDelayedTableMetadata extends HoodieBackedTableMetadata {
    ...
    public HoodieBackedTestDelayedTableMetadata(
