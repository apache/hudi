...
public class TestMetadataPartitionType {
  ...
  public void testPartitionAvailableByMetaClientOnly() {
    ...
    // Verify RECORD_INDEX and FILES and COLUMN_STATS (by default) is enabled due to availability
    assertEquals(3, enabledPartitions.size(), "RECORD_INDEX and FILES should be available");
  ...
  public void testFunctionalIndexPartitionEnabled() {
    ...
    // Verify FUNCTIONAL_INDEX and FILES and COLUMN_STATS (by default) is enabled due to availability
    assertEquals(3, enabledPartitions.size(), "FUNCTIONAL_INDEX and FILES should be available");
    assertTrue(enabledPartitions.contains(MetadataPartitionType.FILES), "FILES should be enabled by availability");
