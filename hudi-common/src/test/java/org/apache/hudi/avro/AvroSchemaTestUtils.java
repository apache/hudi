...
public class AvroSchemaTestUtils {
    ...
    public static Schema.Field createNestedField(String name, Schema schema) {
        return new Schema.Field(
                name, createRecord(name, new Schema.Field("nested", schema, null, null)), null, null);
    }
    ...
    public static Schema.Field createNullableArrayField(String name, Schema schema) {
        return new Schema.Field(
                name,
                Schema.createUnion(Schema.create(Schema.Type.NULL), Schema.createArray(schema)),
                null,
    ...
    public static Schema.Field createNullablePrimitiveField(String name, Schema.Type type) {
        return new Schema.Field(
                name, AvroSchemaUtils.createNullableSchema(type), null, JsonProperties.NULL_VALUE);
    }
    ...
    public static Schema createNullableRecord(String name, Schema.Field... fields) {
        return AvroSchemaUtils.createNullableSchema(
                Schema.createRecord(name, null, null, false, Arrays.asList(fields)));
    }
}
