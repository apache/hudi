...
/**
 * A {@link BufferedRecord} merger that covers three core merging scenarios within {@link org.apache.hudi.core.read.buffer.FileGroupRecordBuffer}:
 *
 * <ol>
 ...
 * </ol>
 */
public interface BufferedRecordMerger<T> extends Serializable {
