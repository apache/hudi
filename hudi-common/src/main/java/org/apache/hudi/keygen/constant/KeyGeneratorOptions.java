...
public class KeyGeneratorOptions extends HoodieConfig {
    ...
    public static final ConfigProperty<String> URL_ENCODE_PARTITIONING =
            ConfigProperty.key("hoodie.datasource.write.partitionpath.urlencode")
                    .defaultValue("false")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> HIVE_STYLE_PARTITIONING_ENABLE =
            ConfigProperty.key("hoodie.datasource.write.hive_style_partitioning")
                    .defaultValue("false")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> RECORDKEY_FIELD_NAME =
            ConfigProperty.key("hoodie.datasource.write.recordkey.field")
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> SECONDARYKEY_COLUMN_NAME =
            ConfigProperty.key("hoodie.datasource.write.secondarykey.column")
                    .noDefaultValue()
                    .withDocumentation(
                            "Columns that constitute the secondary key component.\n"
                                    + "Actual value will be obtained by invoking .toString() on the field value. Nested fields can be specified using\n"
                                    + "the dot notation eg: `a.b.c`");

    public static final ConfigProperty<String> PARTITIONPATH_FIELD_NAME =
            ConfigProperty.key("hoodie.datasource.write.partitionpath.field")
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> KEYGENERATOR_CONSISTENT_LOGICAL_TIMESTAMP_ENABLED =
            ConfigProperty.key(
                    ...
                    .markAdvanced()
                    .withDocumentation(
                            "When set to true, consistent value will be generated for a logical timestamp type column, "
    ...
    /** @deprecated Use {@link #URL_ENCODE_PARTITIONING} and its methods. */
    @Deprecated
    public static final String DEFAULT_URL_ENCODE_PARTITIONING_OPT_VAL =
    ...
    /** @deprecated Use {@link #HIVE_STYLE_PARTITIONING_ENABLE} and its methods. */
    @Deprecated
    public static final String DEFAULT_HIVE_STYLE_PARTITIONING_OPT_VAL =
            HIVE_STYLE_PARTITIONING_ENABLE.defaultValue();
    /** @deprecated Use {@link #RECORDKEY_FIELD_NAME} and its methods. */
    @Deprecated public static final String RECORDKEY_FIELD_OPT_KEY = RECORDKEY_FIELD_NAME.key();
    ...
    public static class Config {
        ...
        public static final String TIMESTAMP_TYPE_FIELD_PROP =
                TimestampKeyGeneratorConfig.TIMESTAMP_TYPE_FIELD.key();
        ...
        @Deprecated
        public static final String TIMESTAMP_INPUT_TIMEZONE_FORMAT_PROP =
        ...
        // still keeping this prop for backward compatibility so that functionality for existing
        // users does not break.
        @Deprecated
        public static final String TIMESTAMP_TIMEZONE_FORMAT_PROP =
                TimestampKeyGeneratorConfig.TIMESTAMP_TIMEZONE_FORMAT.key();

        @Deprecated
        public static final String TIMESTAMP_OUTPUT_TIMEZONE_FORMAT_PROP =
                TimestampKeyGeneratorConfig.TIMESTAMP_OUTPUT_TIMEZONE_FORMAT.key();

        @Deprecated
        public static final String DATE_TIME_PARSER_PROP =
