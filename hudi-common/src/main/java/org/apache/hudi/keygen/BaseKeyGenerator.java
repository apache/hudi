...
/**
  * Base abstract class to extend for {@link KeyGenerator} with default logic of taking partitioning
        ...
        this.hiveStylePartitioning =
                config.getBoolean(
                        ...
                        Boolean.parseBoolean(
                                KeyGeneratorOptions.HIVE_STYLE_PARTITIONING_ENABLE.defaultValue()));
