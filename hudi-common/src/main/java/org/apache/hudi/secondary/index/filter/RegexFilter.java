...
public class RegexFilter extends IndexFilter {
  private final String regex;

  public RegexFilter(ISecondaryIndexReader indexReader, Field field, String regex) {
  ...
  public IRowIdSet getRowIdSet() throws IOException {
    return indexReader.queryRegex(getField(), regex);
  }

  @Override
  public String toString() {
    return "regex(" + getField().name() + ", " + regex + ")";
  }
}
