...
/**
  * The type of a schema, reference avro schema. now avro version used by hoodie, not support
  * localTime. to do add support for localTime if avro version is updated
  */
public interface Type extends Serializable {
        ...
        switch (type.typeId()) {
            ...
            default:
                throw new UnsupportedOperationException(
                        "Cast value " + partitionValue + " to type " + type + " is not supported yet");
        }
    }
    ...
    abstract class PrimitiveType implements Type {
        ...
        /**
          * We need to override equals because the check {@code intType1 == intType2} can return {@code
          * false}. Despite the fact that most subclasses look like singleton with static field {@code
          * INSTANCE}, they can still be created by deserializer.
          */
        @Override
