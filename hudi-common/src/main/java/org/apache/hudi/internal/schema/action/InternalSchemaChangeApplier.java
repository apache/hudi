...
public class InternalSchemaChangeApplier {
            ...
            switch (positionType) {
                ...
                case BEFORE:
                    ...
                    if (!parentName.equals(referParentName)) {
                        throw new IllegalArgumentException(
                                "cannot reorder two columns which has different parent");
                    }
    ...
    public InternalSchema applyRenameChange(String colName, String newName) {
        TableChanges.ColumnUpdateChange updateChange =
                TableChanges.ColumnUpdateChange.get(latestSchema);
    ...
    /**
      ...
      *     the fullName should be specify.
