...
public abstract class AbstractHoodieTableMetadata implements HoodieTableMetadata {
    ...
    public AbstractHoodieTableMetadata(
            HoodieEngineContext engineContext, HoodieStorage storage, String dataBasePath) {
    ...
    protected static ArrayData extractPartitionValues(
        ...
        partitionValues =
                IntStream.range(0, partitionFragments.length)
                        .mapToObj(
                                idx -> {
