...
@JsonTypeName("EXPRESSION_INDEX")
@JsonFormat(shape = JsonFormat.Shape.OBJECT)
public enum ExpressionIndexVersion implements HoodieIndexVersion {
  V1(1, Arrays.asList("1.0.0"));

  private final int versionCode;
  private final List<String> releaseVersions;

  ExpressionIndexVersion(int versionCode, List<String> releaseVersions) {
