...
@JsonTypeName("RECORD_INDEX")
public enum RecordIndexVersion implements HoodieIndexVersion {
  V1(1, Arrays.asList("1.0.0"));

  private final int versionCode;
  private final List<String> releaseVersions;

  RecordIndexVersion(int versionCode, List<String> releaseVersions) {
  ...
  public MetadataPartitionType getPartitionType() {
    return MetadataPartitionType.RECORD_INDEX;
  }
