...
public class MetadataRecordsGenerationParams implements Serializable {
  ...
  MetadataRecordsGenerationParams(HoodieTableMetaClient dataMetaClient, HoodieTableMetaClient metadataMetaClient, List<MetadataPartitionType> enabledPartitionTypes,
                                  String bloomFilterType, int bloomIndexParallelism, boolean isColumnStatsIndexEnabled, int columnStatsIndexParallelism,
                                  List<String> targetColumnsForColumnStatsIndex, List<String> targetColumnsForBloomFilterIndex) {
