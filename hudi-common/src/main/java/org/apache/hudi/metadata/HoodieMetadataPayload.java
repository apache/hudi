...
public class HoodieMetadataPayload implements HoodieRecordPayload<HoodieMetadataPayload> {
   ...
   */
  public List<StoragePathInfo> getFileStatuses(Configuration hadoopConf, StoragePath partitionPath)
      throws IOException {
   ...
   * Returns the files added as part of this record.
   */
  public List<StoragePathInfo> getFileStatuses(HoodieStorage storage, StoragePath partitionPath) {
