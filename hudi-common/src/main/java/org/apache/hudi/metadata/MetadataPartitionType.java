...
public enum MetadataPartitionType {
  ...
  private static boolean isPartitionType(String partitionPath, String typePartition) {
    return partitionPath.equals(typePartition) || partitionPath.startsWith(typePartition);
  }
