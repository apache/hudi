...
/**
  * Metadata log-block records reading implementation, internally relying on {@link
  * HoodieMergedLogRecordScanner} to merge corresponding Metadata Table's delta log-blocks sequence
  */
@ThreadSafe
public class HoodieMetadataLogRecordReader implements Closeable {
    ...
    @SuppressWarnings("unchecked")
    public Map<String, HoodieRecord<HoodieMetadataPayload>> getRecordsByKeyPrefixes(
        ...
        synchronized (this) {
            ...
            return logRecordScanner.getRecords().entrySet().stream()
    ...
    /**
      * Fetches records identified by the provided list of keys in case these are present in the
      * delta-log blocks
      */
    @SuppressWarnings("unchecked")
    public Map<String, HoodieRecord<HoodieMetadataPayload>> getRecordsByKeys(
    ...
    public static class Builder {
        ...
        public Builder(String partitionName) {
            ...
            this.scannerBuilder =
                    shouldUseMetadataMergedLogRecordScanner()
                            ? HoodieMetadataMergedLogRecordScanner.newBuilder()
                            : HoodieMergedLogRecordScanner.newBuilder();
            scannerBuilder
                    .withKeyFieldOverride(HoodieMetadataPayload.KEY_FIELD_NAME)
                    // NOTE: Merging of Metadata Table's records is currently handled using {@code
        ...
        public Builder withBitCaskDiskMapCompressionEnabled(
        ...
        public Builder withLogBlockTimestamps(Set<String> validLogBlockTimestamps) {
            InstantRange instantRange =
                    InstantRange.builder()
                            ...
                            .explicitInstants(validLogBlockTimestamps)
                            .build();
        ...
        public HoodieMetadataLogRecordReader build() {
            return new HoodieMetadataLogRecordReader(
                    (BaseHoodieMergedLogRecordScanner) scannerBuilder.build());
        }
