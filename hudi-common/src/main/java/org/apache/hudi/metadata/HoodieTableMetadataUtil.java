...
public class HoodieTableMetadataUtil {
  ...
  /**
   * Loads the list of buckets for a partition of the Metadata Table with latest file slices.
   *
   * The list of buckets returned is sorted in the correct order of bucket index.
   * @param metaClient instance of {@link HoodieTableMetaClient}.
   * @param partition The name of the partition whose buckets are to be loaded.
   * @return List of buckets.
   */
  public static List<FileSlice> loadPartitionBucketsWithLatestFileSlices(HoodieTableMetaClient metaClient, String partition) {
    LOG.info("Loading buckets for metadata table partition " + partition);
