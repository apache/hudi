...
/**
  * Encapsulates all the needed information about a clustering file slice. This is needed because
  * spark serialization does not work with avro objects.
  */
public class ClusteringOperation implements Serializable {
    ...
    public static ClusteringOperation create(HoodieSliceInfo sliceInfo) {
        return new ClusteringOperation(
                sliceInfo.getDataFilePath(),
                new ArrayList<>(sliceInfo.getDeltaFilePaths()),
                sliceInfo.getFileId(),
                sliceInfo.getPartitionPath(),
                sliceInfo.getBootstrapFilePath(),
                sliceInfo.getVersion());
    }
    ...
    private ClusteringOperation(
            final String dataFilePath,
            final List<String> deltaFilePaths,
            final String fileId,
            final String partitionPath,
            final String bootstrapFilePath,
            final int version) {
