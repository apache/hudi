...
/**
  ...
  *
  * <p>A triple consisting of three elements.
  *
...
public abstract class Triple<L, M, R> implements Comparable<Triple<L, M, R>>, Serializable {
    ...
    public int compareTo(final Triple<L, M, R> other) {
        ...
        if (thisLeft.compareTo(otherLeft) == 0) {
            return Pair.of(getMiddle(), getRight())
                    .compareTo(Pair.of(other.getMiddle(), other.getRight()));
        } else {
    ...
    private void checkComparable(Triple<L, M, R> triplet) {
        if (!(triplet.getLeft() instanceof Comparable)
                || !(triplet.getMiddle() instanceof Comparable)
                || !(triplet.getRight() instanceof Comparable)) {
            throw new IllegalArgumentException(
                    "Elements of Triple must implement Comparable :" + triplet);
        }
    }
}
