...
@EnumDescription(
        "Types of executor that implements org.apache.hudi.common.util.queue.HoodieExecutor. The executor orchestrates concurrent "
                + "producers and consumers communicating through a message queue.")
public enum ExecutorType {
    @EnumFieldDescription(
            "Executor which orchestrates concurrent producers and consumers communicating through a bounded in-memory message queue "
