...
public class HoodieMemoryConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> MAX_MEMORY_FRACTION_FOR_MERGE =
            ConfigProperty.key("hoodie.memory.merge.fraction")
                    .defaultValue(String.valueOf(0.6))
                    .markAdvanced()
                    .withDocumentation(
                            "This fraction is multiplied with the user memory fraction (1 - spark.memory.fraction) "
    ...
    public static final ConfigProperty<String> MAX_MEMORY_FRACTION_FOR_COMPACTION =
            ConfigProperty.key("hoodie.memory.compaction.fraction")
                    .defaultValue(String.valueOf(0.6))
                    .markAdvanced()
                    .withDocumentation(
                            "HoodieCompactedLogScanner reads logblocks, converts records to HoodieRecords and then "
    ...
    public static final ConfigProperty<Long> MAX_MEMORY_FOR_MERGE =
            ConfigProperty.key("hoodie.memory.merge.max.size")
    ...
    public static final ConfigProperty<String> MAX_MEMORY_FOR_COMPACTION =
            HoodieCommonConfig.MAX_MEMORY_FOR_COMPACTION;
    ...
    // Setting this to lower value of 1 MB since no control over how many RecordReaders will be
    // started in a mapper
    ...
    public static final ConfigProperty<String> SPILLABLE_MAP_BASE_PATH =
            ConfigProperty.key("hoodie.memory.spillable.map.path")
                    .noDefaultValue()
                    .markAdvanced()
    ...
    public static final ConfigProperty<Double> WRITESTATUS_FAILURE_FRACTION =
            ConfigProperty.key("hoodie.memory.writestatus.failure.fraction")
                    .defaultValue(0.1)
                    .markAdvanced()
                    .withDocumentation(
    ...
    @Deprecated
    public static final String MAX_MEMORY_FRACTION_FOR_MERGE_PROP =
            MAX_MEMORY_FRACTION_FOR_MERGE.key();
    /** @deprecated Use {@link #MAX_MEMORY_FRACTION_FOR_MERGE} and its methods instead */
    @Deprecated
    public static final String DEFAULT_MAX_MEMORY_FRACTION_FOR_MERGE =
            MAX_MEMORY_FRACTION_FOR_MERGE.defaultValue();
    /** @deprecated Use {@link #MAX_MEMORY_FRACTION_FOR_COMPACTION} and its methods instead */
    @Deprecated
    public static final String MAX_MEMORY_FRACTION_FOR_COMPACTION_PROP =
            MAX_MEMORY_FRACTION_FOR_COMPACTION.key();
    /** @deprecated Use {@link #MAX_MEMORY_FRACTION_FOR_COMPACTION} and its methods instead */
    @Deprecated
    public static final String DEFAULT_MAX_MEMORY_FRACTION_FOR_COMPACTION =
            MAX_MEMORY_FRACTION_FOR_COMPACTION.defaultValue();
    /** @deprecated Use {@link #MAX_MEMORY_FOR_MERGE} and its methods instead */
    @Deprecated public static final String MAX_MEMORY_FOR_MERGE_PROP = MAX_MEMORY_FOR_MERGE.key();
    ...
    public static final int DEFAULT_MAX_DFS_STREAM_BUFFER_SIZE =
            MAX_DFS_STREAM_BUFFER_SIZE.defaultValue();
    ...
    /** @deprecated Use {@link #WRITESTATUS_FAILURE_FRACTION} and its methods instead */
    @Deprecated
    public static final double DEFAULT_WRITESTATUS_FAILURE_FRACTION =
            WRITESTATUS_FAILURE_FRACTION.defaultValue();
    ...
    public static class Builder {
        ...
        public Builder withMaxMemoryFractionPerPartitionMerge(
                double maxMemoryFractionPerPartitionMerge) {
            memoryConfig.setValue(
                    MAX_MEMORY_FRACTION_FOR_MERGE, String.valueOf(maxMemoryFractionPerPartitionMerge));
            return this;
        }
        ...
        public Builder withMaxMemoryFractionPerCompaction(double maxMemoryFractionPerCompaction) {
            memoryConfig.setValue(
                    MAX_MEMORY_FRACTION_FOR_COMPACTION, String.valueOf(maxMemoryFractionPerCompaction));
            return this;
        }
