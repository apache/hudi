...
@Immutable
@ConfigClassProperty(
        name = "Hudi Table Basic Configs",
        groupName = ConfigGroups.Names.TABLE_CONFIG,
        description =
                "Configurations of the Hudi Table like type of ingestion, storage formats, hive table name etc."
...
public class HoodieTableConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> DATABASE_NAME =
            ConfigProperty.key("hoodie.database.name")
                    .noDefaultValue(
                            "Database name can't have default value as it's used to toggle Hive incremental query feature. See HUDI-2837")
                    .withDocumentation(
                            "Database name that will be used for incremental query.If different databases have the same table name during incremental query, "
                                    + "we can set it to limit the table name under a specific database");

    public static final ConfigProperty<String> NAME =
            ConfigProperty.key(HOODIE_TABLE_NAME_KEY)
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<HoodieTableType> TYPE =
            ConfigProperty.key("hoodie.table.type")
    ...
    public static final ConfigProperty<HoodieTableVersion> VERSION =
            ConfigProperty.key("hoodie.table.version")
    ...
    public static final ConfigProperty<HoodieTableVersion> INITIAL_VERSION =
            ConfigProperty.key("hoodie.table.initial.version")
                    .defaultValue(HoodieTableVersion.ZERO)
                    .withDocumentation(
                            "Initial Version of table when the table was created. Used for upgrade/downgrade"
    ...
    public static final ConfigProperty<String> PRECOMBINE_FIELD =
            ConfigProperty.key("hoodie.table.precombine.field")
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> PARTITION_FIELDS =
            ConfigProperty.key("hoodie.table.partition.fields")
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> RECORDKEY_FIELDS =
            ConfigProperty.key("hoodie.table.recordkey.fields")
                    .noDefaultValue()
                    .withDocumentation(
                            "Columns used to uniquely identify the table. Concatenated values of these fields are used as "
                                    + " the record key component of HoodieKey.");

    public static final ConfigProperty<Boolean> CDC_ENABLED =
            ConfigProperty.key("hoodie.table.cdc.enabled")
                    .defaultValue(false)
                    .sinceVersion("0.13.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> CDC_SUPPLEMENTAL_LOGGING_MODE =
            ConfigProperty.key("hoodie.table.cdc.supplemental.logging.mode")
    ...
    public static final ConfigProperty<String> CREATE_SCHEMA =
            ConfigProperty.key("hoodie.table.create.schema")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<HoodieFileFormat> BASE_FILE_FORMAT =
            ConfigProperty.key("hoodie.table.base.file.format")
    ...
    public static final ConfigProperty<HoodieFileFormat> LOG_FILE_FORMAT =
            ConfigProperty.key("hoodie.table.log.file.format")
    ...
    public static final ConfigProperty<String> RECORD_MERGE_MODE =
            ConfigProperty.key("hoodie.record.merge.mode")
    ...
    public static final ConfigProperty<String> PAYLOAD_CLASS_NAME =
            ConfigProperty.key("hoodie.compaction.payload.class")
                    .defaultValue(DefaultHoodieRecordPayload.class.getName())
                    .deprecatedAfter("1.0.0")
                    .withDocumentation(
                            "Payload class to use for performing compactions, i.e merge delta logs with current base file and then "
                                    + " produce a new base file.");

    public static final ConfigProperty<String> PAYLOAD_TYPE =
            ConfigProperty.key("hoodie.compaction.payload.type")
    ...
    public static final ConfigProperty<String> RECORD_MERGER_STRATEGY =
            ConfigProperty.key("hoodie.compaction.record.merger.strategy")
    ...
    public static final ConfigProperty<String> ARCHIVELOG_FOLDER =
            ConfigProperty.key("hoodie.archivelog.folder")
    ...
    public static final ConfigProperty<Boolean> BOOTSTRAP_INDEX_ENABLE =
            ConfigProperty.key("hoodie.bootstrap.index.enable")
                    .defaultValue(true)
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> BOOTSTRAP_INDEX_CLASS_NAME =
            ConfigProperty.key("hoodie.bootstrap.index.class")
    ...
    public static final ConfigProperty<String> BOOTSTRAP_INDEX_TYPE =
            ConfigProperty.key("hoodie.bootstrap.index.type")
                    .defaultValue(BootstrapIndexType.HFILE.name())
                    .sinceVersion("1.0.0")
                    .withDocumentation(
                            "Bootstrap index type determines which implementation to use, for mapping base files to bootstrap base file, that contain actual data.");

    public static final ConfigProperty<String> BOOTSTRAP_BASE_PATH =
            ConfigProperty.key("hoodie.bootstrap.base.path")
                    .noDefaultValue()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Boolean> POPULATE_META_FIELDS =
            ConfigProperty.key("hoodie.populate.meta.fields")
                    .defaultValue(true)
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> KEY_GENERATOR_CLASS_NAME =
            ConfigProperty.key("hoodie.table.keygenerator.class")
                    .noDefaultValue()
                    .deprecatedAfter("1.0.0")
    ...
    public static final ConfigProperty<String> KEY_GENERATOR_TYPE =
            ConfigProperty.key("hoodie.table.keygenerator.type")
                    .noDefaultValue()
                    .sinceVersion("1.0.0")
    ...
    public static final ConfigProperty<HoodieTimelineTimeZone> TIMELINE_TIMEZONE =
            ConfigProperty.key("hoodie.table.timeline.timezone")
    ...
    public static final ConfigProperty<Boolean> PARTITION_METAFILE_USE_BASE_FORMAT =
            ConfigProperty.key("hoodie.partition.metafile.use.base.format")
                    .defaultValue(false)
                    .withDocumentation(
                            "If true, partition metafiles are saved in the same format as base-files for this dataset (e.g. Parquet / ORC). "
    ...
    public static final ConfigProperty<Boolean> DROP_PARTITION_COLUMNS =
            ConfigProperty.key("hoodie.datasource.write.drop.partition.columns")
                    .defaultValue(false)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Boolean> MULTIPLE_BASE_FILE_FORMATS_ENABLE =
            ConfigProperty.key("hoodie.table.multiple.base.file.formats.enable")
                    .defaultValue(false)
                    .sinceVersion("1.0.0")
                    .withDocumentation(
                            "When set to true, the table can support reading and writing multiple base file formats.");
    ...
    public static final ConfigProperty<String> TABLE_CHECKSUM =
            ConfigProperty.key("hoodie.table.checksum")
                    .noDefaultValue()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> TABLE_METADATA_PARTITIONS_INFLIGHT =
            ConfigProperty.key("hoodie.table.metadata.partitions.inflight")
                    .noDefaultValue()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> TABLE_METADATA_PARTITIONS =
            ConfigProperty.key("hoodie.table.metadata.partitions")
                    .noDefaultValue()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
                            "Comma-separated list of metadata partitions that have been completely built and in-sync with data table. "
                                    + "These partitions are ready for use by the readers");

    public static final ConfigProperty<String> SECONDARY_INDEXES_METADATA =
            ConfigProperty.key("hoodie.table.secondary.indexes.metadata")
                    .noDefaultValue()
                    .sinceVersion("0.13.0")
                    .withDocumentation("The metadata of secondary indexes");

    public static final ConfigProperty<String> INDEX_DEFINITION_PATH =
            ConfigProperty.key("hoodie.table.index.defs.path")
                    .noDefaultValue()
                    .sinceVersion("1.0.0")
    ...
    private static void modify(
            HoodieStorage storage,
            StoragePath metadataFolder,
            Properties modifyProps,
            BiConsumer<Properties, Properties> modifyFn) {
        StoragePath cfgPath = new StoragePath(metadataFolder, HOODIE_PROPERTIES_FILE);
        StoragePath backupCfgPath = new StoragePath(metadataFolder, HOODIE_PROPERTIES_FILE_BACKUP);
        try {
            ...
            try (InputStream in = storage.open(cfgPath)) {
                ...
                if (!props.containsKey(TABLE_CHECKSUM.key())
                    ...
                    // subsequent writes will recover and update, reads will go to the backup until
                    // then
                    storage.deleteFile(cfgPath);
    ...
    /**
      * Upserts the table config with the set of properties passed in. We implement a fail-safe backup
      * protocol here for safely updating with recovery and also ensuring the table config continues to
      * be readable.
      */
    public static void update(
            HoodieStorage storage, StoragePath metadataFolder, Properties updatedProps) {
        modify(storage, metadataFolder, updatedProps, ConfigUtils::upsertProperties);
    }

    public static void delete(
            HoodieStorage storage, StoragePath metadataFolder, Set<String> deletedProps) {
    ...
    public static void create(
            HoodieStorage storage, StoragePath metadataFolder, Properties properties) throws IOException {
        ...
        try (OutputStream outputStream = storage.create(propertyPath)) {
            ...
            if (!hoodieConfig.contains(TIMELINE_LAYOUT_VERSION)) {
                ...
                hoodieConfig.setValue(
                        TIMELINE_LAYOUT_VERSION, TimelineLayoutVersion.CURR_VERSION.toString());
            }
            ...
            if (hoodieConfig.contains(TIMELINE_TIMEZONE)) {
                HoodieInstantTimeGenerator.setCommitTimeZone(
                        HoodieTimelineTimeZone.valueOf(hoodieConfig.getString(TIMELINE_TIMEZONE)));
            }
    ...
    public static long generateChecksum(Properties props) {
        ...
        return BinaryUtil.generateChecksum(
                getUTF8Bytes(String.format(TABLE_CHECKSUM_FORMAT, database, table)));
    }
    ...
    public Option<String[]> getRecordKeyFields() {
        ...
        if (keyFieldsValue == null) {
            ...
            return Option.of(
                    Arrays.stream(keyFieldsValue.split(","))
                            .filter(p -> p.length() > 0)
    ...
    public Option<String[]> getPartitionFields() {
        if (contains(PARTITION_FIELDS)) {
            return Option.of(
                    Arrays.stream(getString(PARTITION_FIELDS).split(","))
                            .filter(p -> p.length() > 0)
                            .collect(Collectors.toList())
                            .toArray(new String[] {}));
        }
    ...
    public HoodieCDCSupplementalLoggingMode cdcSupplementalLoggingMode() {
        return HoodieCDCSupplementalLoggingMode.valueOf(
                getStringOrDefault(CDC_SUPPLEMENTAL_LOGGING_MODE).toUpperCase());
    }
    ...
    /**
      * @returns true if metadata table has been created and is being used for this dataset, else
      *     returns false.
      */
    ...
    /**
      ...
      */
    public void setMetadataPartitionState(
            HoodieTableMetaClient metaClient, String partitionPath, boolean enabled) {
        ValidationUtils.checkArgument(
                !partitionPath.contains(CONFIG_VALUES_DELIMITER),
        ...
        setValue(
                TABLE_METADATA_PARTITIONS_INFLIGHT,
        ...
        LOG.info(
                String.format(
                        "MDT %s partition %s has been %s",
                        metaClient.getBasePath(), partitionPath, enabled ? "enabled" : "disabled"));
    }
    ...
    /**
      ...
      */
    public void setMetadataPartitionsInflight(
            HoodieTableMetaClient metaClient, List<String> partitionPaths) {
        Set<String> partitionsInflight = getMetadataPartitionsInflight();
        ...
        LOG.info(
                String.format(
                        "MDT %s partitions %s have been set to inflight",
                        metaClient.getBasePath(), partitionPaths));
    }

    public void setMetadataPartitionsInflight(
            HoodieTableMetaClient metaClient, MetadataPartitionType... partitionTypes) {
        setMetadataPartitionsInflight(
                metaClient,
    ...
    /**
      * Clear {@link HoodieTableConfig#TABLE_METADATA_PARTITIONS} {@link
      * HoodieTableConfig#TABLE_METADATA_PARTITIONS_INFLIGHT}.
      */
    ...
    @Deprecated public static final String HOODIE_TABLE_NAME_PROP_NAME = NAME.key();
    /** @deprecated Use {@link #TYPE} and its methods. */
    @Deprecated public static final String HOODIE_TABLE_TYPE_PROP_NAME = TYPE.key();
    /** @deprecated Use {@link #VERSION} and its methods. */
    @Deprecated public static final String HOODIE_TABLE_VERSION_PROP_NAME = VERSION.key();
    /** @deprecated Use {@link #PRECOMBINE_FIELD} and its methods. */
    @Deprecated public static final String HOODIE_TABLE_PRECOMBINE_FIELD = PRECOMBINE_FIELD.key();
    /** @deprecated Use {@link #BASE_FILE_FORMAT} and its methods. */
    @Deprecated public static final String HOODIE_BASE_FILE_FORMAT_PROP_NAME = BASE_FILE_FORMAT.key();
    /** @deprecated Use {@link #LOG_FILE_FORMAT} and its methods. */
    @Deprecated public static final String HOODIE_LOG_FILE_FORMAT_PROP_NAME = LOG_FILE_FORMAT.key();
    ...
    @Deprecated public static final String HOODIE_PAYLOAD_CLASS_PROP_NAME = PAYLOAD_CLASS_NAME.key();
    ...
    public static final String HOODIE_BOOTSTRAP_INDEX_CLASS_PROP_NAME =
            BOOTSTRAP_INDEX_CLASS_NAME.key();
    /** @deprecated Use {@link #BOOTSTRAP_BASE_PATH} and its methods. */
    @Deprecated public static final String HOODIE_BOOTSTRAP_BASE_PATH = BOOTSTRAP_BASE_PATH.key();
    /** @deprecated Use {@link #TYPE} and its methods. */
    @Deprecated public static final HoodieTableType DEFAULT_TABLE_TYPE = TYPE.defaultValue();
    /** @deprecated Use {@link #VERSION} and its methods. */
    @Deprecated public static final HoodieTableVersion DEFAULT_TABLE_VERSION = VERSION.defaultValue();
    /** @deprecated Use {@link #BASE_FILE_FORMAT} and its methods. */
    @Deprecated
    ...
    /** @deprecated Use {@link #PAYLOAD_CLASS_NAME} and its methods. */
    @Deprecated public static final String DEFAULT_PAYLOAD_CLASS = PAYLOAD_CLASS_NAME.defaultValue();
    /** @deprecated Use {@link #BOOTSTRAP_INDEX_CLASS_NAME} and its methods. */
    @Deprecated
    public static final String DEFAULT_BOOTSTRAP_INDEX_CLASS =
            BOOTSTRAP_INDEX_CLASS_NAME.defaultValue();
    /** @deprecated Use {@link #ARCHIVELOG_FOLDER} and its methods. */
    @Deprecated
