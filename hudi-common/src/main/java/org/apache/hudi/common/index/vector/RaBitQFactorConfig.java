 ...
 * rather than code constants. Readers MUST reject a factor layout whose {@link #factorVersion}
 * they do not support.
 *
 * <ul>
...
public final class RaBitQFactorConfig implements Serializable {
  ...
  /** Factor layout produced by the current neutral-factor computation. */
  public static final int FACTOR_VERSION_V2 = 2;
