...
public class HoodieFunctionalIndexConfig extends HoodieConfig {
  ...
  public static void create(HoodieStorage storage, HoodieLocation metadataFolder, Properties properties)
    ...
    HoodieLocation propertyPath = new HoodieLocation(metadataFolder, INDEX_DEFINITION_FILE);
  ...
  public static void delete(HoodieStorage storage, HoodieLocation metadataFolder,
  ...
  public static void recover(HoodieStorage storage, HoodieLocation metadataFolder)
      throws IOException {
    HoodieLocation cfgPath = new HoodieLocation(metadataFolder, INDEX_DEFINITION_FILE);
    HoodieLocation backupCfgPath = new HoodieLocation(metadataFolder, INDEX_DEFINITION_FILE_BACKUP);
    recoverIfNeeded(storage, cfgPath, backupCfgPath);
  }

  private static void modify(HoodieStorage storage, HoodieLocation metadataFolder,
