...
public abstract class HoodieRecord<T> implements Serializable {
  ...
  public static int COMMIT_TIME_METADATA_FIELD_POS = HOODIE_META_COLUMNS_NAME_TO_POS.get(COMMIT_TIME_METADATA_FIELD);

  public static int COMMIT_SEQNO_METADATA_FIELD_POS = HOODIE_META_COLUMNS_NAME_TO_POS.get(COMMIT_SEQNO_METADATA_FIELD);
