...
public class HoodieLogFile implements Serializable {
    ...
    private HoodieLogFile(
            StoragePathInfo pathInfo, StoragePath logPath, String logPathStr, long fileLen) {
        ...
        return new HoodieLogFile(
                new StoragePath(
                        ...
                        FSUtils.makeLogFileName(
                                fileId, extension, deltaCommitTime, logVersion + 1, logWriteToken)));
    }
