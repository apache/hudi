...
public class FlatLists {
    ...
    /**
      * Creates a memory-, CPU- and cache-efficient immutable list from an existing list. The list is
      * always copied.
      *
    ...
    /**
      ...
      *
      * <p>You can create an instance whose type parameter {@code T} does not extend {@link
      * Comparable}, but you will get a {@link ClassCastException} at runtime when you call {@link
      * #compareTo(Object)} if the elements of the list do not implement {@code Comparable}.
      */
    public interface ComparableList<T> extends List<T>, Comparable<List> {}

    /**
      * Wrapper around a list that makes it implement the {@link Comparable} interface using lexical
      * ordering. The elements must be comparable.
      */
    static class ComparableListImpl<T extends Comparable<T>> extends AbstractList<T>
