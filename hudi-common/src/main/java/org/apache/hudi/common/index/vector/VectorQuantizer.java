...
public interface VectorQuantizer extends Serializable {
  ...
  final class QuantizedVector implements Serializable {
    /** Primary packed sign/MSB code. Length is typically {@link #codeBytes()}. */
    public final byte[] code;
    /** Optional packed lower-bit code planes for multibit RaBitQ. */
    public final byte[] extendedCode;
    /** Original vector norm. Set to 1.0f when assume_normalized=true. */
    ...
    public QuantizedVector(byte[] code,
                           ...
                           Float error1,
                           int bits) {
      this(code, extendedCode, scalar, additiveFactor, rescaleFactor, additiveFactor1, rescaleFactor1, error1, null, bits);
    }
