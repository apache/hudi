...
public final class HoodieRecordGlobalLocation extends HoodieRecordLocation {
    ...
    public HoodieRecordGlobalLocation(
            String partitionPath, String instantTime, String fileId, long position) {
    ...
    public static HoodieRecordGlobalLocation fromLocal(
            String partitionPath, HoodieRecordLocation localLoc) {
        return new HoodieRecordGlobalLocation(
                partitionPath, localLoc.getInstantTime(), localLoc.getFileId());
    }
