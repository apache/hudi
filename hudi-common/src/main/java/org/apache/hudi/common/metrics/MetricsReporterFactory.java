...
import org.apache.hudi.common.metrics.datadog.DatadogMetricsReporter;

import com.codahale.metrics.MetricRegistry;
import org.apache.hudi.common.metrics.prometheus.PrometheusReporter;
import org.apache.hudi.common.metrics.prometheus.PushGatewayMetricsReporter;
import org.apache.hudi.common.metrics.userdefined.AbstractUserDefinedMetricsReporter;
  ...
  public static MetricsReporter createReporter(HoodieMetricsConfig config, MetricRegistry registry) {
    ...
    if (!StringUtils.isNullOrEmpty(reporterClassName)) {
      ...
      if (!(instance instanceof AbstractUserDefinedMetricsReporter)) {
        throw new HoodieException(reporterClassName + " is not a subclass of AbstractUserDefinedMetricsReporter");
      }
