...
public class ActiveTimelineV2 extends BaseTimelineV2 implements HoodieActiveTimeline {
  ...
  @Override
  public <T> HoodieInstant transitionCompactionInflightToComplete(boolean shouldLock, HoodieInstant inflightInstant,
                                                              Option<T> metadata) {
  ...
  @Override
  public <T> HoodieInstant transitionLogCompactionInflightToComplete(boolean shouldLock,
  ...
  @Override
  public <T> HoodieInstant transitionCleanInflightToComplete(boolean shouldLock, HoodieInstant inflightInstant,
                                                         Option<T> metadata) {
  ...
  @Override
  public <T> HoodieInstant transitionRollbackInflightToComplete(boolean shouldLock,
                                                            HoodieInstant inflightInstant, Option<T> metadata) {
  ...
  @Override
  public <T> HoodieInstant transitionReplaceInflightToComplete(boolean shouldLock,
                                                           HoodieInstant inflightInstant, Option<T> metadata) {
  ...
  @Override
  public <T> HoodieInstant transitionClusterInflightToComplete(boolean shouldLock,
                                                           HoodieInstant inflightInstant, Option<T> metadata) {
  ...
  protected <T> void transitionStateToComplete(boolean shouldLock, HoodieInstant fromInstant,
    ...
    try {
      if (metaClient.getTimelineLayoutVersion().isNullVersion()) {
        // Re-create the .inflight file by opening a new file and write the commiOption<T> metadata in
  ...
  protected <T> void transitionPendingState(HoodieInstant fromInstant, HoodieInstant toInstant, Option<T> metadata,
  ...
  @Override
  public <T> HoodieInstant transitionIndexInflightToComplete(boolean shouldLock,
                                                         HoodieInstant inflightInstant, Option<T> metadata) {
