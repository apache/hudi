...
/**
  * The only difference with {@link DefaultHoodieRecordPayload} is that is does not track the event
  * time metadata for efficiency.
  */
public class EventTimeAvroPayload extends DefaultHoodieRecordPayload {
    ...
    public Option<IndexedRecord> combineAndGetUpdateValue(
            IndexedRecord currentValue, Schema schema, Properties properties) throws IOException {
        /*
        ...
        // Null check is needed here to support schema evolution. The record in storage may be from
        // old schema where
