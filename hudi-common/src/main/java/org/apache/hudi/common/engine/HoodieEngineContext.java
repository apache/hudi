...
/**
  * Base class contains the context information needed by the engine at runtime. It will be extended
  * by different engine implementation if needed.
  */
public abstract class HoodieEngineContext {
    ...
    public abstract <I, O> List<O> map(
    ...
    public abstract <I, O> List<O> flatMap(
    ...
    public abstract <I, K, V> Map<K, V> mapToPair(
    ...
    /**
      ...
      */
    public abstract <I, O> O aggregate(
            HoodieData<I> data,
            O zeroValue,
