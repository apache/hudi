...
public class HoodieStorageConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> PARQUET_MAX_FILE_SIZE =
            ConfigProperty.key("hoodie.parquet.max.file.size")
    ...
    public static final ConfigProperty<String> PARQUET_BLOCK_SIZE =
            ConfigProperty.key("hoodie.parquet.block.size")
                    .defaultValue(String.valueOf(120 * 1024 * 1024))
                    .markAdvanced()
                    .withDocumentation(
                            "Parquet RowGroup size in bytes. It's recommended to make this large enough that scan costs can be"
    ...
    public static final ConfigProperty<String> PARQUET_PAGE_SIZE =
            ConfigProperty.key("hoodie.parquet.page.size")
    ...
    public static final ConfigProperty<String> ORC_BLOCK_SIZE =
            ConfigProperty.key("hoodie.orc.block.size")
    ...
    public static final ConfigProperty<String> HFILE_MAX_FILE_SIZE =
            ConfigProperty.key("hoodie.hfile.max.file.size")
                    .defaultValue(String.valueOf(120 * 1024 * 1024))
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> HFILE_BLOCK_SIZE =
            ConfigProperty.key("hoodie.hfile.block.size")
                    .defaultValue(String.valueOf(1024 * 1024))
                    .markAdvanced()
                    .withDocumentation(
                            "Lower values increase the size in bytes of metadata tracked within HFile, but can offer potentially "
                                    + "faster lookup times.");

    public static final ConfigProperty<String> LOGFILE_DATA_BLOCK_FORMAT =
            ConfigProperty.key("hoodie.logfile.data.block.format")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> LOGFILE_MAX_SIZE =
            ConfigProperty.key("hoodie.logfile.max.size")
                    .defaultValue(String.valueOf(1024 * 1024 * 1024)) // 1 GB
                    .markAdvanced()
                    .withDocumentation(
                            "LogFile max size in bytes. This is the maximum size allowed for a log file "
                                    + "before it is rolled over to the next version.");

    public static final ConfigProperty<String> LOGFILE_DATA_BLOCK_MAX_SIZE =
            ConfigProperty.key("hoodie.logfile.data.block.max.size")
                    .defaultValue(String.valueOf(256 * 1024 * 1024))
                    .markAdvanced()
                    .withDocumentation(
                            "LogFile Data block max size in bytes. This is the maximum size allowed for a single data block "
    ...
    public static final ConfigProperty<String> PARQUET_COMPRESSION_RATIO_FRACTION =
            ConfigProperty.key("hoodie.parquet.compression.ratio")
                    .defaultValue(String.valueOf(0.1))
                    .markAdvanced()
                    .withDocumentation(
                            "Expected compression of parquet data used by Hudi, when it tries to size new parquet files. "
    ...
    public static final ConfigProperty<String> PARQUET_COMPRESSION_CODEC_NAME =
            ConfigProperty.key("hoodie.parquet.compression.codec")
                    .defaultValue("gzip")
    ...
    public static final ConfigProperty<Boolean> PARQUET_DICTIONARY_ENABLED =
            ConfigProperty.key("hoodie.parquet.dictionary.enabled")
                    .defaultValue(true)
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> PARQUET_WRITE_LEGACY_FORMAT_ENABLED =
            ConfigProperty.key("hoodie.parquet.writelegacyformat.enabled")
                    .defaultValue("false")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> PARQUET_OUTPUT_TIMESTAMP_TYPE =
            ConfigProperty.key("hoodie.parquet.outputtimestamptype")
    ...
    // SPARK-38094 Spark 3.3 checks if this field is enabled. Hudi has to provide this or there
    // would be NPE thrown
    ...
    public static final ConfigProperty<String> PARQUET_FIELD_ID_WRITE_ENABLED =
            ConfigProperty.key("hoodie.parquet.field_id.write.enabled")
                    .defaultValue("true")
                    .markAdvanced()
                    .sinceVersion("0.12.0")
                    .withDocumentation(
                            "Would only be effective with Spark 3.3+. Sets spark.sql.parquet.fieldId.write.enabled. "
    ...
    public static final ConfigProperty<Boolean> PARQUET_WITH_BLOOM_FILTER_ENABLED =
            ConfigProperty.key("hoodie.parquet.bloom.filter.enabled")
                    .defaultValue(true)
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation(
                            "Control whether to write bloom filter or not. Default true. "
    ...
    public static final ConfigProperty<String> HFILE_COMPRESSION_ALGORITHM_NAME =
            ConfigProperty.key("hoodie.hfile.compression.algorithm")
                    .defaultValue("GZ")
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> ORC_COMPRESSION_CODEC_NAME =
            ConfigProperty.key("hoodie.orc.compression.codec")
                    .defaultValue("ZLIB")
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> LOGFILE_TO_PARQUET_COMPRESSION_RATIO_FRACTION =
            ConfigProperty.key("hoodie.logfile.to.parquet.compression.ratio")
                    .defaultValue(String.valueOf(0.35))
                    .markAdvanced()
                    .withDocumentation(
                            "Expected additional compression as records move from log files to parquet. Used for merge_on_read "
    ...
    public static final ConfigProperty<String> BLOOM_FILTER_TYPE =
            ConfigProperty.key("hoodie.bloom.index.filter.type")
    ...
    public static final ConfigProperty<String> BLOOM_FILTER_NUM_ENTRIES_VALUE =
            ConfigProperty.key("hoodie.index.bloom.num_entries")
                    .defaultValue("60000")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> BLOOM_FILTER_FPP_VALUE =
            ConfigProperty.key("hoodie.index.bloom.fpp")
    ...
    public static final ConfigProperty<String> BLOOM_FILTER_DYNAMIC_MAX_ENTRIES =
            ConfigProperty.key("hoodie.bloom.index.filter.dynamic.max.entries")
                    .defaultValue("100000")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> HOODIE_AVRO_WRITE_SUPPORT_CLASS =
            ConfigProperty.key("hoodie.avro.write.support.class")
                    .defaultValue("org.apache.hudi.avro.HoodieAvroWriteSupport")
                    .markAdvanced()
                    .sinceVersion("0.14.0")
                    .withDocumentation(
                            "Provided write support class should extend HoodieAvroWriteSupport class "
    ...
    public static final ConfigProperty<String> HOODIE_PARQUET_SPARK_ROW_WRITE_SUPPORT_CLASS =
            ConfigProperty.key("hoodie.parquet.spark.row.write.support.class")
                    .defaultValue("org.apache.hudi.io.storage.row.HoodieRowParquetWriteSupport")
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation(
                            "Provided write support class should extend HoodieRowParquetWriteSupport class "
                                    + "and it is loaded at runtime. This is only required when trying to "
    ...
    public static final ConfigProperty<String> HOODIE_STORAGE_CLASS =
            ConfigProperty.key("hoodie.storage.class")
                    .defaultValue("org.apache.hudi.storage.hadoop.HoodieHadoopStorage")
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation(
                            "The fully-qualified class name of the `HoodieStorage` implementation class to instantiate. "
    ...
    public static final ConfigProperty<String> HOODIE_IO_FACTORY_CLASS =
            ConfigProperty.key("hoodie.io.factory.class")
                    .defaultValue("org.apache.hudi.io.hadoop.HoodieHadoopIOFactory")
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation(
                            "The fully-qualified class name of the factory class to return readers and writers of files used "
    ...
    @Deprecated public static final String PARQUET_FILE_MAX_BYTES = PARQUET_MAX_FILE_SIZE.key();
    /** @deprecated Use {@link #PARQUET_MAX_FILE_SIZE} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String PARQUET_BLOCK_SIZE_BYTES = PARQUET_BLOCK_SIZE.key();
    /** @deprecated Use {@link #PARQUET_BLOCK_SIZE} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String PARQUET_PAGE_SIZE_BYTES = PARQUET_PAGE_SIZE.key();
    /** @deprecated Use {@link #PARQUET_PAGE_SIZE} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String HFILE_FILE_MAX_BYTES = HFILE_MAX_FILE_SIZE.key();
    /** @deprecated Use {@link #HFILE_MAX_FILE_SIZE} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String HFILE_BLOCK_SIZE_BYTES = HFILE_BLOCK_SIZE.defaultValue();
    /** @deprecated Use {@link #HFILE_BLOCK_SIZE} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String LOGFILE_SIZE_MAX_BYTES = LOGFILE_MAX_SIZE.key();
    /** @deprecated Use {@link #LOGFILE_MAX_SIZE} and its methods instead */
    @Deprecated
    ...
    public static final String DEFAULT_LOGFILE_DATA_BLOCK_SIZE_MAX_BYTES =
            LOGFILE_DATA_BLOCK_MAX_SIZE.defaultValue();
    ...
    public static final String DEFAULT_STREAM_COMPRESSION_RATIO =
            PARQUET_COMPRESSION_RATIO_FRACTION.defaultValue();
    ...
    /** @deprecated Use {@link #HFILE_COMPRESSION_ALGORITHM_NAME} and its methods instead */
    @Deprecated
    public static final String DEFAULT_HFILE_COMPRESSION_ALGORITHM =
    ...
    public static final String LOGFILE_TO_PARQUET_COMPRESSION_RATIO =
            LOGFILE_TO_PARQUET_COMPRESSION_RATIO_FRACTION.key();
    /**
      * @deprecated Use {@link #LOGFILE_TO_PARQUET_COMPRESSION_RATIO_FRACTION} and its methods instead
      */
    @Deprecated
    public static final String DEFAULT_LOGFILE_TO_PARQUET_COMPRESSION_RATIO =
            LOGFILE_TO_PARQUET_COMPRESSION_RATIO_FRACTION.defaultValue();
    ...
    public static class Builder {
        ...
        public Builder parquetCompressionRatio(double parquetCompressionRatio) {
            storageConfig.setValue(
                    PARQUET_COMPRESSION_RATIO_FRACTION, String.valueOf(parquetCompressionRatio));
            return this;
        }
        ...
        public Builder parquetBloomFilterEnable(boolean parquetBloomFilterEnable) {
            storageConfig.setValue(
                    PARQUET_WITH_BLOOM_FILTER_ENABLED, String.valueOf(parquetBloomFilterEnable));
            return this;
        }
