...
/**
  * Used in consistent hashing index, representing nodes in the consistent hash ring. Record the end
  * hash range value and its corresponding file group id.
  */
...
public class ConsistentHashingNode implements Serializable {
    ...
    public ConsistentHashingNode(
            ...
            @JsonProperty("fileIdPrefix") String fileIdPrefix,
            @JsonProperty("tag") NodeTag tag) {
        this.value = value;
    ...
    public static List<ConsistentHashingNode> fromJsonString(String json) throws Exception {
        ...
        ConsistentHashingNode[] nodes =
                JsonUtils.getObjectMapper().readValue(json, ConsistentHashingNode[].class);
