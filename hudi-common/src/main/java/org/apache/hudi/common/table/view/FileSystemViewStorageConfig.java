...
@ConfigClassProperty(
        name = "File System View Storage Configurations",
...
public class FileSystemViewStorageConfig extends HoodieConfig {
    ...
    // Property Names
    public static final ConfigProperty<FileSystemViewStorageType> VIEW_TYPE =
            ConfigProperty.key("hoodie.filesystem.view.type")
                    .defaultValue(FileSystemViewStorageType.MEMORY)
                    .markAdvanced()
                    .withDocumentation(
                            "File system view provides APIs for viewing the files on the underlying lake storage, "
                                    + " as file groups and file slices. This config controls how such a view is held. Options include "
                                    + Arrays.stream(FileSystemViewStorageType.values())
                                            .map(Enum::name)
    ...
    public static final ConfigProperty<String> INCREMENTAL_TIMELINE_SYNC_ENABLE =
            ConfigProperty.key("hoodie.filesystem.view.incr.timeline.sync.enable")
                    .defaultValue("false")
                    .markAdvanced()
                    .withDocumentation(
                            "Controls whether or not, the file system view is incrementally updated as "
    ...
    public static final ConfigProperty<FileSystemViewStorageType> SECONDARY_VIEW_TYPE =
            ConfigProperty.key("hoodie.filesystem.view.secondary.type")
                    .defaultValue(FileSystemViewStorageType.MEMORY)
                    .markAdvanced()
                    .withDocumentation(
                            "Specifies the secondary form of storage for file system view, if the primary (e.g timeline server) "
                                    + " is unavailable.");

    public static final ConfigProperty<String> REMOTE_HOST_NAME =
            ConfigProperty.key("hoodie.filesystem.view.remote.host")
    ...
    public static final ConfigProperty<Integer> REMOTE_PORT_NUM =
            ConfigProperty.key("hoodie.filesystem.view.remote.port")
                    .defaultValue(26754)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> SPILLABLE_DIR =
            ConfigProperty.key("hoodie.filesystem.view.spillable.dir")
                    .defaultValue("/tmp/")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Long> SPILLABLE_MEMORY =
            ConfigProperty.key("hoodie.filesystem.view.spillable.mem")
    ...
    public static final ConfigProperty<Double> SPILLABLE_COMPACTION_MEM_FRACTION =
            ConfigProperty.key("hoodie.filesystem.view.spillable.compaction.mem.fraction")
                    .defaultValue(0.8)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Double> SPILLABLE_LOG_COMPACTION_MEM_FRACTION =
            ConfigProperty.key("hoodie.filesystem.view.spillable.log.compaction.mem.fraction")
                    .defaultValue(0.8)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<Double> BOOTSTRAP_BASE_FILE_MEM_FRACTION =
            ConfigProperty.key("hoodie.filesystem.view.spillable.bootstrap.base.file.mem.fraction")
                    .defaultValue(0.05)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Double> SPILLABLE_REPLACED_MEM_FRACTION =
            ConfigProperty.key("hoodie.filesystem.view.spillable.replaced.mem.fraction")
                    .defaultValue(0.01)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Double> SPILLABLE_CLUSTERING_MEM_FRACTION =
            ConfigProperty.key("hoodie.filesystem.view.spillable.clustering.mem.fraction")
                    .defaultValue(0.01)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> ROCKSDB_BASE_PATH =
            ConfigProperty.key("hoodie.filesystem.view.rocksdb.base.path")
    ...
    public static final ConfigProperty<Integer> REMOTE_TIMEOUT_SECS =
            ConfigProperty.key("hoodie.filesystem.view.remote.timeout.secs")
    ...
    public static final ConfigProperty<String> REMOTE_RETRY_ENABLE =
            ConfigProperty.key("hoodie.filesystem.view.remote.retry.enable")
                    .defaultValue("false")
                    .markAdvanced()
                    .sinceVersion("0.12.1")
    ...
    public static final ConfigProperty<Integer> REMOTE_MAX_RETRY_NUMBERS =
            ConfigProperty.key("hoodie.filesystem.view.remote.retry.max_numbers")
    ...
    public static final ConfigProperty<Long> REMOTE_INITIAL_RETRY_INTERVAL_MS =
            ConfigProperty.key("hoodie.filesystem.view.remote.retry.initial_interval_ms")
                    .defaultValue(100L)
                    .markAdvanced()
                    .sinceVersion("0.12.1")
                    .withDocumentation(
    ...
    public static final ConfigProperty<Long> REMOTE_MAX_RETRY_INTERVAL_MS =
            ConfigProperty.key("hoodie.filesystem.view.remote.retry.max_interval_ms")
                    .defaultValue(2000L)
                    .markAdvanced()
                    .sinceVersion("0.12.1")
    ...
    public static final ConfigProperty<String> RETRY_EXCEPTIONS =
            ConfigProperty.key("hoodie.filesystem.view.remote.retry.exceptions")
                    .defaultValue("")
                    .markAdvanced()
                    .sinceVersion("0.12.1")
                    .withDocumentation(
                            "The class name of the Exception that needs to be retried, separated by commas. "
    ...
    public static final ConfigProperty<String> REMOTE_BACKUP_VIEW_ENABLE =
            ConfigProperty.key("hoodie.filesystem.remote.backup.view.enable")
                    .defaultValue("true") // Need to be disabled only for tests.
                    .markAdvanced()
                    .withDocumentation(
                            "Config to control whether backup needs to be configured if clients were not able to reach"
                                    + " timeline service.");
    ...
    public long getMaxMemoryForPendingCompaction() {
        long totalMemory = getLong(SPILLABLE_MEMORY);
        return new Double(totalMemory * getDouble(SPILLABLE_COMPACTION_MEM_FRACTION)).longValue();
    }

    public long getMaxMemoryForPendingLogCompaction() {
        long totalMemory = getLong(SPILLABLE_MEMORY);
        return new Double(totalMemory * getDouble(SPILLABLE_LOG_COMPACTION_MEM_FRACTION)).longValue();
    }

    public long getMaxMemoryForBootstrapBaseFile() {
        long totalMemory = getLong(SPILLABLE_MEMORY);
        long reservedForExternalDataFile =
                new Double(totalMemory * getDouble(BOOTSTRAP_BASE_FILE_MEM_FRACTION)).longValue();
        return reservedForExternalDataFile;
    }

    public long getMaxMemoryForReplacedFileGroups() {
        long totalMemory = getLong(SPILLABLE_MEMORY);
        return new Double(totalMemory * getDouble(SPILLABLE_REPLACED_MEM_FRACTION)).longValue();
    }

    public long getMaxMemoryForPendingClusteringFileGroups() {
        long totalMemory = getLong(SPILLABLE_MEMORY);
        return new Double(totalMemory * getDouble(SPILLABLE_CLUSTERING_MEM_FRACTION)).longValue();
    }
    ...
    public static class Builder {
        ...
        private final FileSystemViewStorageConfig fileSystemViewStorageConfig =
                new FileSystemViewStorageConfig();
        ...
        public Builder withIncrementalTimelineSync(boolean enableIncrTimelineSync) {
            fileSystemViewStorageConfig.setValue(
                    INCREMENTAL_TIMELINE_SYNC_ENABLE, Boolean.toString(enableIncrTimelineSync));
            return this;
        }
        ...
        public Builder withRemoteTimelineClientTimeoutSecs(Integer timelineClientTimeoutSecs) {
            fileSystemViewStorageConfig.setValue(
                    REMOTE_TIMEOUT_SECS, timelineClientTimeoutSecs.toString());
            return this;
        }
        ...
        public Builder withRemoteTimelineInitialRetryIntervalMs(Long initialRetryIntervalMs) {
            fileSystemViewStorageConfig.setValue(
                    REMOTE_INITIAL_RETRY_INTERVAL_MS, initialRetryIntervalMs.toString());
            return this;
        }

        public Builder withRemoteTimelineClientMaxRetryIntervalMs(Long maxRetryIntervalMs) {
            fileSystemViewStorageConfig.setValue(
                    REMOTE_MAX_RETRY_INTERVAL_MS, maxRetryIntervalMs.toString());
            return this;
        }
        ...
        public Builder withMemFractionForPendingCompaction(Double memFractionForPendingCompaction) {
            fileSystemViewStorageConfig.setValue(
                    SPILLABLE_COMPACTION_MEM_FRACTION, memFractionForPendingCompaction.toString());
            return this;
        }

        public Builder withMemFractionForExternalDataFile(Double memFractionForExternalDataFile) {
            fileSystemViewStorageConfig.setValue(
                    BOOTSTRAP_BASE_FILE_MEM_FRACTION, memFractionForExternalDataFile.toString());
            return this;
        }
    ...
    @Deprecated public static final String FILESYSTEM_VIEW_STORAGE_TYPE = VIEW_TYPE.key();
    /** @deprecated Use {@link #VIEW_TYPE} and its methods. */
    @Deprecated
    public static final FileSystemViewStorageType DEFAULT_VIEW_STORAGE_TYPE =
            VIEW_TYPE.defaultValue();
    ...
    public static final String FILESYSTEM_VIEW_INCREMENTAL_SYNC_MODE =
            INCREMENTAL_TIMELINE_SYNC_ENABLE.key();
    /** @deprecated Use {@link #INCREMENTAL_TIMELINE_SYNC_ENABLE} and its methods. */
    @Deprecated
    public static final String DEFAULT_FILESYSTEM_VIEW_INCREMENTAL_SYNC_MODE =
            INCREMENTAL_TIMELINE_SYNC_ENABLE.defaultValue();
    ...
    /** @deprecated Use {@link #SECONDARY_VIEW_TYPE} and its methods. */
    @Deprecated
    public static final FileSystemViewStorageType DEFAULT_SECONDARY_VIEW_STORAGE_TYPE =
            SECONDARY_VIEW_TYPE.defaultValue();
    /** @deprecated Use {@link #REMOTE_HOST_NAME} and its methods. */
    @Deprecated public static final String FILESYSTEM_VIEW_REMOTE_HOST = REMOTE_HOST_NAME.key();
    /** @deprecated Use {@link #REMOTE_HOST_NAME} and its methods. */
    @Deprecated
    ...
    @Deprecated public static final String FILESYSTEM_VIEW_REMOTE_PORT = REMOTE_PORT_NUM.key();
    /** @deprecated Use {@link #REMOTE_PORT_NUM} and its methods. */
    @Deprecated
    ...
    @Deprecated public static final String FILESYSTEM_VIEW_SPILLABLE_DIR = SPILLABLE_DIR.key();
    /** @deprecated Use {@link #SPILLABLE_DIR} and its methods. */
    @Deprecated public static final String DEFAULT_VIEW_SPILLABLE_DIR = SPILLABLE_DIR.defaultValue();
    /** @deprecated Use {@link #SPILLABLE_MEMORY} and its methods. */
    @Deprecated public static final String FILESYSTEM_VIEW_SPILLABLE_MEM = SPILLABLE_MEMORY.key();
    /** @deprecated Use {@link #SPILLABLE_MEMORY} and its methods. */
    @Deprecated
    ...
    public static final String FILESYSTEM_VIEW_PENDING_COMPACTION_MEM_FRACTION =
            SPILLABLE_COMPACTION_MEM_FRACTION.key();
    /** @deprecated Use {@link #SPILLABLE_COMPACTION_MEM_FRACTION} and its methods. */
    @Deprecated
    private static final Double DEFAULT_MEM_FRACTION_FOR_PENDING_COMPACTION =
            SPILLABLE_COMPACTION_MEM_FRACTION.defaultValue();
    ...
    public static final String FILESYSTEM_VIEW_BOOTSTRAP_BASE_FILE_FRACTION =
            BOOTSTRAP_BASE_FILE_MEM_FRACTION.key();
    ...
    public static final String FILESYSTEM_VIEW_REPLACED_MEM_FRACTION =
            SPILLABLE_REPLACED_MEM_FRACTION.key();
    /** @deprecated Use {@link #SPILLABLE_REPLACED_MEM_FRACTION} and its methods. */
    @Deprecated
    private static final Double DEFAULT_MEM_FRACTION_FOR_REPLACED_FILEGROUPS =
            SPILLABLE_REPLACED_MEM_FRACTION.defaultValue();
    ...
    public static final String FILESYSTEM_VIEW_PENDING_CLUSTERING_MEM_FRACTION =
            SPILLABLE_CLUSTERING_MEM_FRACTION.key();
    /** @deprecated Use {@link #SPILLABLE_CLUSTERING_MEM_FRACTION} and its methods. */
    @Deprecated
    private static final Double DEFAULT_MEM_FRACTION_FOR_PENDING_CLUSTERING_FILEGROUPS =
            SPILLABLE_CLUSTERING_MEM_FRACTION.defaultValue();
    /** @deprecated Use {@link #ROCKSDB_BASE_PATH} and its methods. */
    @Deprecated private static final String ROCKSDB_BASE_PATH_PROP = ROCKSDB_BASE_PATH.key();
    /** @deprecated Use {@link #ROCKSDB_BASE_PATH} and its methods. */
    @Deprecated
