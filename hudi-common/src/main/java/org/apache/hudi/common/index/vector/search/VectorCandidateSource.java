...
/**
 * Produces ANN candidates for a plan (RFC-109 §4). The MDT implementation owns posting decoding,
...
public interface VectorCandidateSource extends Serializable {
  ...
  VectorCandidatePool scan(VectorSearchPlan plan, HoodieEngineContext engineContext);
}
