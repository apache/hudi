...
public class UnmergedFileGroupRecordBuffer<T, O> extends FileGroupRecordBuffer<T, O> {
  ...
  protected boolean doHasNext() {
    ...
    if (baseFileIterator.hasNext()) {
      ...
      nextRecord = iteratorConverter.convert(readerContext, baseRecord, orderingFieldName, FALSE_SUPPLIER);
      return true;
    }
    ...
    nextRecord = iteratorConverter.convert(readerContext, logRecord, orderingFieldName, () -> isDeleteRecord(logRecord));
