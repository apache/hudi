...
/**
  ...
  *
  * <p>- recordKey : a recordKey that acts as primary key for a record. - partitionPath : the
  * partition path of a record.
  *
  * <p>NOTE: PLEASE READ CAREFULLY BEFORE CHANGING
  *
  * <p>This class is serialized (using Kryo) as part of {@code HoodieDeleteBlock} to make sure this
  * stays backwards-compatible we can't MAKE ANY CHANGES TO THIS CLASS (add, delete, reorder or
  * change types of the fields in this class, make class final, etc) as this would break its
  * compatibility with already persisted blocks.
  *
  * <p>Check out HUDI-5760 for more details
  */
