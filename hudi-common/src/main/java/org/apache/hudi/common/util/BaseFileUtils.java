...
public abstract class BaseFileUtils {
   ...
   */
  public Set<String> readRowKeys(Configuration configuration, StoragePath fileLocation) {
   ...
   */
  public BloomFilter readBloomFilterFromMetadata(Configuration configuration, StoragePath fileLocation) {
   ...
   */
  public String[] readMinMaxRecordKeys(Configuration configuration, StoragePath fileLocation) {
   ...
   */
  public abstract List<GenericRecord> readAvroRecords(Configuration configuration, StoragePath fileLocation);
   ...
   * @return a list of GenericRecord.
   */
  public abstract List<GenericRecord> readAvroRecords(Configuration configuration, StoragePath fileLocation, Schema schema);
   ...
   */
  public abstract Map<String, String> readFooter(Configuration configuration, boolean required, StoragePath fileLocation,
                                                 String... footerNames);
   ...
   * @param fileLocation  the data file location.
   */
  public abstract long getRowCount(Configuration configuration, StoragePath fileLocation);
   ...
   */
  public abstract Set<Pair<String, Long>> filterRowKeys(Configuration configuration, StoragePath fileLocation, Set<String> filter);
   ...
   */
  public abstract List<Pair<HoodieKey, Long>> fetchRecordKeysWithPositions(Configuration configuration, StoragePath fileLocation);
   ...
   * @return {@link ClosableIterator} of {@link HoodieKey}s for reading the file.
   */
  public abstract ClosableIterator<HoodieKey> getHoodieKeyIterator(Configuration configuration, StoragePath fileLocation);
   ...
   */
  public abstract Schema readAvroSchema(Configuration configuration, StoragePath fileLocation);
