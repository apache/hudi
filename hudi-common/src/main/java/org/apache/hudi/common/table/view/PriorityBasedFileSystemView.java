...
/**
  * A file system view which proxies request to a preferred File System View implementation. In case
  * of error, flip all subsequent calls to a backup file-system view implementation.
  */
public class PriorityBasedFileSystemView implements SyncableFileSystemView, Serializable {
    ...
    public PriorityBasedFileSystemView(
            SyncableFileSystemView preferredView,
    ...
    private <T1, R> R execute(
            T1 val, Function1<T1, R> preferredFunction, Function1<T1, R> secondaryFunction) {
        if (errorOnPreferredView) {
            LOG.warn("Routing request to secondary file-system view");
    ...
    private <T1, T2, R> R execute(
            T1 val,
            T2 val2,
            Function2<T1, T2, R> preferredFunction,
    ...
    private <T1, T2, T3, R> R execute(
            T1 val,
            T2 val2,
            T3 val3,
            Function3<T1, T2, T3, R> preferredFunction,
    ...
    private void handleRuntimeException(RuntimeException re) {
        if (re.getCause() instanceof HttpResponseException
            ...
            LOG.warn(
                    "Got error running preferred function. Likely due to another concurrent writer in progress. Trying secondary");
        } else {
    ...
    public Stream<HoodieBaseFile> getLatestBaseFiles() {
        return execute(
                preferredView::getLatestBaseFiles, () -> getSecondaryView().getLatestBaseFiles());
    }
    ...
    public Option<HoodieBaseFile> getLatestBaseFile(String partitionPath, String fileId) {
        return execute(
                partitionPath,
                fileId,
                preferredView::getLatestBaseFile,
    ...
    public Option<HoodieBaseFile> getBaseFileOn(
        ...
        return execute(
                ...
                instantTime,
                fileId,
                preferredView::getBaseFileOn,
                (path, instant, id) -> getSecondaryView().getBaseFileOn(path, instant, id));
    }
    ...
    public Stream<HoodieBaseFile> getLatestBaseFilesInRange(List<String> commitsToReturn) {
        return execute(
                commitsToReturn,
                preferredView::getLatestBaseFilesInRange,
    ...
    public Stream<HoodieBaseFile> getAllBaseFiles(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getAllBaseFiles,
                (path) -> getSecondaryView().getAllBaseFiles(path));
    }
    ...
    public Stream<FileSlice> getLatestFileSlices(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getLatestFileSlices,
                (path) -> getSecondaryView().getLatestFileSlices(path));
    }
    ...
    public Stream<FileSlice> getLatestFileSlicesIncludingInflight(String partitionPath) {
        return execute(
                ...
                (path) -> getSecondaryView().getLatestFileSlicesIncludingInflight(path));
    }
    ...
    public Stream<FileSlice> getLatestFileSlicesStateless(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getLatestFileSlicesStateless,
    ...
    public Stream<FileSlice> getLatestFileSlicesBeforeOrOn(
        ...
        return execute(
                ...
                (path, commitTime, includeSlices) ->
                        getSecondaryView().getLatestFileSlicesBeforeOrOn(path, commitTime, includeSlices));
    }
    ...
    public Stream<FileSlice> getLatestFileSliceInRange(List<String> commitsToReturn) {
        return execute(
                commitsToReturn,
                preferredView::getLatestFileSliceInRange,
    ...
    public Stream<FileSlice> getAllFileSlices(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getAllFileSlices,
                (path) -> getSecondaryView().getAllFileSlices(path));
    }
    ...
    public Stream<HoodieFileGroup> getAllFileGroups(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getAllFileGroups,
                (path) -> getSecondaryView().getAllFileGroups(path));
    }
    ...
    public Stream<HoodieFileGroup> getAllFileGroupsStateless(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getAllFileGroupsStateless,
    ...
    public Stream<HoodieFileGroup> getReplacedFileGroupsBeforeOrOn(
        ...
        return execute(
                ...
                (commitTime, path) -> getSecondaryView().getReplacedFileGroupsBeforeOrOn(commitTime, path));
    }
    ...
    public Stream<HoodieFileGroup> getReplacedFileGroupsBefore(
        ...
        return execute(
                ...
                (commitTime, path) -> getSecondaryView().getReplacedFileGroupsBefore(commitTime, path));
    }
    ...
    public Stream<HoodieFileGroup> getReplacedFileGroupsAfterOrOn(
        ...
        return execute(
                ...
                (commitTime, path) -> getSecondaryView().getReplacedFileGroupsAfterOrOn(commitTime, path));
    }
    ...
    public Stream<HoodieFileGroup> getAllReplacedFileGroups(String partitionPath) {
        return execute(
                partitionPath,
                preferredView::getAllReplacedFileGroups,
    ...
    public Stream<Pair<String, CompactionOperation>> getPendingCompactionOperations() {
        return execute(
                preferredView::getPendingCompactionOperations,
    ...
    public Stream<Pair<String, CompactionOperation>> getPendingLogCompactionOperations() {
        return execute(
                preferredView::getPendingLogCompactionOperations,
    ...
    public Stream<Pair<HoodieFileGroupId, HoodieInstant>> getFileGroupsInPendingClustering() {
        return execute(
                preferredView::getFileGroupsInPendingClustering,
    ...
    public Option<FileSlice> getLatestFileSlice(String partitionPath, String fileId) {
        return execute(
                partitionPath,
                fileId,
                preferredView::getLatestFileSlice,
