        ...
        while (baseFileIterator.isPresent() && baseFileIterator.get().hasNext()) {
            try {
                HoodieRecord currentRecord =
                        baseFileIterator
                                ...
                                .wrapIntoHoodieRecordPayloadWithParams(
                                        ...
                                        scanner.isWithOperationField(),
                                        scanner.getPartitionNameOverride(),
                                        false,
                                        Option.empty());
                ...
                if (mergedRecordOpt.isPresent()) {
                    ...
                    nextRecord =
                            mergedRecord.wrapIntoHoodieRecordPayloadWithParams(
                                    schema,
                                    props,
                                    simpleKeyGenFieldsOpt,
                                    scanner.isWithOperationField(),
                ...
                throw new HoodieIOException(
                        "Failed to wrapIntoHoodieRecordPayloadWithParams: " + e.getMessage());
            }
        }
