...
/**
  * HoodieMessageQueue holds an internal message queue, and control the behavior of 1. insert record
  * into internal message queue. 2. get record from internal message queue. 3. close internal message
  * queue.
  */
