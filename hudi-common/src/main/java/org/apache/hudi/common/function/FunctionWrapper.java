...
/**
  * Function wrapper util class, which catches the exception thrown by input function and return a
  * similar function with no exception thrown.
  */
public class FunctionWrapper {

    public static <I, O> Function<I, O> throwingMapWrapper(
            SerializableFunction<I, O> throwingMapFunction) {
        return v1 -> {
            try {
    ...
    public static <I, O> Function<I, Stream<O>> throwingFlatMapWrapper(
            SerializableFunction<I, Stream<O>> throwingFlatMapFunction) {
        return v1 -> {
            try {
    ...
    public static <I, K, V> Function<I, Pair<K, V>> throwingMapToPairWrapper(
            SerializablePairFunction<I, K, V> throwingPairFunction) {
        return v1 -> {
            try {
    ...
    public static <V> BinaryOperator<V> throwingReduceWrapper(
            SerializableBiFunction<V, V, V> throwingReduceFunction) {
        return (v1, v2) -> {
            try {
