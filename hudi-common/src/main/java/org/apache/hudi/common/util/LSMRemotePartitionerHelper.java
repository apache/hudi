...
public class LSMRemotePartitionerHelper implements Serializable {
  private static final Logger LOG = LogManager.getLogger(LSMRemotePartitionerHelper.class);
  ...
  public LSMRemotePartitionerHelper(FileSystemViewStorageConfig viewConf) {
  ...
  // todo zhangyue143 限速 + Factor能力
  public int getPartition(int numBuckets, String partitionPath, int curBucket, int partitionNum, int factor) throws Exception {
    ...
    builder.addParameter(FACTOR_PARAM, String.valueOf(factor));
