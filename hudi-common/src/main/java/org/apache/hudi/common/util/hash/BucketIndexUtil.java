...
public class BucketIndexUtil {
    ...
    /**
      ...
      * sub-intervals of length bucket_num, different partitions will be mapped to different
      * sub-interval, ensure that the data across multiple partitions is evenly distributed.
      *
      ...
      */
    public static Functions.Function2<String, Integer, Integer> getPartitionIndexFunc(
            int bucketNum, int parallelism) {
