...
public abstract class BaseAvroPayload implements Serializable {
    ...
    /**
      * Defines whether this implementation of {@link HoodieRecordPayload} is deleted. We will not do
      * deserialization in this method.
      */
    ...
    /**
      * Defines whether this implementation of {@link HoodieRecordPayload} could produce {@link
