...
/**
  * A proxy for table file-system view which translates local View API calls to REST calls to remote
  * timeline service.
  */
public class RemoteHoodieTableFileSystemView implements SyncableFileSystemView, Serializable {
    ...
    public static final String LAST_INSTANT_URL =
            String.format("%s/%s", BASE_URL, "timeline/instant/last");
    public static final String LAST_INSTANTS_URL =
            String.format("%s/%s", BASE_URL, "timeline/instants/last");

    public static final String TIMELINE_URL =
            String.format("%s/%s", BASE_URL, "timeline/instants/all");
    ...
    public static final String LOAD_ALL_PARTITIONS_URL =
            String.format("%s/%s", BASE_URL, "loadallpartitions/");
    public static final String LOAD_PARTITIONS_URL =
            String.format("%s/%s", BASE_URL, "loadpartitions/");
    ...
    private static final TypeReference<List<FileSliceDTO>> FILE_SLICE_DTOS_REFERENCE =
            new TypeReference<List<FileSliceDTO>>() {};
    private static final TypeReference<List<FileGroupDTO>> FILE_GROUP_DTOS_REFERENCE =
            new TypeReference<List<FileGroupDTO>>() {};
    private static final TypeReference<Boolean> BOOLEAN_TYPE_REFERENCE =
            new TypeReference<Boolean>() {};
    private static final TypeReference<List<CompactionOpDTO>> COMPACTION_OP_DTOS_REFERENCE =
            new TypeReference<List<CompactionOpDTO>>() {};
    private static final TypeReference<List<ClusteringOpDTO>> CLUSTERING_OP_DTOS_REFERENCE =
            new TypeReference<List<ClusteringOpDTO>>() {};
    private static final TypeReference<List<InstantDTO>> INSTANT_DTOS_REFERENCE =
            new TypeReference<List<InstantDTO>>() {};
    private static final TypeReference<TimelineDTO> TIMELINE_DTO_REFERENCE =
            new TypeReference<TimelineDTO>() {};
    private static final TypeReference<List<BaseFileDTO>> BASE_FILE_DTOS_REFERENCE =
            new TypeReference<List<BaseFileDTO>>() {};
    private static final TypeReference<Map<String, List<BaseFileDTO>>> BASE_FILE_MAP_REFERENCE =
            new TypeReference<Map<String, List<BaseFileDTO>>>() {};
    private static final TypeReference<Map<String, List<FileSliceDTO>>> FILE_SLICE_MAP_REFERENCE =
    ...
    public RemoteHoodieTableFileSystemView(
            String server, int port, HoodieTableMetaClient metaClient) {
        this(
                metaClient,
                FileSystemViewStorageConfig.newBuilder()
                        .withRemoteServerHost(server)
                        .withRemoteServerPort(port)
                        .build());
    }
    ...
    private <T> T executeRequest(
        ...
        timeline
                .lastInstant()
                .ifPresent(instant -> builder.addParameter(LAST_INSTANT_TS, instant.getTimestamp()));
        ...
        Response response =
                retryHelper != null
                        ? retryHelper.start(() -> get(timeoutMs, url, method))
                        : get(timeoutMs, url, method);
    ...
    private Map<String, String> getParamsWithAdditionalParam(
            String partitionPath, String paramName, String paramVal) {
        Map<String, String> paramsMap = new HashMap<>();
        paramsMap.put(BASEPATH_PARAM, basePath);
        paramsMap.put(PARTITION_PARAM, partitionPath);
    ...
    private Map<String, String> getParamsWithAdditionalParams(
            String partitionPath, String[] paramNames, String[] paramVals) {
        Map<String, String> paramsMap = new HashMap<>();
        paramsMap.put(BASEPATH_PARAM, basePath);
        paramsMap.put(PARTITION_PARAM, partitionPath);
    ...
    private Stream<HoodieBaseFile> getLatestBaseFilesFromParams(
            String requestPath, Map<String, String> paramsMap) {
        try {
            List<BaseFileDTO> dataFiles =
                    executeRequest(requestPath, paramsMap, BASE_FILE_DTOS_REFERENCE, RequestMethod.GET);
    ...
    @Override
    public Stream<HoodieBaseFile> getLatestBaseFilesBeforeOrOn(
    ...
    public Map<String, Stream<HoodieBaseFile>> getAllLatestBaseFilesBeforeOrOn(String maxCommitTime) {
        ...
        try {
            Map<String, List<BaseFileDTO>> dataFileMap =
                    executeRequest(
                            ALL_LATEST_BASE_FILES_BEFORE_ON_INSTANT_URL,
                            paramsMap,
                            BASE_FILE_MAP_REFERENCE,
                            RequestMethod.GET);
            return dataFileMap.entrySet().stream()
                    .collect(
                            Collectors.toMap(
                                    Map.Entry::getKey,
    ...
    @Override
    public Option<HoodieBaseFile> getBaseFileOn(
            String partitionPath, String instantTime, String fileId) {
        Map<String, String> paramsMap =
                getParamsWithAdditionalParams(
                        partitionPath,
                        new String[] {INSTANT_PARAM, FILEID_PARAM},
                        new String[] {instantTime, fileId});
        return Option.fromJavaOptional(
                getLatestBaseFilesFromParams(LATEST_DATA_FILE_ON_INSTANT_URL, paramsMap).findFirst());
    }

    @Override
    public Stream<HoodieBaseFile> getLatestBaseFilesInRange(List<String> commitsToReturn) {
        Map<String, String> paramsMap =
                getParams(INSTANTS_PARAM, String.join(MULTI_VALUE_SEPARATOR, commitsToReturn));
    ...
    public Option<HoodieBaseFile> getLatestBaseFile(String partitionPath, String fileId) {
        ...
        return Option.fromJavaOptional(
                getLatestBaseFilesFromParams(LATEST_PARTITION_DATA_FILE_URL, paramsMap).findFirst());
    }
    ...
    private Stream<FileSlice> getLatestFileSlicesStreamFromParams(
        ...
        try {
            List<FileSliceDTO> dataFiles =
                    executeRequest(requestPath, paramsMap, FILE_SLICE_DTOS_REFERENCE, RequestMethod.GET);
    ...
    public Option<FileSlice> getLatestFileSlice(String partitionPath, String fileId) {
        Map<String, String> paramsMap =
                getParamsWithAdditionalParam(partitionPath, FILEID_PARAM, fileId);
        return Option.fromJavaOptional(
                getLatestFileSlicesStreamFromParams(LATEST_PARTITION_SLICE_URL, paramsMap).findFirst());
    }
    ...
    @Override
    public Stream<FileSlice> getLatestFileSlicesBeforeOrOn(
            String partitionPath, String maxCommitTime, boolean includeFileSlicesInPendingCompaction) {
        Map<String, String> paramsMap =
                getParamsWithAdditionalParams(
                        partitionPath,
    ...
    public Map<String, Stream<FileSlice>> getAllLatestFileSlicesBeforeOrOn(String maxCommitTime) {
        ...
        try {
            Map<String, List<FileSliceDTO>> fileSliceMap =
                    executeRequest(
                            ALL_LATEST_SLICES_BEFORE_ON_INSTANT_URL,
                            paramsMap,
                            FILE_SLICE_MAP_REFERENCE,
                            RequestMethod.GET);
            return fileSliceMap.entrySet().stream()
                    .collect(
                            Collectors.toMap(
                                    Map.Entry::getKey,
    ...
    @Override
    public Stream<FileSlice> getLatestMergedFileSlicesBeforeOrOn(
        ...
        return getLatestFileSlicesStreamFromParams(
                LATEST_SLICES_MERGED_BEFORE_ON_INSTANT_URL, paramsMap);
    }
    ...
    private Stream<HoodieFileGroup> getAllFileGroupsForPartitionFromParams(
            String requestPath, Map<String, String> paramsMap) {
        try {
            List<FileGroupDTO> fileGroups =
                    executeRequest(requestPath, paramsMap, FILE_GROUP_DTOS_REFERENCE, RequestMethod.GET);
    ...
    public Stream<HoodieFileGroup> getAllFileGroupsStateless(String partitionPath) {
        Map<String, String> paramsMap = getParamsWithPartitionPath(partitionPath);
        return getAllFileGroupsForPartitionFromParams(
    ...
    public Stream<HoodieFileGroup> getReplacedFileGroupsAfterOrOn(
        ...
        return getAllFileGroupsForPartitionFromParams(
                ALL_REPLACED_FILEGROUPS_AFTER_OR_ON_URL, paramsMap);
    }
    ...
    public boolean refresh() {
        ...
        try {
            ...
            return executeRequest(
                    REFRESH_TABLE_URL, paramsMap, BOOLEAN_TYPE_REFERENCE, RequestMethod.POST);
        } catch (IOException e) {
            throw new HoodieRemoteException(e);
        }
    }
    ...
    private Stream<Pair<String, CompactionOperation>> getPendingCompactionOperations(
            String requestPath, Map<String, String> paramsMap) {
        try {
            List<CompactionOpDTO> dtos =
                    executeRequest(requestPath, paramsMap, COMPACTION_OP_DTOS_REFERENCE, RequestMethod.GET);
    ...
    public Stream<Pair<HoodieFileGroupId, HoodieInstant>> getFileGroupsInPendingClustering() {
        ...
        try {
            List<ClusteringOpDTO> dtos =
                    executeRequest(
                            PENDING_CLUSTERING_FILEGROUPS_URL,
                            paramsMap,
                            CLUSTERING_OP_DTOS_REFERENCE,
                            RequestMethod.GET);
    ...
    public Option<HoodieInstant> getLastInstant() {
        ...
        try {
            List<InstantDTO> instants =
                    executeRequest(LAST_INSTANT_URL, paramsMap, INSTANT_DTOS_REFERENCE, RequestMethod.GET);
    ...
    public HoodieTimeline getTimeline() {
        ...
        try {
            TimelineDTO timelineDto =
                    executeRequest(TIMELINE_URL, paramsMap, TIMELINE_DTO_REFERENCE, RequestMethod.GET);
