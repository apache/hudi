...
public class TablePathUtils {
    ...
    public static Option<StoragePath> getTablePath(HoodieStorage storage, StoragePath path)
        ...
        StoragePath directory = pathInfo.isFile() ? pathInfo.getPath().getParent() : pathInfo.getPath();
    ...
    private static Option<StoragePath> getTablePathFromPartitionPath(
