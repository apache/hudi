...
/**
  ...
  *
  * <p>TODO: enable docs gen by adding {@link ConfigClassProperty} after TSM is landed (HUDI-3475)
  */
@Immutable
public class HoodieTableServiceManagerConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<Boolean> TABLE_SERVICE_MANAGER_ENABLED =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".enabled")
                    .defaultValue(false)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_URIS =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".uris")
    ...
    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_ACTIONS =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".actions")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
                            "The actions deployed on table service manager, such as compaction or clean.");

    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_DEPLOY_USERNAME =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".deploy.username")
    ...
    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_DEPLOY_QUEUE =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".deploy.queue")
                    .defaultValue("default")
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_DEPLOY_RESOURCES =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".deploy.resources")
    ...
    public static final ConfigProperty<Integer> TABLE_SERVICE_MANAGER_DEPLOY_PARALLELISM =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".deploy.parallelism")
                    .defaultValue(100)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_DEPLOY_EXECUTION_ENGINE =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".execution.engine")
                    .defaultValue("spark")
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
                            "The execution engine to deploy for table service of this table, default spark");

    public static final ConfigProperty<String> TABLE_SERVICE_MANAGER_DEPLOY_EXTRA_PARAMS =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".deploy.extra.params")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
                            "The extra params to deploy for table service of this table, split by ';'");

    public static final ConfigProperty<Integer> TABLE_SERVICE_MANAGER_TIMEOUT_SEC =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".connection.timeout.sec")
                    .defaultValue(300)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<Integer> TABLE_SERVICE_MANAGER_RETRIES =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".connection.retries")
                    .defaultValue(3)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
                            "Number of retries while opening a connection to table service manager");

    public static final ConfigProperty<Integer> TABLE_SERVICE_MANAGER_RETRY_DELAY_SEC =
            ConfigProperty.key(TABLE_SERVICE_MANAGER_PREFIX + ".connection.retry.delay.sec")
                    .defaultValue(1)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
    ...
    public boolean isEnabledAndActionSupported(ActionType actionType) {
        return isTableServiceManagerEnabled()
                && getTableServiceManagerActions().contains(actionType.name());
    }
