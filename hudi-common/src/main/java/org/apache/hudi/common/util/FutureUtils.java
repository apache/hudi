...
public class FutureUtils {
    ...
    /**
      ...
      *
      * <ol>
      *   <li>Completes successfully as soon as *all* of the futures complete successfully
      *   <li>Completes exceptionally as soon as *any* of the futures complete exceptionally
    ...
    public static <T> CompletableFuture<List<T>> allOf(List<CompletableFuture<T>> futures) {
        ...
        futures.forEach(
                future -> {
                    // NOTE: We add a callback to every future, to cancel all the other not yet
                    // completed futures,
                    //       which will be providing for an early termination semantic: whenever any
                    // of the futures
                    //       fail other futures will be cancelled and the exception will be returned
                    // as a result
                    future.whenComplete(
                            (ignored, throwable) -> {
                                if (throwable != null) {
