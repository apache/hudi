...
public abstract class BootstrapIndex implements Serializable {
    ...
    /**
      * Check if bootstrap Index is physically present. It does not guarantee the validity of the
      * index. To ensure an index is valid, use useIndex() API.
      */
    ...
    public abstract static class IndexWriter implements AutoCloseable {
        ...
        /**
          ...
          */
        public abstract void appendNextPartition(
    ...
    public static BootstrapIndex getBootstrapIndex(HoodieTableMetaClient metaClient) {
        return ((BootstrapIndex)
                (ReflectionUtils.loadClass(
                        ...
                        new Class[] {HoodieTableMetaClient.class},
                        metaClient)));
    }
}
