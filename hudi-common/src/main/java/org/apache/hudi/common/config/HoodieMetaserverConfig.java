...
public class HoodieMetaserverConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<Boolean> METASERVER_ENABLE =
            ConfigProperty.key(METASERVER_PREFIX + ".enabled")
                    .defaultValue(false)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<String> DATABASE_NAME =
            HoodieTableConfig.DATABASE_NAME.markAdvanced().sinceVersion("0.13.0");

    public static final ConfigProperty<String> TABLE_NAME =
            HoodieTableConfig.NAME.markAdvanced().sinceVersion("0.13.0");

    public static final ConfigProperty<String> METASERVER_URLS =
            ConfigProperty.key(METASERVER_PREFIX + ".uris")
    ...
    public static final ConfigProperty<Integer> METASERVER_CONNECTION_RETRIES =
            ConfigProperty.key(METASERVER_PREFIX + ".connect.retries")
                    .defaultValue(3)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
    ...
    public static final ConfigProperty<Integer> METASERVER_CONNECTION_RETRY_DELAY =
            ConfigProperty.key(METASERVER_PREFIX + ".connect.retry.delay")
                    .defaultValue(1)
                    .markAdvanced()
                    .sinceVersion("0.13.0")
                    .withDocumentation(
