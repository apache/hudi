...
/**
  * ConfigProperty describes a configuration property. It contains the configuration key, deprecated
  * older versions of the key, and an optional default value for the configuration, configuration
  * descriptions and also an inferring mechanism to infer the configuration value based on other
  * configurations.
  *
...
public class ConfigProperty<T> implements Serializable {
    ...
    ConfigProperty(
            ...
            String doc,
            Option<String> sinceVersion,
            Option<String> deprecatedVersion,
    ...
    public ConfigProperty<T> withValidValues(String... validValues) {
        ...
        return new ConfigProperty<>(
                ...
                deprecatedVersion,
                inferFunction,
                new HashSet<>(Arrays.asList(validValues)),
                advanced,
                alternatives);
    }
    ...
    public String toString() {
        return String.format(
                ...
                advanced,
                doc,
                sinceVersion.isPresent() ? sinceVersion.get() : "version is not defined",
