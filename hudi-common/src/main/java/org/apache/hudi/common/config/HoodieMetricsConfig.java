...
import org.apache.hudi.common.metrics.datadog.DatadogHttpClient;
...
public class HoodieMetricsConfig extends HoodieConfig {
  ...
  public DatadogHttpClient.ApiSite getDatadogApiSite() {
    return DatadogHttpClient.ApiSite.valueOf(getString(HoodieMetricsDatadogConfig.DATADOG_API_SITE));
  }
