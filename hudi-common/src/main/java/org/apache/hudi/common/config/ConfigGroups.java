...
/**
  ...
  * several configs. This class group one or more of these superclasses into higher level groups,
  * such as Spark Config, Flink Configs, Metrics .... This class maintains the human readable name
  * and description of each config group.
  */
public class ConfigGroups {
    /**
      * Config group names. Please add the description of each group in {@link
      * ConfigGroups#getDescription}.
      */
    public enum Names {
    ...
    public enum SubGroupNames {
        ...
        NONE("None", "No subgroup. This description should be hidden."),
        FUNCTIONAL_INDEX(
                "Functional Index Configs", "Configurations controlling the behavior of functional index.");
    ...
    public static String getDescription(Names names) {
        ...
        switch (names) {
            ...
            case SPARK_DATASOURCE:
                description =
                        "These configs control the Hudi Spark Datasource, "
            ...
            case FLINK_SQL:
                description =
                        "These configs control the Hudi Flink SQL source/sink connectors, "
            ...
            case WRITE_CLIENT:
                description =
                        "Internally, the Hudi datasource uses a RDD based HoodieWriteClient API "
            ...
            case RECORD_PAYLOAD:
                description =
                        "This is the lowest level of customization offered by Hudi. "
            ...
            case METRICS:
                description =
                        "These set of configs are used to enable monitoring and reporting of key "
            ...
            case HUDI_STREAMER:
                description =
                        "These set of configs are used for Hudi Streamer utility which provides "
