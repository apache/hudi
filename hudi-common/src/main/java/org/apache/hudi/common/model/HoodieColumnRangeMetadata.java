...
/**
  ...
  *
  * <p>NOTE: {@link Comparable} is used as raw-type so that we can handle polymorphism, where caller
  * apriori is not aware of the type {@link HoodieColumnRangeMetadata} is associated with
  */
@SuppressWarnings("rawtype")
public class HoodieColumnRangeMetadata<T extends Comparable> implements Serializable {
    private final String filePath;
    private final String columnName;
    @Nullable private final T minValue;
    @Nullable private final T maxValue;
    ...
    public static <T extends Comparable<T>> HoodieColumnRangeMetadata<T> create(
            String filePath,
            String columnName,
            @Nullable T minValue,
            @Nullable T maxValue,
    ...
    public static <T extends Comparable<T>> HoodieColumnRangeMetadata<T> merge(
            HoodieColumnRangeMetadata<T> left, HoodieColumnRangeMetadata<T> right) {
        ...
        return create(
                filePath, columnName, min, max, nullCount, valueCount, totalSize, totalUncompressedSize);
    }
