...
public class FileStatusDTO {
  ...
  public static FileStatusDTO fromFileStatus(StoragePathInfo fileStatus) {
    if (null == fileStatus) {
      return null;
    }

    FileStatusDTO dto = new FileStatusDTO();
    dto.path = FilePathDTO.fromStoragePath(fileStatus.getPath());
  ...
  public static StoragePathInfo toHoodieFileStatus(FileStatusDTO dto) {
    if (null == dto) {
      return null;
    }
