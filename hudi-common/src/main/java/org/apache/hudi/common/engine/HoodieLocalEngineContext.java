...
public final class HoodieLocalEngineContext extends HoodieEngineContext {
    ...
    public HoodieLocalEngineContext(
            StorageConfiguration<?> conf, TaskContextSupplier taskContextSupplier) {
    ...
    public <I, K, V> Map<K, V> mapToPair(
        ...
        return data.stream()
                ...
                .collect(Collectors.toMap(Pair::getLeft, Pair::getRight, (oldVal, newVal) -> newVal));
    }
