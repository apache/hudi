...
/**
 * Serializable factory for a {@link HoodieVectorBatchReadHandle} (RFC-109 v3 §9, §10). The reranker
 ...
 */
@FunctionalInterface
public interface HoodieVectorBatchReadHandleSupplier extends Serializable {

  HoodieVectorBatchReadHandle get();
}
