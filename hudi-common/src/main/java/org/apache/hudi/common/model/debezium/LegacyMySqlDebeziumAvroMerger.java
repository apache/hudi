...
public class LegacyMySqlDebeziumAvroMerger extends CDCAvroMerger {
  public static final LegacyMySqlDebeziumAvroMerger INSTANCE = new LegacyMySqlDebeziumAvroMerger();
