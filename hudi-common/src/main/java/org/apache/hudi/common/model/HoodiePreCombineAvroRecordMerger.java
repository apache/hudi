...
public class HoodiePreCombineAvroRecordMerger extends HoodieAvroRecordMerger {
    public static final HoodiePreCombineAvroRecordMerger INSTANCE =
            new HoodiePreCombineAvroRecordMerger();
    ...
    private Pair<HoodieRecord, Schema> preCombine(
            HoodieRecord older,
            Schema oldSchema,
            HoodieRecord newer,
            Schema newSchema,
        ...
        if (payload == olderPayload) {
            ...
            HoodieRecord mergedRecord =
                    new HoodieAvroRecord(newer.getKey(), payload, newer.getOperation());
