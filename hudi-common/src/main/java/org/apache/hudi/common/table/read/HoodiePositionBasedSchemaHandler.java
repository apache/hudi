...
/**
  * This class is responsible for handling the schema for the file group reader that supports
  * positional merge.
  */
public class HoodiePositionBasedSchemaHandler<T> extends HoodieFileGroupReaderSchemaHandler<T> {
    public HoodiePositionBasedSchemaHandler(
    ...
    private static Schema addPositionalMergeCol(Schema input) {
        return appendFieldsToSchemaDedupNested(
                input, Collections.singletonList(getPositionalMergeField()));
    }
