...
/**
  ...
  * {@link HoodieRecordMerger} that wants to distinguish the operation mode should implement this
  * interface.
  */
public interface OperationModeAwareness {
    /**
      ...
      *
      * <p>The preCombining takes place in two cases: i). In memory records merging during data
      * ingestion; ii). Log records merging for MOR reader.
      */
