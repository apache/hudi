...
/**
  ...
  * 'DisruptorMessageQueue'. This class takes as queue producer(s), consumer and transformer and
  * exposes API to orchestrate concurrent execution of these actors communicating through disruptor
  */
    ...
    public DisruptorExecutor(
        ...
        super(
                ...
                new DisruptorMessageQueue<>(
                        bufferSize, transformFunction, waitStrategyId, producers.size(), preExecuteRunnable),
                preExecuteRunnable);
    }
