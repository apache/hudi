...
/**
  ...
  *
  * <p>The code in class is ported from {@link org.apache.hadoop.util.hash.JenkinsHash} in Apache
  * Hadoop.
  *
  * <p>
  *
...
public class JenkinsHash extends Hash {
    ...
    /**
      ...
      *     <p>The best hash table sizes are powers of 2. There is no need to do mod a prime (mod is
      *     sooo slow!). If you need less than 32 bits, use a bitmask. For example, if you need only 10
      *     bits, do <code>h = (h & hashmask(10));</code> In which case, the hash table should have
      *     hashsize(10) elements.
      *     <p>If you are hashing n strings byte[][] k, do it like this: for (int i = 0, h = 0; i < n;
      *     ++i) h = hash( k[i], h);
      *     <p>By Bob Jenkins, 2006. bob_jenkins@burtleburtle.net. You may use this code any way you
      *     wish, private, educational, or commercial. It's free.
      *     <p>Use for hash table lookup, or anything where one collision in 2^^32 is acceptable. Do
