...
/**
  ...
  *
  * <ol>
  *   <li>Snapshot: snapshot of the table at the given (latest if not provided) instant is queried
  ...
  *   <li>Incremental: only records added w/in the given time-window (defined by beginning and ending
  *       instant) are queried
  * </ol>
  */
