...
/**
  ...
  *
  * <p>The code in class is adapted from {@link org.apache.hadoop.util.bloom.Filter} in Apache
  * Hadoop.
  *
...
abstract class InternalFilter {
    ...
    /**
      ...
      *
      * <p>For efficiency, implementations should attempt to re-use storage in the existing object
      * where possible.
      *
