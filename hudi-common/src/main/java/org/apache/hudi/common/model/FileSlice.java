...
public class FileSlice implements Serializable {
  ...
  /**
   * <b>NOTE</b>: equals and hashcode generated by Lombok uses getters by default.
   * <p>
   * Using the current `getLogFiles` returns a Stream, instead of a TreeSet, causing equals comparison to fail.
   * </p>
   * To fix this, use `doNotUseGetters = true` to get around this in @EqualsAndHashCode and @ToString
   *
