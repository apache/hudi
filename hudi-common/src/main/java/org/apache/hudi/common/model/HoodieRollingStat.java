...
public class HoodieRollingStat implements Serializable {
    ...
    // TODO
    @Nullable private long totalInputWriteBytesToDisk;
    @Nullable private long totalInputWriteBytesOnDisk;
    ...
    public HoodieRollingStat(
            String fileId, long inserts, long upserts, long deletes, long totalInputWriteBytesOnDisk) {
        this.fileId = fileId;
