...
public class ActiveTimelineV1 extends BaseTimelineV1 implements HoodieActiveTimeline {
  ...
  @Override
  public HoodieInstant transitionCleanInflightToComplete(boolean shouldLock, HoodieInstant inflightInstant, HoodieCleanMetadata metadata) {
  ...
  public HoodieInstant transitionCleanRequestedToInflight(HoodieInstant requestedInstant, HoodieCleanerPlan metadata) {
    ...
    transitionState(requestedInstant, inflight, Option.of(metadata));
    return inflight;
  }
