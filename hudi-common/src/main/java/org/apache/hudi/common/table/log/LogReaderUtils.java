...
public class LogReaderUtils {
    /**
      ...
      *
      * <p>The encoding applies the Base64 codec ({@link java.util.Base64} in Java implementation) on
      * the bytes generated from serializing {@link Roaring64NavigableMap} bitmap, which contains the
      * list of record positions in long type, using the portable format.
      *
    ...
    /**
      ...
      *     implementation) generated from serializing {@link Roaring64NavigableMap} bitmap using the
      *     portable format.
      * @return A {@link Roaring64NavigableMap} bitmap containing the record positions in long type.
      * @throws IOException upon I/O error.
      */
    public static Roaring64NavigableMap decodeRecordPositionsHeader(String content)
            throws IOException {
        Roaring64NavigableMap positionBitmap = new Roaring64NavigableMap();
