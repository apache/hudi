...
/**
  * Encapsulates all the needed information about a clustering group. This is needed because spark
  * serialization does not work with avro objects.
  */
public class ClusteringGroupInfo implements Serializable {
    ...
    private ClusteringGroupInfo(
            final List<ClusteringOperation> operations, final int numOutputGroups) {
