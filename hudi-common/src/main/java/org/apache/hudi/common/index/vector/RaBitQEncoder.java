...
public final class RaBitQEncoder implements Serializable {
  ...
  public static final int ROTATION_VERSION = VectorArtifactIdentity.ROTATION_VERSION;
  ...
  public static String rotationDigest(int dimension, long seed) {
    return VectorArtifactIdentity.rotationDigest(
        dimension, seed, getOrBuildRotationMatrix(dimension, seed));
  }
