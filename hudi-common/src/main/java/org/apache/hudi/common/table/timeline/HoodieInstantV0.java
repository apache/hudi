 ...
 * @see HoodieTimeline
 */
public class HoodieInstantV0 implements Serializable, Comparable<HoodieInstantV0> {
  ...
  public static final Comparator<HoodieInstantV0> ACTION_COMPARATOR =
      Comparator.comparing(instant -> getComparableAction(instant.getAction()));

  public static final Comparator<HoodieInstantV0> COMPARATOR = Comparator.comparing(HoodieInstantV0::getTimestamp)
      .thenComparing(ACTION_COMPARATOR).thenComparing(HoodieInstantV0::getState);

  public static final Comparator<HoodieInstantV0> STATE_TRANSITION_COMPARATOR =
      Comparator.comparing(HoodieInstantV0::getStateTransitionTime)
   ...
   */
  public HoodieInstantV0(StoragePathInfo pathInfo) {
  ...
  public HoodieInstantV0(boolean isInflight, String action, String timestamp) {
  ...
  public HoodieInstantV0(State state, String action, String timestamp) {
    this.state = state;
    this.action = action;
    this.timestamp = timestamp;
    this.stateTransitionTime = null;
  ...
  public HoodieInstantV0(State state, String action, String timestamp, String stateTransitionTime) {
    this.state = state;
    this.action = action;
    this.timestamp = timestamp;
  ...
  public boolean equals(Object o) {
    ...
    HoodieInstantV0 that = (HoodieInstantV0) o;
  ...
  @Override
  public int compareTo(HoodieInstantV0 o) {
