...
public class CompactionOpDTO {
    ...
    public static CompactionOpDTO fromCompactionOperation(
            String compactionInstantTime, CompactionOperation op) {
    ...
    public static Pair<String, CompactionOperation> toCompactionOperation(CompactionOpDTO dto) {
        return Pair.of(
                dto.compactionInstantTime,
                new CompactionOperation(
                        dto.fileId,
                        dto.partitionPath,
                        dto.baseInstantTime,
                        Option.ofNullable(dto.dataFileCommitTime),
                        dto.deltaFilePaths,
                        Option.ofNullable(dto.dataFilePath),
                        Option.ofNullable(dto.bootstrapBaseFile),
                        dto.metrics));
    }
}
