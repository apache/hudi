...
public class HoodieWriteStat implements Serializable {
  ...
  /**
   * Total number of records written for this file. - for updates, is the entire number of records in the file - for
   * inserts, is the actual number of records inserted.
   */
