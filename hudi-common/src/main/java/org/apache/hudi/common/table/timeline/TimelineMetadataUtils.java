...
public class TimelineMetadataUtils {
  ...
  public static <T> T deserializeAvroMetadataLegacy(byte[] bytes, Class<T> clazz)
      throws IOException {
  ...
  public static <T> T deserializeAvroMetadata(Option<InputStream> instantStream, Class<T> clazz)
      throws IOException {
