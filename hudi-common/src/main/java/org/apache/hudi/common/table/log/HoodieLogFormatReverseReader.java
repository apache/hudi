...
public class HoodieLogFormatReverseReader implements HoodieLogFormat.Reader {
  ...
  HoodieLogFormatReverseReader(HoodieStorage storage, List<HoodieLogFile> logFiles,
                               Schema readerSchema,
    ...
    if (logFilePos >= 0) {
      ...
      logFilePos--;
      this.currentReader = new HoodieLogFileReader(storage, nextLogFile, readerSchema, bufferSize,
