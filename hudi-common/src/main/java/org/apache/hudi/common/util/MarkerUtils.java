...
public class MarkerUtils {
  ...
  public static Option<MarkerType> readMarkerType(HoodieStorage storage, String markerDir) {
    StoragePath markerTypeFileLocation = new StoragePath(markerDir, MARKER_TYPE_FILENAME);
  ...
  public static Map<String, Set<String>> readTimelineServerBasedMarkersFromFileSystem(
    ...
    try {
      if (storage.exists(dirPath)) {
        ...
        Predicate<StoragePathInfo> markerTypeFilter = fileStatus ->
   ...
   */
  public static Set<String> readMarkersFromFile(StoragePath markersFileLocation, SerializableConfiguration conf) {
   ...
   * @return Markers in a {@code Set} of String.
   */
  public static Set<String> readMarkersFromFile(StoragePath markersFileLocation,
    ...
    try {
      ...
      inputStream = storage.open(markersFileLocation);
