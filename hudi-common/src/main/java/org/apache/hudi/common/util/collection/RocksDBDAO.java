...
public class RocksDBDAO {
    ...
    private List<ColumnFamilyDescriptor> loadManagedColumnFamilies(DBOptions dbOptions)
        ...
        if (existing.isEmpty()) {
            ...
            managedColumnFamilies.addAll(
                    existing.stream()
                            .map(RocksDBDAO::getColumnFamilyDescriptor)
    ...
    /**
      ...
      */
    public <T extends Serializable> void putInBatch(
            WriteBatch batch, String columnFamilyName, String key, T value) {
        try {
    ...
    /**
      ...
      * @param <T> Type of payload
      */
    public <K extends Serializable, T extends Serializable> void putInBatch(
            WriteBatch batch, String columnFamilyName, K key, T value) {
        try {
    ...
    public <K extends Serializable, T extends Serializable> void put(
        ...
        try {
            byte[] payload = serializePayload(value);
            getRocksDB()
                    .put(managedHandlesMap.get(columnFamilyName), SerializationUtils.serialize(key), payload);
        } catch (Exception e) {
            throw new HoodieException(e);
        }
    }
    ...
    /**
      ...
      * @param key Key
      */
    public <K extends Serializable> void deleteInBatch(
            WriteBatch batch, String columnFamilyName, K key) {
        try {
    ...
    public <K extends Serializable> void delete(String columnFamilyName, K key) {
        try {
            getRocksDB()
                    .delete(managedHandlesMap.get(columnFamilyName), SerializationUtils.serialize(key));
        } catch (Exception e) {
            throw new HoodieException(e);
        }
    }
    ...
    public <K extends Serializable, T extends Serializable> T get(String columnFamilyName, K key) {
        ...
        try {
            byte[] val =
                    getRocksDB()
                            .get(managedHandlesMap.get(columnFamilyName), SerializationUtils.serialize(key));
            return val == null ? null : SerializationUtils.deserialize(val);
        } catch (Exception e) {
            throw new HoodieException(e);
        }
    ...
    /**
      ...
      */
    public <T extends Serializable> Stream<Pair<String, T>> prefixSearch(
            String columnFamilyName, String prefix) {
        ValidationUtils.checkArgument(!closed);
    ...
    public <T extends Serializable> void prefixDelete(String columnFamilyName, String prefix) {
        ...
        if (null != firstEntry) {
            try {
                ...
                getRocksDB()
                        .deleteRange(
                                managedHandlesMap.get(columnFamilyName),
                                getUTF8Bytes(firstEntry),
    ...
    public void addColumnFamily(String columnFamilyName) {
        ...
        managedDescriptorMap.computeIfAbsent(
                columnFamilyName,
                colFamilyName -> {
                    try {
                        ColumnFamilyDescriptor descriptor =
                                getColumnFamilyDescriptor(StringUtils.getUTF8Bytes(colFamilyName));
    ...
    public void dropColumnFamily(String columnFamilyName) {
        ...
        managedDescriptorMap.computeIfPresent(
                columnFamilyName,
