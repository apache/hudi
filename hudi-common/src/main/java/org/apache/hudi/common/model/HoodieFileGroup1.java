 ...
 */
public class HoodieFileGroup1 implements Serializable {
  ...
  public HoodieFileGroup1(HoodieFileGroup fileGroup) {
  ...
  public HoodieFileGroup1(String partitionPath, String id, HoodieTimeline timeline) {
    this(new HoodieFileGroupId(partitionPath, id), timeline);
  }

  public HoodieFileGroup1(HoodieFileGroupId fileGroupId, HoodieTimeline timeline) {
