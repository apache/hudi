...
/**
  * Default payload. {@link HoodieRecordPayload} impl that honors ordering field in both preCombine
  * and combineAndGetUpdateValue.
  *
  * <p>1. preCombine - Picks the latest delta record for a key, based on an ordering field 2.
  * combineAndGetUpdateValue/getInsertValue - Chooses the latest record based on ordering field
  * value.
  */
