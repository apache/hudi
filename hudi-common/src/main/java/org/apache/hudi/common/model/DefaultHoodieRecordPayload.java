...
public class DefaultHoodieRecordPayload extends OverwriteWithLatestAvroPayload {
  ...
  public Option<IndexedRecord> combineAndGetUpdateValue(IndexedRecord currentValue, Schema schema, Properties properties) throws IOException {
     ...
     */
    eventTime = (String) getNestedFieldVal(incomingRecord, properties.getProperty(HoodiePayloadProps.PAYLOAD_EVENT_TIME_FIELD_PROP), true);
  ...
  public Option<Map<String, String>> getMetadata() {
    ...
    if (eventTime != null) {
      metadata.put(METADATA_EVENT_TIME_KEY, eventTime);
    }
