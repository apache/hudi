...
/**
  * Holds payload properties that implementation of {@link HoodieRecordPayload} can leverage. Since
  * both payload classes and HoodiePayloadConfig needs to access these props, storing it here in
  * hudi-common.
  */
public class HoodiePayloadProps {
    ...
    /**
      * A runtime config pass to the {@link HoodieRecordPayload#getInsertValue(Schema, Properties)} to
      * tell if the current record is a update record or insert record for mor table.
      */
    ...
    @Deprecated public static String DEFAULT_PAYLOAD_ORDERING_FIELD_VAL = "ts";
    ...
    @Deprecated public static String DEFAULT_PAYLOAD_EVENT_TIME_FIELD_VAL = "ts";
}
