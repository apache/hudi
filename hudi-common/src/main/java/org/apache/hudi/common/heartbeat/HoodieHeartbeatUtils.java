...
public class HoodieHeartbeatUtils {
    ...
    public static Long getLastHeartbeatTime(
            HoodieStorage storage, String basePath, String instantTime) throws IOException {
        ...
        if (storage.exists(heartbeatFilePath)) {
            ...
            // NOTE : This can happen when a writer is upgraded to use lazy cleaning and the last
            // write had failed
            return 0L;
        }
    }
    ...
    /**
      ...
      */
    public static boolean isHeartbeatExpired(
            String instantTime,
