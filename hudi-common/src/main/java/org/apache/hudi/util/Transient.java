...
public class Transient<T> implements Serializable {
    ...
    /**
      * Creates instance of {@link Transient} by lazily executing provided {@code initializer}, to
      * instantiate value of type {@link T}. Same initializer will be used to re-instantiate the value
      * after original one being dropped during serialization/deserialization cycle
      */
    ...
    /**
      * Creates instance of {@link Transient} by eagerly setting it to provided {@code value}, while
      * given {@code initializer} will be used to re-instantiate the value after original one being
      * dropped during serialization/deserialization cycle
      */
