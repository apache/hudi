...
public class FileStatusCacheHolder {

  private static final FileStatusCacheHolder instance = new FileStatusCacheHolder();

  private SharedInMemoryCache sharedCache = null;

  private FileStatusCacheHolder() {}

  /**
   * @return a new FileStatusCache based on session configuration. Cache memory quota is
   * shared across all clients.
   */
  public FileStatusCache getOrCreate(long maxCacheSize, long cacheTTL) {
  ...
  public static FileStatusCacheHolder get() {
    return instance;
  }
