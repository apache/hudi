...
public class HoodieStorageUtils {
  ...
  public static HoodieStorage getHoodieStorage(Configuration conf) {
    return getHoodieStorage(DEFAULT_URI, conf);
  }

  public static HoodieStorage getHoodieStorage(FileSystem fs) {
    return new HoodieHadoopStorage(fs);
  }

  public static HoodieStorage getHoodieStorage(String basePath, Configuration conf) {
    return getHoodieStorage(HadoopFSUtils.getFs(basePath, conf));
  }

  public static HoodieStorage getHoodieStorage(StoragePath loc, Configuration conf) {
