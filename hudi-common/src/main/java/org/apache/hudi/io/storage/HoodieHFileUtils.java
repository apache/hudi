...
public class HoodieHFileUtils {
   ...
   */
  public static HFile.Reader createHFileReader(
      HoodieStorage storage, StoragePath location, CacheConfig cacheConfig, Configuration configuration) {
    try {
   ...
   */
  public static HFile.Reader createHFileReader(
      HoodieStorage storage, StoragePath dummyLocation, byte[] content) {
