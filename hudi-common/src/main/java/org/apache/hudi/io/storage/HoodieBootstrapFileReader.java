...
abstract class HoodieBootstrapFileReader<T> implements HoodieFileReader<T> {
  ...
  public HoodieBootstrapFileReader(HoodieFileReader<T> skeletonFileReader, HoodieFileReader<T> dataFileReader,
