...
public abstract class HoodieAvroFileReader implements HoodieFileReader<IndexedRecord> {
    ...
    @Override
    public ClosableIterator<HoodieRecord<IndexedRecord>> getRecordIterator(
    ...
    protected ClosableIterator<IndexedRecord> getIndexedRecordIterator(Schema readerSchema)
            throws IOException {
        return getIndexedRecordIterator(readerSchema, readerSchema);
    }

    public abstract ClosableIterator<IndexedRecord> getIndexedRecordIterator(
            Schema readerSchema, Schema requestedSchema) throws IOException;
}
