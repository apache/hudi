...
public interface HoodieFileWriter extends AutoCloseable {
    ...
    void write(String recordKey, HoodieRecord record, Schema schema, Properties props)
            throws IOException;

    void close() throws IOException;

    default void writeWithMetadata(HoodieKey key, HoodieRecord record, Schema schema)
            throws IOException {
