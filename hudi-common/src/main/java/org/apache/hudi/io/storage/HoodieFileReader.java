...
/**
  ...
  *
  * <ul>
  *   <li>{@link HoodieRecord}s
  *   <li>Metadata (statistics, bloom-filters, etc)
  * </ul>
  *
...
public interface HoodieFileReader<T> extends AutoCloseable {
    ...
    ClosableIterator<HoodieRecord<T>> getRecordIterator(Schema readerSchema, Schema requestedSchema)
            throws IOException;

    default ClosableIterator<HoodieRecord<T>> getRecordIterator(Schema readerSchema)
            throws IOException {
