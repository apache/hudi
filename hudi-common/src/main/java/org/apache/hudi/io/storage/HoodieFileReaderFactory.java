...
public class HoodieFileReaderFactory {
  ...
  public HoodieFileReader getContentReader(HoodieConfig config,
    ...
    switch (format) {
      case HFILE:
        ...
        return newHFileFileReader(useNativeHFileReader, conf, path, storage, content, schemaOption);
      default:
        throw new UnsupportedOperationException(format + " format not supported yet.");
    }
  }

  protected HoodieFileReader newParquetFileReader(Configuration conf, StoragePath location) {
  ...
  protected HoodieFileReader newHFileFileReader(boolean useNativeHFileReader,
                                                Configuration conf, StoragePath location,
  ...
  protected HoodieFileReader newOrcFileReader(Configuration conf, StoragePath location) {
    throw new UnsupportedOperationException();
  }
