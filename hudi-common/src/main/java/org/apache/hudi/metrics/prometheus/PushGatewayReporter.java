...
public class PushGatewayReporter extends ScheduledReporter {
    ...
    // Ensures that we maintain a single PushGw client (single connection pool) per Push Gw Server
    // instance.
        ...
        registry
                ...
                .forEach(
                        gaugeEntry -> {
                            ...
                            Pair<String, Map<String, String>> stringMapPair =
                                    MetricUtils.getLabelsAndMetricMap(key);
                                ...
                                if (!gaugeHashMap.containsKey(key)) {
                                    gaugeHashMap.put(
                                            ...
                                            io.prometheus.client.Gauge.build()
                                                    .help("labeled metricName:" + stringMapPair.getKey())
