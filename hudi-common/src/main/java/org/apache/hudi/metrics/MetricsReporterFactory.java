...
public class MetricsReporterFactory {
    ...
    public static Option<MetricsReporter> createReporter(
        ...
        if (!StringUtils.isNullOrEmpty(reporterClassName)) {
            Object instance =
                    ReflectionUtils.loadClass(
                            reporterClassName,
                            new Class<?>[] {Properties.class, MetricRegistry.class},
                            metricsConfig.getProps(),
                            registry);
            if (!(instance instanceof CustomizableMetricsReporter)) {
                throw new HoodieException(
                        metricsConfig.getMetricReporterClassName()
        ...
        if (type == null) {
            LOG.warn(
                    String.format(
                            "Metric creation failed. %s is not configured",
