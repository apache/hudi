...
/**
  ...
  *
  * <p>Responsible for collecting and composing metrics payload.
  *
  * <p>Internally use {@link DatadogHttpClient} to interact with Datadog APIs.
  */
public class DatadogReporter extends ScheduledReporter {
    ...
    public void report(
        ...
        Map<List<String>, List<Pair<String, List<String>>>> labelsPair =
                gauges.keySet().stream()
                        .map(MetricUtils::getLabelsAndMetricList)
                ...
                .forEach(
                        labelsKeyValue -> {
                            ...
                            gauges.forEach(
                                    (metricName, metric) ->
                                            builder.addGauge(
                                                    prefix(MetricUtils.getMetricAndLabels(metricName).getKey()),
                                                    now,
    ...
    /**
      ...
      *
      * <p>Refer to Datadog API reference
