...
public class JmxReporterServer {
    ...
    public static class Builder {
        ...
        public JmxReporterServer build() {
            ...
            ValidationUtils.checkArgument(
                    !StringUtils.isNullOrEmpty(host), "host cannot be null or empty!");
    ...
    protected JmxReporterServer(
            MetricRegistry registry, String host, int port, MBeanServer mBeanServer) {
        String serviceUrl =
    ...
    public void start() {
        ValidationUtils.checkArgument(
                reporter != null && connector != null, "reporter or connector cannot be null!");
        try {
            connector.start();
            reporter.start();
        } catch (Exception e) {
