...
/**
  ...
  *
  * <p>Responsible for reading Hoodie metrics configurations and hooking up with {@link
  * org.apache.hudi.metrics.Metrics}.
  *
  * <p>Internally delegate reporting tasks to {@link DatadogReporter}.
  */
public class DatadogMetricsReporter extends MetricsReporter {
    ...
    public DatadogMetricsReporter(HoodieMetricsConfig config, MetricRegistry registry) {
        ...
        ValidationUtils.checkState(
                !StringUtils.isNullOrEmpty(apiKey),
