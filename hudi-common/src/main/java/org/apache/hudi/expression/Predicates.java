...
public class Predicates {
    ...
    public static class In implements Predicate {
        ...
        public Boolean eval(StructLike data) {
            Set<Object> values =
                    validValues.stream().map(validValue -> validValue.eval(data)).collect(Collectors.toSet());
    ...
    public static class BinaryComparison extends BinaryExpression implements Predicate {
        ...
        public Boolean eval(StructLike data) {
            ...
            Comparator<Object> comparator =
                    Comparators.forType((Type.PrimitiveType) getLeft().getDataType());
            switch (getOperator()) {
                case EQ:
                ...
                default:
                    throw new IllegalArgumentException(
                            "The operation " + getOperator() + " doesn't support binary comparison");
            }
        }
    }
}
