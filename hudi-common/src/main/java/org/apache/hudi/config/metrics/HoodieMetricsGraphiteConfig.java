...
/**
  ...
  *
  * <p>{@link org.apache.hudi.metrics.MetricsReporterType#GRAPHITE}
  */
@ConfigClassProperty(
        name = "Metrics Configurations for Graphite",
        groupName = ConfigGroups.Names.METRICS,
        description =
                "Enables reporting on Hudi metrics using Graphite. "
...
public class HoodieMetricsGraphiteConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> GRAPHITE_SERVER_HOST_NAME =
            ConfigProperty.key(GRAPHITE_PREFIX + ".host")
    ...
    public static final ConfigProperty<Integer> GRAPHITE_SERVER_PORT_NUM =
            ConfigProperty.key(GRAPHITE_PREFIX + ".port")
                    .defaultValue(4756)
                    .markAdvanced()
                    .sinceVersion("0.5.0")
    ...
    public static final ConfigProperty<String> GRAPHITE_METRIC_PREFIX_VALUE =
            ConfigProperty.key(GRAPHITE_PREFIX + ".metric.prefix")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.5.1")
                    .withDocumentation(
    ...
    public static final ConfigProperty<Integer> GRAPHITE_REPORT_PERIOD_IN_SECONDS =
            ConfigProperty.key(GRAPHITE_PREFIX + ".report.period.seconds")
                    .defaultValue(30)
                    .markAdvanced()
                    .sinceVersion("0.10.0")
    ...
    @Deprecated public static final String GRAPHITE_SERVER_HOST = GRAPHITE_SERVER_HOST_NAME.key();
    /** @deprecated Use {@link #GRAPHITE_SERVER_HOST_NAME} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String GRAPHITE_SERVER_PORT = GRAPHITE_SERVER_PORT_NUM.key();
    /** @deprecated Use {@link #GRAPHITE_SERVER_PORT_NUM} and its methods instead */
    @Deprecated
