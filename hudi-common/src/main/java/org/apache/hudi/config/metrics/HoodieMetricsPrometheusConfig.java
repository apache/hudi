...
/**
  ...
  *
  * <p>{@link org.apache.hudi.metrics.MetricsReporterType#PROMETHEUS} {@link
  * org.apache.hudi.metrics.MetricsReporterType#PROMETHEUS_PUSHGATEWAY}
  */
@ConfigClassProperty(
        name = "Metrics Configurations for Prometheus",
        groupName = ConfigGroups.Names.METRICS,
        description =
                "Enables reporting on Hudi metrics using Prometheus. "
...
public class HoodieMetricsPrometheusConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> PUSHGATEWAY_HOST_NAME =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".host")
    ...
    public static final ConfigProperty<Integer> PUSHGATEWAY_PORT_NUM =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".port")
                    .defaultValue(9091)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    public static final ConfigProperty<Integer> PUSHGATEWAY_REPORT_PERIOD_IN_SECONDS =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".report.period.seconds")
                    .defaultValue(30)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    public static final ConfigProperty<Boolean> PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".delete.on.shutdown")
                    .defaultValue(true)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> PUSHGATEWAY_JOBNAME =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".job.name")
                    .defaultValue("")
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    public static final ConfigProperty<String> PUSHGATEWAY_LABELS =
            ConfigProperty.key(PUSHGATEWAY_PREFIX + ".report.labels")
                    .defaultValue("")
                    .markAdvanced()
                    .sinceVersion("0.14.0")
                    .withDocumentation(
                            "Label for the metrics emitted to the Pushgateway. Labels can be specified with key:value pairs separated by commas");
    ...
    public static final ConfigProperty<Integer> PROMETHEUS_PORT_NUM =
            ConfigProperty.key(PROMETHEUS_PREFIX + ".port")
                    .defaultValue(9090)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    @Deprecated public static final String PUSHGATEWAY_HOST = PUSHGATEWAY_HOST_NAME.key();
    /** @deprecated Use {@link #PUSHGATEWAY_HOST_NAME} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String PUSHGATEWAY_PORT = PUSHGATEWAY_PORT_NUM.key();
    /** @deprecated Use {@link #PUSHGATEWAY_PORT_NUM} and its methods instead */
    @Deprecated
    ...
    @Deprecated
    public static final String PUSHGATEWAY_REPORT_PERIOD_SECONDS =
            PUSHGATEWAY_REPORT_PERIOD_IN_SECONDS.key();
    /** @deprecated Use {@link #PUSHGATEWAY_REPORT_PERIOD_IN_SECONDS} and its methods instead */
    @Deprecated
    public static final int DEFAULT_PUSHGATEWAY_REPORT_PERIOD_SECONDS =
            PUSHGATEWAY_REPORT_PERIOD_IN_SECONDS.defaultValue();
    /** @deprecated Use {@link #PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE} and its methods instead */
    @Deprecated
    public static final String PUSHGATEWAY_DELETE_ON_SHUTDOWN =
            PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE.key();
    /** @deprecated Use {@link #PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE} and its methods instead */
    @Deprecated
    public static final boolean DEFAULT_PUSHGATEWAY_DELETE_ON_SHUTDOWN =
            PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE.defaultValue();
    /** @deprecated Use {@link #PUSHGATEWAY_JOBNAME} and its methods instead */
    @Deprecated public static final String PUSHGATEWAY_JOB_NAME = PUSHGATEWAY_JOBNAME.key();
    /** @deprecated Use {@link #PUSHGATEWAY_JOBNAME} and its methods instead */
    @Deprecated
    ...
    @Deprecated
    public static final String PUSHGATEWAY_RANDOM_JOB_NAME_SUFFIX =
            PUSHGATEWAY_RANDOM_JOBNAME_SUFFIX.key();
    /** @deprecated Use {@link #PUSHGATEWAY_RANDOM_JOBNAME_SUFFIX} and its methods instead */
    @Deprecated
    public static final boolean DEFAULT_PUSHGATEWAY_RANDOM_JOB_NAME_SUFFIX =
            PUSHGATEWAY_RANDOM_JOBNAME_SUFFIX.defaultValue();
    /** @deprecated Use {@link #PROMETHEUS_PORT_NUM} and its methods instead */
    @Deprecated public static final String PROMETHEUS_PORT = PROMETHEUS_PORT_NUM.key();
    /** @deprecated Use {@link #PROMETHEUS_PORT_NUM} and its methods instead */
    @Deprecated public static final int DEFAULT_PROMETHEUS_PORT = PROMETHEUS_PORT_NUM.defaultValue();
    ...
    public static class Builder {
        ...
        private HoodieMetricsPrometheusConfig hoodieMetricsPrometheusConfig =
                new HoodieMetricsPrometheusConfig();
        ...
        public HoodieMetricsPrometheusConfig.Builder withPushgatewayPortNum(
                Integer pushgatewayPortNum) {
            hoodieMetricsPrometheusConfig.setValue(
                    PUSHGATEWAY_PORT_NUM, String.valueOf(pushgatewayPortNum));
            return this;
        }

        public HoodieMetricsPrometheusConfig.Builder withPushgatewayReportPeriodInSeconds(
                String periodTime) {
            hoodieMetricsPrometheusConfig.setValue(PUSHGATEWAY_REPORT_PERIOD_IN_SECONDS, periodTime);
            return this;
        }

        public HoodieMetricsPrometheusConfig.Builder withPushgatewayDeleteOnShutdownEnable(
                boolean deleteOnShutdownEnable) {
            hoodieMetricsPrometheusConfig.setValue(
                    PUSHGATEWAY_DELETE_ON_SHUTDOWN_ENABLE, String.valueOf(deleteOnShutdownEnable));
            return this;
        }
        ...
        public HoodieMetricsPrometheusConfig.Builder withPushgatewayRandomJobnameSuffix(
                boolean randomJobnameSuffix) {
            hoodieMetricsPrometheusConfig.setValue(
                    PUSHGATEWAY_RANDOM_JOBNAME_SUFFIX, String.valueOf(randomJobnameSuffix));
            return this;
        }
        ...
        public HoodieMetricsPrometheusConfig.Builder withPrometheusPortNum(int prometheusPortNum) {
            hoodieMetricsPrometheusConfig.setValue(
                    PROMETHEUS_PORT_NUM, String.valueOf(prometheusPortNum));
            return this;
        }
