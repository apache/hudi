...
/**
  ...
  *
  * <p>{@link org.apache.hudi.metrics.MetricsReporterType#JMX}
  */
@ConfigClassProperty(
        name = "Metrics Configurations for Jmx",
        groupName = ConfigGroups.Names.METRICS,
        description =
                "Enables reporting on Hudi metrics using Jmx. "
...
public class HoodieMetricsJmxConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> JMX_HOST_NAME =
            ConfigProperty.key(JMX_PREFIX + ".host")
    ...
    public static final ConfigProperty<Integer> JMX_PORT_NUM =
            ConfigProperty.key(JMX_PREFIX + ".port")
                    .defaultValue(9889)
                    .markAdvanced()
                    .sinceVersion("0.5.1")
    ...
    @Deprecated public static final String JMX_HOST = JMX_HOST_NAME.key();
    /** @deprecated Use {@link #JMX_HOST_NAME} and its methods instead */
    @Deprecated public static final String DEFAULT_JMX_HOST = JMX_HOST_NAME.defaultValue();
    /** @deprecated Use {@link #JMX_PORT_NUM} and its methods instead */
    @Deprecated public static final String JMX_PORT = JMX_PORT_NUM.key();
    /** @deprecated Use {@link #JMX_PORT_NUM} and its methods instead */
    @Deprecated public static final int DEFAULT_JMX_PORT = JMX_PORT_NUM.defaultValue();
