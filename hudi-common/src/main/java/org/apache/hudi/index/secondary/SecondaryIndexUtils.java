...
public class SecondaryIndexUtils {
    ...
    /**
      ...
      */
    public static Option<List<HoodieSecondaryIndex>> getSecondaryIndexes(
    ...
    public static List<HoodieSecondaryIndex> fromJsonString(String jsonStr) {
        try {
            return SecondaryIndexUtils.fromJsonString(
                    jsonStr, new TypeReference<List<HoodieSecondaryIndex>>() {});
        } catch (Exception e) {
