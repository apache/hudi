...
public class HoodieHiveUtils {
    ...
    /**
      * Returns a list of tableNames for which hoodie.<tableName>.consume.mode is set to incremental
    ...
    /**
      * Get timestamp writeable object from long value. Hive3 use TimestampWritableV2 to build
      * timestamp objects and Hive2 use TimestampWritable. So that we need to initialize timestamp
      * according to the version of Hive.
      */
    ...
    /**
      * Get date writeable object from int value. Hive3 use DateWritableV2 to build date objects and
      * Hive2 use DateWritable. So that we need to initialize date according to the version of Hive.
      */
