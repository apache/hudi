...
/**
  * With the base input format implementations in Hadoop/Hive, we need to encode additional
  * information in Path to track base files and logs files for realtime read. Hence, this class
  * tracks a log/base file status in Path.
  */
public class RealtimeFileStatus extends FileStatus {
    ...
    public Path getPath() {
        ...
        if (bootStrapFileStatus != null) {
            realtimePath.setPathWithBootstrapFileStatus(
