...
/**
  ...
  */
public class HoodieRealtimeBootstrapBaseFileSplit extends BootstrapBaseFileSplit
    ...
    /**
      * NOTE: This ctor is necessary for Hive to be able to serialize and then instantiate it when
      * deserializing back
      */
