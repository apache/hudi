...
/**
  ...
  *
  * <ol>
  *   <li>Split corresponding to the base file
  *   <li>List of {@link HoodieLogFile} that holds the delta to be merged (upon reading)
  * </ol>
  *
  * <p>This split is correspondent to a single file-slice in the Hudi terminology.
  *
  * <p>NOTE: If you're adding fields here you need to make sure that you appropriately de-/serialize
  * them in {@link #readFromInput(DataInput)} and {@link #writeToOutput(DataOutput)}
  */
public class HoodieRealtimeFileSplit extends FileSplit implements RealtimeSplit {
    ...
    /**
      * Latest commit instant available at the time of the query in which all of the files pertaining
      * to this split are represented
      */
    ...
    public HoodieRealtimeFileSplit(
            ...
            throws IOException {
        super(
                baseSplit.getPath(), baseSplit.getStart(), baseSplit.getLength(), baseSplit.getLocations());
    ...
    public String toString() {
        return "HoodieRealtimeFileSplit{DataPath="
                + getPath()
                + ", deltaLogPaths="
                + getDeltaLogPaths()
                + ", maxCommitTime='"
