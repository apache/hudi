...
public class BootstrapColumnStichingRecordReader
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(BootstrapColumnStichingRecordReader.class);
    ...
    public BootstrapColumnStichingRecordReader(
            RecordReader<NullWritable, ArrayWritable> left,
            int numLeftColumns,
