...
public class ExternalDataFileSplit extends FileSplit {

  private String sourceFileFullPath;

  public ExternalDataFileSplit() {
    super();
  }

  public ExternalDataFileSplit(FileSplit baseSplit, String sourceFileFullPath)
      throws IOException {
  ...
  public void write(DataOutput out) throws IOException {
    super.write(out);
    writeString(sourceFileFullPath, out);
  }

  @Override
  public void readFields(DataInput in) throws IOException {
    super.readFields(in);
    sourceFileFullPath = readString(in);
  }
}
