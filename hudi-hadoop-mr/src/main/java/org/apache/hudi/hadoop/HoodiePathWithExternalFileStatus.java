 ...
 * in Path.
 */
public class HoodiePathWithExternalFileStatus extends Path {

  private final FileStatus externalFileStatus;

  public HoodiePathWithExternalFileStatus(Path path, FileStatus externalFileStatus) {
    super(path.getParent(), path.getName());
    this.externalFileStatus = externalFileStatus;
  }

  public FileStatus getExternalFileStatus() {
