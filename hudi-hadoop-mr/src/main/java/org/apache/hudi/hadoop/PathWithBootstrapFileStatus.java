...
/**
  * Hacky Workaround !!! With the base input format implementations in Hadoop/Hive, we need to encode
  * additional information in Path to track matching external file. Hence, this weird looking class
  * which tracks an external file status in Path.
  */
