...
/**
  * To resolve issue <a href="https://issues.apache.org/jira/browse/HUDI-83">Fix Timestamp/Date type
  * read by Hive3</a>, we need to handle timestamp types separately based on the parquet-avro
  * approach.
  */
