...
/**
  * {@link Path} implementation encoding additional information necessary to appropriately read base
  * files of the MOR tables, such as list of delta log files (holding updated records) associated w/
  * the base file, etc.
  */
public class HoodieRealtimePath extends Path {
    ...
    public void setPathWithBootstrapFileStatus(
            PathWithBootstrapFileStatus pathWithBootstrapFileStatus) {
