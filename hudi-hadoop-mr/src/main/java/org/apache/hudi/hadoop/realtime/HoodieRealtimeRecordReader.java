...
/**
  ...
  * (parquet and log files read in parallel) based on job configuration.
  */
public class HoodieRealtimeRecordReader implements RecordReader<NullWritable, ArrayWritable> {
    ...
    public HoodieRealtimeRecordReader(
    ...
    /**
      ...
      */
    private static RecordReader<NullWritable, ArrayWritable> constructRecordReader(
            RealtimeSplit split, JobConf jobConf, RecordReader<NullWritable, ArrayWritable> realReader) {
        try {
