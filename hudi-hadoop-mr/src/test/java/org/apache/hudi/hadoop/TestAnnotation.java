...
public class TestAnnotation {
    ...
    public void testHoodieParquetInputFormatAnnotation() {
        assertTrue(
                HoodieParquetInputFormat.class.isAnnotationPresent(UseFileSplitsFromInputFormat.class));
        assertTrue(
                HoodieParquetInputFormat.class.isAnnotationPresent(UseRecordReaderFromInputFormat.class));
        ...
        for (Annotation annotation : annotations) {
            if (UseFileSplitsFromInputFormat.class
                    .getSimpleName()
                    .equals(annotation.annotationType().getSimpleName())) {
                foundFileSplitsAnnotation = true;
            } else if (UseRecordReaderFromInputFormat.class
                    .getSimpleName()
                    .equals(annotation.annotationType().getSimpleName())) {
    ...
    public void testHoodieParquetRealtimeInputFormatAnnotations() {
        assertTrue(
                HoodieParquetRealtimeInputFormat.class.isAnnotationPresent(
                        UseFileSplitsFromInputFormat.class));
        assertTrue(
                HoodieParquetRealtimeInputFormat.class.isAnnotationPresent(
                        UseRecordReaderFromInputFormat.class));
