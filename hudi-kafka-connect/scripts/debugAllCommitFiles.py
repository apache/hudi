...
print("Number of commited logs ", len(commitFiles), commitFiles)
...
print("Number of Total written logs ", len(writtenLogs), writtenLogs)
...
print("Number of Total written logs that were commited ", len(commitedLogs), commitedLogs)
