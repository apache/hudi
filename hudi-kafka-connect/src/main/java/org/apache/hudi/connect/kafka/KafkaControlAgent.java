...
/**
  * Manages the Kafka consumer and producer for the Kafka Control Topic that ensures coordination
  * across the {@link TransactionCoordinator} and {@link TransactionParticipant}s.
  */
