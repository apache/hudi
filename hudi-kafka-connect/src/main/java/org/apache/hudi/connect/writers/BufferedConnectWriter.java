...
/**
  * Specific implementation of a Hudi Writer that buffers all incoming records, and writes them to
  * Hudi files on the end of a transaction using Bulk Insert.
  */
    ...
    public List<WriteStatus> flushRecords() {
        try {
            ...
            if (!bufferedRecords.isEmpty()) {
                if (isMorTable) {
                    writeStatuses =
                            writeClient.upsertPreppedRecords(
