...
/**
  * The events within the Coordinator that trigger the state changes in the state machine of the
  * Coordinator.
  */
public class CoordinatorEvent {
    ...
    public CoordinatorEvent(CoordinatorEventType eventType, String topicName, String commitTime) {
