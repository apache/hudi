...
/**
  ...
  * org.apache.hudi.connect.transaction.TransactionParticipant} to write the incoming records to
  * Hudi.
  */
public class KafkaConnectWriterProvider implements ConnectWriterProvider<WriteStatus> {
    ...
    public KafkaConnectWriterProvider(KafkaConnectConfigs connectConfigs, TopicPartition partition)
        ...
        try {
            this.schemaProvider =
                    StringUtils.isNullOrEmpty(connectConfigs.getSchemaProviderClass())
                            ? null
                            : (SchemaProvider)
                                    ReflectionUtils.loadClass(
                                            connectConfigs.getSchemaProviderClass(),
                    ...
                    HoodieWriteConfig.newBuilder()
                            ...
                            .withIndexConfig(
                                    HoodieIndexConfig.newBuilder()
                                            ...
                                            .build())
                            // participants should not trigger table services, and leave it to the
                            // coordinator
                            ...
                            .withClusteringConfig(
                                    HoodieClusteringConfig.newBuilder().withInlineClustering(false).build())
