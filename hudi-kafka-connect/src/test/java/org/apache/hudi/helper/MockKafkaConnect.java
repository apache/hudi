...
/**
  * Helper class that emulates the Kafka Connect f/w and additionally implements {@link
  * SinkTaskContext} for testing purposes.
  *
  * <p>Everytime the consumer (Participant) calls resume, a fixed batch of kafka records from the
  * current offset are pushed. If the consumer resets the offsets, then a fresh batch of records are
  * sent from the new offset.
  */
