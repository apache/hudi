...
public class TestIOUtils {
    ...
    public void testToBytes() {
        ...
        assertArrayEquals(
                new byte[] {0x02, (byte) 0x93, (byte) 0xed, (byte) 0x88}, IOUtils.toBytes(43249032));
        assertArrayEquals(
                new byte[] {0x19, (byte) 0x99, (byte) 0x9a, 0x61},
                IOUtils.toBytes(Integer.MAX_VALUE / 5 + 200));
        assertArrayEquals(
                new byte[] {(byte) 0x7f, (byte) 0xff, (byte) 0xff, (byte) 0xff},
                IOUtils.toBytes(Integer.MAX_VALUE));
        assertArrayEquals(new byte[] {0, 0, 0, 0, 0, 0, 0, 20}, IOUtils.toBytes(20L));
        assertArrayEquals(
                new byte[] {0, 0, 0, 0, 0x49, 0x52, 0x45, 0x32}, IOUtils.toBytes(1230128434L));
        assertArrayEquals(
                new byte[] {
                    0x19, (byte) 0x99, (byte) 0x99, (byte) 0x99, (byte) 0x99, (byte) 0x99, (byte) 0x9a, 0x61
                },
