...
public class TestStoragePathFilter {
    ...
    public void testFilter() {
        ...
        List<StoragePath> pathList =
                Arrays.stream(new StoragePath[] {path1, path2, path3, path4}).collect(Collectors.toList());

        List<StoragePath> expected =
                Arrays.stream(new StoragePath[] {path1, path2}).collect(Collectors.toList());
