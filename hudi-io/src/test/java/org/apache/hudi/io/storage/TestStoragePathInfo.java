...
public class TestStoragePathInfo {
    ...
    public void testConstructor() {
        ...
        pathInfo =
                new StoragePathInfo(
                        STORAGE_PATH2, -1, true, BLOCK_REPLICATION, BLOCK_SIZE, MODIFICATION_TIME + 2L);
    ...
    public void testCompareTo() {
        StoragePathInfo pathInfo1 =
                new StoragePathInfo(
                        new StoragePath(PATH1),
                        LENGTH,
                        false,
                        BLOCK_REPLICATION,
                        BLOCK_SIZE,
                        MODIFICATION_TIME);
        StoragePathInfo pathInfo2 =
                new StoragePathInfo(
                        new StoragePath(PATH1),
                        LENGTH + 2,
                        false,
                        BLOCK_REPLICATION,
                        BLOCK_SIZE,
                        MODIFICATION_TIME + 2L);
        StoragePathInfo pathInfo3 =
                new StoragePathInfo(
                        new StoragePath(PATH2),
                        LENGTH,
                        false,
                        BLOCK_REPLICATION,
                        BLOCK_SIZE,
