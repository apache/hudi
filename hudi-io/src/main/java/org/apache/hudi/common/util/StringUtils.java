...
public class StringUtils {
    ...
    /**
      ...
      *
      * <p>Allow return {@code null} when {@code Iterable} is {@code null}.
      */
    ...
    /**
      * Splits input string, delimited {@code delimiter} into a list of non-empty strings (skipping any
      * empty string produced during splitting)
      */
    ...
    /**
      ...
      * @return a negative integer if version1 precedes version2, a positive integer if version2
      *     precedes version1, and 0 if and only if the two versions are equal.
      */
    ...
    /**
      ...
      *
      * <p>A <code>null</code> reference passed to this method is a no-op.
      *
      * <pre>
      ...
      * </pre>
      *
      * <p>This method is copied from hadoop StringUtils.
      *
    ...
    /**
      * Replaces a String with another String inside a larger String, for the first <code>max</code>
