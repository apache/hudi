...
public interface Registry extends Serializable {
    ...
    /**
      ...
      *
      * <p>This function creates a {@code LocalRegistry}.
      *
    ...
    /**
      ...
      *
      * <p>If the metric does not exist, it is added. If the metrics already exists, its value is
    ...
    /**
      * Get all Counter type metrics.
      *
      * @param prefixWithRegistryName If true, the names of all metrics are prefixed with name of this
      *     registry.
      */
