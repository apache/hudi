...
/**
  * Provides functionality same as java.util.Optional but is also made Serializable. Additional APIs
  * are provided to convert to/from java.util.Optional
  */
public final class Option<T> implements Serializable {
    ...
    /**
      * Returns this {@link Option} if not empty, otherwise evaluates provided supplier and returns its
      * result
      */
    ...
    public String toString() {
        return val != null ? "Option{val=" + val + "}" : "Optional.empty";
    }
}
