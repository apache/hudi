...
/**
  ...
  *     Maven Wiki</a> This class is copied from {@code org.apache.hadoop.util.ComparableVersion} to
  *     avoid Hadoop dependency.
  */
public class ComparableVersion implements Comparable<ComparableVersion> {
            ...
            switch (item.getType()) {
                ...
                case STRING_ITEM:
                    return comparableQualifier(value)
                            .compareTo(comparableQualifier(((ComparableVersion.StringItem) item).value));
    ...
    private static class ListItem extends ArrayList<ComparableVersion.Item>
        ...
        void normalize() {
            for (ListIterator<ComparableVersion.Item> iterator = listIterator(size());
    ...
    private static ComparableVersion.Item parseItem(boolean isDigit, String buf) {
        return isDigit
                ? new ComparableVersion.IntegerItem(buf)
                : new ComparableVersion.StringItem(buf, false);
    }
