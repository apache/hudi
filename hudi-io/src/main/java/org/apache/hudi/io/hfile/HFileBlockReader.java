...
public class HFileBlockReader {
    ...
    /**
      ...
      */
    public HFileBlockReader(
            HFileContext context, SeekableDataInputStream stream, long startOffset, long endOffset) {
    ...
    public HFileBlock nextBlock(HFileBlockType expectedBlockType) throws IOException {
        ...
        if (block.getBlockType() != expectedBlockType) {
            throw new IOException(
                    "Unexpected block type: " + block.getBlockType() + "; expecting " + expectedBlockType);
        }
