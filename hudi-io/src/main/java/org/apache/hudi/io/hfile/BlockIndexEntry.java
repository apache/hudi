...
/**
  * Represents the index entry of a data block in the Data Index stored in the {@link
  * HFileBlockType#ROOT_INDEX} block.
  *
  * <p>This is completely in-memory representation and does not involve byte parsing.
  *
  * <p>When comparing two {@link BlockIndexEntry} instances, the underlying bytes of the keys are
...
public class BlockIndexEntry implements Comparable<BlockIndexEntry> {
    ...
    public BlockIndexEntry(Key firstKey, Option<Key> nextBlockFirstKey, long offset, int size) {
