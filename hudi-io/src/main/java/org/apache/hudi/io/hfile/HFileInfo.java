...
public class HFileInfo {
    ...
    private static final UTF8StringKey LAST_KEY = new UTF8StringKey(RESERVED_PREFIX + "LASTKEY");
    ...
    private long parseMaxMvccTs() {
        ...
        boolean supportsMvccTs =
                bytes != null && IOUtils.readInt(bytes, 0) == KEY_VALUE_VERSION_WITH_MVCC_TS;
