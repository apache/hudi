...
/**
  * Stores the current position and {@link KeyValue} at the position in the HFile. The same instance
  * is used as a position cursor during HFile reading. The {@link KeyValue} can be lazily read and
  * cached.
  */
public class HFileCursor {
    ...
    public String toString() {
        return "HFilePosition{offset=" + offset + ", keyValue=" + keyValue.toString() + "}";
    }
}
