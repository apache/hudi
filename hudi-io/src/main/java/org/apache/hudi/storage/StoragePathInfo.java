...
/**
  * Represents the information of a storage path representing a directory or a file. The APIs are
  * mainly based on {@code org.apache.hadoop.fs.FileStatus} class with simplification based on what
  * Hudi needs.
  */
