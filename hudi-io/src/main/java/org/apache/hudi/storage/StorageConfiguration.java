...
public abstract class StorageConfiguration<T> implements Serializable {
    /**
      * @return a new {@link StorageConfiguration} instance with a new copy of the configuration of
      *     type {@link T}.
      */
    ...
    /**
      * Sets a property key with a value in the configuration, if the property key does not already
      * exist.
      *
