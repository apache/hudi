...
public class InLineFSUtils {
    ...
    /**
      ...
      *
      * <p>Examples: Input Path: s3a://file1, origScheme: file, startOffset = 20, length = 40 Output:
      * "inlinefs://file1/s3a/?start_offset=20&length=40"
      *
      ...
      */
    public static StoragePath getInlineFilePath(
            StoragePath outerPath, String origScheme, long inLineStartOffset, long inLineLength) {
        final String subPath =
                new File(outerPath.toString().substring(outerPath.toString().indexOf(":") + 1)).getPath();
    ...
    public static StoragePath getOuterFilePathFromInlinePath(StoragePath inlineFSPath) {
        ...
        checkArgument(
                basePath.toString().contains(SCHEME_SEPARATOR), "Invalid InLineFS path: " + inlineFSPath);

        final String pathExceptScheme =
                basePath.toString().substring(basePath.toString().indexOf(SCHEME_SEPARATOR) + 1);
    ...
    /**
      ...
      *
      * <p>input: "inlinefs://file1/s3a/?start_offset=20&length=40". output: 20
      */
    ...
    /**
      ...
      *
      * <p>input: "inlinefs:/file1/s3a/?start_offset=20&length=40". output: 40
      */
