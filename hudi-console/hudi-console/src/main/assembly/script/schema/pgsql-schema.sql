...
drop sequence if exists "public"."streampark_t_permissions_id_seq";
...
-- ----------------------------
create sequence "public"."streampark_t_permissions_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_permissions" (
  "id" int8 not null default nextval('streampark_t_permissions_id_seq'::regclass),
  "team_id" int8,
  "user_id" int8,
  "role_id" int8,
  "create_time" timestamp(6) not null default timezone('UTC-8'::text, (now())::timestamp(0) without time zone),
...
;
comment on column "public"."t_permissions"."team_id" is 'team id';
comment on column "public"."t_permissions"."user_id" is 'user id';
comment on column "public"."t_permissions"."role_id" is 'role id';
alter table "public"."t_permissions" add constraint "t_permissions_pkey" primary key ("id");
create index "un_user_role_inx" on "public"."t_permissions" using btree (
  "team_id" "pg_catalog"."int8_ops" asc nulls last,
  "user_id" "pg_catalog"."int8_ops" asc nulls last,
  "role_id" "pg_catalog"."int8_ops" asc nulls last
);
