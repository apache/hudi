...
ALLOWED_TAGS = {
    ...
    'write', 'trino', 'terraform', 'table services', 'storage type', 'apache paimon',
    ...
    'apache avro', 'apache', 'access control', 'lakehouse', 'merge on read', 'record level index','rli', 'penn interactive', 'southwest airlines',
}
