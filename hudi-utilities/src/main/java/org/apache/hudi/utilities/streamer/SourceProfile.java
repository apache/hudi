...
/**
  * A profile containing details about how the next input batch in StreamSync should be consumed and
  * written. For eg: KafkaSourceProfile contains number of events to consume in this sync round.
  * S3SourceProfile contains the list of files to consume in this sync round.
  * HudiIncrementalSourceProfile contains the beginInstant and endInstant commit times to consume in
  * this sync round etc.
  *
