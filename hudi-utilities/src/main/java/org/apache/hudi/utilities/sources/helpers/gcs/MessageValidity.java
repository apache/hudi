...
public class MessageValidity {
    ...
    public static final MessageValidity DEFAULT_VALID_MESSAGE =
            new MessageValidity(ProcessingDecision.DO_PROCESS, "Valid message");

    MessageValidity(ProcessingDecision processingDecision, String description) {
        this.processingDecision = processingDecision;
        this.description =
                StringUtils.isNullOrEmpty(description) ? Option.empty() : Option.of(description);
    }
