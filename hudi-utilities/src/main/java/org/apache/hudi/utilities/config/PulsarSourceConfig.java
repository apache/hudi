...
public class PulsarSourceConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<Long> PULSAR_SOURCE_MAX_RECORDS_PER_BATCH_THRESHOLD =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.pulsar.maxRecords")
    ...
    public static final ConfigProperty<String> PULSAR_SOURCE_TOPIC_NAME =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.pulsar.topic")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> PULSAR_SOURCE_SERVICE_ENDPOINT_URL =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.pulsar.endpoint.service.url")
    ...
    public static final ConfigProperty<String> PULSAR_SOURCE_ADMIN_ENDPOINT_URL =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.pulsar.endpoint.admin.url")
                    .defaultValue("http://localhost:8080")
                    .withAlternatives(DELTA_STREAMER_CONFIG_PREFIX + "source.pulsar.endpoint.admin.url")
                    .withDocumentation("URL of the target Pulsar endpoint (of the form 'pulsar://host:port'");

    public static final ConfigProperty<OffsetAutoResetStrategy>
            PULSAR_SOURCE_OFFSET_AUTO_RESET_STRATEGY =
                    ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.pulsar.offset.autoResetStrategy")
                            .defaultValue(OffsetAutoResetStrategy.LATEST)
                            .withAlternatives(
                                    DELTA_STREAMER_CONFIG_PREFIX + "source.pulsar.offset.autoResetStrategy")
                            .markAdvanced()
                            .withDocumentation(
                                    "Policy determining how offsets shall be automatically reset in case there's "
