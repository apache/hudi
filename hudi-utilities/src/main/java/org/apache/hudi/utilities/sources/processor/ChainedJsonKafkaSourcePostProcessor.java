...
/**
  * A {@link JsonKafkaSourcePostProcessor} to chain other {@link JsonKafkaSourcePostProcessor}s and
  * apply sequentially.
  */
public class ChainedJsonKafkaSourcePostProcessor extends JsonKafkaSourcePostProcessor {
    ...
    public ChainedJsonKafkaSourcePostProcessor(
            List<JsonKafkaSourcePostProcessor> processors, TypedProperties props) {
        super(props);
