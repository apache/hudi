...
/**
  * Post writer termination strategy for deltastreamer in continuous mode. This strategy is based on
  * no new data for consecutive number of times.
  */
public class NoNewDataTerminationStrategy implements PostWriteTerminationStrategy {
    ...
    public NoNewDataTerminationStrategy(TypedProperties properties) {
        numTimesNoNewDataToShutdown =
                properties.getInteger(
                        MAX_ROUNDS_WITHOUT_NEW_DATA_TO_SHUTDOWN,
                        DEFAULT_MAX_ROUNDS_WITHOUT_NEW_DATA_TO_SHUTDOWN);
    }
