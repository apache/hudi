...
/**
  * A {@link Transformer} to chain other {@link Transformer}s and apply sequentially. Adds
  * errorTableCorruptRecordColumn at the beginning of transformations and validates if that column is
  * not dropped in any of the transformations.
  */
public class ErrorTableAwareChainedTransformer extends ChainedTransformer {
    public ErrorTableAwareChainedTransformer(
    ...
    public Dataset<Row> apply(
        ...
        for (TransformerInfo transformerInfo : transformers) {
            ...
            // validate in every stage to ensure ErrorRecordColumn not dropped by one of the
