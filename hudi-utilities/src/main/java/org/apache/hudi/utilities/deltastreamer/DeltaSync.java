...
/** DeltaSync is renamed to {@link StreamSync}. Please use {@link StreamSync} instead. */
@Deprecated
public class DeltaSync extends StreamSync {
    public DeltaSync(
            ...
            throws IOException {
        super(
                cfg, sparkSession, schemaProvider, props, jssc, fs, conf, onInitializingHoodieWriteClient);
    }
