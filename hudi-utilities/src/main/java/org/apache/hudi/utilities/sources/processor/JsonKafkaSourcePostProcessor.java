...
/**
  * Base class for Json kafka source post processor. User can define their own processor that extends
  * this class to do some post process on the incoming json string records before the records are
  * converted to DataSet<T>.
  */
