 ...
 */
public class StreamerMultiWriterCkptUpdateFunc implements BiConsumer<HoodieTableMetaClient, HoodieCommitMetadata> {
  ...
  //the deltastreamer
  private final StreamSync ds;
  private final String newCheckpoint;
  private final String latestCheckpointWritten;

  public StreamerMultiWriterCkptUpdateFunc(StreamSync ds, String newCheckpoint, String latestCheckpointWritten) {
    this.ds = ds;
