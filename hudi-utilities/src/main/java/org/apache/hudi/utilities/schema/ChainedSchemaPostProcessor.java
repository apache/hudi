...
/**
 * A {@link SchemaPostProcessor} to chain other {@link SchemaPostProcessor}s and process sequentially.
 */
public class ChainedSchemaPostProcessor extends SchemaPostProcessor {

  private List<SchemaPostProcessor> processors;

  protected ChainedSchemaPostProcessor(TypedProperties props, JavaSparkContext jssc) {
    super(props, jssc);
  }
