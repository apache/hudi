...
public class SchemaProviderWithPostProcessor extends SchemaProvider {
    ...
    public SchemaProviderWithPostProcessor(
            SchemaProvider schemaProvider, Option<SchemaPostProcessor> schemaPostProcessor) {
        super(null, null);
    ...
    public Schema getSourceSchema() {
        ...
        return schemaPostProcessor
                .map(processor -> processor.processSchema(sourceSchema))
                .orElse(sourceSchema);
    }
    ...
    public Schema getTargetSchema() {
        ...
        return schemaPostProcessor
                .map(processor -> processor.processSchema(targetSchema))
                .orElse(targetSchema);
    }
