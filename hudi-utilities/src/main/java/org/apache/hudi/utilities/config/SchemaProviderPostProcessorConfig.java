...
@Immutable
@ConfigClassProperty(
        name = "Schema Post Processor Config Configs",
...
public class SchemaProviderPostProcessorConfig extends HoodieConfig {
    ...
    private static final String OLD_PREFIX =
            OLD_SCHEMAPROVIDER_CONFIG_PREFIX + "schema_post_processor.";

    public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "schema_post_processor")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> DELETE_COLUMN_POST_PROCESSOR_COLUMN =
            ConfigProperty.key(PREFIX + "delete.columns")
                    .noDefaultValue()
                    .withAlternatives(OLD_PREFIX + "delete.columns")
                    .markAdvanced()
                    .withDocumentation("Columns to delete in the schema post processor.");

    public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_NAME_PROP =
            ConfigProperty.key(PREFIX + "add.column.name")
                    .noDefaultValue()
                    .withAlternatives(OLD_PREFIX + "add.column.name")
                    .markAdvanced()
                    .withDocumentation("New column's name");

    public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_TYPE_PROP =
            ConfigProperty.key(PREFIX + "add.column.type")
                    .noDefaultValue()
                    .withAlternatives(OLD_PREFIX + "add.column.type")
                    .markAdvanced()
                    .withDocumentation("New column's type");

    public static final ConfigProperty<Boolean> SCHEMA_POST_PROCESSOR_ADD_COLUMN_NULLABLE_PROP =
            ConfigProperty.key(PREFIX + "add.column.nullable")
                    .defaultValue(true)
    ...
    public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_DEFAULT_PROP =
            ConfigProperty.key(PREFIX + "add.column.default")
                    .noDefaultValue()
                    .withAlternatives(OLD_PREFIX + "add.column.default")
                    .markAdvanced()
                    .withDocumentation("New column's default value");

    public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_DOC_PROP =
            ConfigProperty.key(PREFIX + "add.column.doc")
                    .noDefaultValue()
