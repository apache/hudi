...
@ConfigClassProperty(
        name = "Write commit Kafka callback configs",
...
public class HoodieWriteCommitKafkaCallbackConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> BOOTSTRAP_SERVERS =
            ConfigProperty.key(CALLBACK_PREFIX + "kafka.bootstrap.servers")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.7.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> TOPIC =
            ConfigProperty.key(CALLBACK_PREFIX + "kafka.topic")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.7.0")
                    .withDocumentation("Kafka topic name to publish timeline activity into.");

    public static final ConfigProperty<String> PARTITION =
            ConfigProperty.key(CALLBACK_PREFIX + "kafka.partition")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.7.0")
                    .withDocumentation(
                            "It may be desirable to serialize all changes into a single Kafka partition "
    ...
    public static final ConfigProperty<String> ACKS =
            ConfigProperty.key(CALLBACK_PREFIX + "kafka.acks")
                    .defaultValue("all")
                    .markAdvanced()
                    .sinceVersion("0.7.0")
                    .withDocumentation("kafka acks level, all by default to ensure strong durability.");

    public static final ConfigProperty<Integer> RETRIES =
            ConfigProperty.key(CALLBACK_PREFIX + "kafka.retries")
                    .defaultValue(3)
                    .markAdvanced()
                    .sinceVersion("0.7.0")
    ...
    @Deprecated public static final String CALLBACK_KAFKA_BOOTSTRAP_SERVERS = BOOTSTRAP_SERVERS.key();
    /** @deprecated Use {@link #TOPIC} and its methods. */
    @Deprecated public static final String CALLBACK_KAFKA_TOPIC = TOPIC.key();
    /** @deprecated Use {@link #PARTITION} and its methods. */
    @Deprecated public static final String CALLBACK_KAFKA_PARTITION = PARTITION.key();
    /** @deprecated Use {@link #ACKS} and its methods. */
    @Deprecated public static final String CALLBACK_KAFKA_ACKS = ACKS.key();
    /** @deprecated Use {@link #ACKS} and its methods. */
    @Deprecated public static final String DEFAULT_CALLBACK_KAFKA_ACKS = ACKS.defaultValue();
    /** @deprecated Use {@link #RETRIES} and its methods. */
    @Deprecated public static final String CALLBACK_KAFKA_RETRIES = RETRIES.key();
    /** @deprecated Use {@link #RETRIES} and its methods. */
    @Deprecated public static final int DEFAULT_CALLBACK_KAFKA_RETRIES = RETRIES.defaultValue();
}
