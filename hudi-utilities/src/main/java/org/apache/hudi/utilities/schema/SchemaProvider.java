...
/**
  * Class to provide schema for reading data and also writing into a Hoodie table, used by
  * deltastreamer (runs over Spark).
  */
...
public abstract class SchemaProvider implements Serializable {
    ...
    // every schema provider has the ability to refresh itself, which will mean something different
    // per provider.
    public void refresh() {}
}
