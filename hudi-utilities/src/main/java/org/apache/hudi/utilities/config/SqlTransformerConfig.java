...
@Immutable
@ConfigClassProperty(
        name = "Hudi Streamer SQL Transformer Configs",
...
public class SqlTransformerConfig extends HoodieConfig {
    public static final ConfigProperty<String> TRANSFORMER_SQL_FILE =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "transformer.sql.file")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> TRANSFORMER_SQL =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "transformer.sql")
                    .noDefaultValue()
