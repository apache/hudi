...
@Immutable
@ConfigClassProperty(
        name = "Hudi Streamer Schema Provider Configs",
...
public class HoodieSchemaProviderConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> SRC_SCHEMA_REGISTRY_URL =
    ...
    public static final ConfigProperty<String> TARGET_SCHEMA_REGISTRY_URL =
    ...
    public static final ConfigProperty<String> SCHEMA_CONVERTER =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "registry.schemaconverter")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<Boolean> SPARK_AVRO_POST_PROCESSOR_ENABLE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "spark_avro_post_processor.enable")
                    .defaultValue(true)
    ...
    public static final ConfigProperty<String> SCHEMA_REGISTRY_BASE_URL =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "registry.baseUrl")
                    .noDefaultValue()
                    .withAlternatives(OLD_SCHEMAPROVIDER_CONFIG_PREFIX + "registry.baseUrl")
                    .markAdvanced()
                    .withDocumentation("The base URL of the schema registry.");

    public static final ConfigProperty<String> SCHEMA_REGISTRY_URL_SUFFIX =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "registry.urlSuffix")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SCHEMA_REGISTRY_SOURCE_URL_SUFFIX =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "registry.sourceUrlSuffix")
                    .noDefaultValue()
                    .withAlternatives(OLD_SCHEMAPROVIDER_CONFIG_PREFIX + "registry.sourceUrlSuffix")
                    .markAdvanced()
                    .withDocumentation("The source URL suffix.");

    public static final ConfigProperty<String> SCHEMA_REGISTRY_TARGET_URL_SUFFIX =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "registry.targetUrlSuffix")
                    .noDefaultValue()
