...
@Immutable
@ConfigClassProperty(
        name = "JDBC-based Schema Provider Configs",
...
public class JdbcbasedSchemaProviderConfig extends HoodieConfig {
    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_CONNECTION_URL =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.connection.url")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_DRIVER_TYPE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.driver.type")
                    .noDefaultValue()
                    .withAlternatives(OLD_SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.driver.type")
                    .markAdvanced()
                    .withDocumentation(
                            "The class name of the JDBC driver to use to connect to this URL. e.g. org.h2.Driver");

    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_USERNAME =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.username")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_PASSWORD =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.password")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_DBTABLE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.dbtable")
                    .noDefaultValue()
                    .withAlternatives(OLD_SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.dbtable")
                    .markAdvanced()
                    .withDocumentation(
                            "The table with the schema to reference e.g. test_database.test1_table or test1_table");

    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_TIMEOUT =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.timeout")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SOURCE_SCHEMA_JDBC_NULLABLE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.jdbc.nullable")
                    .noDefaultValue()
