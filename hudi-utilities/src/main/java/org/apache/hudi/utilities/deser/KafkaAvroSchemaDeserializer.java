...
/**
  * Extending {@link KafkaAvroSchemaDeserializer} as we need to be able to inject reader schema
...
public class KafkaAvroSchemaDeserializer extends KafkaAvroDeserializer {
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
        ...
        try {
            ...
            sourceSchema =
                    new Schema.Parser().parse(getStringWithAltKeys(props, KAFKA_VALUE_DESERIALIZER_SCHEMA));
        } catch (Throwable e) {
    ...
    /**
      * We need to inject sourceSchema instead of reader schema during deserialization or later stages
      * of the pipeline.
      *
      * @param topic
      * @param isKey
