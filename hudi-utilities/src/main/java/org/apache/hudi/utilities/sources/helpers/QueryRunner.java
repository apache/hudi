...
public class QueryRunner {
  ...
  public Pair<QueryInfo, Dataset<Row>> runIncrementalQuery(QueryInfo queryInfo) {
    ...
    return Pair.of(queryInfo, sparkSession.read().format("org.apache.hudi")
        ...
        .option(DataSourceReadOptions.BEGIN_COMPLETION_TIME().key(), queryInfo.getStartInstant())
        .option(DataSourceReadOptions.END_COMPLETION_TIME().key(), queryInfo.getEndInstant())
