...
public abstract class Source<T> implements SourceCommitCallback, Serializable, Closeable {
  ...
  /**
   * If you override close, ensure super.close() is being called to release resources.
   */
  @Override
