...
@Immutable
@ConfigClassProperty(
        name = "S3 Event-based Hudi Incremental Source Configs",
        groupName = ConfigGroups.Names.HUDI_STREAMER,
        subGroupName = ConfigGroups.SubGroupNames.DELTA_STREAMER_SOURCE,
        description =
                "Configurations controlling the behavior of incremental pulling from S3 events "
...
public class S3EventsHoodieIncrSourceConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<Boolean> S3_INCR_ENABLE_EXISTS_CHECK =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.check.file.exists")
                    .defaultValue(false)
    ...
    public static final ConfigProperty<String> S3_KEY_PREFIX =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.key.prefix")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> S3_FS_PREFIX =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.fs.prefix")
                    .defaultValue("s3")
    ...
    public static final ConfigProperty<String> S3_IGNORE_KEY_PREFIX =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.ignore.key.prefix")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> S3_IGNORE_KEY_SUBSTRING =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.ignore.key.substring")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> SPARK_DATASOURCE_OPTIONS =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.s3incr.spark.datasource.options")
                    .noDefaultValue()
                    .withAlternatives(DELTA_STREAMER_CONFIG_PREFIX + "source.s3incr.spark.datasource.options")
                    .markAdvanced()
                    .withDocumentation(
                            "Json string, passed to the reader while loading dataset. Example Hudi Streamer conf \n"
