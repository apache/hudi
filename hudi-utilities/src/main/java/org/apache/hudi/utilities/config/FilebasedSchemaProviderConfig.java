...
@Immutable
@ConfigClassProperty(
        name = "File-based Schema Provider Configs",
...
public class FilebasedSchemaProviderConfig extends HoodieConfig {
    public static final ConfigProperty<String> SOURCE_SCHEMA_FILE =
    ...
    public static final ConfigProperty<String> TARGET_SCHEMA_FILE =
