...
public class S3SourceConfig extends HoodieConfig {
  ...
  public static final ConfigProperty<Integer> S3_QUEUE_LONG_POLL_WAIT = ConfigProperty
  ...
  public static final ConfigProperty<Integer> S3_SOURCE_QUEUE_MAX_MESSAGES_PER_BATCH = ConfigProperty
  ...
  public static final ConfigProperty<Integer> S3_SOURCE_QUEUE_MAX_MESSAGES_PER_REQUEST = ConfigProperty
      .key(S3_SOURCE_PREFIX + ".queue.max.messages.per.request")
      .defaultValue(10)
      .withDocumentation("Max messages for each request");

  public static final ConfigProperty<Integer> S3_SOURCE_QUEUE_VISIBILITY_TIMEOUT = ConfigProperty
