...
@ConfigClassProperty(
        name = "Write commit pulsar callback configs",
...
public class HoodieWriteCommitPulsarCallbackConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> BROKER_SERVICE_URL =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.broker.service.url")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> TOPIC =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.topic")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("pulsar topic name to publish timeline activity into.");

    public static final ConfigProperty<String> PRODUCER_ROUTE_MODE =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.producer.route-mode")
                    .defaultValue("RoundRobinPartition")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("Message routing logic for producers on partitioned topics.");

    public static final ConfigProperty<Integer> PRODUCER_PENDING_QUEUE_SIZE =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.producer.pending-queue-size")
                    .defaultValue(1000)
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("The maximum size of a queue holding pending messages.");

    public static final ConfigProperty<Integer> PRODUCER_PENDING_SIZE =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.producer.pending-total-size")
                    .defaultValue(50000)
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("The maximum number of pending messages across partitions.");

    public static final ConfigProperty<Boolean> PRODUCER_BLOCK_QUEUE_FULL =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.producer.block-if-queue-full")
                    .defaultValue(true)
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
                            "When the queue is full, the method is blocked "
                                    + "instead of an exception is thrown.");

    public static final ConfigProperty<String> PRODUCER_SEND_TIMEOUT =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.producer.send-timeout")
                    .defaultValue("30s")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("The timeout in each sending to pulsar.");

    public static final ConfigProperty<String> OPERATION_TIMEOUT =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.operation-timeout")
                    .defaultValue("30s")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("Duration of waiting for completing an operation.");

    public static final ConfigProperty<String> CONNECTION_TIMEOUT =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.connection-timeout")
                    .defaultValue("10s")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> REQUEST_TIMEOUT =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.request-timeout")
                    .defaultValue("60s")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation("Duration of waiting for completing a request.");

    public static final ConfigProperty<String> KEEPALIVE_INTERVAL =
            ConfigProperty.key(CALLBACK_PREFIX + "pulsar.keepalive-interval")
                    .defaultValue("30s")
                    .markAdvanced()
                    .sinceVersion("0.11.0")
                    .withDocumentation(
