...
public class KafkaSourceConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> KAFKA_CHECKPOINT_TYPE =
            ConfigProperty.key(PREFIX + "checkpoint.type")
                    .defaultValue("string")
    ...
    public static final ConfigProperty<String> KAFKA_AVRO_VALUE_DESERIALIZER_CLASS =
            ConfigProperty.key(PREFIX + "value.deserializer.class")
    ...
    public static final ConfigProperty<String> KAFKA_VALUE_DESERIALIZER_SCHEMA =
            ConfigProperty.key(PREFIX + "value.deserializer.schema")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<Long> KAFKA_FETCH_PARTITION_TIME_OUT =
            ConfigProperty.key(PREFIX + "fetch_partition.time.out")
    ...
    public static final ConfigProperty<Boolean> ENABLE_KAFKA_COMMIT_OFFSET =
            ConfigProperty.key(PREFIX + "enable.commit.offset")
                    .defaultValue(false)
    ...
    public static final ConfigProperty<Boolean> ENABLE_FAIL_ON_DATA_LOSS =
            ConfigProperty.key(PREFIX + "enable.failOnDataLoss")
                    .defaultValue(false)
                    .withAlternatives(OLD_PREFIX + "enable.failOnDataLoss")
                    .markAdvanced()
                    .withDocumentation(
                            "Fail when checkpoint goes out of bounds instead of seeking to earliest offsets.");

    public static final ConfigProperty<Long> MAX_EVENTS_FROM_KAFKA_SOURCE =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "kafka.source.maxEvents")
    ...
    public static final ConfigProperty<Long> KAFKA_SOURCE_MIN_PARTITIONS =
            ConfigProperty.key(PREFIX + "minPartitions")
                    .defaultValue(0L)
    ...
    public static final ConfigProperty<String> KAFKA_TOPIC_NAME =
            ConfigProperty.key(PREFIX + "topic")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<KafkaResetOffsetStrategies> KAFKA_AUTO_OFFSET_RESET =
            ConfigProperty.key("auto.offset.reset")
                    .defaultValue(KafkaResetOffsetStrategies.LATEST)
                    .markAdvanced()
                    .withDocumentation("Kafka consumer strategy for reading data.");

    public static final ConfigProperty<String> KAFKA_PROTO_VALUE_DESERIALIZER_CLASS =
            ConfigProperty.key(PREFIX + "proto.value.deserializer.class")
