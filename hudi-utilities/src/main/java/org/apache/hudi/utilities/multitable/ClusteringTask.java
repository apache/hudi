...
class ClusteringTask extends TableServiceTask {
    ...
    void run() {
        ...
        // HoodieWriteClient within HoodieClusteringJob is closed internally. not closing
        // HoodieCleaner here is not leaking any resources.
    ...
    public static final class Builder {
        ...
        /**
          * Properties for running clustering task which are already consolidated w/ CLI provided
          * config-overrides.
          */
