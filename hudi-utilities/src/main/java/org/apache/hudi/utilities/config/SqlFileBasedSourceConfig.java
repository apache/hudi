...
@Immutable
@ConfigClassProperty(
        name = "File-based SQL Source Configs",
...
public class SqlFileBasedSourceConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> SOURCE_SQL_FILE =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.sql.file")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<Boolean> EMIT_EPOCH_CHECKPOINT =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.sql.checkpoint.emit")
                    .defaultValue(false)
