...
public abstract class SnapshotLoadQuerySplitter {
    ...
    public static class Config {
        ...
        public static final String SNAPSHOT_LOAD_QUERY_SPLITTER_CLASS_NAME =
                "hoodie.deltastreamer.snapshotload.query.splitter.class.name";
    }
    ...
    /**
      ...
      * @param sourceProfileSupplier An Option of a SourceProfileSupplier to use in load splitting
      *     implementation
      * @return The next checkpoint as an Option.
      */
    @PublicAPIMethod(maturity = ApiMaturityLevel.EVOLVING)
    public abstract Option<String> getNextCheckpoint(
            Dataset<Row> df,
            String beginCheckpointStr,
    ...
    /**
      ...
      */
    public QueryInfo getNextCheckpoint(
            Dataset<Row> df, QueryInfo queryInfo, Option<SourceProfileSupplier> sourceProfileSupplier) {
    ...
    public static Option<SnapshotLoadQuerySplitter> getInstance(TypedProperties props) {
        return props
                .getNonEmptyStringOpt(SNAPSHOT_LOAD_QUERY_SPLITTER_CLASS_NAME, null)
                .map(
                        className ->
                                (SnapshotLoadQuerySplitter)
                                        ReflectionUtils.loadClass(
                                                className, new Class<?>[] {TypedProperties.class}, props));
    }
}
