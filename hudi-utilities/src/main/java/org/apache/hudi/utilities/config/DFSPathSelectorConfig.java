...
@Immutable
@ConfigClassProperty(
        name = "DFS Path Selector Configs",
...
public class DFSPathSelectorConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> SOURCE_INPUT_SELECTOR =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.input.selector")
                    .noDefaultValue()
                    .withAlternatives(DELTA_STREAMER_CONFIG_PREFIX + "source.input.selector")
                    .markAdvanced()
                    .withDocumentation("Source input selector");

    public static final ConfigProperty<String> ROOT_INPUT_PATH =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.dfs.root")
                    .noDefaultValue()
