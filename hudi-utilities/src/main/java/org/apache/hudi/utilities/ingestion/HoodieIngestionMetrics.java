...
public abstract class HoodieIngestionMetrics implements Serializable {
    ...
    public abstract void updateStreamerSourceDelayCount(
            String sourceMetricName, long sourceDelayCount);

    public abstract void updateStreamerSourceNewMessageCount(
    ...
    public abstract void updateStreamerSourceBytesToBeIngestedInSyncRound(
            long sourceBytesToBeIngested);
