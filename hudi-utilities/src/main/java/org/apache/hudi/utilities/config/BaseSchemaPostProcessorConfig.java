...
public class BaseSchemaPostProcessorConfig extends HoodieConfig {
  ...
  public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_NAME = ConfigProperty
      .key("hoodie.deltastreamer.schemaprovider.schema_post_processor.add.column.name")
      .noDefaultValue()
      .withDocumentation("New column's name");

  public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_TYPE = ConfigProperty
      .key("hoodie.deltastreamer.schemaprovider.schema_post_processor.add.column.type")
      .noDefaultValue()
      .withDocumentation("New column's type");

  public static final ConfigProperty<Boolean> SCHEMA_POST_PROCESSOR_ADD_COLUMN_NULLABLE = ConfigProperty
      .key("hoodie.deltastreamer.schemaprovider.schema_post_processor.add.column.nullable")
      .defaultValue(true)
      .withDocumentation("New column's nullable");

  public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_DEFAULT = ConfigProperty
  ...
  public static final ConfigProperty<String> SCHEMA_POST_PROCESSOR_ADD_COLUMN_DOC = ConfigProperty
