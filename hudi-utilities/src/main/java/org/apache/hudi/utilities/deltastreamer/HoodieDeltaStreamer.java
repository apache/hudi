...
/**
  * HoodieDeltaStreamer is renamed to {@link HoodieStreamer}. Please use {@link HoodieStreamer}
  * instead.
  */
@Deprecated
public class HoodieDeltaStreamer extends HoodieStreamer {
    ...
    public HoodieDeltaStreamer(Config cfg, JavaSparkContext jssc, Option<TypedProperties> props)
            throws IOException {
