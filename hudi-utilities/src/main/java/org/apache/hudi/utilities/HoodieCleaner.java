...
public class HoodieCleaner {
    ...
    public HoodieCleaner(Config cfg, JavaSparkContext jssc) {
        this(
                cfg,
                jssc,
                UtilHelpers.buildProperties(jssc.hadoopConfiguration(), cfg.propsFilePath, cfg.configs));
    }
    ...
    public void run() {
        ...
        try (SparkRDDWriteClient client =
                new SparkRDDWriteClient<>(new HoodieSparkEngineContext(jssc), hoodieCfg)) {
            client.clean();
        }
    }
    ...
    public static class Config implements Serializable {
        ...
        @Parameter(
                ...
                description = "base path for the hoodie table to be cleaner.",
                required = true)
    ...
    public static void main(String[] args) {
        ...
        JavaSparkContext jssc =
                UtilHelpers.buildSparkContext("hoodie-cleaner-" + dirName, cfg.sparkMaster);
