...
/**
  ...
  *
  * <p>The SQL file is configured with this hoodie property: hoodie.streamer.transformer.sql.file
  *
  * <p>Example Spark SQL Query:
  *
  * <p>CACHE TABLE tmp_personal_trips AS SELECT * FROM <SRC> WHERE trip_type='personal_trips';
  *
  * <p>SELECT * FROM tmp_personal_trips;
  */
