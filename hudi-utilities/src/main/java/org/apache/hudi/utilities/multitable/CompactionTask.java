...
class CompactionTask extends TableServiceTask {
    ...
    void run() {
        ...
        // HoodieWriteClient within HoodieCompactor is closed internally. not closing HoodieCleaner
        // here is not leaking any resources.
    ...
    public static final class Builder {
        /**
          * Properties for running compaction task which are already consolidated w/ CLI provided
          * config-overrides.
          */
