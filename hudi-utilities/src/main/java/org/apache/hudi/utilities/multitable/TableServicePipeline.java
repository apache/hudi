...
/**
  * TableServicePipeline is a container holding all table services task to execute for a specific
  * hoodie table.
  */
public class TableServicePipeline {
    ...
    /**
      * Add a table service task to the end of table service pipe. The task will be executed in FIFO
      * manner.
      *
