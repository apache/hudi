...
@Immutable
@ConfigClassProperty(
        name = "Hive Incremental Pulling Source Configs",
        groupName = ConfigGroups.Names.HUDI_STREAMER,
        subGroupName = ConfigGroups.SubGroupNames.DELTA_STREAMER_SOURCE,
        description =
                "Configurations controlling the behavior of incremental pulling from a Hive "
...
public class HiveIncrPullSourceConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> ROOT_INPUT_PATH =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.incrpull.root")
                    .noDefaultValue()
