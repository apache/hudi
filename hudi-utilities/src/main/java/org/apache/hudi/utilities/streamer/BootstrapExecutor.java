            ...
            if (props.getBoolean(HIVE_SYNC_BUCKET_SYNC.key(), HIVE_SYNC_BUCKET_SYNC.defaultValue())) {
                metaProps.put(
                        ...
                        HiveSyncConfig.getBucketSpec(
                                props.getString(HoodieIndexConfig.BUCKET_INDEX_HASH_FIELD.key()),
    ...
    private void initializeTable() throws IOException {
        ...
        if (cfg.targetBasePath.equals(bootstrapBasePath)) {
            throw new IllegalArgumentException(
                    "Bootstrap source base path and Hudi table base path must be different");
        }
        ...
        HoodieTableMetaClient.PropertyBuilder builder =
                HoodieTableMetaClient.withPropertyBuilder()
                        ...
                        .setPreCombineField(
                                props.getString(PRECOMBINE_FIELD_NAME.key(), PRECOMBINE_FIELD_NAME.defaultValue()))
        ...
        builder.initTable(
                HadoopFSUtils.getStorageConfWithCopy(jssc.hadoopConfiguration()), cfg.targetBasePath);
    }
