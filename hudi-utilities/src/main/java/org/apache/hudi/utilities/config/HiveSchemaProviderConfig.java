...
@Immutable
@ConfigClassProperty(
        name = "Hive Schema Provider Configs",
...
public class HiveSchemaProviderConfig extends HoodieConfig {
    public static final ConfigProperty<String> SOURCE_SCHEMA_DATABASE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.hive.database")
    ...
    public static final ConfigProperty<String> SOURCE_SCHEMA_TABLE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "source.schema.hive.table")
                    .noDefaultValue()
    ...
    public static final ConfigProperty<String> TARGET_SCHEMA_DATABASE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "target.schema.hive.database")
                    .defaultValue("default")
    ...
    public static final ConfigProperty<String> TARGET_SCHEMA_TABLE =
            ConfigProperty.key(SCHEMAPROVIDER_CONFIG_PREFIX + "target.schema.hive.table")
                    .noDefaultValue()
