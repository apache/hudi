...
class TestKafkaOffsetPostProcessor {
    private static final List<String> EXPECTED_FIELD_NAMES =
            Arrays.asList(
                    "existing_field",
    ...
    private static Stream<Arguments> cases() {
        String offsetField =
                "{\"name\": \"_hoodie_kafka_source_offset\", \"type\": \"long\", \"doc\": \"offset column\", \"default\": 0}";
        String partitionField =
                "{\"name\": \"_hoodie_kafka_source_partition\", \"type\": \"int\", \"doc\": \"partition column\", \"default\": 0}";
        String timestampField =
                "{\"name\": \"_hoodie_kafka_source_timestamp\", \"type\": \"long\", \"doc\": \"timestamp column\", \"default\": 0}";
        String keyField =
                "{\"name\": \"_hoodie_kafka_source_key\", \"type\": [\"null\", \"string\"], \"doc\": \"kafka key column\", \"default\": null}";
        return Stream.of(
                Arguments.of(
                        new Schema.Parser()
                                .parse(
                                        "{\"type\": \"record\", \"name\": \"example\", \"fields\": [{\"name\": \"existing_field\", \"type\": \"string\"}]}")),
                Arguments.of(
                        new Schema.Parser()
                                .parse(
                                        "{\"type\": \"record\", \"name\": \"example\", \"fields\": [{\"name\": \"existing_field\", \"type\": \"string\"}, "
