...
public class SourceTestConfig {
    ...
    public static final ConfigProperty<Integer> NUM_SOURCE_PARTITIONS_PROP =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.test.num_partitions")
                    .defaultValue(10)
    ...
    public static final ConfigProperty<Integer> MAX_UNIQUE_RECORDS_PROP =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.test.max_unique_records")
    ...
    public static final ConfigProperty<Boolean> USE_ROCKSDB_FOR_TEST_DATAGEN_KEYS =
            ConfigProperty.key(
                            STREAMER_CONFIG_PREFIX + "source.test.datagen.use_rocksdb_for_storing_existing_keys")
                    .defaultValue(false)
                    .withAlternatives(
    ...
    public static final ConfigProperty<String> ROCKSDB_BASE_DIR_FOR_TEST_DATAGEN_KEYS =
            ConfigProperty.key(STREAMER_CONFIG_PREFIX + "source.test.datagen.rocksdb_base_dir")
                    .noDefaultValue()
