...
public class TestLazyCastingIterator {
    ...
    private static final String NESTED_COL_SCHEMA =
            "{\"type\":\"record\", \"name\":\"nested_col\",\"fields\": ["
                    + "{\"name\": \"prop1\",\"type\": [\"null\", \"string\"]},{\"name\": \"prop2\", \"type\": \"long\"}]}";

    private static final String EXAMPLE_SCHEMA =
    ...
    private static final String EXAMPLE_SCHEMA_WITHOUT_NESTED_COL =
            "{\"type\": \"record\",\"name\": \"testrec\",\"fields\": [ "
                    + "{\"name\": \"timestamp\",\"type\": \"long\"},{\"name\": \"_row_key\", \"type\": \"string\"},"
                    + "{\"name\": \"ts_ms\", \"type\": \"string\"},"
                    + "{\"name\": \"int_col\", \"type\": [\"null\", \"int\"], \"default\": null },"
    ...
    private static final String EXAMPLE_SCHEMA_INT_COL_AS_LONG =
            "{\"type\": \"record\",\"name\": \"testrec\",\"fields\": [ "
                    + "{\"name\": \"timestamp\",\"type\": \"long\"},{\"name\": \"_row_key\", \"type\": \"string\"},"
                    + "{\"name\": \"ts_ms\", \"type\": \"string\"},"
    ...
    private static final String EXAMPLE_SCHEMA_LONG_COL_AS_INT =
            "{\"type\": \"record\",\"name\": \"testrec\",\"fields\": [ "
                    + "{\"name\": \"timestamp\",\"type\": \"long\"},{\"name\": \"_row_key\", \"type\": \"string\"},"
                    + "{\"name\": \"ts_ms\", \"type\": \"string\"},"
                    + "{\"name\": \"int_col\", \"type\": [\"null\", \"int\"], \"default\": null },"
    ...
    private static final GenericRecord GEN_RECORD_EXAMPLE_WITH_NULL_NESTED =
            getRecordWithExampleSchemaNullNestedCol();
    private static final GenericRecord GEN_RECORD_EXAMPLE_WITHOUT_NESTED =
            getRecordWithExampleSchemaWithoutNestedCol();
    private static final GenericRecord GEN_RECORD_EXAMPLE_INT_COL_AS_LONG =
            getRecordWithExampleSchemaIntColAsLong();
    private static final GenericRecord GEN_RECORD_EXAMPLE_LONG_COL_AS_INT =
            getRecordWithExampleSchemaLongColAsInt();
    ...
    public void testDataWithAdditionalCol() {
        List<GenericRecord> genericRecords = Collections.singletonList(GEN_RECORD_EXAMPLE_WITH_NESTED);
        LazyCastingIterator itr =
                new LazyCastingIterator(genericRecords.iterator(), EXAMPLE_SCHEMA_WITHOUT_NESTED_COL);
        GenericRecord outGenRec = itr.next();
    ...
    public void testDataWithMissingCol() {
        List<GenericRecord> genericRecords =
                Collections.singletonList(GEN_RECORD_EXAMPLE_WITHOUT_NESTED);
        LazyCastingIterator itr = new LazyCastingIterator(genericRecords.iterator(), EXAMPLE_SCHEMA);
        GenericRecord outGenRec = itr.next();
    ...
    public void testDataForIntToLongPromotion() {
        List<GenericRecord> genericRecords =
                Collections.singletonList(GEN_RECORD_EXAMPLE_LONG_COL_AS_INT);
        LazyCastingIterator itr = new LazyCastingIterator(genericRecords.iterator(), EXAMPLE_SCHEMA);
        GenericRecord outGenRec = itr.next();
    ...
    public void testDataForLongToIntPromotion() {
        List<GenericRecord> genericRecords =
                Collections.singletonList(GEN_RECORD_EXAMPLE_INT_COL_AS_LONG);
        LazyCastingIterator itr = new LazyCastingIterator(genericRecords.iterator(), EXAMPLE_SCHEMA);
        Exception e =
                assertThrows(
    ...
    public static GenericRecord getRecordWithExampleSchemaIntColAsLong(
        ...
        GenericRecord record =
                new GenericData.Record(new Schema.Parser().parse(EXAMPLE_SCHEMA_INT_COL_AS_LONG));
        record.put("timestamp", 4357686L);
        record.put("_row_key", "key1");
        record.put("ts_ms", "2020-03-21");
    ...
    public static GenericRecord getRecordWithExampleSchemaLongColAsInt(
            GenericRecord nestedColRecord) {
        GenericRecord record =
                new GenericData.Record(new Schema.Parser().parse(EXAMPLE_SCHEMA_LONG_COL_AS_INT));
        record.put("timestamp", 4357686L);
        record.put("_row_key", "key1");
        record.put("ts_ms", "2020-03-21");
        record.put("int_col", 10);
    ...
    public static GenericRecord getRecordWithExampleSchemaWithoutNestedCol() {
        GenericRecord record =
                new GenericData.Record(new Schema.Parser().parse(EXAMPLE_SCHEMA_WITHOUT_NESTED_COL));
        record.put("timestamp", 4357686L);
        record.put("_row_key", "key1");
        record.put("ts_ms", "2020-03-21");
        record.put("int_col", 10);
