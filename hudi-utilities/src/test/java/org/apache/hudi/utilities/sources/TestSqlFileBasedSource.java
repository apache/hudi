...
public class TestSqlFileBasedSource extends UtilitiesTestBase {
    ...
    private void generateTestTable(String filename, String instantTime, int n) throws IOException {
        ...
        Helpers.saveParquetToDFS(
                Helpers.toGenericRecords(dataGenerator.generateInserts(instantTime, n, useFlattenedSchema)),
                path);
    ...
    public void testSqlFileBasedSourceAvroFormat() throws IOException {
        UtilitiesTestBase.Helpers.copyToDFS(
                "streamer-config/sql-file-based-source.sql",
                storage,
                UtilitiesTestBase.basePath + "/sql-file-based-source.sql");

        props.setProperty(
                sqlFileSourceConfig, UtilitiesTestBase.basePath + "/sql-file-based-source.sql");
    ...
    /**
      * Runs the test scenario of reading data from the source in row format. Source has less records
      * than source limit.
      *
      * @throws IOException
      */
    ...
    /**
      * Runs the test scenario of reading data from the source in row format. Source has more records
      * than source limit.
      *
      * @throws IOException
      */
    ...
    /**
      * Runs the test scenario of reading data from the source in row format. Source table doesn't
      * exists.
      *
      * @throws IOException
      */
    ...
    public void testSqlFileBasedSourceInvalidTable() throws IOException {
        UtilitiesTestBase.Helpers.copyToDFS(
                "streamer-config/sql-file-based-source-invalid-table.sql",
                storage,
    ...
    public void shouldSetCheckpointForSqlFileBasedSourceWithEpochCheckpoint() throws IOException {
        ...
        sqlFileSource = new SqlFileBasedSource(props, jsc, sparkSession, schemaProvider);
        Pair<Option<Dataset<Row>>, String> nextBatch =
