...
public class TestSchedulerConfGenerator {
    ...
    public void testGenerateSparkSchedulingConf() throws Exception {
        ...
        assertNull(
                configs.get(SparkConfigs.SPARK_SCHEDULER_ALLOCATION_FILE_KEY()),
                "spark.scheduler.mode not set");
        ...
        assertNull(
                configs.get(SparkConfigs.SPARK_SCHEDULER_ALLOCATION_FILE_KEY()), "continuousMode is false");
