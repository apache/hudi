...
public class TestHoodieDeltaStreamerSchemaEvolutionExtensive
    ...
    protected void testBase(String updateFile, String updateColumn, String condition, int count)
            throws Exception {
    ...
    protected void testBase(
        ...
        // assertThrows(Exception.class, () -> testBase(tableType, shouldCluster, shouldCompact,
        // reconcileSchema, rowWriterEnable, updateFile, updateColumn, condition, count, false));
    }

    protected void testBase(String updateFile, String updateColumn, Map<String, Integer> conditions)
            throws Exception {
    ...
    protected void doDeltaWriteTypePromo(String resourceString, String colName, DataType colType)
            throws Exception {
    ...
    protected void doDeltaWriteBase(
            String resourceString, Boolean isFirst, Boolean nonNullable, String colName)
            throws Exception {
    ...
    protected void doDeltaWriteBase(
            ...
            throws Exception {
        String datapath =
                String.class.getResource("/data/schema-evolution/" + resourceString).getPath();
        ...
        for (Boolean rowWriterEnable : new Boolean[] {true}) {
            for (Boolean addFilegroups : new Boolean[] {false, true}) {
                for (Boolean multiLogFiles : new Boolean[] {false, true}) {
                    ...
                    b.add(
                            Arguments.of(
                                    "MERGE_ON_READ", false, true, rowWriterEnable, addFilegroups, multiLogFiles));
                }
            }
        }
        return b.build();
    ...
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testErrorTableWithSchemaProvider(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
    ...
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testErrorTableWithTransformer(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
    ...
    public void testDropColStruct(
        ...
        this.multiLogFiles = multiLogFiles;
        testBase(
                "testDropColStruct.json", "tip_history.currency", "tip_history[0].currency is NULL", 2);
    }

    /** Add a new complex type field with default (array) */
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testAddComplexField(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
    ...
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testAddColChangeOrder(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
        ...
        // assertThrows(Exception.class, () -> testBase("testAddColChangeOrderSomeFiles.json",
        // "extra_col", "extra_col = 'yes'", 1));
    }

    /** Add and drop cols in the same write */
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testAddAndDropCols(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
    ...
    protected void testTypePromotionBase(String colName, DataType startType, DataType updateType)
            throws Exception {
        testTypePromotionBase(colName, startType, updateType, updateType);
    }

    protected void testTypeDemotionBase(String colName, DataType startType, DataType updateType)
            throws Exception {
        testTypePromotionBase(colName, startType, updateType, startType);
    }

    protected void testTypePromotionBase(
            String colName, DataType startType, DataType updateType, DataType endType) throws Exception {
        boolean isCow = tableType.equals("COPY_ON_WRITE");
        PARQUET_SOURCE_ROOT = basePath + "parquetFilesDfs" + testNum++;
        tableName = "test_parquet_table" + testNum;
        tableBasePath = basePath + tableName;
    ...
    @ParameterizedTest
    @MethodSource("testArgs")
    public void testTypePromotionDropCols(
            String tableType,
            Boolean shouldCluster,
            Boolean shouldCompact,
            Boolean rowWriterEnable,
    ...
    public void testTypePromotion(
        ...
        testTypePromotionBase(
                "fare",
                createFareStruct(DataTypes.FloatType),
                createFareStruct(DataTypes.DoubleType, dropCols),
                createFareStruct(DataTypes.DoubleType));
        testTypePromotionBase(
                "fare",
                createFareStruct(DataTypes.FloatType),
                createFareStruct(DataTypes.StringType, dropCols),
                createFareStruct(DataTypes.StringType));
        ...
        testTypePromotionBase(
                "fare",
                createFareStruct(DataTypes.DoubleType),
                createFareStruct(DataTypes.FloatType, dropCols),
                createFareStruct(DataTypes.DoubleType));
        testTypePromotionBase(
                "fare",
                createFareStruct(DataTypes.StringType),
