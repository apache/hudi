...
public class TestHoodieCompactorJob extends HoodieOfflineJobTestBase {
    ...
    public void testHoodieCompactorWithOptionalClean(boolean skipClean) throws Exception {
                ...
                HoodieWriteConfig.newBuilder()
                        ...
                        .withLayoutConfig(
                                HoodieLayoutConfig.newBuilder()
                                        ...
                                        .withLayoutPartitioner(SparkBucketIndexPartitioner.class.getName())
                                        .build())
                        .withIndexConfig(
        ...
        HoodieCompactor hoodieCompactorSchedule = init(tableBasePath, true, "SCHEDULE", skipClean);
        ...
        HoodieCompactor hoodieCompactorExecute = init(tableBasePath, false, "EXECUTE", skipClean);
    ...
    private HoodieCompactor init(
            String tableBasePath, boolean runSchedule, String scheduleAndExecute, boolean skipClean) {
        HoodieCompactor.Config compactionConfig =
                buildCompactionConfig(tableBasePath, runSchedule, scheduleAndExecute, skipClean);
        return new HoodieCompactor(jsc, compactionConfig);
    }

    private HoodieCompactor.Config buildCompactionConfig(
        ...
        config.configs.add(
                String.format("%s=%s", HoodieCompactionConfig.INLINE_COMPACT_NUM_DELTA_COMMITS.key(), 1));
        return config;
    }
}
