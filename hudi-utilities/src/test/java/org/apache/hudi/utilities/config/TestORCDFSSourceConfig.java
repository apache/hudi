 ...
 *
 * <p>ORCDFSSource itself stays untested until the HUDI-8081 hive-exec/hive-storage-api class-path
...
class TestORCDFSSourceConfig {
  ...
  void testMergeSchemaConfig() {
    ...
    assertEquals(Option.of("1.2.0"), ORCDFSSourceConfig.ORC_DFS_MERGE_SCHEMA.getSinceVersion());
  }
}
