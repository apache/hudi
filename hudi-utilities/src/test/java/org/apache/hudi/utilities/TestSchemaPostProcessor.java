...
public class TestSchemaPostProcessor extends UtilitiesTestBase {
        ...
        SchemaProvider provider =
                UtilHelpers.wrapSchemaProviderWithPostProcessor(
                        UtilHelpers.createSchemaProvider(
                                SparkAvroSchemaProvider.class.getName(), properties, jsc),
                        properties,
                        jsc,
    ...
    public void testDeleteSupport() {
        DeleteSupportSchemaPostProcessor processor =
                new DeleteSupportSchemaPostProcessor(properties, null);
    ...
    public void testChainedSchemaPostProcessor() {
        ...
        SchemaPostProcessor processor =
                UtilHelpers.createSchemaPostProcessor(
                        properties.getString(SchemaProviderPostProcessorConfig.SCHEMA_POST_PROCESSOR.key()),
                        properties,
                        jsc);
        Schema schema = new Schema.Parser().parse(ORIGINAL_SCHEMA);
        Schema targetSchema = processor.processSchema(schema);
    ...
    public void testDeleteColumn() {
        ...
        properties.put(
                SchemaProviderPostProcessorConfig.DELETE_COLUMN_POST_PROCESSOR_COLUMN.key(), "rider");
    ...
    public void testDeleteColumnThrows() {
        ...
        properties.put(
                ...
                "timestamp,_row_key,rider,driver,fare");
        DropColumnSchemaPostProcessor processor = new DropColumnSchemaPostProcessor(properties, null);
        Schema schema = new Schema.Parser().parse(ORIGINAL_SCHEMA);

        Assertions.assertThrows(
                HoodieSchemaPostProcessException.class, () -> processor.processSchema(schema));
    }
    ...
    public void testAddPrimitiveTypeColumn(String type) {
        properties.put(
                SchemaProviderPostProcessorConfig.SCHEMA_POST_PROCESSOR_ADD_COLUMN_NAME_PROP.key(),
                "primitive_column");
        properties.put(
                SchemaProviderPostProcessorConfig.SCHEMA_POST_PROCESSOR_ADD_COLUMN_TYPE_PROP.key(), type);
        properties.put(
                SchemaProviderPostProcessorConfig.SCHEMA_POST_PROCESSOR_ADD_COLUMN_DOC_PROP.key(),
                "primitive column test");

        AddPrimitiveColumnSchemaPostProcessor processor =
                new AddPrimitiveColumnSchemaPostProcessor(properties, null);
        Schema schema = new Schema.Parser().parse(ORIGINAL_SCHEMA);
        Schema targetSchema = processor.processSchema(schema);
        ...
        // test not nullable
        properties.put(
                SchemaProviderPostProcessorConfig.SCHEMA_POST_PROCESSOR_ADD_COLUMN_NULLABLE_PROP.key(),
                false);
        targetSchema = processor.processSchema(schema);
