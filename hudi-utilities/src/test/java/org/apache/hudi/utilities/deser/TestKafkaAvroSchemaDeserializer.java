...
public class TestKafkaAvroSchemaDeserializer {
    ...
    public void testKafkaAvroSchemaDeserializer() {
        ...
        KafkaAvroSchemaDeserializer avroDeserializer =
                new KafkaAvroSchemaDeserializer(schemaRegistry, new HashMap(config));
        ...
        assertEquals(
                avroRecord, avroDeserializer.deserialize(topic, false, bytesOrigRecord, origSchema));
        ...
        IndexedRecord avroRecordWithAllFieldActual =
                (IndexedRecord) avroDeserializer.deserialize(topic, false, bytesExtendedRecord, evolSchema);
        ...
        IndexedRecord actualRec =
                (IndexedRecord) avroDeserializer.deserialize(topic, false, bytesOrigRecord, origSchema);
        // record won't be equal to original record as we read w/ evolved schema. "age" will be
        // added w/ default value of null
