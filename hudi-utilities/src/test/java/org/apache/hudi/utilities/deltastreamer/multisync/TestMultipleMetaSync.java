...
public class TestMultipleMetaSync extends HoodieDeltaStreamerTestBase {
    ...
    void testMultipleMetaStore() throws Exception {
        ...
        HoodieDeltaStreamer.Config cfg =
                getConfig(tableBasePath, getSyncNames("MockSyncTool1", "MockSyncTool2"));
    ...
    private static String getSyncNames(String... syncs) {
        return Arrays.stream(syncs)
                .map(s -> "org.apache.hudi.utilities.deltastreamer.multisync." + s)
