...
public class TestHoodieSnapshotExporter extends SparkClientFunctionalTestHarness {
  ...
  public void init() throws Exception {
    ...
    List<StoragePathInfo> fileInfoList = storage.listFiles(new StoragePath(sourcePath));
    for (StoragePathInfo fileInfo : fileInfoList) {
      LOG.info(">>> Prepared test file: " + fileInfo.getPath());
    }
  }
