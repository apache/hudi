...
class TestSchemaRegistryProvider {
    ...
    private static final String REGISTRY_RESPONSE =
            "{\"schema\":\"{\\\"type\\\": \\\"record\\\", \\\"namespace\\\": \\\"example\\\", "
                    + "\\\"name\\\": \\\"FullName\\\",\\\"fields\\\": [{ \\\"name\\\": \\\"first\\\", \\\"type\\\": "
                    + "\\\"string\\\" }]}\"}";
    private static final String RAW_SCHEMA =
            "{\"type\": \"record\", \"namespace\": \"example\", "
                    + "\"name\": \"FullName\",\"fields\": [{ \"name\": \"first\", \"type\": "
                    + "\"string\" }]}";
    private static final String CONVERTED_SCHEMA =
            "{\"type\": \"record\", \"namespace\": \"com.example.hoodie\", "
                    + "\"name\": \"FullName\",\"fields\": [{ \"name\": \"first\", \"type\": "
                    + "\"string\" }]}";
    ...
    public void testGetSourceSchemaShouldRequestSchemaWithCreds() throws IOException {
        ...
        verify(spyUnderTest, times(1))
                .setAuthorizationHeader(eq(BASIC_AUTH), Mockito.any(HttpURLConnection.class));
    }
    ...
    public static class DummySchemaConverter implements SchemaRegistryProvider.SchemaConverter {
        ...
        public String convert(String schema) throws IOException {
            return ((ObjectNode) new ObjectMapper().readTree(schema))
    ...
    public void testGetSourceSchemaUsesCachedSchema() throws IOException {
        ...
        // Assuming this verify() has the scope of the whole test? so it should still be 1 from
        // previous call?
        verify(spyUnderTest, times(1)).parseSchemaFromRegistry(Mockito.any());
    }
}
