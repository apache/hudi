...
public class TestProtoConversionUtil {
        ...
        Schema convertedSchema =
                parser.parse(
                        getClass()
                                .getClassLoader()
                                .getResourceAsStream(
                                        "schema-provider/proto/sample_schema_wrapped_and_timestamp_as_record.avsc"));
        Pair<Sample, GenericRecord> inputAndOutput =
                createInputOutputSampleWithRandomValues(convertedSchema, true);
        Sample input = inputAndOutput.getLeft();
        GenericRecord actual =
                serializeAndDeserializeAvro(
                        ProtoConversionUtil.convertToAvro(convertedSchema, input), convertedSchema);
        Assertions.assertEquals(inputAndOutput.getRight(), actual);
        // assert that unsigned long is interpreted correctly
        Schema primitiveUnsignedLongSchema =
                convertedSchema.getField(PRIMITIVE_UNSIGNED_LONG_FIELD_NAME).schema();
        assertUnsignedLongCorrectness(
                primitiveUnsignedLongSchema,
                input.getPrimitiveUnsignedLong(),
                (GenericFixed) actual.get(PRIMITIVE_UNSIGNED_LONG_FIELD_NAME));
        Schema wrappedUnsignedLongSchema =
                convertedSchema
                        .getField(WRAPPED_UNSIGNED_LONG_FIELD_NAME)
                        .schema()
                        .getTypes()
                        .get(1)
                        .getField("value")
                        .schema();
        assertUnsignedLongCorrectness(
                wrappedUnsignedLongSchema,
                input.getWrappedUnsignedLong().getValue(),
                (GenericFixed) ((GenericRecord) actual.get(WRAPPED_UNSIGNED_LONG_FIELD_NAME)).get("value"));
    }
    ...
    public void noFieldsSet_wellKnownTypesAndTimestampsAsRecords() throws IOException {
        ...
        GenericRecord actual =
                serializeAndDeserializeAvro(
                        ProtoConversionUtil.convertToAvro(convertedSchema, sample), convertedSchema);
    ...
    public void allFieldsSet_defaultOptions() throws IOException {
        ...
        Schema convertedSchema =
                parser.parse(
                        getClass()
                                .getClassLoader()
                                .getResourceAsStream("schema-provider/proto/sample_schema_defaults.avsc"));
        Pair<Sample, GenericRecord> inputAndOutput =
                createInputOutputSampleWithRandomValues(convertedSchema, false);
        Sample input = inputAndOutput.getLeft();
        GenericRecord actual =
                serializeAndDeserializeAvro(
                        ProtoConversionUtil.convertToAvro(convertedSchema, input), convertedSchema);
        ...
        assertUnsignedLongCorrectness(
                ...
                (GenericFixed) actual.get(PRIMITIVE_UNSIGNED_LONG_FIELD_NAME));
        Schema wrappedUnsignedLongSchema =
                convertedSchema.getField(WRAPPED_UNSIGNED_LONG_FIELD_NAME).schema().getTypes().get(1);
        assertUnsignedLongCorrectness(
                wrappedUnsignedLongSchema,
                input.getWrappedUnsignedLong().getValue(),
                (GenericFixed) actual.get(WRAPPED_UNSIGNED_LONG_FIELD_NAME));
    }
    ...
    public void recursiveSchema_noOverflow() throws IOException {
        ...
        Schema convertedSchema =
                parser.parse(
                        getClass()
                                .getClassLoader()
                                .getResourceAsStream("schema-provider/proto/parent_schema_recursive_depth_2.avsc"));
        Pair<Parent, GenericRecord> inputAndOutput =
                createInputOutputForRecursiveSchemaNoOverflow(convertedSchema);
        GenericRecord actual =
                serializeAndDeserializeAvro(
                        ProtoConversionUtil.convertToAvro(convertedSchema, inputAndOutput.getLeft()),
                        convertedSchema);
        Assertions.assertEquals(inputAndOutput.getRight(), actual);
    }
    ...
    public void recursiveSchema_withOverflow() throws Exception {
        ...
        Child parsedSingleChildOverflow =
                Child.parseFrom(getOverflowBytesFromChildRecord((GenericRecord) actual.get("child")));
        Assertions.assertEquals(
                input.getChild().getRecurseField().getRecurseField(), parsedSingleChildOverflow);
        // Get children list
        ...
        Assertions.assertEquals(
                input.getChildren(0).getRecurseField().getRecurseField(), parsedChildren1Overflow);
        Child parsedChildren2Overflow = Child.parseFrom(getOverflowBytesFromChildRecord(array.get(1)));
        Assertions.assertEquals(
                input.getChildren(1).getRecurseField().getRecurseField(), parsedChildren2Overflow);
    }
    ...
    public void oneOfSchema() throws IOException {
        ...
        Schema convertedSchema =
                parser.parse(
                        getClass()
                                .getClassLoader()
                                .getResourceAsStream("schema-provider/proto/oneof_schema.avsc"));
    ...
    public void longToUnsignedBigIntegerConversion() {
        ...
        Assertions.assertEquals(
                String.valueOf(Long.MAX_VALUE), toUnsignedBigInteger(Long.MAX_VALUE).toString());
        ...
        Assertions.assertEquals(
                "12297829379609722880", toUnsignedBigInteger(-6148914694099828736L).toString());
    }

    private void assertUnsignedLongCorrectness(
            Schema fieldSchema, long expectedValue, GenericFixed actual) {
        BigDecimal actualPrimitiveUnsignedLong =
                DECIMAL_CONVERSION.fromFixed(actual, fieldSchema, fieldSchema.getLogicalType());
        Assertions.assertEquals(
                Long.toUnsignedString(expectedValue), actualPrimitiveUnsignedLong.toString());
    }

    private Pair<Sample, GenericRecord> createInputOutputSampleWithRandomValues(
            Schema schema, boolean wellKnownTypesAsRecords) {
        ...
        Schema mapMessageSchema =
                schema
                        .getField("map_message")
                        .schema()
                        .getElementType()
                        .getField("value")
                        .schema()
        ...
        long primitiveFixedLong =
                primitiveUnsignedLongInUnsignedRange
                        ? Long.parseUnsignedLong(MAX_UNSIGNED_LONG) - RANDOM.nextInt(1000)
                        : RANDOM.nextLong();
        ...
        List<Integer> primitiveList =
                Arrays.asList(RANDOM.nextInt(), RANDOM.nextInt(), RANDOM.nextInt());
        ...
        List<Nested> nestedList =
                Arrays.asList(
                        Nested.newBuilder().setNestedInt(RANDOM.nextInt()).build(),
                        Nested.newBuilder().setNestedInt(RANDOM.nextInt()).build());
        ...
        if (wellKnownTypesAsRecords) {
            ...
            wrappedUIntOutput =
                    getWrappedRecord(schema, "wrapped_unsigned_int", (long) wrappedUnsignedInt);
            wrappedULongOutput =
                    getWrappedRecord(
                            schema,
                            "wrapped_unsigned_long",
                            unsignedLongAsGenericFixed(wrappedUnsignedLong, unsignedLongSchema));
        ...
        expectedRecord.put(
                ...
                unsignedLongAsGenericFixed(primitiveUnsignedLong, unsignedLongSchema));
        ...
        expectedRecord.put(
                "repeated_message",
                nestedList.stream()
                        .map(m -> convertNestedMessage(listMessageSchema, m))
        ...
        expectedRecord.put(
                ...
                convertMapToList(
                        ...
                        "map_message",
                        nestedMap,
                        value -> convertNestedMessage(mapMessageSchema, value)));
    ...
    private GenericFixed unsignedLongAsGenericFixed(long unsignedLong, Schema unsignedLongSchema) {
        ...
        return DECIMAL_CONVERSION.toFixed(
                bigDecimal, unsignedLongSchema, unsignedLongSchema.getLogicalType());
    }
    ...
    private GenericRecord createDefaultOutput(Schema schema) {
        ...
        expectedRecord.put(
                "primitive_unsigned_long", unsignedLongAsGenericFixed(0L, unsignedLongSchema));
    ...
    public Pair<Parent, GenericRecord> createInputOutputForRecursiveSchemaNoOverflow(Schema schema) {
        Child singleChild =
                Child.newBuilder()
                        .setBasicField(1)
                        .setRecurseField(Child.newBuilder().setBasicField(2).build())
                        .build();
        Child children1 =
                Child.newBuilder()
                        .setBasicField(11)
                        .setRecurseField(Child.newBuilder().setBasicField(12).build())
                        .build();
        Child children2 =
                Child.newBuilder()
                        .setBasicField(21)
                        .setRecurseField(Child.newBuilder().setBasicField(22).build())
                        .build();
        ...
        Schema childLevel2AvroSchema =
                childAvroSchema.getField("recurse_field").schema().getTypes().get(1);

        Schema childrenAvroSchema = schema.getField("children").schema().getElementType();
        Schema childrenLevel2AvroSchema =
                childrenAvroSchema.getField("recurse_field").schema().getTypes().get(1);
    ...
    public Pair<Parent, GenericRecord> createInputOutputForRecursiveSchemaWithOverflow(
            Schema schema) {
        Child singleChildOverflow =
                Child.newBuilder()
                        .setBasicField(3)
                        .setRecurseField(Child.newBuilder().setBasicField(4).build())
                        .build();
        Child singleChild =
                Child.newBuilder()
                        .setBasicField(1)
                        .setRecurseField(
                                Child.newBuilder().setBasicField(2).setRecurseField(singleChildOverflow).build())
                        .build();
        Child children1Overflow =
                Child.newBuilder()
                        .setBasicField(13)
                        .setRecurseField(Child.newBuilder().setBasicField(14).build())
                        .build();
        Child children1 =
                Child.newBuilder()
                        .setBasicField(11)
                        .setRecurseField(
                                Child.newBuilder().setBasicField(12).setRecurseField(children1Overflow).build())
                        .build();
        Child children2Overflow =
                Child.newBuilder()
                        .setBasicField(23)
                        .setRecurseField(Child.newBuilder().setBasicField(24).build())
                        .build();
        Child children2 =
                Child.newBuilder()
                        .setBasicField(21)
                        .setRecurseField(
                                Child.newBuilder().setBasicField(22).setRecurseField(children2Overflow).build())
                        .build();
        List<Child> childrenList = Arrays.asList(children1, children2);
        Parent input = Parent.newBuilder().setChild(singleChild).addAllChildren(childrenList).build();
        ...
        Schema childLevel2AvroSchema =
                childAvroSchema.getField("recurse_field").schema().getTypes().get(1);
        Schema recursionOverflowSchema =
                childLevel2AvroSchema.getField("recurse_field").schema().getTypes().get(1);
    ...
    private ByteBuffer getOverflowBytesFromChildRecord(GenericRecord record) {
        return (ByteBuffer)
                ((GenericRecord) ((GenericRecord) record.get("recurse_field")).get("recurse_field"))
                        .get("proto_bytes");
    }

    private GenericRecord serializeAndDeserializeAvro(GenericRecord input, Schema schema) {
        // serialize and deserialize the data to make sure the avro record can be persisted and then
        // read back
    ...
    private GenericData.Record getTimestampRecord(Schema protoSchema, Timestamp time) {
        GenericData.Record timestampRecord =
                new GenericData.Record(protoSchema.getField("timestamp").schema().getTypes().get(1));
    ...
    private GenericData.Record getWrappedRecord(Schema protoSchema, String fieldName, Object value) {
        GenericData.Record wrappedRecord =
                new GenericData.Record(protoSchema.getField(fieldName).schema().getTypes().get(1));
    ...
    private static <K, V> List<GenericRecord> convertMapToList(
            final Schema protoSchema,
            final String fieldName,
            final Map<K, V> originalMap,
            final Function<V, ?> valueConverter) {
        return originalMap.entrySet().stream()
                .map(
                        entry -> {
                            GenericData.Record record =
                                    new GenericData.Record(protoSchema.getField(fieldName).schema().getElementType());
    ...
    private static <K, V> List<GenericRecord> convertMapToList(
            final Schema protoSchema, final String fieldName, final Map<K, V> originalMap) {
