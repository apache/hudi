...
public class TestGcsEventsSource extends UtilitiesTestBase {
    ...
    @Mock PubsubMessagesFetcher pubsubMessagesFetcher;
    ...
    public void beforeEach() throws Exception {
        schemaProvider =
                new FilebasedSchemaProvider(
                        Helpers.setupSchemaOnDFS("streamer-config", "gcs-metadata.avsc"), jsc);
    ...
    public void shouldReturnEmptyOnNoMessages() {
        ...
        GcsEventsSource source =
                new GcsEventsSource(props, jsc, sparkSession, null, pubsubMessagesFetcher);
    ...
    public void shouldReturnDataOnValidMessages() {
        ...
        GcsEventsSource source =
                new GcsEventsSource(props, jsc, sparkSession, schemaProvider, pubsubMessagesFetcher);
        Pair<Option<Dataset<Row>>, String> dataAndCheckpoint =
                source.fetchNextBatch(Option.of("0"), 100);
    ...
    public void shouldFetchMessagesInBatches() {
        ReceivedMessage msg1 =
                fileCreateMessage("objectId-1", "{\"data\":{\"bucket\":\"bucket-1\"}, \"size\": \"1024\"}");
        ReceivedMessage msg2 =
                fileCreateMessage("objectId-2", "{\"data\":{\"bucket\":\"bucket-2\"}, \"size\": \"1024\"}");
        ReceivedMessage msg3 =
                fileCreateMessage("objectId-3", "{\"data\":{\"bucket\":\"bucket-3\"}, \"size\": \"1024\"}");
        ReceivedMessage msg4 =
                fileCreateMessage("objectId-4", "{\"data\":{\"bucket\":\"bucket-4\"}, \"size\": \"1024\"}");
        ...
        GcsEventsSource source =
                new GcsEventsSource(props, jsc, sparkSession, null, pubsubMessagesFetcher);
        Pair<Option<Dataset<Row>>, String> dataAndCheckpoint1 =
                source.fetchNextBatch(Option.of("0"), 100);
        ...
        Pair<Option<Dataset<Row>>, String> dataAndCheckpoint2 =
                source.fetchNextBatch(Option.of("0"), 100);
    ...
    public void shouldSkipInvalidMessages1() {
        ReceivedMessage invalid1 =
                fileDeleteMessage("objectId-1", "{\"data\":{\"bucket\":\"bucket-1\"}, \"size\": \"1024\"}");
        ReceivedMessage invalid2 =
                fileCreateMessageWithOverwroteGen(
                        "objectId-2", "{\"data\":{\"bucket\":\"bucket-2\"}, \"size\": \"1024\"}");
        ReceivedMessage valid1 =
                fileCreateMessage("objectId-3", "{\"data\":{\"bucket\":\"bucket-3\"}, \"size\": \"1024\"}");

        when(pubsubMessagesFetcher.fetchMessages())
                .thenReturn(Arrays.asList(invalid1, valid1, invalid2));
    ...
    public void shouldGcsEventsSourceDoesNotDedupeInternally() {
        ReceivedMessage dupe1 =
                fileCreateMessage("objectId-1", "{\"data\":{\"bucket\":\"bucket-1\"}, \"size\": \"1024\"}");
        ReceivedMessage dupe2 =
                fileCreateMessage("objectId-1", "{\"data\":{\"bucket\":\"bucket-1\"}, \"size\": \"1024\"}");
    ...
    private ReceivedMessage fileCreateMessageWithOverwroteGen(String objectId, String payload) {
        ...
        return ReceivedMessage.newBuilder()
                .setMessage(objectWithEventTypeAndAttrs(objectId, "OBJECT_FINALIZE", attrs, payload))
                .setAckId(objectId)
                .build();
    }
    ...
    private ReceivedMessage fileCreateMessage(String objectId, String payload) {
        return ReceivedMessage.newBuilder()
                .setMessage(objectFinalizeMessage(objectId, payload))
                .setAckId(objectId)
                .build();
    }
    ...
    private ReceivedMessage fileDeleteMessage(String objectId, String payload) {
        return ReceivedMessage.newBuilder()
                .setMessage(objectDeleteMessage(objectId, payload))
                .setAckId(objectId)
                .build();
    }
    ...
    private PubsubMessage.Builder objectWithEventType(
            String objectId, String eventType, String dataMessage) {
        return messageWithAttrs(createBasicAttrs(objectId, eventType), dataMessage);
    }

    private PubsubMessage.Builder objectWithEventTypeAndAttrs(
            String objectId, String eventType, Map<String, String> attrs, String dataMessage) {
