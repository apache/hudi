...
public class TestS3EventsHoodieIncrSource extends SparkClientFunctionalTestHarness {
    ...
    @Mock QueryRunner mockQueryRunner;
    @Mock CloudObjectsSelectorCommon mockCloudObjectsSelectorCommon;
    ...
    public void setUp() throws IOException {
        ...
        String schemaFilePath =
                TestCloudObjectsSelectorCommon.class
                        .getClassLoader()
    ...
    /**
      ...
      *
      * <p>s3 : { object : { size: key: } bucket: { name: }
      */
    ...
    public void testOneFileInCommit() throws IOException {
        ...
        readAndAssert(
                READ_UPTO_LATEST_COMMIT, Option.of("1#path/to/file1.json"), 200L, "1#path/to/file2.json");
        readAndAssert(
                READ_UPTO_LATEST_COMMIT, Option.of("1#path/to/file2.json"), 200L, "1#path/to/file3.json");
    }
    ...
    public void testEmptyDataAfterFilter() throws IOException {
        ...
        readAndAssert(
                READ_UPTO_LATEST_COMMIT, Option.of("1#path/to/file3.json"), 1000L, "2", typedProperties);
        readAndAssert(
                READ_UPTO_LATEST_COMMIT,
                Option.of("2#path/to/skip4.json"),
                1000L,
                "2#path/to/skip4.json",
                typedProperties);
        readAndAssert(
                READ_UPTO_LATEST_COMMIT,
                Option.of("2#path/to/skip5.json"),
                1000L,
                "2#path/to/skip5.json",
                typedProperties);
    ...
    public void testFilterAnEntireCommit(boolean useSourceProfile) throws IOException {
        ...
        readAndAssert(
                READ_UPTO_LATEST_COMMIT, Option.of("1"), 50L, "2#path/to/file4.json", typedProperties);
    }
    ...
    public void testFilterAnEntireMiddleCommit(boolean useSourceProfile) throws IOException {
        ...
        readAndAssert(
                READ_UPTO_LATEST_COMMIT,
                Option.of("1#path/to/file3.json"),
                50L,
                "3#path/to/file4.json",
                typedProperties);
    ...
    public void testSplitSnapshotLoad(
        ...
        verify(mockCloudObjectsSelectorCommon, atLeastOnce())
                .loadAsDataset(
                        Mockito.any(),
                        Mockito.any(),
                        Mockito.any(),
    ...
    private void readAndAssert(
        ...
        S3EventsHoodieIncrSource incrSource =
                new S3EventsHoodieIncrSource(
                        typedProperties,
                        jsc(),
                        spark(),
                        mockQueryRunner,
                        new CloudDataFetcher(
                                typedProperties, jsc(), spark(), metrics, mockCloudObjectsSelectorCommon),
                        new DefaultStreamContext(
                                schemaProvider.orElse(null), Option.of(sourceProfileSupplier)));
    ...
    private void setMockQueryRunner(Dataset<Row> inputDs, Option<String> nextCheckPointOpt) {
        ...
        when(mockQueryRunner.run(Mockito.any(QueryInfo.class), Mockito.any()))
                .thenAnswer(
                        invocation -> {
