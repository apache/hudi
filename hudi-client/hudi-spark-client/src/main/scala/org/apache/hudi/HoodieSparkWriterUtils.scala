...
object HoodieSparkWriterUtils {
  ...
  def getPartitionColumns(properties: Properties): String = {
    ...
    getPartitionColumnsFromKeyGenerator(keyGenerator, props)
  }
   ...
   * @return partition columns
   */
  def getPartitionColumnsFromKeyGenerator(keyGen: KeyGenerator, typedProperties: TypedProperties): String = {
    keyGen match {
