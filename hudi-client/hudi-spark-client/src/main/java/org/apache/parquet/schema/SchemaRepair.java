...
public class SchemaRepair {
  ...
  // Avro Schema repair methods

  public static Schema repairLogicalTypes(Schema requestedSchema, Option<Schema> tableSchema) {
    if (tableSchema.isEmpty()) {
      return requestedSchema;
    }
    return repairLogicalTypes(requestedSchema, tableSchema.get());
  ...
  static Schema repairLogicalTypes(Schema requestedSchema, Schema tableSchema) {
