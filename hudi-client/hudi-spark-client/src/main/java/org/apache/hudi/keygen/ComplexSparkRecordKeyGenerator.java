...
public class ComplexSparkRecordKeyGenerator implements SparkRecordKeyGeneratorInterface {

  List<String> recordKeyFields;
  BuiltinKeyGenerator.SparkRowAccessor rowAccessor;

  public ComplexSparkRecordKeyGenerator(List<String> recordKeyFields, BuiltinKeyGenerator.SparkRowAccessor rowAccessor) {
