...
public class SparkBulkInsertCommitActionExecutor<T> extends BaseSparkCommitActionExecutor<T> {
    ...
    public SparkBulkInsertCommitActionExecutor(
    ...
    public HoodieWriteMetadata<HoodieData<WriteStatus>> execute() {
        try {
            return SparkBulkInsertHelper.newInstance()
                    .bulkInsert(
                            inputRecordsRDD, instantTime, table, config, this, true, bulkInsertPartitioner);
