...
/**
  * Clustering Strategy based on following. 1) Creates clustering groups based on max size allowed
  * per group. 2) Excludes files that are greater than 'small.file.limit' from clustering plan.
  */
public class SparkSizeBasedClusteringPlanStrategy<T>
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(SparkSizeBasedClusteringPlanStrategy.class);

    public SparkSizeBasedClusteringPlanStrategy(
