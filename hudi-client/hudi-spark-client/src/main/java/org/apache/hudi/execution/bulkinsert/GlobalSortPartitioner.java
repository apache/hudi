...
/**
  * A built-in partitioner that does global sorting for the input records across partitions after
    ...
    public JavaRDD<HoodieRecord<T>> repartitionRecords(
        ...
        return records.sortBy(
                record -> {
                    ...
                    // the records split evenly across RDD partitions, such that small partitions
                    // fit
                    // into 1 RDD partition, while big ones spread evenly across multiple RDD
                    // partitions
