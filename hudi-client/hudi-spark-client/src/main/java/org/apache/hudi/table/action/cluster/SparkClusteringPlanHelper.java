...
public class SparkClusteringPlanHelper<T extends HoodieRecordPayload<T>>
    extends BaseClusteringPlanHelper<T> {

  private static final Logger LOG = LogManager.getLogger(SparkClusteringPlanHelper.class);

  private SparkClusteringPlanHelper() {
  }

  private static class ClusteringPlanHelperHolder {
    private static final SparkClusteringPlanHelper SPARK_CLUSTERING_PLAN_HELPER = new SparkClusteringPlanHelper();
  }

  public static SparkClusteringPlanHelper newInstance() {
    return ClusteringPlanHelperHolder.SPARK_CLUSTERING_PLAN_HELPER;
  }

  @Override
  public Option<HoodieClusteringPlan> createClusteringPlan(
