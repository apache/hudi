...
public final class VectorRoutingArtifacts {
  ...
  public static final int ROUTING_VERSION = VectorArtifactIdentity.ROUTING_VERSION;
  ...
  public static String digest(
      ...
      int[] leafOffsets,
      float expandRatio) {
    return VectorArtifactIdentity.routingDigest(
        coarseCentroids, leafCentroids, leafOffsets, expandRatio);
  }
