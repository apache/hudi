...
/** Update strategy based on following. if some file groups have update record, throw exception */
public class SparkRejectUpdateStrategy<T> extends BaseSparkUpdateStrategy<T> {
    ...
    public SparkRejectUpdateStrategy(
    ...
    public Pair<HoodieData<HoodieRecord<T>>, Set<HoodieFileGroupId>> handleUpdate(
        ...
        fileGroupIdsWithRecordUpdate.forEach(
                fileGroupIdWithRecordUpdate -> {
