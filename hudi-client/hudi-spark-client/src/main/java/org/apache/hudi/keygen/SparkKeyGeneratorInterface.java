...
/**
  * Spark-specific {@link KeyGenerator} interface extension allowing implementation to specifically
  * implement record-key, partition-path generation w/o the need for (expensive) conversion from
  * Spark internal representation (for ex, to Avro)
  */
public interface SparkKeyGeneratorInterface extends KeyGeneratorInterface {
    ...
    /**
      ...
      *
      * <p>NOTE: Difference b/w {@link Row} and {@link InternalRow} is that {@link InternalRow} could
      * internally hold just a binary representation of the data, while {@link Row} has it deserialized
      * into JVM-native representation (like {@code Integer}, {@code Long}, {@code String}, etc)
      *
