...
public class HoodieSparkFileWriterFactory extends HoodieFileWriterFactory {
  ...
  @Override
  protected HoodieFileWriter newHFileFileWriter(String instantTime, StoragePath location, Configuration conf, HoodieConfig config, Schema schema,
                                                TaskContextSupplier taskContextSupplier) throws IOException {
    throw new HoodieIOException("Not support write to HFile");
  }

  @Override
  protected HoodieFileWriter newOrcFileWriter(String instantTime, StoragePath location, Configuration conf, HoodieConfig config, Schema schema,
                                              TaskContextSupplier taskContextSupplier) throws IOException {
