...
public class HoodieSparkFileReaderFactory extends HoodieFileReaderFactory {
    ...
    public HoodieFileReader newParquetFileReader(StoragePath path) {
        ...
        storage
                .getConf()
                .setIfUnset(SQLConf.CASE_SENSITIVE().key(), SQLConf.CASE_SENSITIVE().defaultValueString());
    ...
    protected HoodieFileReader newHFileFileReader(
            HoodieConfig hoodieConfig, StoragePath path, Option<Schema> schemaOption) throws IOException {
    ...
    public HoodieFileReader newBootstrapFileReader(
        ...
        return new HoodieSparkBootstrapFileReader(
                skeletonFileReader, dataFileReader, partitionFields, partitionValues);
    }
}
