...
/**
  * Key generator for deletes using global indices. Global index deletes do not require partition
  * value so this key generator avoids using partition value for generating HoodieKey.
  */
