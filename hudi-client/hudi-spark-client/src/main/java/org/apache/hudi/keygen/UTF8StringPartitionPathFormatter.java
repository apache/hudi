...
public class UTF8StringPartitionPathFormatter extends PartitionPathFormatterBase<UTF8String> {
    ...
    public UTF8StringPartitionPathFormatter(
            Supplier<StringBuilder<UTF8String>> stringBuilderFactory,
    ...
    protected UTF8String encode(UTF8String partitionPathPart) {
        return UTF8String.fromString(
                PartitionPathEncodeUtils.escapePathName(partitionPathPart.toString()));
    }
    ...
    public static class UTF8StringBuilder implements StringBuilder<UTF8String> {
        private final org.apache.hudi.unsafe.UTF8StringBuilder sb =
                new org.apache.hudi.unsafe.UTF8StringBuilder();
