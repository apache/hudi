...
public class HoodieAppendOnlyRowCreateHandle extends HoodieRowCreateHandle {
  ...
  public HoodieAppendOnlyRowCreateHandle(HoodieTable table, HoodieWriteConfig writeConfig, String partitionPath, String fileId, String instantTime,
  ...
  protected HoodieInternalRowFileWriter createNewFileWriter(
      ...
      throws IOException {
    return HoodieInternalRowFileWriterFactory.getInternalRowAppendOnlyFileWriter(
