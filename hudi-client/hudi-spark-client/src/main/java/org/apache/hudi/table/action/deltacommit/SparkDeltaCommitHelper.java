...
public class SparkDeltaCommitHelper<T extends HoodieRecordPayload<T>> extends SparkCommitHelper<T> {

  private static final Logger LOG = LogManager.getLogger(SparkDeltaCommitHelper.class);

  // UpsertPartitioner for MergeOnRead table type
  private SparkUpsertDeltaCommitPartitioner mergeOnReadUpsertPartitioner;

  public SparkDeltaCommitHelper(
  ...
  public Partitioner getUpsertPartitioner(WorkloadProfile profile) {
    ...
    mergeOnReadUpsertPartitioner = new SparkUpsertDeltaCommitPartitioner(
        profile, (HoodieSparkEngineContext) context, table, config);
