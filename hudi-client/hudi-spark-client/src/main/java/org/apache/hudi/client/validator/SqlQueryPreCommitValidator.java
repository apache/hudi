 ...
 */
public abstract class SqlQueryPreCommitValidator<T extends HoodieRecordPayload<T>, I, K, O extends JavaRDD<WriteStatus>> extends SparkPreCommitValidator<T, I, K, O> {
