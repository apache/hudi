...
public class SparkInsertOverwriteTableCommitHelper<T extends HoodieRecordPayload<T>>
    extends SparkInsertOverwriteCommitHelper<T> {
  public SparkInsertOverwriteTableCommitHelper(
  ...
  public Map<String, List<String>> getPartitionToReplacedFileIds(
    ...
    List<String> partitionPaths = FSUtils.getAllPartitionPaths(
        context, config.getMetadataConfig(), table.getMetaClient().getBasePath());
