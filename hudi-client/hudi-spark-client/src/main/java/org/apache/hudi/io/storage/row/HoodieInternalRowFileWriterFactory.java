...
public class HoodieInternalRowFileWriterFactory {
   ...
   *
   */
  public static HoodieInternalRowFileWriter getInternalRowFileWriter(StoragePath location,
  ...
  private static HoodieInternalRowFileWriter newParquetInternalRowFileWriter(StoragePath location,
                                                                             HoodieTable table,
                                                                             HoodieWriteConfig writeConfig,
