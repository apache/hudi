...
/**
  * Partition path formatter allows to efficiently combine partition paths into generic Java {@link
  * String} (as well as engine-specific containers like {@code UTF8String} for ex), while being
  * flexible in terms of
  *
  * <ul>
  *   <li>Allowing to configure how to handle empty values
  *   <li>Allowing to encode individual values
  *   <li>Supporting Hive-style partitioning ({@code column=value})
  * </ul>
  *
  * @param <S> string type
  */
public abstract class PartitionPathFormatterBase<S> {
    ...
    PartitionPathFormatterBase(
            Supplier<StringBuilder<S>> stringBuilderFactory,
    ...
    /**
      * This is a generic interface closing the gap and unifying the {@link java.lang.StringBuilder}
      * with {@link org.apache.hudi.unsafe.UTF8StringBuilder} implementations, allowing us to avoid
      * code-duplication by performing most of the key-generation in a generic and unified way
      *
