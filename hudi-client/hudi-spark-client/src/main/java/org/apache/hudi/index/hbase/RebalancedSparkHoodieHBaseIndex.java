...
/**
  * Extends {@link SparkHoodieHBaseIndex}, add random prefix to key for avoiding data skew issue in
  * hbase regions.
  */
public class RebalancedSparkHoodieHBaseIndex extends SparkHoodieHBaseIndex {
    ...
    protected String getHBaseKey(String originalKey) {
        ...
        String bucketStr =
                String.format(
                        "%0" + String.valueOf(config.getHBaseIndexRegionCount() - 1).length() + "d", bucket);
