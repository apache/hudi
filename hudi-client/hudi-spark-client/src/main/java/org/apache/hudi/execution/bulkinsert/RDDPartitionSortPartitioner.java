...
/**
  * A built-in partitioner that does local sorting for each RDD partition after coalesce for bulk
  * insert operation, corresponding to the {@code BulkInsertSortMode.PARTITION_SORT} mode.
  *
