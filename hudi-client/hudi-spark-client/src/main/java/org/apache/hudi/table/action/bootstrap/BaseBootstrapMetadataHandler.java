...
public abstract class BaseBootstrapMetadataHandler implements BootstrapMetadataHandler {
    ...
    public BaseBootstrapMetadataHandler(
    ...
    public BootstrapWriteStatus runMetadataBootstrap(
            String srcPartitionPath, String partitionPath, KeyGeneratorInterface keyGenerator) {
        ...
        try {
            ...
            executeBootstrap(
                    bootstrapHandle, sourceFilePath, keyGenerator, partitionPath, recordKeySchema);
        } catch (Exception e) {
            throw new HoodieException(e.getMessage(), e);
        }

        BootstrapWriteStatus writeStatus =
                (BootstrapWriteStatus) bootstrapHandle.getWriteStatuses().get(0);
        BootstrapFileMapping bootstrapFileMapping =
    ...
    abstract void executeBootstrap(
            HoodieBootstrapHandle<?, ?, ?, ?> bootstrapHandle,
