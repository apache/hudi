...
public abstract class BaseBootstrapMetadataHandler implements BootstrapMetadataHandler {
  ...
  abstract Schema getAvroSchema(StoragePath sourceFileLocation) throws IOException;

  abstract void executeBootstrap(HoodieBootstrapHandle<?, ?, ?, ?> bootstrapHandle,
                                 StoragePath sourceFileLocation, KeyGeneratorInterface keyGenerator, String partitionPath, Schema avroSchema) throws Exception;
}
