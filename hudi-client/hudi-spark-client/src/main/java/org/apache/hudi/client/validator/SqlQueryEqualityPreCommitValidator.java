...
/**
  ...
  *
  * <p>Expects both queries to return same result.
  */
public class SqlQueryEqualityPreCommitValidator<T, I, K, O extends HoodieData<WriteStatus>>
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(SqlQueryEqualityPreCommitValidator.class);

    public SqlQueryEqualityPreCommitValidator(
    ...
    protected void validateUsingQuery(
        ...
        if (!areDatasetsEqual) {
            ...
            throw new HoodieValidationException(
                    "Query validation failed for '" + query + "'. See stdout for expected vs actual records");
        }
    }
}
