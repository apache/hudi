...
/**
  * A built-in partitioner that does global sorting for the input Rows across partitions after
  * repartition for bulk insert operation, corresponding to the {@code
