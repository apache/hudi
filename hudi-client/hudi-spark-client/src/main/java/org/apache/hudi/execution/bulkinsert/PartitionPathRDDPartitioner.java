...
/**
  * A Spark RDD partitioner implementation that determines the Spark partition based on the table
  * partition path, generating targeted number of Spark partitions.
  */
public class PartitionPathRDDPartitioner extends Partitioner implements Serializable {
    ...
    PartitionPathRDDPartitioner(
            SerializableFunctionUnchecked<Object, String> partitionPathExtractor, int numPartitions) {
