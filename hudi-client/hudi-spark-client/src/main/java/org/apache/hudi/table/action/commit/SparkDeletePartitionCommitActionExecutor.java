...
public class SparkDeletePartitionCommitActionExecutor<T>
    ...
    public SparkDeletePartitionCommitActionExecutor(
    ...
    public HoodieWriteMetadata<HoodieData<WriteStatus>> execute() {
        ...
        try {
            ...
            context.setJobStatus(
                    this.getClass().getSimpleName(), "Gather all file ids from all deleting partitions.");
            Map<String, List<String>> partitionToReplaceFileIds =
                    HoodieJavaPairRDD.getJavaPairRDD(
                                    context
            ...
            throw new HoodieDeletePartitionException(
                    "Failed to drop partitions for commit time " + instantTime, e);
        }
    }
}
