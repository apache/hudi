...
public class SparkExtensibleBucketClusteringPlanStrategy<T extends HoodieRecordPayload<T>>
    extends BaseExtensibleBucketClusteringPlanStrategy<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>, JavaRDD<WriteStatus>> {

  public SparkExtensibleBucketClusteringPlanStrategy(HoodieTable table, HoodieEngineContext engineContext,
  ...
  protected List<HoodieClusteringGroup> buildMergeClusteringGroup(HoodieExtensibleBucketMetadata metadata, String partitionPath, List<FileSlice> fileSlices, int mergeNum) {
    return super.buildMergeClusteringGroup(metadata, partitionPath, fileSlices, mergeNum);
  }
  ...
  protected List<HoodieClusteringGroup> buildSplitClusteringGroup(HoodieExtensibleBucketMetadata metadata, String partitionPath, List<FileSlice> fileSlices, int splitNum) {
    return super.buildSplitClusteringGroup(metadata, partitionPath, fileSlices, splitNum);
  }
}
