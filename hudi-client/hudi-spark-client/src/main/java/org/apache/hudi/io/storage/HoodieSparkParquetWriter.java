...
public class HoodieSparkParquetWriter extends HoodieBaseParquetWriter<InternalRow>
    ...
    public HoodieSparkParquetWriter(
            StoragePath file,
    ...
    protected void updateRecordMetadata(
            InternalRow row, UTF8String recordKey, String partitionPath, long recordCount) {
        row.update(COMMIT_TIME_METADATA_FIELD.ordinal(), instantTime);
        row.update(
                COMMIT_SEQNO_METADATA_FIELD.ordinal(),
