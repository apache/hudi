...
public class HoodieSparkParquetStreamWriter implements HoodieSparkFileWriter, AutoCloseable {
    ...
    public HoodieSparkParquetStreamWriter(
            FSDataOutputStream outputStream, HoodieRowParquetConfig parquetConfig) throws IOException {
        this.writeSupport = parquetConfig.getWriteSupport();
        this.writer =
                new Builder<>(new OutputStreamBackedOutputFile(outputStream), writeSupport)
