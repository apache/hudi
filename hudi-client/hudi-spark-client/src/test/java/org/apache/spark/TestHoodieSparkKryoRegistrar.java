...
public class TestHoodieSparkKryoRegistrar {
    ...
    public void testSerdeHoodieHadoopConfiguration() {
        ...
        HadoopStorageConfiguration deserialized =
                kryo.readObject(input, HadoopStorageConfiguration.class);
        input.close();
    ...
    private Map<String, String> getPropsInMap(HadoopStorageConfiguration conf) {
        ...
        conf.unwrap().iterator().forEachRemaining(e -> configMap.put(e.getKey(), e.getValue()));
        return configMap;
    }
}
