...
public class TestPartitionTTLManagement extends HoodieClientTestBase {
    ...
    public void testKeepByCreationTime() {
        final HoodieWriteConfig cfg =
                getConfigBuilder(true)
                        .withPath(metaClient.getBasePath())
                        .withTTLConfig(
                                HoodieTTLConfig.newBuilder()
        ...
        try (SparkRDDWriteClient client = getHoodieWriteClient(cfg)) {
            ...
            Assertions.assertEquals(
                    Sets.newHashSet(partitionPath0, partitionPath1),
                    result.getPartitionToReplaceFileIds().keySet());
            Assertions.assertEquals(
                    10, readRecords(new String[] {partitionPath0, partitionPath1, partitionPath2}).size());
        }
    }
    ...
    private void writeRecordsForPartition(
