...
public class TestUniformBootstrapModeSelector {
    ...
    public void testFullBootstrapModeSelector() {
        ...
        FullRecordBootstrapModeSelector modeSelector =
                new FullRecordBootstrapModeSelector(HoodieWriteConfig.newBuilder().withPath("").build());
        testModeSelector(modeSelector, BootstrapMode.FULL_RECORD);
    }

    @Test
    public void testMetadataOnlyBootstrapModeSelector() {
        MetadataOnlyBootstrapModeSelector modeSelector =
                new MetadataOnlyBootstrapModeSelector(HoodieWriteConfig.newBuilder().withPath("").build());
