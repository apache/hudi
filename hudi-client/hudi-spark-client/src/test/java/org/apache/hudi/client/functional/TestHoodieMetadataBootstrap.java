...
public class TestHoodieMetadataBootstrap extends TestHoodieMetadataBase {
    ...
    /**
      * Validate that bootstrap considers only files part of completed commit and ignore any extra
      * files.
      */
    @Test
    ...
    @ParameterizedTest
    @EnumSource(HoodieTableType.class)
    public void testMetadataBootstrapInsertUpsertRollback(HoodieTableType tableType)
            throws Exception {
        init(tableType, false);
        doPreBootstrapWriteOperation(testTable, INSERT, "0000001");
        doPreBootstrapWriteOperation(testTable, "0000002");
    ...
    @ParameterizedTest
    @EnumSource(HoodieTableType.class)
    public void testMetadataBootstrapAfterRestoreAndUpserts(HoodieTableType tableType)
            throws Exception {
        init(tableType, false);
        testRestore(true);
    }
    ...
    private void bootstrapAndVerifyFailure() throws Exception {
        ...
        Assertions.assertThrows(
                Error.class, () -> validateMetadata(testTable), "expected 6 lines, but only got 4");
    }
    ...
    private HoodieWriteConfig getWriteConfig(int minArchivalCommits, int maxArchivalCommits)
            throws Exception {
