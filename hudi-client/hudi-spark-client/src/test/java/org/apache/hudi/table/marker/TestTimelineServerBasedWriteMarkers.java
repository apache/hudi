...
public class TestTimelineServerBasedWriteMarkers extends TestWriteMarkersBase {
        ...
        this.jsc =
                new JavaSparkContext(
                        HoodieClientTestUtils.getSparkConfForTest(
                                TestTimelineServerBasedWriteMarkers.class.getName()));
            ...
            timelineService =
                    new TimelineService(
                            ...
                            FileSystemViewManager.createViewManager(
                                    localEngineContext, storageConf, HoodieCommonConfig.newBuilder().build()));
            timelineService.startService();
        } catch (Exception ex) {
            throw new RuntimeException(ex);
        }
        this.writeMarkers =
                new TimelineServerBasedWriteMarkers(
    ...
    void verifyMarkersInFileSystem(boolean isTablePartitioned) throws IOException {
        ...
        StoragePath markerTypeFilePath =
                new StoragePath(markerFolderPath, MarkerUtils.MARKER_TYPE_FILENAME);
        ...
        assertEquals(
                MarkerType.TIMELINE_SERVER_BASED.toString(), FileIOUtils.readAsUTFString(inputStream));
