...
public class TestHoodieSparkFunctionalIndex extends HoodieSparkClientTestHarness {
    ...
    public void testYearFunction() {
                        ...
                        DataTypes.createStructType(
                                Arrays.asList(
                                        DataTypes.createStructField(
                                                "timestampColumn", DataTypes.TimestampType, false))));
        ...
        HoodieSparkFunctionalIndex index =
                new HoodieSparkFunctionalIndex(
                        "yearIndex", "year", Arrays.asList("timestampColumn"), new HashMap<>());
    ...
    public void testHourFunction() {
        ...
        HoodieSparkFunctionalIndex index =
                new HoodieSparkFunctionalIndex(
                        "hourIndex", "hour", Arrays.asList("timestampColumn"), new HashMap<>());
