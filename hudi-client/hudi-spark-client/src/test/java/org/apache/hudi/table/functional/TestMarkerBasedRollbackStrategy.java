...
public class TestMarkerBasedRollbackStrategy extends HoodieClientTestBase {
  ...
  @Test
  public void testRollbackMultipleLogFilesInOneFileGroupInMORTableVersionSix() throws Exception {
    ...
    HoodieRecord record = new RawTripTestPayload(
        "{\"_row_key\":\"key1\",\"time\":\"2016-01-31T03:16:41.415Z\",\"number\":12}")
        .toHoodieRecord();
    String instantTime1 = "001";
    testTable.forCommit(instantTime1);
    StoragePath baseFilePath = testTable.withInserts(partition, fileId, Collections.singletonList(record));
    ...
    writeConfig.setValue(WRITE_TABLE_VERSION, String.valueOf(6));
    ...
    MarkerBasedRollbackStrategy rollbackStrategy =
        new MarkerBasedRollbackStrategy(hoodieTable, context, writeConfig, "004");
    HoodieInstant instantToRollback = new InstantGeneratorV1().createNewInstant(
