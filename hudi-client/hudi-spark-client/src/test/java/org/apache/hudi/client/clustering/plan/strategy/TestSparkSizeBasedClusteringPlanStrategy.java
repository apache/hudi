...
public class TestSparkSizeBasedClusteringPlanStrategy {
    ...
    public void testBuildClusteringGroup() {
                        ...
                        .withClusteringConfig(
                                HoodieClusteringConfig.newBuilder()
                                        .withClusteringPlanStrategyClass(
                                                SparkSizeBasedClusteringPlanStrategy.class.getName())
        ...
        SparkSizeBasedClusteringPlanStrategy planStrategy =
                new SparkSizeBasedClusteringPlanStrategy(table, context, config);
