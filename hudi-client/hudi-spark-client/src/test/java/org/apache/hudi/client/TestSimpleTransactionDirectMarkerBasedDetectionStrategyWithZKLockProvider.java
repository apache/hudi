...
public class TestSimpleTransactionDirectMarkerBasedDetectionStrategyWithZKLockProvider
    ...
    private void setUp(boolean partitioned) throws Exception {
        ...
        config =
                getConfigBuilder()
                        ...
                        .withEarlyConflictDetectionStrategy(
    ...
    public void testSimpleTransactionDirectMarkerBasedDetectionStrategy(boolean partitioned)
            throws Exception {
        setUp(partitioned);

        final String nextCommitTime1 = "00000000000001";
        final SparkRDDWriteClient client1 = getHoodieWriteClient(config);
        Function2<List<HoodieRecord>, String, Integer> recordGenFunction1 =
                generateWrapRecordsFn(false, config, dataGen::generateInserts);
        ...
        // this commit 003 will failed quickly because early conflict detection before create
        // marker.
