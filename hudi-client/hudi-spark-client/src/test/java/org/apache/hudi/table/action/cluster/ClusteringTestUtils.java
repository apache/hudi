...
public class ClusteringTestUtils {
    ...
    public static HoodieWriteConfig getClusteringConfig(
            String basePath, String schemaStr, Properties properties) {
    ...
    public static String runClustering(
            SparkRDDWriteClient clusteringClient, boolean skipExecution, boolean shouldCommit) {
        // Schedule and execute clustering.
        String clusteringCommitTime = clusteringClient.createNewInstantTime();
        return runClusteringOnInstant(
                clusteringClient, skipExecution, shouldCommit, clusteringCommitTime);
    }

    public static String runClusteringOnInstant(
    ...
    public static HoodieClusteringPlan createClusteringPlan(
            HoodieTableMetaClient metaClient, String instantTime, String fileId) {
        try {
            ...
            slice.setBaseFile(
                    new CompactionTestUtils.DummyHoodieBaseFile(
                            Paths.get(basePath, partition, baseFileName(instantTime, fileId)).toString()));
