...
public class TestSavepointRestoreCopyOnWrite extends HoodieClientTestBase {
    ...
    /**
      * Actions: C1, C2, savepoint C2, C3, C4, restore. Should go back to C2, C3 and C4 should be
      * cleaned up.
      */
    @Test
    ...
    /**
      ...
      *
      * <p>Actions: C1, C2, savepoint C2, C3, C4 inflight, restore. Should go back to C2, C3, C4 should
      * be cleaned up.
      */
    @Test
    ...
    /**
      ...
      *
      * <p>Actions: C1, C2, savepoint C2, C3, C4 (RB_C3), C5, restore. Should go back to C2. C3,
      * C4(RB_C3), C5 should be cleaned up.
      *
      * <p>Actions: C1, C2, savepoint C2, C3, C4 (RB_C3) inflight, restore. Should go back to C2. C3,
      * C4 (RB_C3) should be cleaned up.
      */
    @ParameterizedTest
            ...
            if (commitRollback) {
                ...
                HoodieInstant pendingInstant =
                        metaClient
                                ...
                                .lastInstant()
                                .orElseThrow(() -> new HoodieException("Pending instant does not exist"));
                HoodieSparkTable.create(client.getConfig(), context)
                        .scheduleRollback(
                                context, client.createNewInstantTime(), pendingInstant, false, true, false);
            }
