...
public class TestSparkBuildClusteringGroupsForPartition {
    ...
    @Mock HoodieSparkCopyOnWriteTable table;
    @Mock HoodieSparkEngineContext context;
                ...
                hoodieWriteConfigBuilder
                        .withClusteringConfig(
                                HoodieClusteringConfig.newBuilder()
                                        ...
                                        .build())
                        .build();
        PartitionAwareClusteringPlanStrategy strategyWithSortEnabled =
                new SparkSizeBasedClusteringPlanStrategy(table, context, configWithSortEnabled);
                ...
                hoodieWriteConfigBuilder
                        .withClusteringConfig(
                                HoodieClusteringConfig.newBuilder()
                                        ...
                                        .build())
                        .build();
        PartitionAwareClusteringPlanStrategy strategyWithSortDisabled =
                new SparkSizeBasedClusteringPlanStrategy(table, context, configWithSortDisabled);
                ...
                hoodieWriteConfigBuilder
                        .withClusteringConfig(
                                HoodieClusteringConfig.newBuilder()
                                        ...
                                        .build())
                        .build();
        PartitionAwareClusteringPlanStrategy clusteringPlanStrategy =
                new SparkSizeBasedClusteringPlanStrategy(table, context, writeConfig);
        Stream<HoodieClusteringGroup> groups =
                clusteringPlanStrategy.buildClusteringGroupsForPartition(partition, fileSliceGroups);
    ...
    private FileSlice generateFileSliceWithLen(
            String partitionPath, String fileId, String baseInstant, long fileLen) {
        FileSlice fs = new FileSlice(new HoodieFileGroupId(partitionPath, fileId), baseInstant);
