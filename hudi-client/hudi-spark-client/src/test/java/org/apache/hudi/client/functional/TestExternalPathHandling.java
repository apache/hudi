...
public class TestExternalPathHandling extends HoodieClientTestBase {
    ...
    public void testFlow(FileIdAndNameGenerator fileIdAndNameGenerator, List<String> partitions)
            throws Exception {
        ...
        metaClient
                ...
                .transitionReplaceRequestedToInflight(
                        new HoodieInstant(
                                HoodieInstant.State.REQUESTED, HoodieTimeline.REPLACE_COMMIT_ACTION, instantTime1),
                        Option.empty());
        writeClient.commit(
                instantTime1,
                rdd1,
        ...
        WriteStatus newWriteStatus =
                createWriteStatus(instantTime2, partitionPath1, filePath2, fileId2);
        ...
        metaClient
                ...
                .transitionReplaceRequestedToInflight(
                        new HoodieInstant(
                                HoodieInstant.State.REQUESTED, HoodieTimeline.REPLACE_COMMIT_ACTION, instantTime2),
                        Option.empty());
        writeClient.commit(
                instantTime2,
                rdd2,
        ...
        metaClient
                ...
                .transitionReplaceRequestedToInflight(
                        new HoodieInstant(
                                HoodieInstant.State.REQUESTED, HoodieTimeline.REPLACE_COMMIT_ACTION, instantTime3),
                        Option.empty());
        writeClient.commit(
                instantTime3,
                rdd3,
        ...
        assertFileGroupCorrectness(
                instantTime3, partitionPath2, filePath3, fileId3, partitionPath2.isEmpty() ? 2 : 1);
        ...
        HoodieCleanerPlan cleanerPlan =
                cleanerPlan(
                        ...
                        Collections.singletonMap(
                                partitionPath1,
                                Collections.singletonList(new HoodieCleanFileInfo(filePath1, false))));
        metaClient
                .getActiveTimeline()
        ...
        List<HoodieCleanStat> cleanStats =
                Collections.singletonList(
                        createCleanStat(partitionPath1, Arrays.asList(filePath1), instantTime2, instantTime3));
        HoodieCleanMetadata cleanMetadata =
                CleanerUtils.convertCleanMetadata(
                        cleanTime, Option.empty(), cleanStats, Collections.EMPTY_MAP);
        try (HoodieTableMetadataWriter hoodieTableMetadataWriter =
            ...
            metaClient
                    ...
                    .transitionCleanInflightToComplete(
                            true, inflightClean, TimelineMetadataUtils.serializeCleanMetadata(cleanMetadata));
            // make sure we still get the same results as before
            assertFileGroupCorrectness(
                    instantTime2, partitionPath1, filePath2, fileId2, partitionPath2.isEmpty() ? 2 : 1);
            assertFileGroupCorrectness(
                    instantTime3, partitionPath2, filePath3, fileId3, partitionPath2.isEmpty() ? 2 : 1);
    ...
    static Stream<Arguments> getArgs() {
        FileIdAndNameGenerator external =
                (index, instantTime) -> {
        ...
        return Stream.of(
                Arguments.of(external, partitionedTable), Arguments.of(external, unpartitionedTable));
    }
    ...
    private void assertFileGroupCorrectness(
            String instantTime, String partitionPath, String filePath, String fileId, int expectedSize) {
    ...
    private WriteStatus createWriteStatus(
            String commitTime, String partitionPath, String filePath, String fileId) {
        ...
        stats.put(
                FIELD_1,
                HoodieColumnRangeMetadata.<Comparable>create(filePath, FIELD_1, 1, 2, 0, 2, 5, 10));
        stats.put(
                FIELD_2,
                HoodieColumnRangeMetadata.<Comparable>create(filePath, FIELD_2, "a", "b", 1, 3, 10, 20));
        writeStat.putRecordsStats(stats);
        writeStatus.setStat(writeStat);
        return writeStatus;
    }

    private HoodieCleanStat createCleanStat(
    ...
    private HoodieCleanerPlan cleanerPlan(
