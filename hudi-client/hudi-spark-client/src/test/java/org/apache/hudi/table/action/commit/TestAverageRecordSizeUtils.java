...
public class TestAverageRecordSizeUtils {
    ...
    public void testAverageRecordSize(
            List<Pair<HoodieInstant, List<HWriteStat>>> instantSizePairs, long expectedSize) {
                    ...
                    entry
                            ...
                            .forEach(
                                    hWriteStat -> {
                                        ...
                                        writeStat.setTotalWriteBytes(
                                                hWriteStat.getPerRecordSize() * hWriteStat.getTotalRecordsWritten());
        ...
        assertEquals(
                expectedSize, AverageRecordSizeUtils.averageBytesPerRecord(mockTimeline, writeConfig));
    }
    ...
    public void testErrorHandling() {
                ...
                HoodieWriteConfig.newBuilder()
                        .withProps(
                                Collections.singletonMap(
                                        COPY_ON_WRITE_RECORD_SIZE_ESTIMATE.key(), String.valueOf(recordSize)))
                        .build(false);
        HoodieDefaultTimeline commitsTimeline = new HoodieDefaultTimeline();
        ...
        assertEquals(
                recordSize, AverageRecordSizeUtils.averageBytesPerRecord(mockTimeline, writeConfig));
    }

    private static String getBaseFileName(String instantTime) {
        String fileName = UUID.randomUUID().toString();
        return FSUtils.makeBaseFileName(
                instantTime, TEST_WRITE_TOKEN, fileName, PARQUET.getFileExtension());
    }
    ...
    static Stream<Arguments> testCases() {
                ...
                Arguments.of(
                        Arrays.asList(
                                Pair.of(
                                        ...
                                        Collections.singletonList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant)), 10000000L, 100L)))),
                        100L));
                ...
                Arguments.of(
                        Arrays.asList(
                                ...
                                Pair.of(
                                        ...
                                        Collections.singletonList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant + 100)), 10000000L, 200L)))),
                        200L));

        // two instants, while 2nd one is smaller in size so as to not meet the threshold. So, 1st
                ...
                Arguments.of(
                        Arrays.asList(
                                ...
                                Pair.of(
                                        ...
                                        Collections.singletonList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant + 100)), 10000L, 200L)))),
                        100L));
        ...
        // delta commit has a mix of parquet and log files. only parquet files should be accounted
        // for.
        arguments.add(
                Arguments.of(
                        Arrays.asList(
                                Pair.of(
                                        ...
                                        Collections.singletonList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant)), 1000000L, 100L))),
                                Pair.of(
                                        new HoodieInstant(
                                                HoodieInstant.State.COMPLETED,
                                                HoodieTimeline.DELTA_COMMIT_ACTION,
                                        ...
                                        Arrays.asList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant + 100)), 10000000L, 200L),
                                                new HWriteStat(
                                                        getLogFileName(String.valueOf(baseInstant + 100)), 10000000L, 300L)))),
                        200L));
                ...
                Arguments.of(
                        Arrays.asList(
                                ...
                                Pair.of(
                                        ...
                                        Arrays.asList(
                                                new HWriteStat(
                                                        getLogFileName(String.valueOf(baseInstant + 100)), 1000000L, 200L),
                                                new HWriteStat(
                                                        getLogFileName(String.valueOf(baseInstant + 100)), 10000000L, 300L)))),
                        100L));
                                ...
                                Pair.of(
                                        ...
                                        Arrays.asList(
                                                new HWriteStat(
                                                        getLogFileName(String.valueOf(baseInstant + 100)), 1000000L, 200L),
                                                new HWriteStat(
                                                        getLogFileName(String.valueOf(baseInstant + 100)), 1000000L, 300L))),
                                Pair.of(
                                        new HoodieInstant(
                                                HoodieInstant.State.COMPLETED,
                                                HoodieTimeline.REPLACE_COMMIT_ACTION,
                                        ...
                                        Collections.singletonList(
                                                new HWriteStat(
                                                        getBaseFileName(String.valueOf(baseInstant + 200)), 1000000L, 400L)))),
                        400L));
