...
public class TestConsistencyGuard extends HoodieSparkClientTestHarness {
  ...
  public void testCheckPassingAppearAndDisAppear(String consistencyGuardType) throws Exception {
    FileCreateUtils.createBaseFile(metaClient, "partition/path", "000", "f1");
    FileCreateUtils.createBaseFile(metaClient, "partition/path", "000", "f2");
    FileCreateUtils.createBaseFile(metaClient, "partition/path", "000", "f3");
