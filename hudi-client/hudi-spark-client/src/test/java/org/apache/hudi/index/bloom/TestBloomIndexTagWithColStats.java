...
public class TestBloomIndexTagWithColStats extends TestHoodieMetadataBase {
    ...
    private static final Schema SCHEMA =
            getSchemaFromResource(TestBloomIndexTagWithColStats.class, "/exampleSchema.avsc", true);
    ...
    private void testTagLocationOnPartitionedTable(KeyGenerator keyGenerator) throws Exception {
        ...
        HoodieRecord record =
                new HoodieAvroRecord(
                        keyGenerator.getKey(genericRecord), new HoodieAvroPayload(Option.of(genericRecord)));
        ...
        HoodieBloomIndex bloomIndex =
                new HoodieBloomIndex(config, SparkHoodieBloomIndexHelper.getInstance());
        ...
        taggedRecordRDD =
                tagLocation(bloomIndex, recordRDD, HoodieSparkTable.create(config, context, metaClient));
