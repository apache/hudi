...
public class HoodieSparkWriteableTestTable extends HoodieWriteableTestTable {
    ...
    private HoodieSparkWriteableTestTable(
            String basePath,
    ...
    public static HoodieSparkWriteableTestTable of(
    ...
    public static HoodieSparkWriteableTestTable of(
            ...
            BloomFilter filter,
            Option<HoodieEngineContext> context) {
        return new HoodieSparkWriteableTestTable(
    ...
    public static HoodieSparkWriteableTestTable of(
            HoodieTableMetaClient metaClient, Schema schema, HoodieTableMetadataWriter metadataWriter) {
    ...
    public static HoodieSparkWriteableTestTable of(
        ...
        BloomFilter filter =
                BloomFilterFactory.createBloomFilter(
                        10000, 0.0000001, -1, BloomFilterTypeCode.DYNAMIC_V0.name());
    ...
    public static HoodieSparkWriteableTestTable of(
            HoodieTable hoodieTable, Schema schema, BloomFilter filter) {
        HoodieTableMetaClient metaClient = hoodieTable.getMetaClient();
        return of(metaClient, schema, filter);
    }
    ...
    public String getFileIdWithInserts(String partition, List<HoodieRecord> records)
            throws Exception {
    ...
    public HoodieSparkWriteableTestTable withInserts(String partition, String fileId)
            throws Exception {
        return withInserts(partition, fileId, new HoodieRecord[0]);
    }

    public HoodieSparkWriteableTestTable withInserts(
            String partition, String fileId, HoodieRecord... records) throws Exception {
    ...
    public HoodieSparkWriteableTestTable withLogAppends(
            String partition, String fileId, HoodieRecord... records) throws Exception {
        withLogAppends(partition, fileId, Arrays.asList(records));
        return this;
    }

    public Map<String, List<HoodieLogFile>> withLogAppends(
            String partition, String fileId, List<HoodieRecord> records) throws Exception {
