...
public class TestDirectWriteMarkers extends TestWriteMarkersBase {
  ...
  public void setup() throws IOException {
    ...
    this.markerFolderLocation = new StoragePath(Paths.get(metaClient.getMarkerFolderPath("000")).toUri());
  ...
  void verifyMarkersInFileSystem(boolean isTablePartitioned) throws IOException {
    List<StoragePathInfo> markerFiles = FileSystemTestUtils.listRecursive(storage, markerFolderLocation)
