...
public class TestHBasePutBatchSizeCalculator {
    ...
    public void testPutBatchSizeCalculation() {
        SparkHoodieHBaseIndex.HBasePutBatchSizeCalculator batchSizeCalculator =
                new SparkHoodieHBaseIndex.HBasePutBatchSizeCalculator();
        ...
        // Total puts per batch will be (16,667 / parallelism) = 83.335, where 200 is the
        // maxExecutors
        assertEquals(putBatchSize, 84);

        // Number of Region Servers are halved, total requests sent in a second are also halved, so
        // batchSize is also halved
