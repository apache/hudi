 ...
 */
public class BootstrapRecordWriter extends BoundedInMemoryQueueConsumer<HoodieRecord, Void> {

  private final HoodieBootstrapHandle bootstrapHandle;

  public BootstrapRecordWriter(HoodieBootstrapHandle bootstrapHandle) {
