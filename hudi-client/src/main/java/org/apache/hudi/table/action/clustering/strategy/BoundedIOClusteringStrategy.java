 ...
 */
public class BoundedIOClusteringStrategy extends ClusteringStrategy {
  ...
  public List<HoodieClusteringOperation> orderAndFilter(HoodieWriteConfig writeConfig,
    ...
    // IO limit
    // Preserves the original ordering of clustering
    List<HoodieClusteringOperation> finalOperations = new ArrayList<>();
    long targetIORemaining = writeConfig.getTargetIOPerClusteringInMB();
    for (HoodieClusteringOperation op : operations) {
