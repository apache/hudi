...
public abstract class BaseRollbackActionExecutor extends BaseActionExecutor<HoodieRollbackMetadata> {
  ...
  protected void dropBootstrapIndexIfNeeded(HoodieInstant instantToRollback) {
    if (HoodieTimeline.compareTimestamps(instantToRollback.getTimestamp(), HoodieTimeline.EQUALS,
      ...
      LOG.info("Dropped bootstrap index as metadata bootstrap commit is getting rolled back !!");
    }
  }
}
