...
public class MetadataOnlyBootstrapSelector extends BootstrapPartitionSelector {

  public MetadataOnlyBootstrapSelector(HoodieWriteConfig bootstrapConfig) {
  ...
  public Map<BootstrapMode, List<Pair<String, List<String>>>> select(List<Pair<String, List<String>>> partitions) {
    return partitions.stream().map(p -> Pair.of(BootstrapMode.METADATA_ONLY_BOOTSTRAP, p))
