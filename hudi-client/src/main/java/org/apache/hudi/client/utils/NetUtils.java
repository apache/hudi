...
public class NetUtils {
   ...
   */
  private static final String WILDCARD_ADDRESS = new InetSocketAddress(0).getAddress()
      .getHostAddress();
  ...
  public static String unresolvedHostToNormalizedString(String host) {
    ...
    if (IPAddressUtil.isIPv6LiteralAddress(host)) {
      ...
      try {
        ...
        throw new HoodieException("The configured hostname is not valid", e);
      }
    }
   ...
   * We re-implement this here in order to reduce dependency on Guava. The Guava library has
