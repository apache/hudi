...
public class HoodieKeyAndBloomLookupHandle<T extends HoodieRecordPayload> extends HoodieReadHandle<T> {
  ...
  private static final Logger LOG = LogManager.getLogger(HoodieKeyAndBloomLookupHandle.class);
  ...
  public HoodieKeyAndBloomLookupHandle(HoodieWriteConfig config, HoodieTable<T> hoodieTable,
