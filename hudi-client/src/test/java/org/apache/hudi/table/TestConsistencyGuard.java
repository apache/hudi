...
public class TestConsistencyGuard extends HoodieClientTestHarness {
  ...
  public void testCheckPassingAppearAndDisAppear(String consistencyGuardType) throws Exception {
    FilesTestUtils.fakeDataFile(basePath, "partition/path", "000", "f1");
    FilesTestUtils.fakeDataFile(basePath, "partition/path", "000", "f2");
    FilesTestUtils.fakeDataFile(basePath, "partition/path", "000", "f3");
