...
public class SparkUpsertCommitActionExecutor<T extends HoodieRecordPayload> extends SparkCommitActionExecutor<T> {

  private JavaRDD<HoodieRecord<T>> inputRecordsRDD;

  public SparkUpsertCommitActionExecutor(HoodieEngineContext context,
  ...
  public HoodieWriteMetadata<JavaRDD<WriteStatus>> execute() {
    return SparkWriteHelper.newInstance().write(instantTime, inputRecordsRDD, (HoodieSparkEngineContext) context, table,
