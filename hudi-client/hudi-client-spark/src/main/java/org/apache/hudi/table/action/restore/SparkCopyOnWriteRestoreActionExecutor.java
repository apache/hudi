...
public class SparkCopyOnWriteRestoreActionExecutor<T extends HoodieRecordPayload> extends BaseRestoreActionExecutor<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>, JavaRDD<WriteStatus>, JavaPairRDD<HoodieKey, Option<Pair<String, String>>>> {

  public SparkCopyOnWriteRestoreActionExecutor(HoodieEngineContext context,
  ...
  @Override
  protected HoodieRollbackMetadata rollbackInstant(HoodieInstant rollbackInstant) {
