...
public class HoodieBloomIndexCheckFunction
  ...
  private final BaseHoodieTable hoodieTable;

  private final HoodieWriteConfig config;

  public HoodieBloomIndexCheckFunction(BaseHoodieTable hoodieTable, HoodieWriteConfig config) {
    this.hoodieTable = hoodieTable;
    this.config = config;
  }

  @Override
  public Iterator<List<HoodieKeyLookupHandle.KeyLookupResult>> call(Integer partition,
