...
/**
 * A spark implementation of {@link BaseCompactHelpers}.
 *
 * @param <T>
 */
public class SparkCompactHelpers<T extends HoodieRecordPayload> extends BaseCompactHelpers<T, JavaRDD<HoodieRecord<T>>,
  ...
  @Override
  public HoodieCommitMetadata createCompactionMetadata(BaseHoodieTable<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>,
