...
public class HoodieSparkGlobalSimpleIndex<T extends HoodieRecordPayload> extends HoodieSparkSimpleIndex<T> {
   ...
   * @param hoodieTable instance of {@link BaseHoodieTable} to use
   ...
   *
   * @param jsc         instance of {@link JavaSparkContext} to use
   * @param hoodieTable instance of {@link BaseHoodieTable} of interest
   ...
   */
  protected List<Pair<String, HoodieBaseFile>> getAllBaseFilesInTable(final JavaSparkContext jsc, final BaseHoodieTable hoodieTable) {
  ...
  protected JavaPairRDD<HoodieKey, HoodieRecordLocation> fetchRecordLocations(JavaSparkContext jsc, BaseHoodieTable hoodieTable, int parallelism, List<Pair<String, HoodieBaseFile>> baseFiles) {
