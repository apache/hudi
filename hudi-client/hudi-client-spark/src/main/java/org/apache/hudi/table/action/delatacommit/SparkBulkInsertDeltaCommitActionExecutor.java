...
public class SparkBulkInsertDeltaCommitActionExecutor<T extends HoodieRecordPayload>
    extends SparkDeltaCommitActionExecutor<T> {

  private final JavaRDD<HoodieRecord<T>> inputRecordsRDD;
  private final Option<UserDefinedBulkInsertPartitioner<JavaRDD<HoodieRecord<T>>>> bulkInsertPartitioner;

  public SparkBulkInsertDeltaCommitActionExecutor(HoodieSparkEngineContext context,
