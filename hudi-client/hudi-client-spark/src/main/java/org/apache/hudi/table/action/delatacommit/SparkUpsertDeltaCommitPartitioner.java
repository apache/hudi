 ...
 */
public class SparkUpsertDeltaCommitPartitioner<T extends HoodieRecordPayload> extends UpsertPartitioner<T> {

  SparkUpsertDeltaCommitPartitioner(BaseWorkloadProfile profile, HoodieSparkEngineContext context, BaseHoodieTable table,
