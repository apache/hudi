...
public class FunctionalTestHarness implements SparkProvider, DFSProvider, HoodieMetaClientProvider, HoodieWriteClientProvider {
  ...
  public HoodieSparkWriteClient getHoodieWriteClient(HoodieWriteConfig cfg) throws IOException {
    return new HoodieSparkWriteClient(context(), cfg, false, HoodieSparkTable.create(cfg, jsc.hadoopConfiguration()));
  }
  ...
  public synchronized void runBeforeEach() throws Exception {
    ...
    if (!initialized) {
      ...
      HoodieSparkReadClient.addHoodieSupport(sparkConf);
