...
public class TestFlinkSizeBasedClusteringPlanStrategy {
    ...
    @Mock HoodieFlinkCopyOnWriteTable table;
    @Mock HoodieFlinkEngineContext context;
    ...
    public void testBuildClusteringGroupsForPartitionOnlyOneFile() {
        ...
        PartitionAwareClusteringPlanStrategy strategyWithSortEnabled =
                new FlinkSizeBasedClusteringPlanStrategy(table, context, configWithSortEnabled);
        ...
        PartitionAwareClusteringPlanStrategy strategyWithSortDisabled =
                new FlinkSizeBasedClusteringPlanStrategy(table, context, configWithSortDisabled);
