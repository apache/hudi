...
/**
  * RowData implementation for Hoodie Row. It wraps an {@link RowData} and keeps meta columns
  * locally. But the {@link RowData} does include the meta columns as well just that {@link
  * HoodieRowDataWithMetaFields} will intercept queries for meta columns and serve from its copy
...
public class HoodieRowDataWithMetaFields extends AbstractHoodieRowData {
    ...
    public HoodieRowDataWithMetaFields(
            String commitTime,
