...
public class HoodieWriteResult implements Serializable {
    ...
    public HoodieWriteResult(List<WriteStatus> writeStatuses) {
        this(writeStatuses, Collections.emptyMap());
    }

    public HoodieWriteResult(List<WriteStatus> writeStatuses, Map<String, List<String>> partitionToReplaceFileIds) {
    ...
    public void setWriteStatuses(final List<WriteStatus> writeStatuses) {
        this.writeStatuses = writeStatuses;
    }
