...
public class FlinkSizeBasedClusteringPlanStrategyRecently<T>
    ...
    public FlinkSizeBasedClusteringPlanStrategyRecently(
        ...
        if (!table.getConfig().getTableType().equals(HoodieTableType.COPY_ON_WRITE)) {
            throw new UnsupportedOperationException(
                    "FlinkSizeBasedClusteringPlanStrategyRecently only support cow table for now.");
        }
    }
                            ...
                            try {
                                HoodieCommitMetadata metadata =
                                        HoodieCommitMetadata.fromBytes(
                                                cowCommitTimeline.getInstantDetails(instant).get(),
