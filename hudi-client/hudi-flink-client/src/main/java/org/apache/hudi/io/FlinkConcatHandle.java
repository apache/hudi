...
/**
  ...
  *
  * <p>The records iterator for super constructor is reset as empty thus the initialization for new
  * records does nothing. This handle keep the iterator for itself to override the write behavior.
  */
public class FlinkConcatHandle<T, I, K, O> extends FlinkMergeHandle<T, I, K, O> {
