...
public class FlinkDeleteDeltaCommitActionExecutor<T extends HoodieRecordPayload<T>>
    extends AbstractFlinkDeltaCommitActionExecutor<T> {

  private List<HoodieKey> keys;

  public FlinkDeleteDeltaCommitActionExecutor(HoodieFlinkEngineContext context,
