...
/**
  ...
  *
  * <p>For the first mini-batch, it initializes and sets up the next file path to write, then closes
  * the file writer. The subsequent mini-batches are appended to the same file through a different
  * append handle with same write file name.
  *
...
public class FlinkAppendHandle<T, I, K, O> extends HoodieAppendHandle<T, I, K, O>
    ...
    protected boolean isUpdateRecord(HoodieRecord<T> hoodieRecord) {
        ...
        // and operation HoodieCdcOperation.DELETE would be put into either an INSERT bucket or
        // UPDATE bucket.
