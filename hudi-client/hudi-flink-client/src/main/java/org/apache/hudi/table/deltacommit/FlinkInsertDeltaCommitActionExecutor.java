...
public class FlinkInsertDeltaCommitActionExecutor<T extends HoodieRecordPayload<T>>
    extends AbstractFlinkDeltaCommitActionExecutor<T> {

  private  List<HoodieRecord<T>> inputRecords;

  public FlinkInsertDeltaCommitActionExecutor(HoodieFlinkEngineContext context,
