...
public class FlinkRowMergeAndReplaceHandle<T, I, K, O>
  ...
  protected void makeOldAndNewFilePaths(String partitionPath, String oldFileName, String newFileName) {
    ...
    try {
      int rollNumber = 0;
      while (fs.exists(targetFilePath)) {
        Path oldPath = targetFilePath;
      ...
      throw new HoodieException("Checking existing path for merge and replace handle error: " + targetFilePath, e);
    }
  }
  ...
  public void finalizeWrite() {
    ...
    try {
      fs.rename(targetFilePath, oldFilePath);
    } catch (IOException e) {
