...
public class FlinkClientUtil {
    ...
    public static HoodieTableMetaClient createMetaClient(String basePath) {
        return HoodieTableMetaClient.builder()
                ...
                .setConf(HadoopFSUtils.getStorageConfWithCopy(FlinkClientUtil.getHadoopConf()))
                .build();
    }

    /**
      * Returns the hadoop configuration with possible hadoop conf paths. E.G. the configurations under
      * path $HADOOP_CONF_DIR and $HADOOP_HOME.
      */
