...
public class FlinkDeltaCommitHelper<T extends HoodieRecordPayload<T>> extends FlinkCommitHelper<T> {
  public FlinkDeltaCommitHelper(
      HoodieEngineContext context, HoodieWriteHandle<?, ?, ?, ?> writeHandle, HoodieWriteConfig config,
