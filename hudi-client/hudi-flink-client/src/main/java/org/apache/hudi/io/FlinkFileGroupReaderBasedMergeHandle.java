 ...
 *
 * @see FlinkFileGroupReaderBasedMergeAndReplaceHandle
 */
public class FlinkFileGroupReaderBasedMergeHandle<T, I, K, O>
   ...
   * <p>
   * todo: identify whether the rollover here is needed.
   */
  ...
  public void finalizeWrite() {
    ...
    for (StoragePath path : rolloverPaths) {
      try {
        storage.deleteFile(path);
        LOG.info("Delete the rollover data file: {} success!", path);
      } catch (IOException e) {
  ...
  public StoragePath getWritePath() {
    return !rolloverPaths.isEmpty() ? rolloverPaths.get(0) : newFilePath;
  }
}
