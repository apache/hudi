...
public class HoodieFlinkMergeOnReadTable<T> extends HoodieFlinkCopyOnWriteTable<T> {
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsert(
        ...
        ValidationUtils.checkArgument(
                writeHandle instanceof FlinkAppendHandle,
                "MOR write handle should always be a FlinkAppendHandle");
        FlinkAppendHandle<?, ?, ?, ?> appendHandle = (FlinkAppendHandle<?, ?, ?, ?>) writeHandle;
        return new FlinkUpsertDeltaCommitActionExecutor<>(
                        context, appendHandle, config, this, instantTime, hoodieRecords)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsertPrepped(
        ...
        ValidationUtils.checkArgument(
                ...
                "MOR write handle should always be a FlinkAppendHandle");
        FlinkAppendHandle<?, ?, ?, ?> appendHandle = (FlinkAppendHandle<?, ?, ?, ?>) writeHandle;
        return new FlinkUpsertPreppedDeltaCommitActionExecutor<>(
                        context, appendHandle, config, this, instantTime, preppedRecords)
                .execute();
    }
    ...
    @Override
    public Iterator<List<WriteStatus>> handleInsertsForLogCompaction(
            String instantTime,
