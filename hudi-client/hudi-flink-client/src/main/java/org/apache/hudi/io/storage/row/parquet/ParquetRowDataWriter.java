...
/**
  ...
  *
  * <p>Reference {@code org.apache.flink.formats.parquet.row.ParquetRowDataWriter} to support
  * timestamp of INT64 8 bytes and complex data types.
  */
public class ParquetRowDataWriter {
    ...
    public ParquetRowDataWriter(
            RecordConsumer recordConsumer, RowType rowType, GroupType schema, boolean utcTimestamp) {
    ...
    /**
      * TIMESTAMP_MILLIS and TIMESTAMP_MICROS is the deprecated ConvertedType of TIMESTAMP with the
      * MILLIS and MICROS precision respectively. See
    ...
    /**
      * Converts a {@code TimestampData} to its corresponding int64 value. This function only accepts
      * TimestampData of precision 3 or 6. Special attention will need to be given to a TimestampData
      * of precision = 6.
      *
      * <p>For example representing `1970-01-01T00:00:03.100001` of precision 6 will have:
      *
      * <ul>
      *   <li>millisecond = 3100
      *   <li>nanoOfMillisecond = 1000
      * </ul>
      *
      * As such, the int64 value will be:
      *
      * <p>millisecond * 1000 + nanoOfMillisecond / 1000
      *
    ...
    private long timestampToInt64(TimestampData timestampData, int precision) {
        if (precision == 3) {
            ...
            // using an else clause here as precision has been validated to be {3, 6} in the
            // constructor
    ...
    /**
      ...
      * https://github.com/apache/parquet-format/blob/master/LogicalTypes.md#timestamp
      *
      * <p>TODO: Leaving this here as there might be a requirement to support TIMESTAMP(9) in the
      * future
      */
    ...
    private Binary timestampToInt96(TimestampData timestampData) {
        ...
        if (utcTimestamp) {
            ...
            nanosOfDay =
                    (mills % MILLIS_IN_DAY) * NANOS_PER_MILLISECOND + timestampData.getNanoOfMillisecond();
        } else {
