...
public class FlinkDeleteHelper<R> extends
  ...
  public HoodieWriteMetadata<List<WriteStatus>> execute(String instantTime,
    ...
    try {
      ...
      List<HoodieRecord<EmptyHoodieRecordPayload>> taggedRecords = table.getIndex().tagLocation(HoodieListData.eager(dedupedRecords), context, table, Option.of(instantTime)).collectAsList();
