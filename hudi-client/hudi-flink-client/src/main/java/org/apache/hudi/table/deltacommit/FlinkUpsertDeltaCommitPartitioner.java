...
public class FlinkUpsertDeltaCommitPartitioner<T extends HoodieRecordPayload<T>> extends UpsertPartitioner {

  public FlinkUpsertDeltaCommitPartitioner(WorkloadProfile profile,
