...
/**
  * A {@code BulkInsertPartitioner} implementation for Metadata Table to improve performance of
  * initialization of metadata table partition when a very large number of records are inserted.
  *
