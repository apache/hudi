...
/**
  ...
  * size allowed per group. 2) Excludes files that are greater than 'small.file.limit' from
  * clustering plan.
  */
public class JavaSizeBasedClusteringPlanStrategy<T>
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(JavaSizeBasedClusteringPlanStrategy.class);

    public JavaSizeBasedClusteringPlanStrategy(
