...
public class JavaBulkInsertDeltaCommitActionExecutor<T> extends BaseJavaDeltaCommitActionExecutor<T> {

  private final List<HoodieRecord<T>> inputRecords;
  private final Option<BulkInsertPartitioner> bulkInsertPartitioner;

  public JavaBulkInsertDeltaCommitActionExecutor(HoodieJavaEngineContext context, HoodieWriteConfig config, HoodieTable table,
