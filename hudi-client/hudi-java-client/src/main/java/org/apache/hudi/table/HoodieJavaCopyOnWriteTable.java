...
public class HoodieJavaCopyOnWriteTable<T> extends HoodieJavaTable<T>
    ...
    protected HoodieJavaCopyOnWriteTable(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsert(
        ...
        return new JavaUpsertCommitActionExecutor<>(context, config, this, instantTime, records)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> insert(
            HoodieEngineContext context, String instantTime, List<HoodieRecord<T>> records) {
        return new JavaInsertCommitActionExecutor<>(context, config, this, instantTime, records)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> bulkInsert(
        ...
        return new JavaBulkInsertCommitActionExecutor(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> deletePrepped(
        ...
        return new JavaDeletePreppedCommitActionExecutor<>(
                        (HoodieJavaEngineContext) context, config, this, instantTime, preppedRecords)
                .execute();
    }

    @Override
    public HoodieWriteMetadata deletePartitions(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsertPrepped(
            HoodieEngineContext context, String instantTime, List<HoodieRecord<T>> preppedRecords) {
        return new JavaUpsertPreppedCommitActionExecutor<>(
                        (HoodieJavaEngineContext) context, config, this, instantTime, preppedRecords)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> insertPrepped(
            HoodieEngineContext context, String instantTime, List<HoodieRecord<T>> preppedRecords) {
        return new JavaInsertPreppedCommitActionExecutor<>(
                        (HoodieJavaEngineContext) context, config, this, instantTime, preppedRecords)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> insertOverwrite(
            HoodieEngineContext context, String instantTime, List<HoodieRecord<T>> records) {
        return new JavaInsertOverwriteCommitActionExecutor(context, config, this, instantTime, records)
                .execute();
    }
    ...
    public Option<HoodieCompactionPlan> scheduleCompaction(
        ...
        throw new HoodieNotSupportedException(
                "ScheduleCompaction is not supported on a CopyOnWrite table");
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> cluster(
        ...
        return new JavaExecuteClusteringCommitActionExecutor<>(
