...
/**
  ...
  * compactions, passes it through a CompactionFilter and executes all the compactions and writes a
  * new version of base files and make a normal commit.
  */
    ...
    public void preCompact(
        ...
        if (WriteOperationType.LOG_COMPACT.equals(operationType)) {
            throw new UnsupportedOperationException(
                    "Log compaction is not supported for this execution engine.");
        }
