...
public class HoodieJavaMergeOnReadTable<T> extends HoodieJavaCopyOnWriteTable<T> {
    protected HoodieJavaMergeOnReadTable(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsert(
            HoodieEngineContext context, String instantTime, List<HoodieRecord<T>> hoodieRecords) {
        return new JavaUpsertDeltaCommitActionExecutor<>(
                        (HoodieJavaEngineContext) context, config, this, instantTime, hoodieRecords)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> upsertPrepped(
        ...
        return new JavaUpsertPreppedDeltaCommitActionExecutor<>(
                        (HoodieJavaEngineContext) context, config, this, instantTime, preppedRecords)
                .execute();
    }
    ...
    public HoodieWriteMetadata<List<WriteStatus>> bulkInsertPrepped(
        ...
        return new JavaBulkInsertPreppedCommitActionExecutor(
    ...
    public Option<HoodieCompactionPlan> scheduleCompaction(
        ...
        ScheduleCompactionActionExecutor scheduleCompactionExecutor =
                new ScheduleCompactionActionExecutor(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> compact(
        ...
        RunCompactionActionExecutor compactionExecutor =
                new RunCompactionActionExecutor(
                        context,
                        config,
                        this,
    ...
    public Option<HoodieCompactionPlan> scheduleLogCompaction(
            HoodieEngineContext context, String instantTime, Option<Map<String, String>> extraMetadata) {
        ScheduleCompactionActionExecutor scheduleLogCompactionExecutor =
                new ScheduleCompactionActionExecutor(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> logCompact(
        ...
        RunCompactionActionExecutor logCompactionExecutor =
                new RunCompactionActionExecutor(
                        context,
                        config,
                        this,
