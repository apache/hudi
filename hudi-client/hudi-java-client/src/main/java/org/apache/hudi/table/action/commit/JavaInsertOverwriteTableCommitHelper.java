...
public class JavaInsertOverwriteTableCommitHelper<T extends HoodieRecordPayload<T>>
    extends JavaInsertOverwriteCommitHelper<T> {
  public JavaInsertOverwriteTableCommitHelper(
