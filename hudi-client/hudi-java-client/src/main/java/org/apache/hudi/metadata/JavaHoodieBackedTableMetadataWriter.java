...
public class JavaHoodieBackedTableMetadataWriter
    ...
    /**
      ...
      */
    protected JavaHoodieBackedTableMetadataWriter(
    ...
    protected void bulkCommit(
        ...
        commitInternal(
                ...
                true,
                Option.of(new JavaHoodieMetadataBulkInsertPartitioner()));
    }
    ...
    public void deletePartitions(String instantTime, List<MetadataPartitionType> partitions) {
        throw new HoodieNotSupportedException(
                "Dropping metadata index not supported for Java metadata table yet.");
    }
    ...
    protected HoodieData<HoodieRecord> getFunctionalIndexRecords(
            ...
            StorageConfiguration<?> storageConf) {
        throw new HoodieNotSupportedException(
                "Functional index not supported for Java metadata table writer yet.");
    }
    ...
    public HoodieData<HoodieRecord> getDeletedSecondaryRecordMapping(
            ...
            HoodieIndexDefinition indexDefinition) {
        throw new HoodieNotSupportedException(
                "Java metadata table writer does not support secondary index yet.");
    }
}
