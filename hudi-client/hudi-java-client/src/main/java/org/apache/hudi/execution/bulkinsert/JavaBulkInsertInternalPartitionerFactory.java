...
/**
  * A factory to generate built-in partitioner to repartition input records into at least expected
  * number of output spark partitions for bulk insert operation.
  */
