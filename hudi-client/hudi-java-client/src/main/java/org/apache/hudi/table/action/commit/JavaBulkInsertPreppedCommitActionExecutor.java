...
public class JavaBulkInsertPreppedCommitActionExecutor<T> extends BaseJavaCommitActionExecutor<T> {
    ...
    public JavaBulkInsertPreppedCommitActionExecutor(
    ...
    public HoodieWriteMetadata<List<WriteStatus>> execute() {
        try {
            return JavaBulkInsertHelper.newInstance()
                    .bulkInsert(
                            preppedInputRecord,
                            instantTime,
                            table,
