...
public class JavaErrorTableWriteStatusWriter extends HoodieBackedErrorTableWriter<List<WriteStatus>> {
  ...
  public static HoodieBackedErrorTableWriter create(Configuration conf, HoodieWriteConfig writeConfig, HoodieEngineContext context) {
    return new JavaErrorTableWriteStatusWriter(conf, writeConfig, context);
  }

  JavaErrorTableWriteStatusWriter(Configuration hadoopConf, HoodieWriteConfig writeConfig, HoodieEngineContext engineContext) {
