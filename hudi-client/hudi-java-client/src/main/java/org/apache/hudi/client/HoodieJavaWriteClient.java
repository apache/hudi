...
public class HoodieJavaWriteClient<T>
    ...
    public HoodieJavaWriteClient(HoodieEngineContext context, HoodieWriteConfig writeConfig) {
        ...
        this.tableServiceClient =
                new HoodieJavaTableServiceClient<>(context, writeConfig, getTimelineServer());
    }

    public HoodieJavaWriteClient(
    ...
    public List<WriteStatus> bulkInsert(
        ...
        HoodieWriteMetadata<List<WriteStatus>> result =
                table.bulkInsert(context, instantTime, records, userDefinedBulkInsertPartitioner);
        return postWrite(result, instantTime, table);
    }
    ...
    public void transitionInflight(String instantTime) {
        ...
        metaClient
                ...
                .transitionRequestedToInflight(
                        new HoodieInstant(
                                HoodieInstant.State.REQUESTED, metaClient.getCommitActionType(), instantTime),
                        Option.empty(),
    ...
    public List<WriteStatus> bulkInsertPreppedRecords(
        ...
        HoodieWriteMetadata<List<WriteStatus>> result =
                table.bulkInsertPrepped(context, instantTime, preppedRecords, bulkInsertPartitioner);
        return postWrite(result, instantTime, table);
    }
