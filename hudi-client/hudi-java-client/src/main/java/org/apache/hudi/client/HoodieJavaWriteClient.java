...
public class HoodieJavaWriteClient<T> extends
  ...
  public List<WriteStatus> upsert(List<HoodieRecord<T>> records,
    ...
    preWrite(instantTime, WriteOperationType.UPSERT, table.getMetaClient(), records);
  ...
  public List<WriteStatus> upsertPreppedRecords(List<HoodieRecord<T>> preppedRecords,
    ...
    table.validateUpsertSchema();
    preWrite(instantTime, WriteOperationType.UPSERT_PREPPED, table.getMetaClient(), preppedRecords);
  ...
  public List<WriteStatus> insert(List<HoodieRecord<T>> records, String instantTime) {
    ...
    table.validateUpsertSchema();
    preWrite(instantTime, WriteOperationType.INSERT, table.getMetaClient(), records);
  ...
  public List<WriteStatus> insertPreppedRecords(List<HoodieRecord<T>> preppedRecords,
    ...
    preWrite(instantTime, WriteOperationType.INSERT_PREPPED, table.getMetaClient(), preppedRecords);
  ...
  public List<WriteStatus> bulkInsert(List<HoodieRecord<T>> records,
    ...
    table.validateInsertSchema();
    preWrite(instantTime, WriteOperationType.BULK_INSERT, table.getMetaClient(), records);
  ...
  public List<WriteStatus> bulkInsertPreppedRecords(List<HoodieRecord<T>> preppedRecords,
    ...
    table.validateInsertSchema();
    preWrite(instantTime, WriteOperationType.BULK_INSERT_PREPPED, table.getMetaClient(), preppedRecords);
  ...
  public List<WriteStatus> deletePrepped(List<HoodieRecord<T>> preppedRecords, final String instantTime) {
    ...
    preWrite(instantTime, WriteOperationType.DELETE_PREPPED, table.getMetaClient(), preppedRecords);
