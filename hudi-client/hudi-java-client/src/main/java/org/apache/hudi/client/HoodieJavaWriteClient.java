...
public class HoodieJavaWriteClient<T> extends
  ...
  public List<WriteStatus> upsert(List<HoodieRecord<T>> records,
    ...
    preWrite(instantTime, WriteOperationType.UPSERT, table.getMetaClient(), HoodieListData.eager(records));
  ...
  public List<WriteStatus> insert(List<HoodieRecord<T>> records, String instantTime) {
    ...
    table.validateUpsertSchema();
    preWrite(instantTime, WriteOperationType.INSERT, table.getMetaClient(), HoodieListData.eager(records));
  ...
  public List<WriteStatus> insertPreppedRecords(List<HoodieRecord<T>> preppedRecords,
    ...
    preWrite(instantTime, WriteOperationType.INSERT_PREPPED, table.getMetaClient(), HoodieListData.eager(preppedRecords));
  ...
  public List<WriteStatus> bulkInsert(List<HoodieRecord<T>> records,
    ...
    table.validateInsertSchema();
    preWrite(instantTime, WriteOperationType.BULK_INSERT, table.getMetaClient(), HoodieListData.eager(records));
