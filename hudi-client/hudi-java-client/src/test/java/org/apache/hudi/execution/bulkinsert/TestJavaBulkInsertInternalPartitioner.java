...
public class TestJavaBulkInsertInternalPartitioner extends HoodieJavaClientTestHarness {
    ...
    public void testCustomColumnSortPartitioner(String sortColumnString) throws Exception {
        ...
        testBulkInsertInternalPartitioner(
                ...
                records,
                true,
                generatePartitionNumRecords(records),
                ...
                record ->
                        FlatLists.ofComparableArray(
                                HoodieAvroUtils.getRecordColumnValues(
                                        (HoodieAvroRecord) record, sortColumns, schema, false)));
    }

    private void verifyRecordAscendingOrder(
            List<HoodieRecord> records, Option<Comparator<HoodieRecord>> comparator) {
