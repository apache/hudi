...
public class LSMTimelineWriter {
  ...
  public void write(
    ...
    StoragePath fileLocation = new StoragePath(metaClient.getArchivePath(),
  ...
  private HoodieLSMTimelineManifest.LSMFileEntry getFileEntry(String fileName) throws IOException {
    long fileLen = metaClient.getHoodieStorage().getPathInfo(
  ...
  private HoodieFileWriter openWriter(StoragePath fileLocation) {
    try {
