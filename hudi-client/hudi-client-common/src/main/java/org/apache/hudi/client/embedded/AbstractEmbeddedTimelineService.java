 ...
 */
public abstract class AbstractEmbeddedTimelineService {
  private static final Logger LOG = LogManager.getLogger(AbstractEmbeddedTimelineService.class);
  ...
  protected transient TimelineService server;

  public AbstractEmbeddedTimelineService(HoodieEngineContext context, FileSystemViewStorageConfig config) {
