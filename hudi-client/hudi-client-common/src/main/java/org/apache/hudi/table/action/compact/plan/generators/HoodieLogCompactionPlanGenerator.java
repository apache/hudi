...
public class HoodieLogCompactionPlanGenerator<T extends HoodieRecordPayload, I, K, O>
    ...
    @Override
    protected HoodieCompactionPlan getCompactionPlan(
            HoodieTableMetaClient metaClient, List<HoodieCompactionOperation> operations) {
    ...
    @Override
    protected boolean filterFileSlice(
            FileSlice fileSlice,
        ...
        return isFileSliceEligibleForLogCompaction(fileSlice, lastCompletedInstantTime, instantRange)
                && super.filterFileSlice(
                        fileSlice, lastCompletedInstantTime, pendingFileGroupIds, instantRange);
    }
    ...
    /**
      * Can schedule logcompaction if log files count is greater than 4 or total log blocks is greater
      * than 4.
      *
    ...
    private boolean isFileSliceEligibleForLogCompaction(
        ...
        LOG.info(
                "Total blocks seen are "
                        + totalBlocks
                        + ", log blocks threshold is "
