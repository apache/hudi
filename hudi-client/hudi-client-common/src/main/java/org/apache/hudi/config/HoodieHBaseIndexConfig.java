...
public class HoodieHBaseIndexConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> ZKQUORUM =
            ConfigProperty.key("hoodie.index.hbase.zkquorum")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> ZKPORT =
            ConfigProperty.key("hoodie.index.hbase.zkport")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> TABLENAME =
            ConfigProperty.key("hoodie.index.hbase.table")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "Only applies if index type is HBASE. HBase Table name to use as the index. "
    ...
    public static final ConfigProperty<Integer> GET_BATCH_SIZE =
            ConfigProperty.key("hoodie.index.hbase.get.batch.size")
                    .defaultValue(100)
                    .markAdvanced()
                    .withDocumentation(
                            "Controls the batch size for performing gets against HBase. "
                                    + "Batching improves throughput, by saving round trips.");

    public static final ConfigProperty<String> ZK_NODE_PATH =
            ConfigProperty.key("hoodie.index.hbase.zknode.path")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "Only applies if index type is HBASE. This is the root znode that will contain "
                                    + "all the znodes created/used by HBase");

    public static final ConfigProperty<Integer> PUT_BATCH_SIZE =
            ConfigProperty.key("hoodie.index.hbase.put.batch.size")
                    .defaultValue(100)
                    .markAdvanced()
                    .withDocumentation(
                            "Controls the batch size for performing puts against HBase. "
                                    + "Batching improves throughput, by saving round trips.");

    public static final ConfigProperty<String> QPS_ALLOCATOR_CLASS_NAME =
            ConfigProperty.key("hoodie.index.hbase.qps.allocator.class")
                    .defaultValue(DefaultHBaseQPSResourceAllocator.class.getName())
                    .markAdvanced()
                    .withDocumentation(
                            "Property to set which implementation of HBase QPS resource allocator to be used, which"
                                    + "controls the batching rate dynamically.");

    public static final ConfigProperty<Boolean> PUT_BATCH_SIZE_AUTO_COMPUTE =
            ConfigProperty.key("hoodie.index.hbase.put.batch.size.autocompute")
                    .defaultValue(false)
                    .markAdvanced()
    ...
    public static final ConfigProperty<Float> QPS_FRACTION =
            ConfigProperty.key("hoodie.index.hbase.qps.fraction")
                    .defaultValue(0.5f)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Integer> MAX_QPS_PER_REGION_SERVER =
            ConfigProperty.key("hoodie.index.hbase.max.qps.per.region.server")
                    .defaultValue(1000)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Boolean> COMPUTE_QPS_DYNAMICALLY =
            ConfigProperty.key("hoodie.index.hbase.dynamic_qps")
                    .defaultValue(false)
                    .markAdvanced()
                    .withDocumentation(
                            "Property to decide if HBASE_QPS_FRACTION_PROP is dynamically calculated based on write volume.");

    public static final ConfigProperty<String> MIN_QPS_FRACTION =
            ConfigProperty.key("hoodie.index.hbase.min.qps.fraction")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "Minimum for HBASE_QPS_FRACTION_PROP to stabilize skewed write workloads");

    public static final ConfigProperty<String> MAX_QPS_FRACTION =
            ConfigProperty.key("hoodie.index.hbase.max.qps.fraction")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "Maximum for HBASE_QPS_FRACTION_PROP to stabilize skewed write workloads");

    public static final ConfigProperty<Integer> DESIRED_PUTS_TIME_IN_SECONDS =
            ConfigProperty.key("hoodie.index.hbase.desired_puts_time_in_secs")
                    .defaultValue(600)
                    .markAdvanced()
                    .withDocumentation("");

    public static final ConfigProperty<String> SLEEP_MS_FOR_PUT_BATCH =
            ConfigProperty.key("hoodie.index.hbase.sleep.ms.for.put.batch")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation("");

    public static final ConfigProperty<String> SLEEP_MS_FOR_GET_BATCH =
            ConfigProperty.key("hoodie.index.hbase.sleep.ms.for.get.batch")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation("");

    public static final ConfigProperty<Integer> ZK_SESSION_TIMEOUT_MS =
            ConfigProperty.key("hoodie.index.hbase.zk.session_timeout_ms")
                    .defaultValue(60 * 1000)
                    .markAdvanced()
                    .withDocumentation(
                            "Session timeout value to use for Zookeeper failure detection, for the HBase client."
    ...
    public static final ConfigProperty<Integer> ZK_CONNECTION_TIMEOUT_MS =
            ConfigProperty.key("hoodie.index.hbase.zk.connection_timeout_ms")
                    ...
                    .markAdvanced()
                    .withDocumentation(
                            "Timeout to use for establishing connection with zookeeper, from HBase client.");

    public static final ConfigProperty<String> ZKPATH_QPS_ROOT =
            ConfigProperty.key("hoodie.index.hbase.zkpath.qps_root")
    ...
    public static final ConfigProperty<Boolean> UPDATE_PARTITION_PATH_ENABLE =
            ConfigProperty.key("hoodie.hbase.index.update.partition.path")
                    .defaultValue(false)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Boolean> ROLLBACK_SYNC_ENABLE =
            ConfigProperty.key("hoodie.index.hbase.rollback.sync")
                    .defaultValue(false)
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> SECURITY_AUTHENTICATION =
            ConfigProperty.key("hoodie.index.hbase.security.authentication")
                    .defaultValue("simple")
                    .markAdvanced()
                    .withDocumentation(
                            "Property to decide if the hbase cluster secure authentication is enabled or not. "
                                    + "Possible values are 'simple' (no authentication), and 'kerberos'.");

    public static final ConfigProperty<String> KERBEROS_USER_KEYTAB =
            ConfigProperty.key("hoodie.index.hbase.kerberos.user.keytab")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "File name of the kerberos keytab file for connecting to the hbase cluster.");

    public static final ConfigProperty<String> KERBEROS_USER_PRINCIPAL =
            ConfigProperty.key("hoodie.index.hbase.kerberos.user.principal")
                    .noDefaultValue()
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> REGIONSERVER_PRINCIPAL =
            ConfigProperty.key("hoodie.index.hbase.regionserver.kerberos.principal")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation(
                            "The value of hbase.regionserver.kerberos.principal in hbase cluster.");

    public static final ConfigProperty<String> MASTER_PRINCIPAL =
            ConfigProperty.key("hoodie.index.hbase.master.kerberos.principal")
                    .noDefaultValue()
                    .markAdvanced()
    ...
    public static final ConfigProperty<Integer> BUCKET_NUMBER =
            ConfigProperty.key("hoodie.index.hbase.bucket.number")
                    .defaultValue(8)
                    .markAdvanced()
                    .withDocumentation(
                            "Only applicable when using RebalancedSparkHoodieHBaseIndex, same as hbase regions count can get the best performance");
    ...
    @Deprecated public static final String HBASE_ZK_ZNODEPARENT = ZK_NODE_PATH.key();
    ...
    public static final String DEFAULT_HBASE_INDEX_QPS_ALLOCATOR_CLASS =
            QPS_ALLOCATOR_CLASS_NAME.defaultValue();
    ...
    public static final String HBASE_PUT_BATCH_SIZE_AUTO_COMPUTE_PROP =
            PUT_BATCH_SIZE_AUTO_COMPUTE.key();
    /** @deprecated Use {@link #PUT_BATCH_SIZE_AUTO_COMPUTE} and its methods instead */
    @Deprecated
    public static final Boolean DEFAULT_HBASE_PUT_BATCH_SIZE_AUTO_COMPUTE =
            PUT_BATCH_SIZE_AUTO_COMPUTE.defaultValue();
    /** @deprecated Use {@link #MAX_QPS_FRACTION} and its methods instead */
    @Deprecated public static final String HBASE_QPS_FRACTION_PROP = QPS_FRACTION.key();
    ...
    @Deprecated public static final int DEFAULT_HBASE_BATCH_SIZE = 100;
    /** @deprecated Use {@link #MAX_QPS_PER_REGION_SERVER} and its methods instead */
    @Deprecated
    public static final int DEFAULT_HBASE_MAX_QPS_PER_REGION_SERVER =
            MAX_QPS_PER_REGION_SERVER.defaultValue();
    /** @deprecated Use {@link #QPS_FRACTION} and its methods instead */
    @Deprecated public static final float DEFAULT_HBASE_QPS_FRACTION = QPS_FRACTION.defaultValue();
    ...
    public static final boolean DEFAULT_HOODIE_INDEX_COMPUTE_QPS_DYNAMICALLY =
            COMPUTE_QPS_DYNAMICALLY.defaultValue();
    /** @deprecated Use {@link #MIN_QPS_FRACTION} and its methods instead */
    @Deprecated public static final String HBASE_MIN_QPS_FRACTION_PROP = MIN_QPS_FRACTION.key();
    /** @deprecated Use {@link #MAX_QPS_FRACTION} and its methods instead */
    @Deprecated public static final String HBASE_MAX_QPS_FRACTION_PROP = MAX_QPS_FRACTION.key();
    ...
    public static final String HOODIE_INDEX_DESIRED_PUTS_TIME_IN_SECS =
            DESIRED_PUTS_TIME_IN_SECONDS.key();
    /** @deprecated Use {@link #DESIRED_PUTS_TIME_IN_SECONDS} and its methods instead */
    @Deprecated
    public static final int DEFAULT_HOODIE_INDEX_DESIRED_PUTS_TIME_IN_SECS =
            DESIRED_PUTS_TIME_IN_SECONDS.defaultValue();
    ...
    public static final String HOODIE_INDEX_HBASE_ZK_CONNECTION_TIMEOUT_MS =
            ZK_CONNECTION_TIMEOUT_MS.key();
    /** @deprecated Use {@link #ZK_CONNECTION_TIMEOUT_MS} and its methods instead */
    @Deprecated
    public static final int DEFAULT_ZK_CONNECTION_TIMEOUT_MS =
            ZK_CONNECTION_TIMEOUT_MS.defaultValue();
    /** @deprecated Use {@link #ZKPATH_QPS_ROOT} and its methods instead */
    @Deprecated public static final String HBASE_ZK_PATH_QPS_ROOT = ZKPATH_QPS_ROOT.key();
    /** @deprecated Use {@link #ZKPATH_QPS_ROOT} and its methods instead */
    @Deprecated
    ...
    public static final Boolean DEFAULT_HBASE_INDEX_UPDATE_PARTITION_PATH =
            UPDATE_PARTITION_PATH_ENABLE.defaultValue();
    /** @deprecated Use {@link #ROLLBACK_SYNC_ENABLE} and its methods instead */
    @Deprecated public static final String HBASE_INDEX_ROLLBACK_SYNC = ROLLBACK_SYNC_ENABLE.key();
    /** @deprecated Use {@link #ROLLBACK_SYNC_ENABLE} and its methods instead */
    @Deprecated
    public static final Boolean DEFAULT_HBASE_INDEX_ROLLBACK_SYNC =
            ROLLBACK_SYNC_ENABLE.defaultValue();
    ...
    public static class Builder {
        ...
        public Builder hbaseIndexPutBatchSizeAutoCompute(boolean putBatchSizeAutoCompute) {
            hBaseIndexConfig.setValue(
                    PUT_BATCH_SIZE_AUTO_COMPUTE, String.valueOf(putBatchSizeAutoCompute));
            return this;
        }
        ...
        public Builder hbaseIndexShouldComputeQPSDynamically(boolean shouldComputeQPsDynamically) {
            hBaseIndexConfig.setValue(
                    COMPUTE_QPS_DYNAMICALLY, String.valueOf(shouldComputeQPsDynamically));
            return this;
        }
        ...
        /**
          * Method to set maximum QPS allowed per Region Server. This should be same across various jobs.
          * This is intended to limit the aggregate QPS generated across various jobs to an HBase Region
          * Server.
          *
          * <p>It is recommended to set this value based on your global indexing throughput needs and
          * most importantly, how much your HBase installation is able to tolerate without Region Servers
          * going down.
          */
        public HoodieHBaseIndexConfig.Builder hbaseIndexMaxQPSPerRegionServer(
            ...
            hBaseIndexConfig.setValue(
                    HoodieHBaseIndexConfig.MAX_QPS_PER_REGION_SERVER, String.valueOf(maxQPSPerRegionServer));
            return this;
        }
