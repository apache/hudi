 ...
 */
public abstract class UserDefinedBulkInsertPartitioner<I> implements BulkInsertPartitioner<I> {

  public HoodieWriteConfig config;

  public UserDefinedBulkInsertPartitioner(HoodieWriteConfig config) {
    this.config = config;
  }
}
