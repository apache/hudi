...
@ConfigClassProperty(
        name = "Payload Configurations",
        groupName = ConfigGroups.Names.RECORD_PAYLOAD,
        description =
                "Payload related configs, that can be leveraged to "
...
public class HoodiePayloadConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> EVENT_TIME_FIELD =
            ConfigProperty.key(PAYLOAD_EVENT_TIME_FIELD_PROP_KEY)
                    .defaultValue("ts")
                    .markAdvanced()
                    .withDocumentation(
                            "Table column/field name to derive timestamp associated with the records. This can"
    ...
    public static final ConfigProperty<String> PAYLOAD_CLASS_NAME =
            ConfigProperty.key("hoodie.compaction.payload.class")
                    ...
                    .markAdvanced()
                    .withDocumentation(
                            "This needs to be same as class used during insert/upserts. Just like writing, compaction also uses "
    ...
    @Deprecated
    public static final ConfigProperty<String> ORDERING_FIELD =
            ConfigProperty.key(PAYLOAD_ORDERING_FIELD_PROP_KEY)
                    .defaultValue("ts")
                    .markAdvanced()
                    .withDocumentation(
                            "Table column/field name to order records that have the same key, before "
    ...
    /** @deprecated Use {@link #PAYLOAD_CLASS_NAME} and its methods instead */
    @Deprecated public static final String PAYLOAD_CLASS_PROP = PAYLOAD_CLASS_NAME.key();
