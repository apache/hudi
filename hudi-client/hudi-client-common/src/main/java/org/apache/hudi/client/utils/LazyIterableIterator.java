...
/**
  ...
  *
  * <p>Provide a way to obtain a inputItr of type O (output), out of an inputItr of type I (input)
  *
  * <p>Things to remember: - Assumes Spark calls hasNext() to check for elements, before calling
  * next() to obtain them - Assumes hasNext() gets called atleast once. - Concrete Implementation is
