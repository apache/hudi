...
public class LogCompactionExecutionHelper<T extends HoodieRecordPayload, I, K, O>
    ...
    protected String instantTimeToUseForScanning(
            String logCompactionInstantTime, String maxInstantTime) {
    ...
    @Override
    protected Iterator<List<WriteStatus>> writeFileAndGetWriteStats(
        ...
        header.put(
                HoodieLogBlock.HeaderMetadataType.COMPACTED_BLOCK_TIMES,
                StringUtils.join(scanner.getValidBlockInstants(), ","));
        // Compacting is very similar to applying updates to existing file
        return compactionHandler.handleInsertsForLogCompaction(
                instantTime,
