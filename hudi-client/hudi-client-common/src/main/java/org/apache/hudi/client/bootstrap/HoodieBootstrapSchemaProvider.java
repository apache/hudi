...
/**
  * Bootstrap Schema Provider. Schema provided in config is used. If not available, use schema from
  * Parquet
  */
public abstract class HoodieBootstrapSchemaProvider {
    ...
    /**
      ...
      * @return Avro Schema
      */
    public final Schema getBootstrapSchema(
    ...
    /**
      * Select a random file to be used to generate avro schema. Override this method to get custom
      * schema selection.
      *
      * @param context HoodieEngineContext
      * @param partitions List of partitions with files within them
      * @return Avro Schema
      */
    protected abstract Schema getBootstrapSourceSchema(
            HoodieEngineContext context, List<Pair<String, List<HoodieFileStatus>>> partitions);
}
