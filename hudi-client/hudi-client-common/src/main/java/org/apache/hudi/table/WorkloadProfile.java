...
/**
  ...
  *
  * <p>TODO(vc): Think about obtaining this directly from index.tagLocation
  */
public class WorkloadProfile implements Serializable {
    ...
    public WorkloadProfile(
            Pair<HashMap<String, WorkloadStat>, WorkloadStat> profile, boolean hasOutputWorkLoadStats) {
    ...
    public WorkloadProfile(
            Pair<HashMap<String, WorkloadStat>, WorkloadStat> profile,
    ...
    public Set<String> getOutputPartitionPaths() {
        return hasOutputWorkLoadStats
                ? outputPartitionPathStatMap.keySet()
                : inputPartitionPathStatMap.keySet();
    }
    ...
    public WorkloadStat getOutputWorkloadStat(String partitionPath) {
        return hasOutputWorkLoadStats
                ? outputPartitionPathStatMap.get(partitionPath)
                : inputPartitionPathStatMap.get(partitionPath);
    }
