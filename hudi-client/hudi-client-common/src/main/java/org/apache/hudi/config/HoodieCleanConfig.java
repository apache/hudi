...
public class HoodieCleanConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> AUTO_CLEAN =
            ConfigProperty.key("hoodie.clean.automatic")
                    .defaultValue("true")
                    .markAdvanced()
                    .withDocumentation(
                            "When enabled, the cleaner table service is invoked immediately after each commit, "
    ...
    public static final ConfigProperty<String> ASYNC_CLEAN =
            ConfigProperty.key("hoodie.clean.async.enabled")
                    .defaultValue("false")
    ...
    public static final ConfigProperty<String> CLEANER_POLICY =
            ConfigProperty.key("hoodie.clean.policy")
                    .defaultValue(KEEP_LATEST_COMMITS.name())
                    .withAlternatives("hoodie.cleaner.policy")
                    ...
                    .withInferFunction(
                            cfg -> {
                                ...
                                // If the cleaner policy is not configured, the cleaner policy is
                                // inferred only when one
                                // of the following configs are explicitly configured by the user:
                                // "hoodie.clean.commits.retained" (inferred as KEEP_LATEST_COMMITS)
                                // "hoodie.clean.hours.retained" (inferred as KEEP_LATEST_BY_HOURS)
                                // "hoodie.clean.fileversions.retained" (inferred as
                                // KEEP_LATEST_FILE_VERSIONS)
                                if (isCommitsRetainedConfigured
                                        && !isHoursRetainedConfigured
    ...
    public static final ConfigProperty<String> CLEANER_COMMITS_RETAINED =
            ConfigProperty.key(CLEANER_COMMITS_RETAINED_KEY)
                    .defaultValue("10")
                    .withDocumentation(
                            "When "
                                    + KEEP_LATEST_COMMITS.name()
    ...
    public static final ConfigProperty<String> CLEANER_HOURS_RETAINED =
            ConfigProperty.key(CLEANER_HOURS_RETAINED_KEY)
                    .defaultValue("24")
                    .markAdvanced()
                    .withDocumentation(
                            "When "
                                    + KEEP_LATEST_BY_HOURS.name()
                                    + " cleaning policy is used, the number of hours for which commits need to be retained. "
    ...
    public static final ConfigProperty<String> CLEANER_FILE_VERSIONS_RETAINED =
            ConfigProperty.key(CLEANER_FILE_VERSIONS_RETAINED_KEY)
                    ...
                    .withDocumentation(
                            "When "
                                    + KEEP_LATEST_FILE_VERSIONS.name()
                                    + " cleaning policy is used, "
    ...
    public static final ConfigProperty<String> CLEAN_TRIGGER_STRATEGY =
            ConfigProperty.key("hoodie.clean.trigger.strategy")
    ...
    public static final ConfigProperty<String> CLEAN_MAX_COMMITS =
            ConfigProperty.key("hoodie.clean.trigger.max.commits")
                    .defaultValue("1")
    ...
    public static final ConfigProperty<String> CLEANER_INCREMENTAL_MODE_ENABLE =
            ConfigProperty.key("hoodie.clean.incremental.enabled")
                    .defaultValue("true")
                    .withAlternatives("hoodie.cleaner.incremental.mode")
                    .markAdvanced()
                    .withDocumentation(
                            "When enabled, the plans for each cleaner service run is computed incrementally off the events "
    ...
    public static final ConfigProperty<String> FAILED_WRITES_CLEANER_POLICY =
            ConfigProperty.key("hoodie.clean.failed.writes.policy")
    ...
    public static final ConfigProperty<String> CLEANER_PARALLELISM_VALUE =
            ConfigProperty.key("hoodie.clean.parallelism")
                    .defaultValue("200")
                    .withAlternatives("hoodie.cleaner.parallelism")
                    .markAdvanced()
                    .withDocumentation(
                            "This config controls the behavior of both the cleaning plan and "
    ...
    public static final ConfigProperty<Boolean> ALLOW_MULTIPLE_CLEANS =
            ConfigProperty.key("hoodie.clean.multiple.enabled")
                    .defaultValue(false)
                    ...
                    .withDocumentation(
                            "Allows scheduling/executing multiple cleans by enabling this config. If users prefer to strictly ensure clean requests should be mutually exclusive, "
    ...
    public static final ConfigProperty<String> CLEANER_BOOTSTRAP_BASE_FILE_ENABLE =
            ConfigProperty.key("hoodie.clean.delete.bootstrap.base.file")
                    .defaultValue("false")
                    .withAlternatives("hoodie.cleaner.delete.bootstrap.base.file")
                    .markAdvanced()
                    .withDocumentation(
                            "When set to true, cleaner also deletes the bootstrap base file when it's skeleton base file is "
    ...
    @Deprecated public static final String CLEANER_POLICY_PROP = CLEANER_POLICY.key();
    /** @deprecated Use {@link #AUTO_CLEAN} and its methods instead */
    @Deprecated public static final String AUTO_CLEAN_PROP = AUTO_CLEAN.key();
    /** @deprecated Use {@link #ASYNC_CLEAN} and its methods instead */
    @Deprecated public static final String ASYNC_CLEAN_PROP = ASYNC_CLEAN.key();
    ...
    public static final String CLEANER_BOOTSTRAP_BASE_FILE_ENABLED =
            CLEANER_BOOTSTRAP_BASE_FILE_ENABLE.key();
    /** @deprecated Use {@link #CLEANER_PARALLELISM_VALUE} and its methods instead */
    @Deprecated public static final String CLEANER_PARALLELISM = CLEANER_PARALLELISM_VALUE.key();
    /** @deprecated Use {@link #CLEANER_PARALLELISM_VALUE} and its methods instead */
    @Deprecated
    public static final String DEFAULT_CLEANER_PARALLELISM = CLEANER_PARALLELISM_VALUE.defaultValue();
    /** @deprecated Use {@link #CLEANER_POLICY} and its methods instead */
    @Deprecated private static final String DEFAULT_CLEANER_POLICY = CLEANER_POLICY.defaultValue();
    ...
    private static final String DEFAULT_FAILED_WRITES_CLEANER_POLICY =
            FAILED_WRITES_CLEANER_POLICY.defaultValue();
    /** @deprecated Use {@link #AUTO_CLEAN} and its methods instead */
    @Deprecated private static final String DEFAULT_AUTO_CLEAN = AUTO_CLEAN.defaultValue();
    /** @deprecated Use {@link #ASYNC_CLEAN} and its methods instead */
    @Deprecated private static final String DEFAULT_ASYNC_CLEAN = ASYNC_CLEAN.defaultValue();
    /** @deprecated Use {@link #CLEANER_INCREMENTAL_MODE_ENABLE} and its methods instead */
    @Deprecated
    private static final String DEFAULT_INCREMENTAL_CLEANER =
            CLEANER_INCREMENTAL_MODE_ENABLE.defaultValue();
    /** @deprecated Use {@link #CLEANER_FILE_VERSIONS_RETAINED} and its methods instead */
    @Deprecated
    private static final String DEFAULT_CLEANER_FILE_VERSIONS_RETAINED =
            CLEANER_FILE_VERSIONS_RETAINED.defaultValue();
    /** @deprecated Use {@link #CLEANER_COMMITS_RETAINED} and its methods instead */
    @Deprecated
    private static final String DEFAULT_CLEANER_COMMITS_RETAINED =
            CLEANER_COMMITS_RETAINED.defaultValue();
    /** @deprecated Use {@link #CLEANER_BOOTSTRAP_BASE_FILE_ENABLE} and its methods instead */
    @Deprecated
    private static final String DEFAULT_CLEANER_BOOTSTRAP_BASE_FILE_ENABLED =
            CLEANER_BOOTSTRAP_BASE_FILE_ENABLE.defaultValue();
    ...
    public static class Builder {
        ...
        public HoodieCleanConfig.Builder withIncrementalCleaningMode(Boolean incrementalCleaningMode) {
            cleanConfig.setValue(
                    CLEANER_INCREMENTAL_MODE_ENABLE, String.valueOf(incrementalCleaningMode));
            return this;
        }
        ...
        public HoodieCleanConfig.Builder withCleanBootstrapBaseFileEnabled(
                Boolean cleanBootstrapSourceFileEnabled) {
            cleanConfig.setValue(
                    CLEANER_BOOTSTRAP_BASE_FILE_ENABLE, String.valueOf(cleanBootstrapSourceFileEnabled));
            return this;
        }

        public HoodieCleanConfig.Builder withFailedWritesCleaningPolicy(
