...
public class HoodieSortMergeJoinMergeHandleWithChangeLog<T, I, K, O> extends HoodieSortMergeJoinMergeHandle<T, I, K, O> {
  ...
  public HoodieSortMergeJoinMergeHandleWithChangeLog(HoodieWriteConfig config, String instantTime, HoodieTable hoodieTable, Iterator recordItr,
                                                     String partitionPath, String fileId, HoodieBaseFile baseFile,
                                                     TaskContextSupplier taskContextSupplier, Option keyGeneratorOpt) {
    super(config, instantTime, hoodieTable, recordItr, partitionPath, fileId, baseFile, taskContextSupplier, keyGeneratorOpt);
