...
public class TimelineServerBasedWriteMarkers extends WriteMarkers {
  ...
  protected Option<HoodieLocation> create(String partitionPath, String fileName, IOType type, boolean checkIfExists) {
    ...
    if (success) {
      return Option.of(new HoodieLocation(FSUtils.getPartitionPath(markerDirPath, partitionPath), markerFileName));
    } else {
      return Option.empty();
    }
  }
  ...
  @Override
  public Option<HoodieLocation> createWithEarlyConflictDetection(String partitionPath, String fileName, IOType type, boolean checkIfExists,
