...
public class ActiveActionWithDetails extends ActiveAction {
    ...
    public static ActiveActionWithDetails fromInstantAndDetails(
            List<Pair<HoodieInstant, Option<byte[]>>> instantAndDetails) {
        ...
        return new ActiveActionWithDetails(
                requested,
                requestedDetails,
                inflight,
                inflightDetails,
    ...
    public Option<byte[]> getLogCompactionPlan(HoodieTableMetaClient metaClient) {
        ValidationUtils.checkState(
                this.requestedDetails.isPresent(), "log compaction plan does not exist");
        return this.requestedDetails;
    }
}
