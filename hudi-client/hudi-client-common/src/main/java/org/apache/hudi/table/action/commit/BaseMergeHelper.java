...
public abstract class BaseMergeHelper {
   ...
   */
  public abstract void runMerge(HoodieTable<?, ?, ?, ?> table, HoodieMergeHandle<?, ?, ?, ?> upsertHandle,  Option<String[]> partitionFields, Object[] partitionValues) throws IOException;
