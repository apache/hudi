...
public abstract class BaseMergeHelper {
   ...
   */
  public abstract void runMerge(HoodieTable<?, ?, ?, ?> table, HoodieRowMergeHandle<?, ?, ?, ?> mergeHandle) throws IOException;
  ...
  protected static class UpdateHandler implements HoodieConsumer<HoodieRecord, Void> {
    ...
    private final HoodieRowMergeHandle mergeHandle;

    protected UpdateHandler(HoodieRowMergeHandle mergeHandle) {
