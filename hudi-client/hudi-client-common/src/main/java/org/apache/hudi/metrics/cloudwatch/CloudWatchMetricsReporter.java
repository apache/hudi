...
/**
  * Hudi Amazon CloudWatch metrics reporter. Responsible for reading Hoodie metrics configurations
  * and hooking up with {@link org.apache.hudi.metrics.Metrics}. Internally delegates reporting tasks
  * to {@link CloudWatchReporter}.
  */
public class CloudWatchMetricsReporter extends MetricsReporter {
    ...
    CloudWatchMetricsReporter(
            HoodieWriteConfig writeConfig, MetricRegistry registry, CloudWatchReporter reporter) {
    ...
    CloudWatchMetricsReporter(
            HoodieMetricsConfig metricsConfig, MetricRegistry registry, CloudWatchReporter reporter) {
        this.metricsConfig = metricsConfig;
        this.registry = registry;
