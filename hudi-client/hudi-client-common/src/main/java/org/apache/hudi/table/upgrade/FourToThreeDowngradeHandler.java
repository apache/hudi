...
/**
  * DowngradeHandler to assist in downgrading {@link org.apache.hudi.table.HoodieTable} from version
  * 4 to 3.
  */
public class FourToThreeDowngradeHandler implements DowngradeHandler {
    ...
    public Map<ConfigProperty, String> downgrade(
        ...
        if (config.isMetadataTableEnabled()) {
            ...
            // Hence, it is safe to delete the metadata table, which will be re-initialized in
            // subsequent commit.
