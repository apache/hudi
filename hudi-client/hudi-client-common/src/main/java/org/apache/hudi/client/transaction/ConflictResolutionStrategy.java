...
/**
  * Strategy interface for conflict resolution with multiple writers. Users can provide pluggable
  * implementations for different kinds of strategies to resolve conflicts when multiple writers are
  * mutating the hoodie table.
  */
public interface ConflictResolutionStrategy {
    ...
    /**
      * Write clients uses their preCommit API to run conflict resolution. This method determines
      * whether to execute preCommit for table services like clustering.
      *
      * @return boolean
      */
    @PublicAPIMethod(maturity = ApiMaturityLevel.EVOLVING)
