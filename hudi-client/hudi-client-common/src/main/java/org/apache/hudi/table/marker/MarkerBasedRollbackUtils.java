...
public class MarkerBasedRollbackUtils {
  ...
  public static List<String> getAllMarkerPaths(HoodieTable table, HoodieEngineContext context,
    ...
    Option<MarkerType> markerTypeOption = readMarkerType(
        table.getMetaClient().getHoodieStorage(), markerDir);
    ...
    if (!markerTypeOption.isPresent()) {
      ...
      try {
        ...
        return getTimelineServerBasedMarkers(context, parallelism, markerDir, table.getMetaClient().getHoodieStorage());
      }
    }
