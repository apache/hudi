...
public class SavepointHelpers {
  ...
  public static void deleteSavepoint(BaseHoodieTable table, String savepointTime) {
  ...
  public static void validateSavepointRestore(BaseHoodieTable table, String savepointTime) {
  ...
  public static void validateSavepointPresence(BaseHoodieTable table, String savepointTime) {
    HoodieInstant savePoint = new HoodieInstant(false, HoodieTimeline.SAVEPOINT_ACTION, savepointTime);
    boolean isSavepointPresent = table.getCompletedSavepointTimeline().containsInstant(savePoint);
    if (!isSavepointPresent) {
