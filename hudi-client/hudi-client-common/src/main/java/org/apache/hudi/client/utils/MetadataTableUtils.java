...
public class MetadataTableUtils {
    ...
    /**
      ...
      *
      * <p>Note that metadata table has to be enabled, and the storage type of the file system view
      * cannot be EMBEDDED_KV_STORE or SPILLABLE_DISK (these two types are not integrated with metadata
      * table, see HUDI-5612).
      *
      * @param config Write configs.
      * @return {@code true} if using batch lookup; {@code false} otherwise.
      */
    public static boolean shouldUseBatchLookup(
