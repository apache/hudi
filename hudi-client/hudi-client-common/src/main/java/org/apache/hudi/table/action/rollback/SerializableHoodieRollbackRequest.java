...
/**
  * HoodieRollbackRequest in HoodieRollbackPlan (avro pojo) is not operable directly within spark
  * parallel engine. Hence converting the same to this {@link SerializableHoodieRollbackRequest} and
  * then using it within spark.parallelize.
  */
