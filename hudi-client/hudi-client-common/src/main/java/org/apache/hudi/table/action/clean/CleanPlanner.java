        ...
        instant -> HoodieTimeline.compareTimestamps(instant.getTimestamp(), HoodieTimeline.GREATER_THAN_OR_EQUALS,
            ...
            HoodieTimeline.LESSER_THAN, newInstantToRetain.get().getTimestamp())).flatMap(instant -> {
              ...
              try {
                ...
                } else if (HoodieTimeline.COMMIT_ACTION.equals(action)) {
                ...
                } // MOR Deltacommits don't "leave behind" any older base files to clean since they only create log files to new/existing file slices
              } catch (IOException e) {
