...
public class HoodieExtensibleBucketLayout extends HoodieStorageLayout {
  ...
  public HoodieExtensibleBucketLayout(HoodieWriteConfig config) {
    super(config);
  }
  ...
  /**
   * Extensible bucket will tag all incoming records, so we could go ahead reusing an existing Partitioner
   */
  @Override
