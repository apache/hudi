...
public class HoodieMetrics {
  ...
  public HoodieMetrics(HoodieWriteConfig config, HoodieStorage storage) {
    ...
    if (config.isMetricsOn()) {
      ...
      this.rollbackTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.ROLLBACK_ACTION);
      this.cleanTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.CLEAN_ACTION);
      this.archiveTimerName = getMetricsName(TIMER_METRIC, ARCHIVE_ACTION);
      this.commitTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.COMMIT_ACTION);
      this.deltaCommitTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.DELTA_COMMIT_ACTION);
      this.clusterCommitTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.CLUSTERING_ACTION);
      this.finalizeTimerName = getMetricsName(TIMER_METRIC, FINALIZE_ACTION);
      this.compactionTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.COMPACTION_ACTION);
      this.logCompactionTimerName = getMetricsName(TIMER_METRIC, HoodieTimeline.LOG_COMPACTION_ACTION);
      this.indexTimerName = getMetricsName(TIMER_METRIC, INDEX_ACTION);
      this.sourceReadAndIndexTimerName = getMetricsName(TIMER_METRIC, SOURCE_READ_AND_INDEX_ACTION);
      this.conflictResolutionTimerName = getMetricsName(TIMER_METRIC, CONFLICT_RESOLUTION_STR);
      this.conflictResolutionSuccessCounterName = getMetricsName(COUNTER_METRIC, CONFLICT_RESOLUTION_STR + SUCCESS_EXTENSION);
      this.conflictResolutionFailureCounterName = getMetricsName(COUNTER_METRIC, CONFLICT_RESOLUTION_STR + FAILURE_EXTENSION);
      ...
      this.compactionRequestedCounterName = getMetricsName(COUNTER_METRIC, HoodieTimeline.COMPACTION_ACTION + HoodieTimeline.REQUESTED_EXTENSION);
      this.compactionCompletedCounterName = getMetricsName(COUNTER_METRIC, HoodieTimeline.COMPACTION_ACTION + HoodieTimeline.COMPLETED_EXTENSION);
