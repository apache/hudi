...
@ConfigClassProperty(
        name = "Write commit callback configs",
...
public class HoodieWriteCommitCallbackConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<Boolean> TURN_CALLBACK_ON =
            ConfigProperty.key(CALLBACK_PREFIX + "on")
                    .defaultValue(false)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    public static final ConfigProperty<String> CALLBACK_CLASS_NAME =
            ConfigProperty.key(CALLBACK_PREFIX + "class")
                    .defaultValue("org.apache.hudi.callback.impl.HoodieWriteCommitHttpCallback")
                    .markAdvanced()
                    .sinceVersion("0.6.0")
                    .withDocumentation(
                            "Full path of callback class and must be a subclass of HoodieWriteCommitCallback class, "
    ...
    public static final ConfigProperty<String> CALLBACK_HTTP_URL =
            ConfigProperty.key(CALLBACK_PREFIX + "http.url")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.6.0")
    ...
    public static final ConfigProperty<String> CALLBACK_HTTP_API_KEY_VALUE =
            ConfigProperty.key(CALLBACK_PREFIX + "http.api.key")
    ...
    public static final ConfigProperty<Integer> CALLBACK_HTTP_TIMEOUT_IN_SECONDS =
            ConfigProperty.key(CALLBACK_PREFIX + "http.timeout.seconds")
                    .defaultValue(30)
                    .markAdvanced()
                    .sinceVersion("0.6.0")
                    .withDocumentation("Callback timeout in seconds.");

    public static final ConfigProperty<String> CALLBACK_HTTP_CUSTOM_HEADERS =
            ConfigProperty.key(CALLBACK_PREFIX + "http.custom.headers")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation(
                            "Http callback custom headers. Format: HeaderName1:HeaderValue1;HeaderName2:HeaderValue2");

    /** @deprecated Use {@link #TURN_CALLBACK_ON} and its methods instead */
    @Deprecated public static final String CALLBACK_ON = TURN_CALLBACK_ON.key();
    /** @deprecated Use {@link #TURN_CALLBACK_ON} and its methods instead */
    @Deprecated public static final boolean DEFAULT_CALLBACK_ON = TURN_CALLBACK_ON.defaultValue();
    /** @deprecated Use {@link #CALLBACK_CLASS_NAME} and its methods instead */
    @Deprecated public static final String CALLBACK_CLASS_PROP = CALLBACK_CLASS_NAME.key();
    /** @deprecated Use {@link #CALLBACK_CLASS_NAME} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String CALLBACK_HTTP_URL_PROP = CALLBACK_HTTP_URL.key();
    /** @deprecated Use {@link #CALLBACK_HTTP_API_KEY_VALUE} and its methods instead */
    @Deprecated public static final String CALLBACK_HTTP_API_KEY = CALLBACK_HTTP_API_KEY_VALUE.key();
    /** @deprecated Use {@link #CALLBACK_HTTP_API_KEY_VALUE} and its methods instead */
    @Deprecated
    public static final String DEFAULT_CALLBACK_HTTP_API_KEY =
            CALLBACK_HTTP_API_KEY_VALUE.defaultValue();
    ...
    /** @deprecated Use {@link #CALLBACK_HTTP_TIMEOUT_IN_SECONDS} and its methods instead */
    @Deprecated
    public static final int DEFAULT_CALLBACK_HTTP_TIMEOUT_SECONDS =
            CALLBACK_HTTP_TIMEOUT_IN_SECONDS.defaultValue();
    ...
    public static class Builder {
        ...
        private final HoodieWriteCommitCallbackConfig writeCommitCallbackConfig =
                new HoodieWriteCommitCallbackConfig();

        public HoodieWriteCommitCallbackConfig.Builder fromFile(File propertiesFile)
                throws IOException {
