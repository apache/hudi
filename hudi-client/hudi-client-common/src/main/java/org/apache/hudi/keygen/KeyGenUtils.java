...
public class KeyGenUtils {
  ...
  public static String[] extractRecordKeysByFields(String recordKey, List<String> fields) {
    ...
    // composite key case
    // Here we're reducing number of substrings and use index positions to reduce memory allocation,
    // because for bucket index this will be called for each record
    int keyValueSep1;
    int keyValueSep2;
    int commaPosition;
    String currentField;
