 ...
 */
public abstract class BaseCompactionAdminClient extends BaseHoodieClient {

  public BaseCompactionAdminClient(HoodieEngineContext context, String basePath) {
   ...
   */
  public abstract List<ValidationOpResult> validateCompactionPlan(HoodieTableMetaClient metaClient, String compactionInstant,
   ...
   * @param fsViewOpt File System View
   */
  public ValidationOpResult validateCompactionOperation(HoodieTableMetaClient metaClient, String compactionInstant,
   ...
   */
  public abstract List<RenameOpResult> runRenamingOps(HoodieTableMetaClient metaClient,
   ...
   *         compaction.
   */
  protected abstract List<Pair<HoodieLogFile, HoodieLogFile>> getRenamingActionsForUnschedulingCompactionPlan(
