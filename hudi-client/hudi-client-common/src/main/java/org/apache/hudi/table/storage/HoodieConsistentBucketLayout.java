...
public class HoodieConsistentBucketLayout extends HoodieStorageLayout {
    public static final Set<WriteOperationType> SUPPORTED_OPERATIONS =
    ...
    /**
      * Consistent hashing will tag all incoming records, so we could go ahead reusing an existing
      * Partitioner
      */
    @Override
