...
/**
  * Iterator providing for the semantic of simultaneously iterating over 2 other iterators and
  * combining their respective output
  *
...
public class MergingIterator<T1, T2, R> implements Iterator<R> {
    ...
    public MergingIterator(
            Iterator<T1> leftIterator, Iterator<T2> rightIterator, BiFunction<T1, T2, R> mergeFunction) {
