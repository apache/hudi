...
/**
  ...
  * with transaction locks using {@link DirectMarkerTransactionManager}.
  */
public class SimpleTransactionDirectMarkerBasedDetectionStrategy
        extends SimpleDirectMarkerBasedDetectionStrategy {

    private static final Logger LOG =
            LoggerFactory.getLogger(SimpleTransactionDirectMarkerBasedDetectionStrategy.class);
    ...
    public void detectAndResolveConflictIfNecessary() throws HoodieEarlyConflictDetectionException {
        DirectMarkerTransactionManager txnManager =
                new DirectMarkerTransactionManager(
                        (HoodieWriteConfig) config,
        ...
        try {
            ...
            LOG.warn(
                    "Exception occurs during create marker file in early conflict detection mode within transaction.");
            throw e;
        } finally {
