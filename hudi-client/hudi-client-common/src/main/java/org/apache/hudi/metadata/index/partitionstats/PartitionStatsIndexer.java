...
public class PartitionStatsIndexer extends BaseIndexer {
  ...
  @Override
  public List<IndexPartitionInitialization> buildInitializationData(String dataTableInstantTime, String instantTimeForPartition, Map<String, Map<String, Long>> partitionIdToAllFilesMap,
