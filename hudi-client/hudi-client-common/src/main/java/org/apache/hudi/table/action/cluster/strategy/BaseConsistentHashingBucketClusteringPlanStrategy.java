 ...
 */
public class BaseConsistentHashingBucketClusteringPlanStrategy<T extends HoodieRecordPayload, I, K, O>
    extends PartitionAwareClusteringPlanStrategy<T, I, K, O> {

  private static final Logger LOG = LogManager.getLogger(BaseConsistentHashingBucketClusteringPlanStrategy.class);
  ...
  public BaseConsistentHashingBucketClusteringPlanStrategy(HoodieTable table, HoodieEngineContext engineContext,
  ...
  /**
   * TODO maybe add config to force schedule the clustering. It could allow clustering on partitions that are not doing write operation.
  ...
  protected Stream<HoodieClusteringGroup> buildClusteringGroupsForPartition(String partitionPath, List<FileSlice> fileSlices) {
    Option<HoodieConsistentHashingMetadata> metadata = ConsistentBucketIndexUtils.loadMetadata(getHoodieTable().getMetaClient(), partitionPath);
