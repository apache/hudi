 ...
 */
@NotThreadSafe
public abstract class ZookeeperBasedLockProviderBase implements LockProvider<InterProcessMutex>, Serializable {

  private static final Logger LOG = LoggerFactory.getLogger(ZookeeperBasedLockProviderBase.class);
  ...
  public ZookeeperBasedLockProviderBase(final LockConfiguration lockConfiguration, final StorageConfiguration<?> conf) {
