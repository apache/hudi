    ...
    public void send(String callbackMsg) {
        ...
        try (CloseableHttpResponse response = client.execute(request)) {
            ...
            if (statusCode >= 300) {
                ...
                LOG.info(
                        "Sent Callback data with {} custom headers to {} successfully !",
                        customHeaders.size(),
                        url);
            }
        } catch (IOException e) {
            ...
            while (tokenizer.hasMoreTokens()) {
                ...
                if (!StringUtils.isNullOrEmpty(token)) {
                    ...
                    if (keyValue.length == 2) {
                        ...
                        LOG.warn(
                                "Unable to parse some custom headers. Supported format is: Header_name1:Header value1;Header_name2:Header value2");
                    }
                }
            }
        }
