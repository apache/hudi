 ...
 */
public abstract class BaseCompactHelpers<T extends HoodieRecordPayload, I, K, O, P> {
  public abstract HoodieCommitMetadata createCompactionMetadata(BaseHoodieTable<T, I, K, O, P> table,
                                                                String compactionInstantTime,
                                                                O writeStatuses,
                                                                String schema) throws IOException;

  public void completeInflightCompaction(BaseHoodieTable table, String compactionCommitTime, HoodieCommitMetadata commitMetadata) {
