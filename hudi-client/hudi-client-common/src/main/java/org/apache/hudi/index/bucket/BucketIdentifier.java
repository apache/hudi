...
public class BucketIdentifier implements Serializable {
    ...
    // Ensure the same records keys from different writers are desired to be distributed into the
    // same bucket
    ...
    private static List<String> getHashKeysUsingIndexFields(
            String recordKey, List<String> indexKeyFields) {
