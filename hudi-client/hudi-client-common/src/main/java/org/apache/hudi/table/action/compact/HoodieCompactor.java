...
public interface HoodieCompactor<T extends HoodieRecordPayload, I, K, O, P> extends Serializable {
   ...
   */
  HoodieCompactionPlan generateCompactionPlan(HoodieEngineContext context, BaseHoodieTable<T, I, K, O, P> hoodieTable, HoodieWriteConfig config,
                                              String compactionCommitTime, Set<HoodieFileGroupId> fgIdsInPendingCompactions) throws IOException;

  /**
   * Execute compaction operations and report back status.
   */
  O compact(HoodieEngineContext context, HoodieCompactionPlan compactionPlan, BaseHoodieTable<T, I, K, O, P> hoodieTable,
