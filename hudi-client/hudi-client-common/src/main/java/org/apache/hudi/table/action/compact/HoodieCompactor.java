...
public class HoodieCompactor implements Serializable {
  ...
  public List<WriteStatus> compact(
      HoodieCopyOnWriteTableOperation hoodieCopyOnWriteTable, HoodieTableMetaClient metaClient,
  ...
  public HoodieCompactionPlan generateCompactionPlan(
      ...
      String compactionCommitTime, Set<HoodieFileGroupId> fgIdsInPendingCompactionAndClustering)
      throws IOException {
