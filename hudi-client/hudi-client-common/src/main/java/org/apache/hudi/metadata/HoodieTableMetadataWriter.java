...
public interface HoodieTableMetadataWriter extends Serializable, AutoCloseable {
   ...
   * @param metadataWriteConfig    - metadata table write config.
   ...
   * @throws IOException
   */
  void initializeMetadataPartitions(HoodieTableMetaClient metadataMetaClient, HoodieWriteConfig metadataWriteConfig, List<MetadataPartitionType> metadataPartitions,
   ...
   * @param writeStatuses
   */
  void update(HoodieCommitMetadata commitMetadata, String instantTime, boolean isTableServiceAction, HoodieData<WriteStatus> writeStatuses);
