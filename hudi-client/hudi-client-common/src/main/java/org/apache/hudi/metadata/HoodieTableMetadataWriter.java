...
public interface HoodieTableMetadataWriter extends Serializable, AutoCloseable {
   ...
   * @param isTableService true if caller is a table service. false otherwise. Only regular write operations can trigger metadata table services and this argument
   *                       will assist in this.
   */
  void update(HoodieCommitMetadata commitMetadata, String instantTime, boolean isTableService);
