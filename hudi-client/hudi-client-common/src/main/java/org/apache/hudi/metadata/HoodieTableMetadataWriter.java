...
public interface HoodieTableMetadataWriter extends Serializable, AutoCloseable {
    ...
    /**
      ...
      *
      * @param engineContext
      * @param indexPartitionInfos - information about partitions to build such as partition type and
      *     base instant time
      * @param instantTime The async index instant time from data table
      */
    void buildMetadataPartitions(
    ...
    /**
      ...
      */
    void updateFromWriteStatuses(
            HoodieCommitMetadata commitMetadata,
            HoodieData<WriteStatus> writeStatuses,
            String instantTime);

    /**
      * Update the metadata table due to a COMMIT or REPLACECOMMIT operation. As compared to {@link
      * #updateFromWriteStatuses(HoodieCommitMetadata, HoodieData, String)}, this method directly
      * updates metadata with the given records, instead of first converting {@link WriteStatus} to
      * {@link HoodieRecord}.
      *
      * @param commitMetadata commit metadata of the operation of interest.
      ...
      */
    void update(
            HoodieCommitMetadata commitMetadata, HoodieData<HoodieRecord> records, String instantTime);
    ...
    /**
      ...
      *
      * @param instantTime - instant time when replacecommit corresponding to the drop will be recorded
      *     in the metadata timeline
    ...
    /**
      ...
      *
      * @param inFlightInstantTimestamp Timestamp of an instant which is in-progress. This instant is
      *     ignored while deciding if optimizations can be performed.
      */
