...
public abstract class UpdateStrategy<T, I> implements Serializable {
    ...
    /**
      ...
      *
      * @param taggedRecordsRDD the records to write, tagged with target file id, future can update
      *     tagged records location to a different fileId.
      * @return the recordsRDD strategy updated and a set of file groups to be updated while pending
      *     clustering.
      */
