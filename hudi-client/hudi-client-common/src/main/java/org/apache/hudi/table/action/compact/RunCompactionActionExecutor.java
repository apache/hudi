...
public class RunCompactionActionExecutor<T>
    ...
    public RunCompactionActionExecutor(
    ...
    public HoodieWriteMetadata<HoodieData<WriteStatus>> execute() {
        ...
        compactor.preCompact(
                table, pendingMajorOrMinorCompactionTimeline, this.operationType, instantTime);
        ...
        try {
            ...
            HoodieCompactionPlan compactionPlan =
                    operationType.equals(WriteOperationType.COMPACT)
            ...
            Pair<Option<String>, Option<String>> schemaPair =
                    InternalSchemaCache.getInternalSchemaAndAvroSchemaForClusteringAndCompaction(
                            table.getMetaClient(), instantTime);
            ...
            context.setJobStatus(
                    ...
                    "Preparing compaction metadata: " + config.getTableName());
