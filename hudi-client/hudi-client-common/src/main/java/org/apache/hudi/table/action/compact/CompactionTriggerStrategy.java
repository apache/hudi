...
public enum CompactionTriggerStrategy {
    ...
    @EnumFieldDescription(
            "triggers compaction when there are at least N delta commits after "
    ...
    @EnumFieldDescription(
            "triggers compaction when both there are at least N delta commits and "
    ...
    @EnumFieldDescription(
            "triggers compaction when both there are at least N delta commits or "
