...
public class HoodieClusteringConfig extends HoodieConfig {
  ...
  public static class Builder {
    ...
    private void validate() {
      ...
      if (isConsistentHashingBucketIndex()) {
        ...
        if (engineType == EngineType.FLINK) {
          ...
          ValidationUtils.checkArgument(
              clusteringConfigString.equals(SPARK_CONSISTENT_BUCKET_EXECUTION_STRATEGY) || clusteringConfigString.equals(SINGLE_SPARK_CONSISTENT_BUCKET_EXECUTION_STRATEGY),
    ...
    private String getDefaultExecutionStrategyClassName(EngineType engineType) {
      switch (engineType) {
        case SPARK:
          return isConsistentHashingBucketIndex() ? SINGLE_SPARK_CONSISTENT_BUCKET_EXECUTION_STRATEGY : SPARK_SORT_AND_SIZE_EXECUTION_STRATEGY;
        case FLINK:
        case JAVA:
