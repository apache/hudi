...
@Immutable
@ConfigClassProperty(
        name = "PreCommit Validator Configurations",
...
public class HoodiePreCommitValidatorConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> VALIDATOR_CLASS_NAMES =
            ConfigProperty.key("hoodie.precommit.validators")
                    .defaultValue("")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> EQUALITY_SQL_QUERIES =
            ConfigProperty.key("hoodie.precommit.validators.equality.sql.queries")
                    .defaultValue("")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> SINGLE_VALUE_SQL_QUERIES =
            ConfigProperty.key("hoodie.precommit.validators.single.value.sql.queries")
                    .defaultValue("")
                    .markAdvanced()
                    .withDocumentation(
                            "Spark SQL queries to run on table before committing new data to validate state after commit."
                                    + "Multiple queries separated by ';' delimiter are supported."
    ...
    /**
      * Spark SQL queries to run on table before committing new data to validate state before and after
      * commit. Multiple queries separated by ';' delimiter are supported. Example query: 'select
      * count(*) from \<TABLE_NAME\> where col=null' Note \<TABLE_NAME\> variable is expected to be
      * present in query.
      */
    public static final ConfigProperty<String> INEQUALITY_SQL_QUERIES =
            ConfigProperty.key("hoodie.precommit.validators.inequality.sql.queries")
                    .defaultValue("")
                    .markAdvanced()
                    .withDocumentation(
                            "Spark SQL queries to run on table before committing new data to validate state before and after commit."
    ...
    public static class Builder {
        ...
        private final HoodiePreCommitValidatorConfig preCommitValidatorConfig =
                new HoodiePreCommitValidatorConfig();
