...
public enum BootstrapMode {
    /**
      * In this mode, record level metadata is generated for each source record and both original
      * record and metadata for each record copied.
      */
    @EnumFieldDescription(
            "In this mode, the full record data is copied into hudi and metadata columns are added. A full"
    ...
    /**
      * In this mode, record level metadata alone is generated for each source record and stored in new
      * bootstrap location.
      */
    @EnumFieldDescription(
            "In this mode, the full record data is not copied into Hudi therefore it avoids full cost of rewriting the dataset. "
