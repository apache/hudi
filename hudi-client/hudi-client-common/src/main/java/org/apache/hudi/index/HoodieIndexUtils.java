...
public class HoodieIndexUtils {
   ...
   */
  public static List<Pair<String, Long>> filterKeysFromFile(StoragePath fileLocation,
    ...
    try (HoodieFileReader fileReader = HoodieFileReaderFactory.getReaderFactory(HoodieRecordType.AVRO)
        .getFileReader(DEFAULT_HUDI_CONFIG_FOR_READER, configuration, fileLocation)) {
