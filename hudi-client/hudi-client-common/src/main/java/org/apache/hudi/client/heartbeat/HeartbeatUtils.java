...
public class HeartbeatUtils {
    ...
    /**
      ...
      */
    public static boolean deleteHeartbeatFile(
            HoodieStorage storage, String basePath, String instantTime) {
    ...
    /**
      ...
      */
    public static boolean deleteHeartbeatFile(
            HoodieStorage storage, String basePath, String instantTime, HoodieWriteConfig config) {
    ...
    /**
      * Check if the heartbeat corresponding to instantTime has expired. If yes, abort by throwing an
      * exception.
      *
      * @param instantTime
      * @param table
