...
/**
  ...
  *
  * <p>The implementation performs a merge-sort by comparing the key of the record being written to
  * the list of keys in newRecordKeys (sorted in-memory).
  */
@NotThreadSafe
public class HoodieSortedMergeHandle<T, I, K, O> extends HoodieMergeHandle<T, I, K, O> {
    ...
    public HoodieSortedMergeHandle(
    ...
    public void write(HoodieRecord oldRecord) {
        ...
        // To maintain overall sorted order across updates and inserts, write any new inserts whose
        // keys are less than
        // the oldRecord's key.
