...
/**
  ...
  *
  * <p>The actual implementation of {@link BulkInsertPartitioner} is determined by the bulk insert
  * sort mode, {@link BulkInsertSortMode}, specified by {@code
...
public interface BulkInsertPartitioner<I> extends Serializable {
    ...
    /**
      ...
      *
      * <p>Note that, the number of output partitions may or may not be enforced, depending on the
    ...
    /**
      * Return file group id prefix for the given data partition. By default, return a new file group
      * id prefix, so that incoming records will route to a fresh new file group
      *
