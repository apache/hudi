...
/**
  * UpgradeHandler to assist in upgrading {@link org.apache.hudi.table.HoodieTable} from version 2 to
  * 3.
  */
public class TwoToThreeUpgradeHandler implements UpgradeHandler {
    public static final String SPARK_SIMPLE_KEY_GENERATOR =
    ...
    public Map<ConfigProperty, String> upgrade(
        ...
        if (config.isMetadataTableEnabled()) {
            // Metadata Table in version 2 is asynchronous and in version 3 is synchronous.
            // Synchronous table will not
            // sync any instants not already synced. So its simpler to re-bootstrap the table. Also,
            // the schema for the
        ...
        tablePropsToAdd.put(
                HoodieTableConfig.URL_ENCODE_PARTITIONING,
        ...
        ValidationUtils.checkState(
                keyGenClassName != null,
                String.format(
                        "Missing config: %s or %s",
