...
/**
  * Base Class for running archive/clean/delta-sync/compaction/clustering in separate thread and
  * controlling their life-cycles.
  */
public abstract class HoodieAsyncService implements Serializable {
    ...
    /**
      * Request shutdown either forcefully or gracefully. Graceful shutdown allows the service to
      * finish up the current round of work and shutdown. For graceful shutdown, it waits till the
      * service is shutdown
      *
    ...
    /**
      * Start the service. Runs the service in a different thread and returns. Also starts a monitor
      * thread to run-callbacks in case of shutdown
      *
