...
public abstract class BaseBulkInsertHelper<T, I, K, O, R> extends ParallelismHelper<I> {
    ...
    protected BaseBulkInsertHelper(
            SerializableFunctionUnchecked<I, Integer> partitionNumberExtractor) {
    ...
    /**
      * Only write input records. Does not change timeline/index. Return information about new files
      * created.
      *
