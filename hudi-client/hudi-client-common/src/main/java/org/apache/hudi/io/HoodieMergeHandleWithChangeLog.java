...
public class HoodieMergeHandleWithChangeLog<T, I, K, O> extends HoodieMergeHandle<T, I, K, O> {
    ...
    protected boolean writeUpdateRecord(
        ...
        final boolean result =
                super.writeUpdateRecord(newRecord, oldRecord, combinedRecordOpt, writerSchema);
        if (result) {
    ...
    public List<WriteStatus> close() {
        ...
        if (cdcLogger == null || recordsWritten == 0L || (recordsWritten == insertRecordsWritten)) {
            ...
            // case 1: all the data from the previous file slice are deleted. and no new data is
            // inserted;
