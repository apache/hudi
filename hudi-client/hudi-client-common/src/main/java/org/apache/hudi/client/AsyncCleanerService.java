 ...
 */
class AsyncCleanerService<T extends HoodieRecordPayload, I, K, O, P> extends AbstractAsyncService {

  private static final Logger LOG = LogManager.getLogger(AsyncCleanerService.class);

  private final BaseHoodieWriteClient<T,I,K,O,P> writeClient;
  private final String cleanInstantTime;
  private final transient ExecutorService executor = Executors.newSingleThreadExecutor();

  protected AsyncCleanerService(BaseHoodieWriteClient<T,I,K,O,P> writeClient, String cleanInstantTime) {
