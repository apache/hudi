...
public class KeepByTimeStrategy extends PartitionTTLStrategy {
    ...
    protected List<String> getExpiredPartitionsForTimeStrategy(
            List<String> partitionsForTTLManagement) {
        ...
        return lastCommitTimeForPartitions.entrySet().stream()
    ...
    private Map<String, Option<String>> getLastCommitTimeForPartitions(List<String> partitionPaths) {
        ...
        return hoodieTable.getContext()
                .map(
                        partitionPaths,
                        partitionPath -> {
                            Option<String> partitionLastModifiedTime =
                                    hoodieTable
                                            .getHoodieView()
    ...
    /**
      ...
      *
      * <p>This method checks if the current time has passed the TTL threshold based on a reference
      * time, which could be the creation time or the last commit time of the partition.
      *
