...
public class RecordBasedIndexingCatchupTask extends AbstractIndexingCatchupTask {
    ...
    public RecordBasedIndexingCatchupTask(
    ...
    private HoodieData<HoodieRecord> readRecordKeysFromFileSlices(HoodieInstant instant)
            throws IOException {
        ...
        HoodieMetadataFileSystemView fsView =
                new HoodieMetadataFileSystemView(
                        metaClient, metaClient.getActiveTimeline().filter(i -> i.equals(instant)), metadata);
