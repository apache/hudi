...
public class HoodieCompactionPlanGenerator<T extends HoodieRecordPayload, I, K, O>
    ...
    public HoodieCompactionPlanGenerator(
    ...
    protected HoodieCompactionPlan getCompactionPlan(
        ...
        return writeConfig
                ...
                .generateCompactionPlan(
                        writeConfig,
                        operations,
                        CompactionUtils.getAllPendingCompactionPlans(metaClient).stream()
                                .map(Pair::getValue)
                                .collect(toList()));
    }

    @Override
    protected List<String> filterPartitionPathsByStrategy(
            HoodieWriteConfig writeConfig, List<String> partitionPaths) {
