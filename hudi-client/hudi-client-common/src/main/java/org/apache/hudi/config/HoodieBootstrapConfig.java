...
@ConfigClassProperty(
        ...
        description =
                "Configurations that control how you want to bootstrap your existing tables for the first time into hudi. "
...
public class HoodieBootstrapConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> PARTITION_SELECTOR_REGEX_MODE =
            ConfigProperty.key("hoodie.bootstrap.mode.selector.regex.mode")
    ...
    public static final ConfigProperty<String> MODE_SELECTOR_CLASS_NAME =
            ConfigProperty.key("hoodie.bootstrap.mode.selector")
    ...
    public static final ConfigProperty<String> DATA_QUERIES_ONLY =
            ConfigProperty.key("hoodie.bootstrap.data.queries.only")
                    .defaultValue("false")
                    .markAdvanced()
                    .sinceVersion("0.14.0")
                    .withDocumentation(
                            "Improves query performance, but queries cannot use hudi metadata fields");

    public static final ConfigProperty<String> FULL_BOOTSTRAP_INPUT_PROVIDER_CLASS_NAME =
            ConfigProperty.key("hoodie.bootstrap.full.input.provider")
    ...
    public static final ConfigProperty<String> PARTITION_PATH_TRANSLATOR_CLASS_NAME =
            ConfigProperty.key("hoodie.bootstrap.partitionpath.translator.class")
    ...
    public static final ConfigProperty<String> PARALLELISM_VALUE =
            ConfigProperty.key("hoodie.bootstrap.parallelism")
                    .defaultValue("1500")
                    .markAdvanced()
                    .sinceVersion("0.6.0")
                    .withDocumentation(
                            "For metadata-only bootstrap, Hudi parallelizes the operation so that "
    ...
    public static final ConfigProperty<String> PARTITION_SELECTOR_REGEX_PATTERN =
            ConfigProperty.key("hoodie.bootstrap.mode.selector.regex")
                    .defaultValue(".*")
                    .markAdvanced()
                    .sinceVersion("0.6.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> INDEX_CLASS_NAME =
            ConfigProperty.key("hoodie.bootstrap.index.class")
                    ...
                    .sinceVersion("0.6.0")
                    .withDocumentation(
                            "Implementation to use, for mapping a skeleton base file to a bootstrap base file.");

    /** @deprecated Use {@link #BASE_PATH} and its methods instead */
    @Deprecated public static final String BOOTSTRAP_BASE_PATH_PROP = BASE_PATH.key();
    /** @deprecated Use {@link #INDEX_CLASS_NAME} and its methods instead */
    @Deprecated public static final String BOOTSTRAP_INDEX_CLASS_PROP = INDEX_CLASS_NAME.key();
    /** @deprecated Use {@link #INDEX_CLASS_NAME} and its methods instead */
    @Deprecated
    ...
    @Deprecated public static final String BOOTSTRAP_MODE_SELECTOR = MODE_SELECTOR_CLASS_NAME.key();
    ...
    public static final String FULL_BOOTSTRAP_INPUT_PROVIDER =
            FULL_BOOTSTRAP_INPUT_PROVIDER_CLASS_NAME.key();
    /** @deprecated Use {@link #FULL_BOOTSTRAP_INPUT_PROVIDER_CLASS_NAME} and its methods instead */
    @Deprecated
    public static final String DEFAULT_FULL_BOOTSTRAP_INPUT_PROVIDER =
            FULL_BOOTSTRAP_INPUT_PROVIDER_CLASS_NAME.defaultValue();
    ...
    public static final String BOOTSTRAP_PARTITION_PATH_TRANSLATOR_CLASS =
            PARTITION_PATH_TRANSLATOR_CLASS_NAME.key();
    /** @deprecated Use {@link #PARTITION_PATH_TRANSLATOR_CLASS_NAME} and its methods instead */
    @Deprecated
    public static final String DEFAULT_BOOTSTRAP_PARTITION_PATH_TRANSLATOR_CLASS =
            PARTITION_PATH_TRANSLATOR_CLASS_NAME.defaultValue();
    /** @deprecated Use {@link #PARALLELISM_VALUE} and its methods instead */
    @Deprecated public static final String BOOTSTRAP_PARALLELISM = PARALLELISM_VALUE.key();
    /** @deprecated Use {@link #PARALLELISM_VALUE} and its methods instead */
    @Deprecated
    ...
    public static class Builder {
        ...
        public Builder withBootstrapPartitionPathTranslatorClass(String partitionPathTranslatorClass) {
            bootstrapConfig.setValue(PARTITION_PATH_TRANSLATOR_CLASS_NAME, partitionPathTranslatorClass);
            return this;
        }
        ...
        public HoodieBootstrapConfig build() {
            ...
            bootstrapConfig.setDefaultValue(
                    INDEX_CLASS_NAME, BootstrapIndexType.getDefaultBootstrapIndexClassName(bootstrapConfig));
