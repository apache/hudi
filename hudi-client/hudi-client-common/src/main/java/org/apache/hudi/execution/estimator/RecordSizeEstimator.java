...
/**
 * Abstract class to compute the estimated record size used for assigning records to spark partitions
 * for file writing.
 */
...
public abstract class RecordSizeEstimator implements Serializable {
  ...
  public abstract long averageBytesPerRecord(HoodieTimeline commitTimeline, CommitMetadataSerDe commitMetadataSerDe);
}
