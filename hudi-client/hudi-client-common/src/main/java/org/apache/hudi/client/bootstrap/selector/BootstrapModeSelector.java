...
/**
  * Pluggable Partition Selector for selecting partitions to perform full or metadata-only
  * bootstrapping.
  */
public abstract class BootstrapModeSelector implements Serializable {
    ...
    /**
      * Classify partitions for the purpose of bootstrapping. For a non-partitioned source, input list
      * will be one entry.
      *
