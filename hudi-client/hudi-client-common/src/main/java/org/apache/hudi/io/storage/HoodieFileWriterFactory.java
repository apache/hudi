...
public class HoodieFileWriterFactory {
  ...
  public static <T extends HoodieRecordPayload, R extends IndexedRecord, I, K, O, P> HoodieFileWriter<R> getFileWriter(
      String instantTime, Path path, BaseHoodieTable<T, I, K, O, P> hoodieTable, HoodieWriteConfig config, Schema schema,
  ...
  private static <T extends HoodieRecordPayload, R extends IndexedRecord, I, K, O, P> HoodieFileWriter<R> newParquetStorageWriter(
      String instantTime, Path path, HoodieWriteConfig config, Schema schema, BaseHoodieTable<T, I, K, O, P> hoodieTable,
      TaskContextSupplier taskContextSupplier) throws IOException {
