...
public class HoodieLockMetrics {
  ...
  public static final String LOCK_ACQUIRED_BY_OTHERS_ERROR_COUNTER_NAME = "lock_acquired_others_error";
  public static final String LOCK_STATE_UNKNOWN_COUNTER_NAME = "lock_state_unknown";
  public static final String LOCK_ACQUIRE_PRECONDITION_FAILURE_COUNTER_NAME = "lock_acquire_precondition_failure";
  public static final String LOCK_PROVIDER_FATAL_ERROR_COUNTER_NAME = "lock_provider_fatal_error";
  public static final String LOCK_RELEASE_FAILURE_COUNTER_NAME = "lock_release_failure";
  public static final String LOCK_EXPIRATION_DEADLINE_COUNTER_NAME = "lock_expiration_deadline";
  public static final String LOCK_DANGLING_COUNTER_NAME = "lock_dangling";
  public static final String LOCK_INTERRUPTED_COUNTER_NAME = "lock_interrupted";
