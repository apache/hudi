...
public class MergeOnReadRestoreActionExecutor<T, I, K, O>
    ...
    public MergeOnReadRestoreActionExecutor(
    ...
    protected HoodieRollbackMetadata rollbackInstant(HoodieInstant instantToRollback) {
        switch (instantToRollback.getAction()) {
            ...
            case HoodieTimeline.REPLACE_COMMIT_ACTION:
                ...
                // TODO : Delete the .aux files along with the instant file, okay for now since the
                // archival process will
                // delete these files when it does not see a corresponding instant file under
                // .hoodie
                break;
            default:
        ...
        table.getMetaClient().reloadActiveTimeline();
        MergeOnReadRollbackActionExecutor rollbackActionExecutor =
                new MergeOnReadRollbackActionExecutor(
                        context, config, table, instantTime, instantToRollback, true, true, false);

        // TODO : Get file status and create a rollback stat and file
        // TODO : Delete the .aux files along with the instant file, okay for now since the archival
        // process will
