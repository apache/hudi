...
public class ConcurrentOperation {
  ...
  public ConcurrentOperation(HoodieInstant instant, HoodieTableMetaClient metaClient) throws IOException {
    ...
    if ((instant.getAction().equals(COMPACTION_ACTION) || instant.getAction().equals(CLUSTERING_ACTION)
        || (instant.getAction().equals(REPLACE_COMMIT_ACTION) && ClusteringUtils.isClusteringInstant(metaClient.getActiveTimeline(), instant)))
