...
public class TestHoodieJmxMetrics {
    ...
    public void testRegisterGauge() {
        ...
        assertEquals("123", metrics.getRegistry().getGauges().get("jmx_metric1").getValue().toString());
    }

    @Test
    public void testRegisterGaugeByRangerPort() {
        metrics.registerGauge("jmx_metric2", 123L);
        assertEquals("123", metrics.getRegistry().getGauges().get("jmx_metric2").getValue().toString());
    }
    ...
    public void testMultipleJmxReporterServer() {
        ...
        assertEquals("123", metrics.getRegistry().getGauges().get("jmx_metric3").getValue().toString());

        metrics2.registerGauge("jmx_metric4", 123L);
        assertEquals(
                "123", metrics2.getRegistry().getGauges().get("jmx_metric4").getValue().toString());
    }
