...
class TestSimpleConcurrentFileWritesConflictResolutionStrategyWithMORTable extends HoodieCommonTestHarness {
  @Override
  ...
  @Test
  void testConcurrentWritesWithInterleavingInflightCompaction() throws Exception {
