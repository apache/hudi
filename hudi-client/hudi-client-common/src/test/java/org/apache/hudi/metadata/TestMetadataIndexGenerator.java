...
public class TestMetadataIndexGenerator extends HoodieCommonTestHarness {
  ...
  public void testRLIIndexGeneratorWithInsertsAndUpserts() throws Exception {
    ...
    HoodieWriteConfig writeConfig = HoodieWriteConfig.newBuilder()
        .withPath("random")
        .build();
    MetadataIndexGenerator.PerWriteStatsBasedIndexGenerator perWriteStatsBasedIndexGenerator = new MetadataIndexGenerator.PerWriteStatsBasedIndexGenerator(
        Collections.singletonList(MetadataPartitionType.RECORD_INDEX), writeConfig, storageConf, "001");
    Iterator<Pair<String, HoodieRecord>> rliRecordsPair = perWriteStatsBasedIndexGenerator.apply(writeStatus);
