...
public class TestLegacyArchivedMetaEntryReader {
    private static final Logger LOG =
            LoggerFactory.getLogger(TestLegacyArchivedMetaEntryReader.class);
    ...
    void testReadLegacyArchivedTimeline() throws Exception {
        ...
        assertThat(
                activeActions.stream()
                        .map(ActiveAction::getInstantTime)
                        .sorted()
    ...
    private void prepareLegacyArchivedTimeline(HoodieTableMetaClient metaClient) throws Exception {
        ...
        for (int i = 1; i < 11; i++) {
            ...
            HoodieCommitMetadata metadata =
                    testTable.createCommitMetadata(
        ...
        List<HoodieInstant> instants =
                new HoodieActiveTimeline(metaClient, false)
                        .getInstantsAsStream()
                        .sorted()
    ...
    public void archive(HoodieTableMetaClient metaClient, List<HoodieInstant> instants)
    ...
    private IndexedRecord convertToAvroRecord(
