...
public class TestPartitionAwareClusteringPlanStrategy {
    ...
    @Mock HoodieTable table;
    @Mock HoodieEngineContext context;
    ...
    public void setUp() {
        ...
        this.hoodieWriteConfig =
                HoodieWriteConfig.newBuilder()
                        ...
                        .withClusteringConfig(HoodieClusteringConfig.newBuilder().fromProperties(props).build())
                        .build();
    }

    @Test
    public void testFilterPartitionPaths() {
        PartitionAwareClusteringPlanStrategy strategyTestRegexPattern =
                new DummyPartitionAwareClusteringPlanStrategy(table, context, hoodieWriteConfig);
        ...
        List list =
                strategyTestRegexPattern.getRegexPatternMatchedPartitions(
                        hoodieWriteConfig, fakeTimeBasedPartitionsPath);
    ...
    class DummyPartitionAwareClusteringPlanStrategy extends PartitionAwareClusteringPlanStrategy {
        ...
        public DummyPartitionAwareClusteringPlanStrategy(
        ...
        protected Stream<HoodieClusteringGroup> buildClusteringGroupsForPartition(
                String partitionPath, List list) {
            return null;
        }
