...
public class TestFileSliceMetricUtils {
    ...
    public void testFileSliceMetricUtilsWithLogFile() {
        ...
        fileSlices.add(
                buildFileSlice(
                        15 * 1024 * 1024, new ArrayList<>(Arrays.asList(5 * 1024 * 1024L, 3 * 1024 * 1024L))));
        fileSlices.add(
                buildFileSlice(
                        20 * 1024 * 1024, new ArrayList<>(Collections.singletonList(2 * 1024 * 1024L))));
        FileSliceMetricUtils.addFileSliceCommonMetrics(fileSlices, metrics, defaultBaseFileSize);
        ...
        assertEquals(80.0, metrics.get(FileSliceMetricUtils.TOTAL_IO_MB), epsilon);
        assertEquals(
                10.0 * 1024 * 1024, metrics.get(FileSliceMetricUtils.TOTAL_LOG_FILE_SIZE), epsilon);
