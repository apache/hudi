...
public class TestClusteringPlanStrategyConfigCompatibility {
    ...
    public void testCheckAndGetClusteringPlanStrategy(
            String oldClass, String newClass, ClusteringPlanPartitionFilterMode mode) {
        ...
        Assertions.assertEquals(
                newClass, ClusteringPlanStrategy.checkAndGetClusteringPlanStrategy(config));
