...
public class TestHoodieIndexUtils {
    ...
    public void testGetFunctionalIndexPath() {
        ...
        indexDefinitions.put(
                indexName,
                new HoodieIndexDefinition(
                        "func_index_testIndex",
                        "column_stats",
                        "lower",
        ...
        String result =
                HoodieIndexUtils.getPartitionNameFromPartitionType(partitionType, metaClient, indexName);
    ...
    public void testGetNonFunctionalIndexPath() {
        ...
        String result =
                HoodieIndexUtils.getPartitionNameFromPartitionType(partitionType, metaClient, null);
    ...
    public void testExceptionForMissingFunctionalIndexMetadata() {
        ...
        assertThrows(
                ...
                () ->
                        HoodieIndexUtils.getPartitionNameFromPartitionType(
                                partitionType, metaClient, "testIndex"));
    }
}
