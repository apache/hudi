...
public class TestHoodieWriteConfig {
    ...
    public void testDefaultIndexAccordingToEngineType() {
        testEngineSpecificConfig(
                HoodieWriteConfig::getIndexType,
                constructConfigMap(
    ...
    public void testDefaultClusteringPlanStrategyClassAccordingToEngineType() {
        testEngineSpecificConfig(
                HoodieWriteConfig::getClusteringPlanStrategyClass,
                constructConfigMap(
    ...
    public void testDefaultClusteringExecutionStrategyClassAccordingToEngineType() {
        testEngineSpecificConfig(
                HoodieWriteConfig::getClusteringExecutionStrategyClass,
                constructConfigMap(
    ...
    public void testDefaultMarkersTypeAccordingToEngineType() {
        testEngineSpecificConfig(
                HoodieWriteConfig::getMarkersType,
                constructConfigMap(
    ...
    public void testInferCleaningPolicy() {
        ...
        writeConfig =
                HoodieWriteConfig.newBuilder()
                        .withPath("/tmp")
                        .withCleanConfig(HoodieCleanConfig.newBuilder().retainCommits(10).build())
                        .build();
        assertEquals(HoodieCleaningPolicy.KEEP_LATEST_COMMITS, writeConfig.getCleanerPolicy());
        ...
        writeConfig =
                HoodieWriteConfig.newBuilder()
                        .withPath("/tmp")
                        .withCleanConfig(HoodieCleanConfig.newBuilder().cleanerNumHoursRetained(96).build())
                        .build();
        ...
        writeConfig =
                HoodieWriteConfig.newBuilder()
                        .withPath("/tmp")
                        .withCleanConfig(HoodieCleanConfig.newBuilder().retainFileVersions(2).build())
                        .build();
    ...
    public void testAutoConcurrencyConfigAdjustmentWithTableServices(HoodieTableType tableType) {
        ...
        verifyConcurrencyControlRelatedConfigs(
                ...
                HoodieFailedWritesCleaningPolicy.valueOf(
        ...
        HoodieWriteConfig writeConfig =
                HoodieWriteConfig.newBuilder()
                        ...
                        .withClusteringConfig(
                                new HoodieClusteringConfig.Builder().withAsyncClustering(true).build())
    ...
    public void testConsistentBucketIndexDefaultClusteringConfig() {
        ...
        assertEquals(
                HoodieClusteringConfig.SPARK_CONSISTENT_BUCKET_EXECUTION_STRATEGY,
    ...
    public void testConsistentBucketIndexInvalidClusteringConfig() {
        Properties props = new Properties();
        props.setProperty(KeyGeneratorOptions.RECORDKEY_FIELD_NAME.key(), "uuid");
        TypedProperties consistentBucketIndexProps =
                HoodieIndexConfig.newBuilder()
                        .fromProperties(props)
                        .withIndexType(HoodieIndex.IndexType.BUCKET)
                        .withBucketIndexEngineType(HoodieIndex.BucketIndexEngineType.CONSISTENT_HASHING)
        ...
        assertThrows(
                ...
                () ->
                        writeConfigBuilder.withClusteringConfig(
    ...
    public void testSimpleBucketIndexPartitionerConfig() {
        ...
        HoodieWriteConfig writeConfig =
                HoodieWriteConfig.newBuilder()
                        ...
                        .build();
        assertEquals(
                HoodieLayoutConfig.SIMPLE_BUCKET_LAYOUT_PARTITIONER_CLASS_NAME,
                ...
                HoodieWriteConfig.newBuilder()
                        ...
                        .withIndexConfig(
                                HoodieIndexConfig.newBuilder()
                                        ...
                                        .build())
                        .withLayoutConfig(
                                HoodieLayoutConfig.newBuilder()
                                        .withLayoutPartitioner("org.apache.hudi.table.action.commit.UpsertPartitioner")
                                        .build())
                        .build();
        assertEquals(
                "org.apache.hudi.table.action.commit.UpsertPartitioner",
    ...
    public void testAutoAdjustCleanPolicyForNonBlockingConcurrencyControl() {
        ...
        // Verify automatically set hoodie.clean.failed.writes.policy=LAZY for non-blocking
        // concurrency control
        verifyConcurrencyControlRelatedConfigs(
                writeConfig,
                true,
    ...
    @ParameterizedTest
    @EnumSource(HoodieTableType.class)
    public void testNonBlockingConcurrencyControlInvalidTableTypeOrIndexType(
            HoodieTableType tableType) {
        TypedProperties props = new TypedProperties();
    ...
    /**
      ...
      * @param expectedConfigMap Expected config map, with key as the engine type and value as the
      *     corresponding config value for the engine.
      */
    private void testEngineSpecificConfig(
            Function<HoodieWriteConfig, Object> getConfigFunc,
    ...
    /**
      ...
      * @return {@link Map<EngineType, Object>} instance, with key as the engine type and value as the
      *     corresponding config value for the engine.
      */
    ...
    private void verifyConcurrencyControlRelatedConfigs(
            HoodieWriteConfig writeConfig,
            boolean expectedTableServicesEnabled,
