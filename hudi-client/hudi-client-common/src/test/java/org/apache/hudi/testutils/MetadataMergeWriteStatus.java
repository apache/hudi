...
public class MetadataMergeWriteStatus extends WriteStatus {
    ...
    private static void mergeMetadataMaps(
            Map<String, String> mergeFromMap, Map<String, String> mergeToMap) {
    ...
    public void markFailure(
            HoodieRecord record, Throwable t, Option<Map<String, String>> recordMetadata) {
