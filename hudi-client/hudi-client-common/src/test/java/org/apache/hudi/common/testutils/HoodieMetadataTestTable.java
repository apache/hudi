...
/**
  * {@link HoodieTestTable} impl used for testing metadata. This class does synchronous updates to
  * HoodieTableMetadataWriter if non null.
  */
public class HoodieMetadataTestTable extends HoodieTestTable {

    private final HoodieTableMetadataWriter writer;

    protected HoodieMetadataTestTable(
            String basePath,
    ...
    public static HoodieTestTable of(
            HoodieTableMetaClient metaClient,
            HoodieTableMetadataWriter writer,
            Option<HoodieEngineContext> context) {
        testTableState = HoodieTestTableState.of();
        return new HoodieMetadataTestTable(
    ...
    public HoodieTestTable addReplaceCommit(
            ...
            throws Exception {
        super.addReplaceCommit(
                instantTime, requestedReplaceMetadata, inflightReplaceMetadata, completeReplaceMetadata);
        if (writer != null) {
            writer.updateFromWriteStatuses(
                    completeReplaceMetadata, context.get().emptyHoodieData(), instantTime);
        }
        return this;
    }
