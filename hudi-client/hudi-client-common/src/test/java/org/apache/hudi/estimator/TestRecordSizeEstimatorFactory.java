...
public class TestRecordSizeEstimatorFactory {
  ...
  public void testRecordSizeEstimatorFactoryWithCustomConfig(String className, Class<?> clazz) {
    ...
    RecordSizeEstimator estimator = RecordSizeEstimatorFactory.createRecordSizeEstimator(builder.build());
  ...
  static Stream<Arguments> differentEstimatorImplementations() {
    ...
    arguments.add(Arguments.of(TestRecordSizeEstimator.class.getName(), TestRecordSizeEstimator.class));
    // Not configured
