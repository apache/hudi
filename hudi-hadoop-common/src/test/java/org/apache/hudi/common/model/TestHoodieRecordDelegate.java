...
public class TestHoodieRecordDelegate {
    ...
    public void testKryoSerializeDeserialize() {
        ...
        assertEquals(
                new HoodieRecordLocation("001", "file01"), hoodieRecordDelegate.getCurrentLocation().get());
        assertEquals(
                new HoodieRecordLocation("001", "file-01"), hoodieRecordDelegate.getNewLocation().get());
    }
