...
public class TestHoodieAvroFileReaderFactory {
  ...
  public void testGetFileReader() throws IOException {
    ...
    HoodieFileReader parquetReader = getIOFactory(storageConf).getReaderFactory(HoodieRecordType.AVRO)
    ...
    final Throwable thrown = assertThrows(UnsupportedOperationException.class, () -> {
      HoodieFileReader logWriter = getIOFactory(storageConf).getReaderFactory(HoodieRecordType.AVRO)
    ...
    HoodieFileReader orcReader = getIOFactory(storageConf)
