...
public class TestHoodieHadoopIOFactory {
    ...
    public void testGetFileFormatUtils() throws IOException {
        try (HoodieStorage storage =
            ...
            assertTrue(
                    ioFactory.getFileFormatUtils(new StoragePath("file:///a/b.parquet"))
                            instanceof ParquetUtils);
            assertTrue(
                    ioFactory.getFileFormatUtils(new StoragePath("file:///a/b.orc")) instanceof OrcUtils);
            assertTrue(
                    ioFactory.getFileFormatUtils(new StoragePath("file:///a/b.hfile")) instanceof HFileUtils);
            assertThrows(
