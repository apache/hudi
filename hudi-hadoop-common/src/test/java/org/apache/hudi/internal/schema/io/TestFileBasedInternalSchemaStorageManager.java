...
public class TestFileBasedInternalSchemaStorageManager extends HoodieCommonTestHarness {
    ...
    public void testPersistAndReadHistorySchemaStr() throws IOException {
        ...
        FileBasedInternalSchemaStorageManager fm =
        ...
        fm.persistHistorySchemaStr(
                "0001", SerDeHelper.inheritSchemas(secondSchema, fm.getHistorySchemaStr()));
        // Simulate commit.
        simulateCommit("0001");
        metaClient.reloadActiveTimeline();
        // try to read schema
        ...
        fm.persistHistorySchemaStr(
                "0002", SerDeHelper.inheritSchemas(thirdSchema, fm.getHistorySchemaStr()));
        ...
        fm.persistHistorySchemaStr(
                "0004", SerDeHelper.inheritSchemas(lastSchema, fm.getHistorySchemaStr()));
        simulateCommit("0004");
        metaClient.reloadActiveTimeline();
    ...
    private void simulateCommit(String commitTime) {
        ...
        HoodieInstant instant =
                new HoodieInstant(HoodieInstant.State.REQUESTED, HoodieTimeline.COMMIT_ACTION, commitTime);
