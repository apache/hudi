...
public class TestInProcessLockProvider {
    ...
    public void testLockIdentity() throws InterruptedException {
        ...
        InProcessLockProvider lockProvider1 =
                new InProcessLockProvider(lockConfiguration1, storageConf);
        ...
        Thread writer2 =
                new Thread(
                        () -> {
                            InProcessLockProvider lockProvider2 =
                                    new InProcessLockProvider(lockConfiguration1, storageConf);
        ...
        Thread writer3 =
                new Thread(
                        () -> {
                            ...
                            InProcessLockProvider lockProvider3 =
                                    new InProcessLockProvider(lockConfiguration1, storageConf);
                            ...
                            if (!isLocked) {
                                ...
                                throw new AssertionFailedError(
                                        "The lock instance in Writer 3 should be held by Writer 2: "
    ...
    public void testLockAcquisition() {
        InProcessLockProvider inProcessLockProvider =
                new InProcessLockProvider(lockConfiguration1, storageConf);
        assertDoesNotThrow(
                () -> {
    ...
    public void testLockReAcquisitionBySameThreadWithTwoTables() {
        InProcessLockProvider inProcessLockProvider1 =
                new InProcessLockProvider(lockConfiguration1, storageConf);
        InProcessLockProvider inProcessLockProvider2 =
                new InProcessLockProvider(lockConfiguration2, storageConf);
    ...
    public void testTryUnLockByDifferentThread() {
        ...
        // try acquiring by diff thread. should fail. since main thread still have acquired the
        // lock. if previous unblock by a different thread would have succeeded, this lock
    ...
    public void testTryLockAcquisitionBeforeTimeOutFromTwoThreads() {
        final InProcessLockProvider inProcessLockProvider =
                new InProcessLockProvider(lockConfiguration1, storageConf);
                ...
                new Thread(
                        () -> {
                            ...
                            Assertions.assertTrue(
                                    inProcessLockProvider.tryLock(awaitMaxTimeoutMs, TimeUnit.MILLISECONDS));
                            assertDoesNotThrow(
                                    () -> {
                                        inProcessLockProvider.unlock();
                                    });
