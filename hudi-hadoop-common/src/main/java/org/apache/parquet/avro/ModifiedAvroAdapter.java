...
/**
 * Uses a modified AvroSchemaConverter: HoodieAvroSchemaConverter that
 * adds support for local timestamp types which was only added in parquet 1.14.0
 */
public class ModifiedAvroAdapter implements AvroAdapter {
