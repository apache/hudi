...
/**
  * Copy from org.apache.parquet.avro.AvroParquetReader.Builder. We use
  * HoodieAvroParquetReaderBuilder to build HoodieAvroReadSupport that can support reading avro from
  * non-legacy map/list in parquet file.
  */
