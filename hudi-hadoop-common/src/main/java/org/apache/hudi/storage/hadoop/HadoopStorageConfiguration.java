...
public class HadoopStorageConfiguration extends StorageConfiguration<Configuration> {
    ...
    /**
      * Serializes the storage configuration. DO NOT change the signature, as required by {@link
      * Serializable}. This method has to be private; otherwise, serde of the object of this class in
      * Spark does not work.
      *
    ...
    /**
      * Deserializes the storage configuration. DO NOT change the signature, as required by {@link
      * Serializable}. This method has to be private; otherwise, serde of the object of this class in
      * Spark does not work.
      *
