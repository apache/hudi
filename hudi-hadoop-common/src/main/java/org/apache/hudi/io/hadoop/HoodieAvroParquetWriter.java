...
/**
  ...
  * ATTENTION: HoodieParquetWriter is not thread safe and developer should take care of the order of
  * write and close
  */
@NotThreadSafe
public class HoodieAvroParquetWriter extends HoodieBaseParquetWriter<IndexedRecord>
    ...
    public HoodieAvroParquetWriter(
            StoragePath file,
