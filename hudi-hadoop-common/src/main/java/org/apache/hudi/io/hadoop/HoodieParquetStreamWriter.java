...
/**
  ...
  *
  * <p>TODO(HUDI-3035) unify w/ HoodieParquetWriter.
  */
public class HoodieParquetStreamWriter implements HoodieAvroFileWriter, AutoCloseable {
    ...
    public HoodieParquetStreamWriter(
            FSDataOutputStream outputStream, HoodieParquetConfig<HoodieAvroWriteSupport> parquetConfig)
            throws IOException {
        this.writeSupport = parquetConfig.getWriteSupport();
        this.writer =
                new Builder<IndexedRecord>(new OutputStreamBackedOutputFile(outputStream), writeSupport)
