...
public class HoodieAvroFileWriterFactory extends HoodieFileWriterFactory {
    ...
    protected HoodieFileWriter newParquetFileWriter(
        ...
        HoodieAvroWriteSupport writeSupport =
                getHoodieAvroWriteSupport(schema, config, enableBloomFilter(populateMetaFields, config));
    ...
    protected HoodieFileWriter newHFileFileWriter(
        ...
        return new HoodieAvroHFileWriter(
                ...
                schema,
                taskContextSupplier,
                config.getBoolean(HoodieTableConfig.POPULATE_META_FIELDS));
    }
    ...
    private HoodieAvroWriteSupport getHoodieAvroWriteSupport(
        ...
        return (HoodieAvroWriteSupport)
                ReflectionUtils.loadClass(
                        ...
                        new AvroSchemaConverter(storage.getConf().unwrapAs(Configuration.class))
                                .convert(schema),
                        schema,
                        filter,
                        config.getProps());
