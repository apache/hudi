...
public class HoodieAvroParquetReader extends HoodieAvroFileReader {
    ...
    public HoodieAvroParquetReader(HoodieStorage storage, StoragePath path) {
        ...
        this.storage =
                storage.newInstance(path, tryOverrideDefaultConfigs(storage.getConf().newInstance()));
        this.path = path;
        this.parquetUtils =
    ...
    @Override
    public ClosableIterator<HoodieRecord<IndexedRecord>> getRecordIterator(Schema readerSchema)
            throws IOException {
    ...
    @Override
    protected ClosableIterator<IndexedRecord> getIndexedRecordIterator(Schema schema)
            throws IOException {
    ...
    private ClosableIterator<IndexedRecord> getIndexedRecordIteratorInternal(
            Schema schema, Option<Schema> requestedSchema) throws IOException {
    ...
    public ClosableIterator<String> getRecordKeyIterator() throws IOException {
        ClosableIterator<IndexedRecord> recordKeyIterator =
                getIndexedRecordIterator(HoodieAvroUtils.getRecordKeySchema());
