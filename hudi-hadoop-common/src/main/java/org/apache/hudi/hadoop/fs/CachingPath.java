...
/**
  * This is an extension of the {@code Path} class allowing to avoid repetitive computations (like
  * {@code getFileName}, {@code toString}) which are secured by its immutability
  *
...
public class CachingPath extends Path {
    ...
    /**
      ...
      *
      * <p>NOTE: This is an unsafe version that is relying on the fact that the caller is aware what
      * they are doing this is not going to work with paths having scheme (which require parsing) and
      * is only meant to work w/ relative paths in a few specific cases.
      */
    ...
    /**
      * This is {@link Path#getPathWithoutSchemeAndAuthority(Path)} counterpart, instantiating {@link
      * CachingPath}
      */
