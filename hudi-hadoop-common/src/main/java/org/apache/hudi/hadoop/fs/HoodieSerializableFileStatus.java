...
/**
  ...
  *
  * <p>Use `HoodieFileStatus` generated by Avro instead this class if possible This class is needed
  * because `hudi-hadoop-mr-bundle` relies on Avro 1.8.2, and won't work well with `HoodieFileStatus`
  */
public class HoodieSerializableFileStatus implements Serializable {
    ...
    public static HoodieSerializableFileStatus fromFileStatus(FileStatus status) {
        ...
        return new HoodieSerializableFileStatus(
                status.getPath(),
                status.getLen(),
                status.isDir(),
