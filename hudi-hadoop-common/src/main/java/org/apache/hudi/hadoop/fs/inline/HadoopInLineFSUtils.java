...
/**
  * Utils to parse InLineFileSystem paths. Inline FS format:
...
public class HadoopInLineFSUtils extends InLineFSUtils {
    ...
    public static StorageConfiguration<Configuration> buildInlineConf(
        ...
        (inlineConf.unwrapAs(Configuration.class))
                .setClassLoader(InLineFileSystem.class.getClassLoader());
        return inlineConf;
    }
    ...
    /**
      ...
      *
      * <p>Outer File Path format: "outer_file_scheme://path/to/outer/file"
      *
      * <p>Example Input: "inlinefs://file1/s3a/?start_offset=20&length=40". Output: "s3a://file1"
      *
