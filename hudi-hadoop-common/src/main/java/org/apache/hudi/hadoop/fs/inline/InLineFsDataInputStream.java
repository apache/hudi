...
/**
  * Inline {@link FSDataInputStream}. A startOffset that is passed in is assumed to be the start of
  * the InputStream. All operations are handled having the {@code startOffset} as starting point.
  */
public class InLineFsDataInputStream extends FSDataInputStream {
    ...
    public InLineFsDataInputStream(long startOffset, FSDataInputStream outerStream, long length)
            throws IOException {
