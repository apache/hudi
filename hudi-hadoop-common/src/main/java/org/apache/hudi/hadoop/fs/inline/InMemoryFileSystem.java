...
/**
  ...
  * #getFileAsBytes()} is called This FileSystem is used only in write path. Does not support any
  * read apis except {@link #getFileAsBytes()}.
  */
public class InMemoryFileSystem extends FileSystem {

    // TODO: this needs to be per path to support num_cores > 1, and we should release the buffer
    // once done
