...
* Release Note : ([Release Note for Apache Hudi 0.8.0](/releases#release-080-docs))
...
* Release Note : ([Release Note for Apache Hudi 0.7.0](/releases#release-070-docs))
...
* Release Note : ([Release Note for Apache Hudi 0.6.0](/releases#release-060-docs))
...
* Release Note : ([Release Note for Apache Hudi 0.5.3](/releases#release-053-docs))
