...
description: "Metica built its first lakehouse from scratch on Apache Hudi and Amazon EMR — scaling from ~16 GB to billions of events without re-architecting, where every growth milestone became a config change, not a migration."
