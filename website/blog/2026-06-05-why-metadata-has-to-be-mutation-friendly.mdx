...
description: "The Hudi metadata table is itself a Merge-on-Read table — here's why MOR's append-first mutation model is what makes a continuously evolving, indexing-rich metadata layer scale."
authors: [sivabalan]
category: deep-dive
image: /assets/images/blog/2026-06-05-why-metadata-has-to-be-mutation-friendly/mdt-stops-catalog-state.png
tags:
- metadata
- mor
- merge on read
