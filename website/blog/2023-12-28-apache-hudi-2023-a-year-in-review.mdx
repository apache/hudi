...
description: "Reflect on and celebrate the myriad of exciting developments and accomplishments that have defined the year 2023 for the Hudi community."
authors: [xushiyan]
category: community
...
[Non-Blocking Concurrency Control](https://hudi.apache.org/releases/release-1.0#concurrency-control-1)
