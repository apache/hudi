...
excerpt: "Let's Recap 2022 in Hudi"
author: Sivabalan Narayanan
category: blog
image: /assets/images/blog/2022-12-09-Apache-Hudi-2022-A-year-in-Review.png
tags:
- how-to
- recap
- apache hudi
...
![/assets/images/blog/DataCouncil.jpg](/assets/images/blog/2022-12-09-Apache-Hudi-2022-A-year-in-Review.png)
...
![/assets/images/blog/2022-12-09-oss-community-1.png](/assets/images/blog/2022-12-09-oss-community-1.png)

You don’t have to travel far to meet and collaborate with the Hudi community. We hold [monthly virtual meetups](https://hudi.apache.org/community/syncs#monthly-community-call), [weekly office hours](https://hudi.apache.org/community/office_hours), and there are plenty of friendly faces on [Hudi Slack](https://join.slack.com/t/apache-hudi/shared_invite/zt-1e94d3xro-JvlNO1kSeIHJBTVfLPlI5w) who like to talk shop. Join us via Zoom for the next Hudi meetup!
...
7. [TPC-DS Benchmarks Hudi vs Delta Lak](https://www.onehouse.ai/blog/apache-hudi-vs-delta-lake-transparent-tpc-ds-lakehouse-performance-benchmarks) - Alexey Kudinkin from Onehouse
...
- [New CDC format](https://github.com/apache/hudi/blob/master/rfc/rfc-51/rfc-51.md)with Debezium-like database change log to provide before and after image and operation field for streaming changes from Hudi tables, friendly to engines like Flink;
