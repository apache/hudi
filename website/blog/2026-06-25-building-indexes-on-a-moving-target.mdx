...
description: "Async indexing in Hudi lets you add a new index to a multi-petabyte table without stopping ingestion — and the design only works because MOR put the right primitives in place years earlier."
authors: [sivabalan]
category: deep-dive
