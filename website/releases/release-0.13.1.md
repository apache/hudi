...
# [Release 0.13.1](https://github.com/apache/hudi/releases/tag/release-0.13.1) ([docs](/docs/0.13.1/quick-start-guide))
## Migration Guide
...
:::tip
0.13.1 release also contains all the new features and bug fixes from 0.13,0, of which the release notes are
shown below.
:::
