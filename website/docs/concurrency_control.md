...
:::note
`NON_BLOCKING_CONCURRENCY_CONTROL` between ingestion writer and table service writer is supported for following table services:
Cleaning, Compaction, Rollback, and Metadata Table Service.
:::
