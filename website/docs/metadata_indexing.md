...
First, we will generate a continuous workload. In the below example, we are going to start a [Hudi Streamer](/docs/next/ingestion_spark#hudi-streamer) which will continuously write data
