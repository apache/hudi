...
First, we will generate a continuous workload. In the below example, we are going to start a [Hudi Streamer](/docs/hoodie_streamer#hudi-streamer) which will continuously write data
