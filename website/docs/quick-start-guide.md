...
**Hudi Streamer** - Hudi provides an incremental ingestion/ETL tool - [Hudi Streamer](hoodie_streaming_ingestion.md#hudi-streamer), to assist with ingesting data into Hudi 
...
Check out more information on [modeling data in Hudi](/faq/general#how-do-i-model-the-data-stored-in-hudi) and different ways to perform [batch writes](writing_data.md) and [streaming writes](writing_tables_streaming_writes.md).
