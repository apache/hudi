...
- **[VECTOR type & Similarity Search](vector_search.md)** — Store embeddings and run vector similarity search directly in Spark SQL
...
- **[Lance File Format](lance_file_format.md)** — Vector-friendly columnar format for AI/ML workloads
