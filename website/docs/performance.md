...
- User can also tune the size of the [base/parquet file](/docs/configurations#hoodieparquetmaxfilesize), [log files](/docs/configurations#hoodielogfilemaxsize) & expected [compression ratio](configurations#hoodieparquetcompressionratio),
...
See [here](tuning-guide.md) for some tuning tips.
