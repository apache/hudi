...
last_modified_at: 2024-12-06T17:38:05.854
---
...
| [hoodie.metadata.index.partition.stats.enable](#hoodiemetadataindexpartitionstatsenable) | false   | Enable aggregating stats for each column at the storage partition level.<br />`Config Param: ENABLE_METADATA_INDEX_PARTITION_STATS`<br />`Since Version: 1.0.0`                                                                                                                                                                                                                                                                                                                                   |
...
| [hoodie.expression.index.name](#hoodieexpressionindexname)         | (N/A)         | Name of the expression index. This is also used for the partition name in the metadata table.<br />`Config Param: INDEX_NAME`<br />`Since Version: 1.0.0`                                                                                                                                                                                                                                |
