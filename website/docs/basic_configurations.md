...
| [hoodie.table.index.defs.path](#hoodietableindexdefspath)                                        | (N/A)                                                       | Absolute path where the index definitions are stored<br />`Config Param: INDEX_DEFINITION_PATH`<br />`Since Version: 1.0.0`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [hoodie.bootstrap.index.class](#hoodiebootstrapindexclass)                                       | org.apache.hudi.common.bootstrap.index.HFileBootstrapIndex  | Implementation to use, for mapping base files to bootstrap base file, that contain actual data.<br />`Config Param: BOOTSTRAP_INDEX_CLASS_NAME`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| [hoodie.compaction.payload.class](#hoodiecompactionpayloadclass)                                 | org.apache.hudi.common.model.DefaultHoodieRecordPayload     | Payload class to use for performing compactions, i.e merge delta logs with current base file and then  produce a new base file.<br />`Config Param: PAYLOAD_CLASS_NAME`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [hoodie.compaction.payload.type](#hoodiecompactionpayloadtype)                                   | HOODIE_AVRO_DEFAULT                                         | org.apache.hudi.common.model.RecordPayloadType: Payload to use for merging records     AWS_DMS_AVRO: Provides support for seamlessly applying changes captured via Amazon Database Migration Service onto S3.     HOODIE_AVRO: A payload to wrap a existing Hoodie Avro Record. Useful to create a HoodieRecord over existing GenericRecords.     HOODIE_AVRO_DEFAULT(default): Honors ordering field in both preCombine and combineAndGetUpdateValue.     EVENT_TIME_AVRO: The only difference with HOODIE_AVRO_DEFAULT is that this does not track the event time metadata for efficiency     OVERWRITE_NON_DEF_LATEST_AVRO: Subclass of OVERWRITE_LATEST_AVRO used for delta streamer.     OVERWRITE_LATEST_AVRO: Honors ordering field in preCombine and overwrites storage with latest delta record in combineAndGetUpdateValue     PARTIAL_UPDATE_AVRO: Used for partial update to Hudi Table.     MYSQL_DEBEZIUM_AVRO: Provides support for seamlessly applying changes captured via Debezium for MysqlDB.     POSTGRES_DEBEZIUM_AVRO: Provides support for seamlessly applying changes captured via Debezium for PostgresDB.     HOODIE_METADATA: A record payload Hudi's internal metadata table.     VALIDATE_DUPLICATE_AVRO: A record payload to validate the duplicate key for INSERT statement in spark-sql.     EXPRESSION_AVRO: A record payload for MERGE INTO statement in spark-sql.     CUSTOM: Use the payload class set in `hoodie.datasource.write.payload.class`<br />`Config Param: PAYLOAD_TYPE`<br />`Since Version: 1.0.0` |
...
| [hoodie.errortable.validate.recordcreation.enable](#hoodieerrortablevalidaterecordcreationenable) | true             | Records that fail to be created due to keygeneration failure or other issues will be sent to the Error Table<br />`Config Param: ERROR_ENABLE_VALIDATE_RECORD_CREATION`<br />`Since Version: 0.14.2`                                                                                                                         |
