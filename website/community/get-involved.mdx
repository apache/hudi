...
| For quick pings & 1-1 chats                           | Join our <SlackCommunity title="slack group" />. In case the link does not work, please leave a comment on this [github issue](https://github.com/apache/hudi/issues/143) or drop an email to dev@hudi.apache.org                                                     |
