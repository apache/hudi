...
Stored procedures are available when using Hudi SparkSQL extensions in all Spark versions.
...
:::note
The system here has no practical meaning, the complete procedure name is system.procedure_name.
:::
...
| instant     | rollback_instant | total_files_deleted | time_taken_in_millis | total_partitions |
|-------------|------------------|---------------------|----------------------|------------------|
...
| [enable_metadata](configurations.md#hoodiemetadataenable)      | Boolean | N        | true          | Enable the internal metadata table                                                                                                                                                                                                                     |
...
| columns                                                | String | N        | ""            | Columns of the source table that should be copied to the new table                                                                                                                                                                          |
...
| partition_regex_pattern | String  | N        | None          | Regex pattern to filter partitions (e.g., `2025.*`)            |
...
Show completed cleaning operations with metadata like timing, files deleted, and retention policies.
...
Show clean operations in all states (REQUESTED, INFLIGHT, COMPLETED) with state information.
...
|--------------------------------------------------------------|--------|----------|---------------|--------------------------------------------------------------------------------------------|
| table                                                        | String | Y        | None          | Hudi table name                                                                            |
| [ttl_policy](configurations.md#hoodiepartitionttlstrategyytype) | String | N        | None          | TTL policy type                                                                            |
| [retain_days](configurations.md#hoodiepartitionttldaysretain)   | Int    | N        | None          | Number of days to retain partitions                                                        |
