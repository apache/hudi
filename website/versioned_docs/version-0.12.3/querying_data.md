...
## PrestoDB
To setup PrestoDB for querying Hudi, see the [Query Engine Setup](/docs/0.12.3/query_engine_setup#prestodb) page.

## Trino
To setup Trino for querying Hudi, see the [Query Engine Setup](/docs/0.12.3/query_engine_setup#trino) page.
