...
First, we will generate a continuous workload. In the below example, we are going to start a [deltastreamer](/docs/0.12.3/hoodie_deltastreamer#deltastreamer) which will continuously write data
