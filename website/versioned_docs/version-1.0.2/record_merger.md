...
avoiding order status from "jumping back" in time. Combined with [non-blocking concurrency control](/docs/1.0.2/concurrency_control#non-blocking-concurrency-control-mode), 
