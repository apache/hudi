...
config [hoodie.clustering.plan.strategy.class](/docs/1.0.2/configurations#hoodieclusteringplanstrategyclass).
...
config [hoodie.clustering.execution.strategy.class](/docs/1.0.2/configurations/#hoodieclusteringexecutionstrategyclass). By
...
the config for update strategy - [`hoodie.clustering.updates.strategy`](/docs/1.0.2/configurations/#hoodieclusteringupdatesstrategy) is set to ***SparkRejectUpdateStrategy***. If some file group has updates during clustering then it will reject updates and throw an
...
listed [here](/docs/1.0.2/configurations/#Clustering-Configs). Out of this list, a few configurations that will be very useful
