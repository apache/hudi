...
**_Note_**: _In a recent release the delete block keys were unintentionally serialized as kryo; this was fixed in the 0.14 release. Thankfully, since Hudi’s log blocks and format are versioned, when the file slice is compacted things return to normal._
