...
```bash
spark-submit \
  --jars "packaging/hudi-spark-bundle/target/hudi-spark3.4-bundle_2.12-0.14.2.jar" \
  --deploy-mode "client" \
  --class "org.apache.hudi.utilities.HoodieSnapshotExporter" \
      packaging/hudi-utilities-bundle/target/hudi-utilities-bundle_2.12-0.14.2.jar \
...
```bash
spark-submit \
  --jars "packaging/hudi-spark-bundle/target/hudi-spark3.4-bundle_2.12-0.14.2.jar,my-custom.jar" \
  --deploy-mode "client" \
  --class "org.apache.hudi.utilities.HoodieSnapshotExporter" \
      packaging/hudi-utilities-bundle/target/hudi-utilities-bundle_2.12-0.14.2.jar \
  --source-base-path "/tmp/" \
