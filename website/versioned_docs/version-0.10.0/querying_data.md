...
To setup Spark for querying Hudi, see the [Query Engine Setup](/docs/0.10.0/query_engine_setup#Spark-DataSource) page.
...
## Hive
To setup Hive for querying Hudi, see the [Query Engine Setup](/docs/0.10.0/query_engine_setup#hive) page.
...
## PrestoDB
To setup PrestoDB for querying Hudi, see the [Query Engine Setup](/docs/0.10.0/query_engine_setup#PrestoDB) page.

## Trino
To setup Trino for querying Hudi, see the [Query Engine Setup](/docs/0.10.0/query_engine_setup#Trino) page.
