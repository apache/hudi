...
```
wget https://repo1.maven.org/maven2/org/apache/hudi/hudi-spark-bundle_2.12/1.0.1/hudi-spark-bundle_2.12-1.0.1.jar
```     
...
``` 
CLIENT_JAR=$DATAPROC_DIR/lib/gcs-connector.jar CLI_BUNDLE_JAR=hudi-cli-bundle_2.12-1.0.1.jar SPARK_BUNDLE_JAR=hudi-spark-bundle_2.12-1.0.1.jar ./hudi-cli-with-bundle.sh  
```
