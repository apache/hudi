...
available for preview in version 1.0.1-beta only. You can read more about it under section [Model C: Multi-writer](concurrency_control.md#full-on-multi-writer--async-table-services).
...
| hoodie.write.lock.provider          | N/A **(Required)**                                                            | Lock provider class name, user can provide their own implementation of LockProvider which should be subclass of org.apache.hudi.common.lock.LockProvider<br /><br />`Config Param: LOCK_PROVIDER_CLASS_NAME`<br />`Since Version: 0.8.0`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
