...
- **Quick Start** : Read [Quick Start](/docs/1.0.1/flink-quick-start-guide#quick-start) to get started quickly Flink sql client to write to(read from) Hudi.
...
If you are relatively new to Apache Hudi, it is important to be familiar with a few core concepts:
  ...
  - [Hudi Storage Layout](storage_layouts.md) - How the files are laid out on storage
