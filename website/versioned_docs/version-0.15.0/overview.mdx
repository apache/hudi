...
Apache Hudi (pronounced “hoodie”) is the next generation [streaming data lake platform](/blog/2021/07/21/streaming-data-lake-platform).
 Hudi brings core warehouse and database functionality directly to a data lake. Hudi provides [tables](sql_ddl),
[transactions](timeline), [efficient upserts/deletes](write_operations), [advanced indexes](indexing),
