...
Apache Hudi (pronounced “hoodie”) is the next generation [streaming data lake platform](/blog/2021/07/21/streaming-data-lake-platform).
 Hudi brings core warehouse and database functionality directly to a data lake. Hudi provides [tables](sql_ddl.md),
[transactions](timeline.md), [efficient upserts/deletes](write_operations.md), [advanced indexes](indexing.md),
[ingestion services](hoodie_streaming_ingestion.md), data [clustering](clustering.md)/[compaction](compaction.md) optimizations,
and [concurrency](concurrency_control.md) all while keeping your data in open source file formats.
...
Apache Hudi can easily be used on any [cloud storage platform](cloud.md).
