...
config [hoodie.clustering.execution.strategy.class](/docs/0.15.0/configurations/#hoodieclusteringexecutionstrategyclass). By
...
the config for update strategy - [`hoodie.clustering.updates.strategy`](/docs/0.15.0/configurations/#hoodieclusteringupdatesstrategy) is set to ***SparkRejectUpdateStrategy***. If some file group has updates during clustering then it will reject updates and throw an
...
listed [here](/docs/0.15.0/configurations/#Clustering-Configs). Out of this list, a few configurations that will be very useful
