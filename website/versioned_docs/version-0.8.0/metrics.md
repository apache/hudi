...
<figure>
    <img className="docimage" src="/assets/images/hudi_jxm_metrics.png" alt="hudi_jxm_metrics.png"  />
</figure>
...
As configured above, assuming a Graphite server is running on host 192.168.0.106 and port 2003, a running Hudi job will connect and report metrics data to it. Below is an illustration of monitoring hudi metrics through Graphite.
  <figure>
      <img className="docimage" src="/assets/images/hudi_graphite_metrics.png" alt="hudi_graphite_metrics.png"  />
  </figure>
...
<figure>
    <img className="docimage" src="/assets/images/blog/2020-05-28-datadog-metrics-demo.png" alt="hudi_datadog_metrics.png"  />
</figure>
