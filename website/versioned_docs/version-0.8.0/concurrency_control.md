...
## Single Writer Guarantees
 ...
 - *INSERT Guarantee*: The target table wilL NEVER have duplicates if [dedup](configurations#insert_drop_dups_opt_key) is enabled.
 - *BULK_INSERT Guarantee*: The target table will NEVER have duplicates if [dedup](configurations#insert_drop_dups_opt_key)) is enabled.
...
- *UPSERT Guarantee*: The target table will NEVER show duplicates.
- *INSERT Guarantee*: The target table MIGHT have duplicates even if [dedup](configurations#insert_drop_dups_opt_key)) is enabled.
- *BULK_INSERT Guarantee*: The target table MIGHT have duplicates even if [dedup](configurations#insert_drop_dups_opt_key)) is enabled.
