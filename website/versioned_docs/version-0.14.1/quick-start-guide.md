...
**Structured Streaming** - Hudi supports Spark Structured Streaming reads and writes as well. Please see [here](hoodie_streaming_ingestion.md#structured-streaming) for more.

Check out more information on [modeling data in Hudi](faq_general.md#how-do-i-model-the-data-stored-in-hudi) and different ways to [writing Hudi Tables](writing_data.md).
