...
Apache Hudi brings core warehouse and database functionality directly to a data lake. Hudi provides [tables](sql_ddl.md),
[transactions](timeline.md), [efficient upserts/deletes](write_operations.md), [advanced indexes](indexing.md),
[streaming ingestion services](hoodie_streaming_ingestion.md), data [clustering](clustering.md)/[compaction](compaction.md) optimizations,
