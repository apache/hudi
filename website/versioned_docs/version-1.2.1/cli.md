...
These steps use Hudi version 1.2.1. If you want to use a different version you will have to edit the below commands 
appropriately:  
...
To list all inflight and requested instants that have been running longer than a specified number of minutes, use `commits show_infights`:
...
- **`commits show_infights`** Show inflight instants that are left longer than a certain duration.
