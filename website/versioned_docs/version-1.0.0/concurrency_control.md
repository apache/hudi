...
available for preview in version 1.0.0-beta only. You can read more about it under section [Model C: Multi-writer](concurrency_control.md#full-on-multi-writer--async-table-services).
