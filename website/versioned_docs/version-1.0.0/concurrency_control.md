...
available for preview in version 1.0.0-beta only. You can read more about it under section [Model C: Multi-writer](/docs/1.0.0/concurrency_control#model-c-multi-writer).
