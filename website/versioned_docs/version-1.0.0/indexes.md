...
write patterns, Hudi considers [indexing](/docs/1.0.0/indexes#indexing) as an integral part of its design and has uniquely supported
...
for more details. All these, support the index types mentioned [above](/docs/1.0.0/indexes#index-types-in-hudi).
