...
[DeltaStreamer](/docs/0.13.1/hoodie_deltastreamer#deltastreamer) is the standalone utility to incrementally pull upstream changes 
...
`--packages org.apache.hudi:hudi-utilities-bundle_2.11:0.13.1` to the `spark-submit` command. From 0.11.0 release, we start
...
```java
[hoodie]$ spark-submit --packages org.apache.hudi:hudi-utilities-bundle_2.11:0.13.1 \
 --master yarn \
 --deploy-mode cluster \
 --num-executors 10 \
 --executor-memory 3g \
