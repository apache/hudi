...
- in `$FLINK_HOME/conf/flink-conf.yaml`, [add other global configurations according to the characteristics of your task](/docs/0.12.0/flink_configuration#global-configurations)
...
Check out the [Flink Setup](/docs/0.12.0/flink_configuration) how-to page for deeper dive into configuration settings. 
