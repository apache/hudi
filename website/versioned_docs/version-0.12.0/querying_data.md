...
## Hive
To setup Hive for querying Hudi, see the [Query Engine Setup](/docs/0.12.0/query_engine_setup#hive) page.
...
## PrestoDB
To setup PrestoDB for querying Hudi, see the [Query Engine Setup](/docs/0.12.0/query_engine_setup#prestodb) page.

## Trino
To setup Trino for querying Hudi, see the [Query Engine Setup](/docs/0.12.0/query_engine_setup#trino) page.
...
## Redshift Spectrum
To set up Redshift Spectrum for querying Hudi, see the [Query Engine Setup](/docs/0.12.0/query_engine_setup#redshift-spectrum) page.


## StarRocks
To set up StarRocks for querying Hudi, see the [Query Engine Setup](/docs/0.12.0/query_engine_setup#starrocks) page.
