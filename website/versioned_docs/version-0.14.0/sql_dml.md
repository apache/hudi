...
To manage duplicates with `INSERT INTO`, please check out [insert dup policy config](/docs/0.14.0/configurations#hoodiedatasourceinsertduppolicy).
:::
...
showcased in the [Flink Quickstart](flink-quick-start-guide.md).
