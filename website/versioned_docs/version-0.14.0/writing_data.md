...
The two main tools available are the [Hudi Streamer](hoodie_streaming_ingestion.md#hudi-streamer) tool, as well as the [Spark Hudi datasource](#spark-datasource-writer).
