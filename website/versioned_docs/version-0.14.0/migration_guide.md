...
Refer to [Bootstrap procedure](https://hudi.apache.org/docs/procedures#bootstrap) for more details. 
...
By default, with only `hoodie.bootstrap.base.path` being provided METADATA_ONLY mode is selected. For other options, please refer [bootstrap configs](https://hudi.apache.org/docs/configurations#Bootstrap-Configs) for more details.
