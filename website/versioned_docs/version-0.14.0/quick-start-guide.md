...
Check out more information on [modeling data in Hudi](faq.md#how-do-i-model-the-data-stored-in-hudi) and different ways to [writing Hudi Tables](writing_data.md).
