...
write patterns, Hudi considers [indexing](/docs/0.14.0/metadata#indexing) as an integral part of its design and has uniquely supported 
...
[`hoodie.metadata.enable`](/docs/0.14.0/configurations#hoodiemetadataenable) to `false`. The 
