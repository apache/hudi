...
:::danger
This page is no longer maintained. Please refer to Hudi [SQL DDL](/docs/sql_ddl), [SQL DML](/docs/sql_dml), [SQL Queries](/docs/sql_queries) and [Procedures](/docs/procedures) for the latest documentation.
:::
