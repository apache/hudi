...
public class TestCompactionCommand extends CLIFunctionalTestHarness {
  ...
  public void testCompactionShowArchived() throws IOException {
    ...
    HoodieCompactionPlan plan = HoodieCLI.getTableMetaClient().reloadActiveTimeline().deserializeInstantContent(
        HoodieTimeline.getCompactionRequestedInstant(instance), HoodieCompactionPlan.class);
