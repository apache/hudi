...
public class TestArchivedCommitsCommand extends CLIFunctionalTestHarness {
    ...
    public void init() throws Exception {
        ...
        HoodieWriteConfig cfg =
                HoodieWriteConfig.newBuilder()
                        .withPath(tablePath)
                        .withSchema(HoodieTestCommitMetadataGenerator.TRIP_EXAMPLE_SCHEMA)
                        .withParallelism(2, 2)
        ...
        for (int i = 100; i < 106; i++) {
            ...
            HoodieTestCommitMetadataGenerator.createCommitFileWithMetadata(
                    tablePath, timestamp, storageConf());
        }
    ...
    public void testShowArchivedCommits() {
        ...
        String expectedResult =
                HoodiePrintHelper.print(header, new HashMap<>(), "", false, -1, false, rows);
