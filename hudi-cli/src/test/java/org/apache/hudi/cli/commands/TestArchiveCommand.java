...
public class TestArchiveCommand extends CLIFunctionalTestHarness {
    ...
    public void testArchiving() throws Exception {
        ...
        // therefore we expect 12 instants because 6 commits - 2 commits in active timeline = 4 in
        // archived
        // since each commit is completed, there are 3 instances per commit (requested, inflight,
        // completed)
