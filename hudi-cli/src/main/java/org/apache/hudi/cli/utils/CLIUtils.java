...
public class CLIUtils {
    /**
      ...
      * @return a {@link HoodieDefaultTimeline} instance containing the instants in the specified
      *     range.
      */
    public static HoodieDefaultTimeline getTimelineInRange(
            String startTs, String endTs, boolean includeArchivedTimeline) {
