...
public class SparkUtil {
    ...
    public static SparkLauncher initLauncher(String propertiesFile) throws URISyntaxException {
        ...
        if (libDirectory.exists()) {
            ...
            Arrays.stream(libDirectory.list())
                    .forEach(
                            library -> sparkLauncher.addJar(new File(libDirectory, library).getAbsolutePath()));
        } else {
    ...
    public static SparkConf getDefaultConf(final String appName, final Option<String> sparkMaster) {
        ...
        sparkConf.set(
                HoodieCliSparkConfig.CLI_SERIALIZER, "org.apache.spark.serializer.KryoSerializer");
        ...
        sparkConf.set(
                HoodieCliSparkConfig.CLI_MAPRED_OUTPUT_COMPRESSION_CODEC,
    ...
    public static JavaSparkContext initJavaSparkContext(
            String name, Option<String> master, Option<String> executorMemory) {
    ...
    public static JavaSparkContext initJavaSparkContext(SparkConf sparkConf) {
        ...
        jsc.hadoopConfiguration()
                .setBoolean(HoodieCliSparkConfig.CLI_PARQUET_ENABLE_SUMMARY_METADATA, false);
