...
public class CleansCommand {
    ...
    public String showCleans(
            ...
            @ShellOption(
                            value = {"--startTs"},
                            help = "start time for cleans, default: now - 10 days",
                            defaultValue = ShellOption.NULL)
                    String startTs,
            @ShellOption(
                            value = {"--endTs"},
                            help = "end time for clean, default: upto latest",
                            defaultValue = ShellOption.NULL)
                    String endTs,
            @ShellOption(
    ...
    public String runClean(
            ...
            @ShellOption(
                            value = "--propsFilePath",
                            help =
                                    "path to properties file on localfs or dfs with configurations for hoodie client for cleaning",
                            defaultValue = "")
