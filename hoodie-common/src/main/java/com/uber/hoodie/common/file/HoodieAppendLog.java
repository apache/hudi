...
package com.uber.hoodie.common.file;
...
public class HoodieAppendLog {
    private static final Log LOG = LogFactory.getLog(HoodieAppendLog.class);

    private HoodieAppendLog() {
    }                         // no public ctor
     ...
     * {@link HoodieAppendLog}.
     *
     * @see HoodieAppendLog.Writer
     */
    ...
    public static class Writer implements java.io.Closeable, Syncable {
        ...
        private static Option filesystem(FileSystem fs) {
            return new HoodieAppendLog.Writer.FileSystemOption(fs);
        }
        ...
        Writer(Configuration conf,
            ...
            if (ownStream) {
                ...
                if (appendIfExistsOption != null && appendIfExistsOption.getValue()
                    ...
                    HoodieAppendLog.Reader reader = new HoodieAppendLog.Reader(conf,
                            HoodieAppendLog.Reader.file(p), new Reader.OnlyHeaderOption());
                    try {
                        ...
                        metadataOption = (MetadataOption) HoodieAppendLog.Writer
         ...
         * @deprecated Use
         *   {@link HoodieAppendLog#createWriter(Configuration, Writer.Option...)}
         *   instead.
         */
        @Deprecated
         ...
         * immediately after calling {@link HoodieAppendLog.Reader#seek(long)} with a position
         * returned by this method, {@link HoodieAppendLog.Reader#next(Writable)} may be called.  However
    ...
    public static class Reader implements java.io.Closeable {
         ...
         *                  reader {@link HoodieAppendLog.Sorter},
        ...
        /** @deprecated Call {@link #nextRaw(DataOutputBuffer, HoodieAppendLog.ValueBytes)}. */
        @Deprecated
         ...
         * HoodieAppendLog.Writer#getLength()} when writing this file.  To seek to an arbitrary
         * position, use {@link HoodieAppendLog.Reader#sync(long)}.
         */
