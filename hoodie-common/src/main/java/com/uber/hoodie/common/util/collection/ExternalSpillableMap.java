 ...
 *
 * (1) Key-Value pairs in a in-memory map (2) Key-ValueMetadata pairs in an in-memory map which
 ...
 * the spill threshold is too low, we spill frequently and incur unnecessary disk writes.
 */
