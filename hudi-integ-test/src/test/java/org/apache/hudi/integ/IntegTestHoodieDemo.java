 ...
 */
public class IntegTestHoodieDemo extends ITTestBase {
    ...
    private void ingestFirstBatchAndHiveSync() throws Exception {
        List<String> cmds = CollectionUtils.createImmutableList(
                "spark-submit"
                        ...
                        + " --class org.apache.hudi.integ.testsuite.HoodieTestSuiteJob " + HUDI_INTEG_TEST_BUNDLE
                        ...
                        + " --target-base-path  /user/hive/warehouse/hudi-integ-test-suite/input"
                        ...
                        + " --schemaprovider-class org.apache.hudi.integ.testsuite.schema.TestSuiteFileBasedSchemaProvide "
                        + " --input-file-size 125829120 --compact-scheduling-minshare 1"
                        + " --workload-yaml-path file:/var/demo/config/test-suite/cow-clustering-example.yaml"
