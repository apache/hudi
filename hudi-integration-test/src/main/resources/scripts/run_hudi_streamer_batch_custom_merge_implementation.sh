...
echo "MERGE_STRATEGY_ID: $MERGE_STRATEGY_ID"
echo "MERGE_IMPLEMENTATION_CLASS: $MERGE_IMPLEMENTATION_CLASS"
...
for ((i = 0; ; i++)); do
  ...
  $SPARK_HOME/bin/spark-submit \
      ...
      --merge-strategy-id $MERGE_STRATEGY_ID \
      --merge-impl-classes $MERGE_IMPLEMENTATION_CLASS \
