  ...
  public static FileSystemViewManager buildFileSystemViewManager(Config config, SerializableConfiguration conf) {
    ...
    switch (config.viewStorageType) {
      case MEMORY:
        ...
        return FileSystemViewManager.createViewManager(localEngineContext, WriteConcurrencyMode.SINGLE_WRITER, metadataConfig, inMemConfBuilder.build(), commonConfig);
      case SPILLABLE_DISK: {
        ...
        return FileSystemViewManager.createViewManager(localEngineContext, WriteConcurrencyMode.SINGLE_WRITER, metadataConfig, spillableConfBuilder.build(), commonConfig);
      }
      case EMBEDDED_KV_STORE: {
        ...
        return FileSystemViewManager.createViewManager(localEngineContext, WriteConcurrencyMode.SINGLE_WRITER, metadataConfig, rocksDBConfBuilder.build(), commonConfig);
      }
      default:
