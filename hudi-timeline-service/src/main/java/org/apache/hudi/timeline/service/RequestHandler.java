...
public class RequestHandler {
  ...
  private static boolean localTimelineBehind(HoodieTimeline localTimeline, String lastKnownInstantFromClient, String numInstantsFromClient) {
    ...
    // In this patch, fs view is synced actively after each instant been completed, which
    // alleviates the problem, but we should keep the #sync pre-condition logically correct.
