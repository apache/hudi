...
public class MarkerDirState implements Serializable {
  ...
  public boolean exists() {
    try {
      return storage.exists(new HoodieLocation(markerDirPath));
  ...
  public boolean deleteAllMarkers() {
    boolean result = FSUtils.deleteDir(hoodieEngineContext, storage, new HoodieLocation(markerDirPath), parallelism);
    allMarkers.clear();
  ...
  private void writeMarkerTypeToFile() {
    HoodieLocation dirPath = new HoodieLocation(markerDirPath);
    try {
  ...
  private int parseMarkerFileIndex(String markerFilePathStr) {
    String markerFileName = new HoodieLocation(markerFilePathStr).getName();
  ...
  private void flushMarkersToFile(int markerFileIndex) {
    ...
    HoodieLocation markersFilePath = new HoodieLocation(
