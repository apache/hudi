 ...
 */
public class HoodieExampleDataGeneratorSlim<T extends HoodieRecordPayload<T>> {
  ...
  public HoodieExampleDataGeneratorSlim(String[] partitionPaths) {
    this(partitionPaths, new HashMap<>());
  }

  public HoodieExampleDataGeneratorSlim() {
    this(DEFAULT_PARTITION_PATHS);
  }

  public HoodieExampleDataGeneratorSlim(String[] partitionPaths, Map<Integer, KeyPartition> keyPartitionMap) {
