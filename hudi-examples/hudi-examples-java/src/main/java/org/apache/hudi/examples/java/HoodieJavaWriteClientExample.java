...
/**
  ...
  *
  * <p>Usage: HoodieJavaWriteClientExample <tablePath> <tableName> <tablePath> and <tableName>
  * describe root path of hudi and table name for example, `HoodieJavaWriteClientExample
