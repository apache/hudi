...
--schemaprovider-class org.apache.hudi.examples.datagen.HoodieExampleDataGenerator \
--transformer-class org.apache.hudi.examples.spark.common.IdentityTransformer
