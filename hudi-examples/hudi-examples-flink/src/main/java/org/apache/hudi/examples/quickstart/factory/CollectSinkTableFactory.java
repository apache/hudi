...
/**
  ...
  *
  * <p>Note: The CollectTableSink collects all the data of a table into a global collection {@code
  * RESULT}, so the tests should executed in single thread and the table name should be the same.
  */
