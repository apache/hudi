...
public class DataGenerator {
    ...
    public static List<RowData> generateRandomRowData(DataType dataType) {
        ...
        return Arrays.asList(
                DataGenerator.createRowData(
                        ...
                        StringData.fromString("driver-K"),
                        1.0 + Math.random() * (90),
                ...
                DataGenerator.createRowData(
                        ...
                        StringData.fromString("driver-M"),
                        1.0 + Math.random() * (90),
                        StringData.fromString("brazil")),
                DataGenerator.createRowData(
                        dataType,
                        TimestampData.fromEpochMillis(System.currentTimeMillis()),
                        StringData.fromString("334e26e9-8355-45cc-97c6-c31daf0df330"),
                        StringData.fromString("rider-C"),
                        StringData.fromString("driver-L"),
                        15.4,
                ...
                DataGenerator.createRowData(
                        ...
                        StringData.fromString("driver-N"),
                        1.0 + Math.random() * (90),
                        StringData.fromString("london")));
    }
    ...
    public static BinaryRowData createRowData(DataType dataType, Object... fields) {
        ...
        LogicalType[] types =
                ROW_TYPE.getFields().stream().map(RowType.RowField::getType).toArray(LogicalType[]::new);
