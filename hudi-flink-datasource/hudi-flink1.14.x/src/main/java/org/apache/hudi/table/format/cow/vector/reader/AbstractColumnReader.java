...
/**
  * Abstract {@link ColumnReader}. See {@link org.apache.parquet.column.impl.ColumnReaderImpl}, part
  * of the code is referred from Apache Spark and Apache Parquet.
  *
  * <p>Note: Reference Flink release 1.11.2 {@link
  * org.apache.flink.formats.parquet.vector.reader.AbstractColumnReader} because some of the package
  * scope methods.
  */
public abstract class AbstractColumnReader<V extends WritableColumnVector>
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(
                    org.apache.flink.formats.parquet.vector.reader.AbstractColumnReader.class);
    ...
    /**
      * Support lazy dictionary ids decode. See more in {@link ParquetDictionary}. If return false, we
      * will decode all the data first.
      */
