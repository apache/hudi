...
/**
  ...
  *
  * <p>NOTE: reference from Flink release 1.11.2 {@code ParquetSplitReaderUtil}, modify to support
  * INT64 based TIMESTAMP_MILLIS as ConvertedType, should remove when Flink supports that.
  */
public class ParquetSplitReaderUtil {
    ...
    public static ParquetColumnarRowSplitReader genPartColumnarRowReader(
        ...
        ValidationUtils.checkState(
                Arrays.stream(selectedFields).noneMatch(x -> x == -1),
        ...
        ParquetColumnarRowSplitReader.ColumnBatchGenerator gen =
                readVectors -> {
                    ...
                    for (int i = 0; i < vectors.length; i++) {
                        ...
                        vectors[i] =
                                createVector(readVectors, selNonPartNames, name, type, partitionSpec, batchSize);
                    }
        ...
        switch (type.getTypeRoot()) {
            ...
            case VARBINARY:
                ...
                if (value == null) {
                    ...
                    bsv.fill(value instanceof byte[] ? (byte[]) value : getUTF8Bytes(value.toString()));
                }
                return bsv;
            case BOOLEAN:
            ...
            case DATE:
                ...
                return createVectorFromConstant(
                        new IntType(), value == null ? null : dateToInternal((Date) value), batchSize);
    ...
    public static ColumnReader createColumnReader(
            ...
            PageReadStore pages)
            throws IOException {
        return createColumnReader(utcTimestamp, fieldType, physicalType, descriptors, pages, 0);
    }
        ...
        switch (fieldType.getTypeRoot()) {
            ...
            case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
                switch (descriptor.getPrimitiveType().getPrimitiveTypeName()) {
                    case INT64:
                        int precision =
                                fieldType instanceof TimestampType
            ...
            case ARRAY:
                return new ArrayColumnReader(
                        descriptor, pageReader, utcTimestamp, descriptor.getPrimitiveType(), fieldType);
            case MAP:
    ...
    public static WritableColumnVector createWritableColumnVector(
            int batchSize, LogicalType fieldType, Type physicalType, List<ColumnDescriptor> descriptors) {
    ...
    private static WritableColumnVector createWritableColumnVector(
        ...
        switch (fieldType.getTypeRoot()) {
            ...
            case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
                checkArgument(
                        primitiveType.getOriginalType() != OriginalType.TIME_MICROS,
    ...
    /**
      * Returns the field index with given physical row type {@code groupType} and field name {@code
      * fieldName}.
      *
