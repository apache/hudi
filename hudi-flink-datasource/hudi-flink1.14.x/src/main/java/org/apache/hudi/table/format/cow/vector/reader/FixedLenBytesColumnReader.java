...
/**
  ...
  *
  * <p>Note: Reference Flink release 1.13.2 {@code
  * org.apache.flink.formats.parquet.vector.reader.FixedLenBytesColumnReader} to always write as
  * legacy decimal format.
  */
public class FixedLenBytesColumnReader<V extends WritableColumnVector>
        extends AbstractColumnReader<V> {

    public FixedLenBytesColumnReader(ColumnDescriptor descriptor, PageReader pageReader)
            throws IOException {
