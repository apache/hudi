...
public class FormatUtils {
    ...
    /**
      * Returns the RowKind of the given record, never null. Returns RowKind.INSERT when the given
    ...
    public static ExternalSpillableMap<String, byte[]> spillableMap(
            HoodieWriteConfig writeConfig, long maxCompactionMemoryInBytes) {
        try {
    ...
    /**
      ...
      */
    public static Option<String> getRawValueWithAltKeys(
            org.apache.flink.configuration.Configuration flinkConf, ConfigProperty<?> configProperty) {
    ...
    /**
      * Gets the boolean value for a {@link ConfigProperty} config from Flink configuration. The key
      ...
      *     otherwise.
      */
    public static boolean getBooleanWithAltKeys(
            org.apache.flink.configuration.Configuration conf, ConfigProperty<?> configProperty) {
