...
import org.apache.hudi.source.split.SplitProvider;
 ...
 */
abstract class AbstractHoodieEnumerator
    implements SplitEnumerator<HoodieSourceSplit, HoodieEnumeratorState>,
    SupportsHandleExecutionAttemptSourceEvent {
  private static final Logger LOG = LoggerFactory.getLogger(AbstractHoodieEnumerator.class);
