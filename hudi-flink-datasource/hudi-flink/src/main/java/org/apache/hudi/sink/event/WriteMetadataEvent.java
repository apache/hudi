...
public class WriteMetadataEvent implements OperatorEvent {
    ...
    /**
      * Flag saying whether the event comes from the end of input, e.g. the source is bounded, there
      * are two cases in which this flag should be set to true: 1. batch execution mode 2. bounded
      * stream source such as VALUES
      */
    ...
    /**
      ...
      * @param lastBatch Whether the event reports the last batch within an checkpoint interval, if
      *     true, the whole data set of the checkpoint has been flushed successfully
    ...
    /**
      ...
      *
      * <p>The event indicates that the new instant can start directly, there is no old instant write
      * statuses to recover.
      */
    ...
    public static class Builder {
        ...
        public WriteMetadataEvent build() {
            ...
            return new WriteMetadataEvent(
                    taskID, instantTime, writeStatus, lastBatch, endInput, bootstrap);
        }
