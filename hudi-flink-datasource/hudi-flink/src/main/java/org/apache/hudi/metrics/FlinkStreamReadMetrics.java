...
public class FlinkStreamReadMetrics extends HoodieFlinkMetrics {
    ...
    public void setIssuedInstant(String issuedInstant) {
        try {
            Instant instant =
                    HoodieInstantTimeGenerator.parseDateFromInstantTime(issuedInstant).toInstant();
    ...
    public void setSplitLatestCommit(String splitLatestCommit) {
        try {
            Instant instant =
                    HoodieInstantTimeGenerator.parseDateFromInstantTime(splitLatestCommit).toInstant();
