...
public class ClusteringUtil {
            ...
            switch (bucketIndexEngineType) {
                case SIMPLE:
                    throw new HoodieNotSupportedException(
                            "Clustering is not supported for simple bucket index.");
    ...
    /**
      ...
      */
    public static void scheduleClustering(
            Configuration conf, HoodieFlinkWriteClient writeClient, boolean committed) {
    ...
    /**
      ...
      * @param writeClient The write client
      */
    public static void rollbackClustering(
            HoodieFlinkTable<?> table, HoodieFlinkWriteClient writeClient) {
        ...
        inflightInstants.forEach(
                inflightInstant -> {
                    LOG.info(
                            "Rollback the inflight clustering instant: " + inflightInstant + " for failover");
    ...
    /**
      ...
      */
    public static void rollbackClustering(
            HoodieFlinkTable<?> table, HoodieFlinkWriteClient<?> writeClient, String instantTime) {
