...
public class WriteOperatorFactory<I> extends SimpleUdfStreamOperatorFactory<Object>
    ...
    public static <I> WriteOperatorFactory<I> instance(
            Configuration conf, AbstractWriteOperator<I> operator) {
