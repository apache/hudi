...
public class FlinkOptions extends HoodieConfig {
  ...
  @AdvancedConfig
  public static final ConfigOption<Boolean> INSERT_ROWDATA_ENABLED = ConfigOptions
      .key("write.rowdata.append.enabled")
      .booleanType()
      .defaultValue(true)
      .withDescription("Whether to enable writing with RowData directly without converting to Avro.");
