...
public class FlinkCompactionMetrics extends FlinkWriteMetrics {
    ...
    public void registerMetrics() {
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "pendingCompactionCount"), () -> pendingCompactionCount);
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "compactionStateSignal"), () -> compactionStateSignal);
    }
    ...
    public void setFirstPendingCompactionInstant(
            ...
            if (!firstPendingCompactionInstant.isPresent()) {
                ...
                Instant start =
                        HoodieInstantTimeGenerator.parseDateFromInstantTime(
                                        firstPendingCompactionInstant.get().getTimestamp())
                                .toInstant();
