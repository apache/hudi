...
/**
  ...
  * org.apache.flink.api.java.typeutils.RowTypeInfo} for representing objects and converts Avro types
  ...
  * {@code org.apache.flink.formats.avro.AvroRowDeserializationSchema} and {@code
...
public class AvroSchemaConverter {
    ...
    /**
      * Converts an Avro schema {@code schema} into a nested row structure with deterministic field
      * order and data types that are compatible with Flink's Table & SQL API.
      *
    ...
    public static DataType convertToDataType(Schema schema) {
        switch (schema.getType()) {
            ...
            case MAP:
                return DataTypes.MAP(DataTypes.STRING().notNull(), convertToDataType(schema.getValueType()))
                        .notNull();
            case UNION:
                ...
                if (schema.getTypes().size() == 2
                    ...
                    DataType rawDataType =
                            new AtomicDataType(new TypeInformationRawType<>(false, Types.GENERIC(Object.class)))
                                    .notNull();
            ...
            case ROW:
                ...
                for (int i = 0; i < rowType.getFieldCount(); i++) {
                    ...
                    SchemaBuilder.GenericDefault<Schema> fieldBuilder =
                            builder.name(fieldName).type(convertToSchema(fieldType, rowName + "." + fieldName));
