...
public class AvroToRowDataConverters {
    ...
    private static AvroToRowDataConverter createNullableConverter(
            LogicalType type, boolean utcTimezone) {
    ...
    private static AvroToRowDataConverter createTimestampConverter(
            int precision, boolean utcTimezone) {
        ...
        return avroObject -> {
            ...
            if (utcTimezone) {
                ...
                return TimestampData.fromTimestamp(
                        Timestamp.from(instant)); // this applies the local timezone
            }
        };
    }
