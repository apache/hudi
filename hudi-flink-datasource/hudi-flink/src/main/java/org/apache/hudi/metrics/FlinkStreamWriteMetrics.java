...
/**
  * Metrics for flink stream write (including append write, normal/bucket stream write etc.). Used in
  * subclasses of {@link AbstractStreamWriteFunction}.
  */
public class FlinkStreamWriteMetrics extends HoodieFlinkMetrics {
    ...
    /**
      * Number of handles opened during a checkpoint window. Increased with partition number/bucket
      * number etc.
      */
