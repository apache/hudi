...
public class RowDataToAvroConverters {
    ...
    private static Conversions.DecimalConversion decimalConversion =
                            ...
                            new RowDataToAvroConverter() {
                                ...
                                public Object convert(Schema schema, Object object) {
                                    ...
                                    return Math.addExact(
                                            Math.multiplyExact(instant.getEpochSecond(), 1000_000),
                ...
                if (precision <= 3) {
                    converter =
                            new RowDataToAvroConverter() {
                                ...
                                public Object convert(Schema schema, Object object) {
                                    return utcTimezone
                                            ? ((TimestampData) object).toInstant().toEpochMilli()
                                ...
                                public Object convert(Schema schema, Object object) {
                                    Instant instant =
                                            utcTimezone
                                                    ...
                                                    : ((TimestampData) object).toTimestamp().toInstant();
                                    return Math.addExact(
                                            Math.multiplyExact(instant.getEpochSecond(), 1000_000),
                                            instant.getNano() / 1000);
                                }
            ...
            public Object convert(Schema schema, Object object) {
                ...
                if (schema.getType() == Schema.Type.UNION) {
                    ...
                    if (size == 2 && types.get(1).getType() == Schema.Type.NULL) {
                        ...
                        throw new IllegalArgumentException("The Avro schema is not a nullable type: " + schema);
                    }
                } else {
                    actualSchema = schema;
                }
        ...
        return new RowDataToAvroConverter() {
            ...
            public Object convert(Schema schema, Object object) {
                ...
                for (int i = 0; i < length; ++i) {
                    ...
                    Object avroObject =
                            fieldConverters[i].convert(schemaField.schema(), fieldGetters[i].getFieldOrNull(row));
    ...
    private static RowDataToAvroConverter createArrayConverter(
            ArrayType arrayType, boolean utcTimezone) {
