 ...
 */
public class StreamWriteRowDataOperator<I extends HoodieFlinkInternalRow> extends AbstractWriteOperator<I> {

  public StreamWriteRowDataOperator(Configuration conf, RowType rowType) {
    super(new StreamWriteRowDataFunction<>(conf, rowType));
  }

  public static <I extends HoodieFlinkInternalRow> WriteOperatorFactory<I> getFactory(Configuration conf, RowType rowType) {
