    ...
    public static class AsyncClusteringService extends HoodieAsyncTableService {
        ...
        private void cluster() throws Exception {
                ...
                clusteringInstant =
                        instants.stream()
                                ...
                                .orElseThrow(
                                        () ->
                                                new HoodieException(
                                                        "Clustering instant [" + cfg.clusteringInstantTime + "] not found"));
            } else {
            ...
            Option<Pair<HoodieInstant, HoodieClusteringPlan>> clusteringPlanOption =
                    ClusteringUtils.getClusteringPlan(table.getMetaClient(), clusteringInstant);
            ...
            if (clusteringPlan == null
                    || (clusteringPlan.getInputGroups() == null)
            ...
            DataStream<ClusteringCommitEvent> dataStream =
                    env.addSource(
                                    new ClusteringPlanSourceFunction(
                                            clusteringInstant.getTimestamp(), clusteringPlan, conf))
