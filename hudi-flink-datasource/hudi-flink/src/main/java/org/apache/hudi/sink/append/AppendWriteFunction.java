...
/**
  ...
  *
  * <p>The function writes base files directly for each checkpoint, the file may roll over when it’s
  * size hits the configured threshold.
  *
        ...
        if (attemptId > 0) {
            ...
            if (this.currentInstant != null
                    && !metaClient
                            ...
                            .containsInstant(currentInstant)) {
                LOG.info(
                        "Recover task[{}] for instant [{}] with attemptId [{}]",
                        taskID,
                        this.currentInstant,
                        attemptId);
