 ...
 * the coordinator thread. But enumerator may call the {@link SplitProvider#pendingSplitCount()}
 * from the I/O threads.
 */
@Internal
public interface SplitProvider extends Closeable {
   ...
   * call {@link SplitProvider#onUnassignedSplits} to return the split.
   */
