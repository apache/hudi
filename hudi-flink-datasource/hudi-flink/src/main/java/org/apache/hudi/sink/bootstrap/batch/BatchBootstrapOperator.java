...
/**
  ...
  *
  * <p>When a record comes in, the function firstly checks whether the partition path of the record
  * is already loaded, if the partition is not loaded yet, loads the entire partition and sends the
  * index records to downstream operators before it sends the input record; if the partition is
  * loaded already, sends the input record directly.
  *
