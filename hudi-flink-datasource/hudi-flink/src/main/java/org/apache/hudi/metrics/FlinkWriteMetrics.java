...
public class FlinkWriteMetrics extends HoodieFlinkMetrics {
    ...
    public void registerMetrics() {
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "totalPartitionsWritten"), () -> totalPartitionsWritten);
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "totalUpdateRecordsWritten"), () -> totalUpdateRecordsWritten);
        metricGroup.gauge(
                getMetricsName(actionType, "totalInsertRecordsWritten"), () -> totalInsertRecordsWritten);
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "totalCompactedRecordsUpdated"),
                () -> totalCompactedRecordsUpdated);
        metricGroup.gauge(
                getMetricsName(actionType, "totalLogFilesCompacted"), () -> totalLogFilesCompacted);
    ...
    public void updateCommitMetrics(String instantTime, HoodieCommitMetadata metadata) {
        ...
        updateCommitMetrics(
                commitEpochTimeInMs, System.currentTimeMillis() - commitEpochTimeInMs, metadata);
    }

    public void updateCommitMetrics(
            long commitEpochTimeInMs, long durationInMs, HoodieCommitMetadata metadata) {
