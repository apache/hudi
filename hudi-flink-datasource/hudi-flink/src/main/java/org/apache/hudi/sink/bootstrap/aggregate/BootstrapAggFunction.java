...
/**
  * Aggregate function that accumulates the loaded task number of function {@link
  * org.apache.hudi.sink.bootstrap.BootstrapOperator}.
  */
public class BootstrapAggFunction
        implements AggregateFunction<Integer, BootstrapAccumulator, Integer> {
    ...
    @Override
    public BootstrapAccumulator merge(
            BootstrapAccumulator bootstrapAccumulator, BootstrapAccumulator acc) {
