...
public class FlinkClusteringMetrics extends FlinkWriteMetrics {
    ...
    public void registerMetrics() {
        ...
        metricGroup.gauge(
                getMetricsName(actionType, "pendingClusteringCount"), () -> pendingClusteringCount);
    ...
    public void setFirstPendingClusteringInstant(
            Option<HoodieInstant> firstPendingClusteringInstant) {
        try {
            if (!firstPendingClusteringInstant.isPresent()) {
                ...
                Instant start =
                        HoodieInstantTimeGenerator.parseDateFromInstantTime(
                                        (firstPendingClusteringInstant.get()).getTimestamp())
                                .toInstant();
