...
public class HadoopConfigurations {
    ...
    public static org.apache.hadoop.conf.Configuration getParquetConf(
        ...
        org.apache.hadoop.conf.Configuration copy =
                new org.apache.hadoop.conf.Configuration(hadoopConf);
        Map<String, String> parquetOptions =
                FlinkOptions.getPropertiesWithPrefix(options.toMap(), PARQUET_PREFIX);
    ...
    public static org.apache.hadoop.conf.Configuration getHiveConf(Configuration conf) {
        String explicitDir =
                conf.getString(FlinkOptions.HIVE_SYNC_CONF_DIR, System.getenv("HIVE_CONF_DIR"));
