...
public class OptionsInference {
    ...
    /**
      * Utilities that help to auto generate the client id for multi-writer scenarios. It basically
      * handles two cases:
      *
      * <ul>
      *   <li>find the next client id for the new job;
      *   <li>clean the existing inactive client heartbeat files.
      * </ul>
      *
      * @see ClientIds
      */
