 ...
 */
public final class BucketStreamWriteRowDataOperator extends AbstractWriteOperator<HoodieFlinkInternalRow> {
  ...
  public static WriteOperatorFactory<HoodieFlinkInternalRow> getFactory(Configuration conf, RowType rowType) throws HoodieNotSupportedException {
