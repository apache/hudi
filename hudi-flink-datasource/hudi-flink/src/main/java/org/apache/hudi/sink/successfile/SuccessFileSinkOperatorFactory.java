...
public class SuccessFileSinkOperatorFactory<I> extends SimpleUdfStreamOperatorFactory<Object>
        implements CoordinatedOperatorFactory<Object>, OneInputStreamOperatorFactory<I, Object> {
  private static final long serialVersionUID = 1L;
  private final SuccessFileSinkOperator operator;
  private final Configuration conf;

  public SuccessFileSinkOperatorFactory(SuccessFileSinkOperator<I> operator, Configuration conf) {
    super(operator);
