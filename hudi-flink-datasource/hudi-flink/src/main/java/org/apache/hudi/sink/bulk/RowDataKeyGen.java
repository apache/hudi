...
public class RowDataKeyGen implements Serializable {
  ...
  private final RowDataDataProjection recordKeyProjection;
  private final RowDataDataProjection partitionPathProjection;
   ...
   */
  private static RowDataDataProjection getProjection(String[] fields, List<String> schemaFields, List<LogicalType> schemaTypes) {
    ...
    return RowDataDataProjection.instance(types, positions);
  }
