...
/**
  ...
  *
  * <p>It starts a cleaning task on new checkpoints, there is only one cleaning task at a time, a new
  * task can not be scheduled until the last task finished(fails or normally succeed). The cleaning
  * task never expects to throw but only log.
  */
