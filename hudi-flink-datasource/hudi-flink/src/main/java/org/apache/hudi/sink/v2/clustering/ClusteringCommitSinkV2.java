...
public class ClusteringCommitSinkV2 extends CleanFunctionV2<ClusteringCommitEvent> {
  ...
  public ClusteringCommitSinkV2(Configuration conf) {
    super(conf);
    this.conf = conf;
  }
  ...
  public void processElement(
      ClusteringCommitEvent event,
      ProcessFunction<ClusteringCommitEvent, RowData>.Context context,
    ...
    if (event.isFailed()
      ...
      LOG.error("Received abnormal ClusteringCommitEvent of instant {}, task ID is {},"
