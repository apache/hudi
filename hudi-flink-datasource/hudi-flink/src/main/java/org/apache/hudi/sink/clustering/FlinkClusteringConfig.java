...
public class FlinkClusteringConfig extends Configuration {
    ...
    @Parameter(
            names = {"--schedule", "-sc"},
            description = "Schedule the clustering plan in this job.\n" + "Default is false")
    public Boolean schedule = false;

    @Parameter(
            names = {"--instant-time", "-it"},
            description = "Clustering Instant time")
    public String clusteringInstantTime = null;

    @Parameter(
            names = {"--clean-async-enabled"},
            description =
                    "Whether to cleanup the old commits immediately on new commits, disabled by default")
    ...
    @Parameter(
            names = {"--seq"},
            description =
                    "Clustering plan execution sequence, two options are supported:\n"
    ...
    @Parameter(
            names = {"--service"},
            description = "Flink Clustering runs in service mode, disable by default")
    public Boolean serviceMode = false;

    @Parameter(
            names = {"--min-clustering-interval-seconds"},
    ...
    /**
      * Transforms a {@code FlinkClusteringConfig.config} into {@code Configuration}. The latter is
      * more suitable for the table APIs. It reads all the properties in the properties file (set by
    ...
    public static Configuration toFlinkConfig(FlinkClusteringConfig config) {
        ...
        conf.setBoolean(
                FlinkOptions.URL_ENCODE_PARTITIONING,
