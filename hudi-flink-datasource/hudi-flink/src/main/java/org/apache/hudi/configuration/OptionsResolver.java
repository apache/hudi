...
public class OptionsResolver {
   ...
   * <p>
   * todo:
   * <p> support RowData append for COW: HUDI-9149
   * <p> support RowData append for operation besides UPSERT: HUDI-9149
   * <p> support RowData append for nested complex DataType field: HUDI-9146, currently RowData for
   * MOR table is not supported yet, Flink uses Avro parquet reader to read parquet data blocks in
