...
/**
  ...
  *
  * <ul>
  *   <li>Integer => Long, Float, Double, Decimal, String
  *   <li>Long => Float, Double, Decimal, String
  *   <li>Float => Double, Decimal, String
  *   <li>Double => Decimal, String
  *   <li>Decimal => Decimal, String
  *   <li>String => Decimal, Date
  *   <li>Date => String
  * </ul>
  */
public final class CastMap implements Serializable {
    ...
    void add(int pos, LogicalType fromType, LogicalType toType) {
        ...
        if (converter == null) {
            throw new IllegalArgumentException(
                    String.format("Cannot create cast %s => %s at pos %s", fromType, toType, pos));
        }
    ...
    /**
      * Fields {@link Cast#from} and {@link Cast#to} are redundant due to {@link Cast#convert(Object)}
      * determines conversion. However, it is convenient to debug {@link CastMap} when {@link
