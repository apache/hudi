...
/**
  * A utility which can incrementally consume data from Kafka and apply it to the target table. It
  * has the similar functionality with SQL data source except that the source is bind to Kafka and
  * the format is bind to JSON.
  */
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (OptionsResolver.isAppendMode(conf)) {
            ...
            if (OptionsResolver.needsAsyncClustering(conf)) {
                ...
                // add clean function to rollback failed writes for lazy failed writes cleaning
                // policy
