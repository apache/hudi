...
/**
 * A stream write function with simple bucket hash index for processing of {@link HoodieFlinkInternalRow},
 * which places records into buffer of {@link StreamWriteFunction}.
 */
final class BucketStreamWriteRowDataFunction<T extends HoodieFlinkInternalRow> extends BucketStreamWriteFunction<T> {
