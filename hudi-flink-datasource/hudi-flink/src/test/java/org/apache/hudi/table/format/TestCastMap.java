...
public class TestCastMap {
    ...
    public void testCastString() {
        ...
        assertEquals(
                DecimalData.fromBigDecimal(BigDecimal.ONE, 1, 0),
                castMap.castIfNeeded(0, BinaryStringData.fromString("1.0")));
        assertEquals(
                (int) LocalDate.parse("2022-05-12").toEpochDay(),
    ...
    public void testCastDate() {
        ...
        assertEquals(
                BinaryStringData.fromString("2022-05-12"),
