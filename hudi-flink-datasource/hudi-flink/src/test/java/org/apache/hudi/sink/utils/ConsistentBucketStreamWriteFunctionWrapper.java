...
/**
  * A wrapper class to manipulate the {@link ConsistentBucketStreamWriteFunction} instance for
  * testing.
  *
  * @param <I> Input type
  */
public class ConsistentBucketStreamWriteFunctionWrapper<I>
    ...
    public ConsistentBucketStreamWriteFunctionWrapper(String tablePath, Configuration conf)
            throws Exception {
