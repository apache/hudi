 ...
 * @param <I> Input type
 */
public abstract class BaseBucketWriteFunctionWrapper<I> implements TestFunctionWrapper<I> {
  ...
  public BaseBucketWriteFunctionWrapper(String tablePath) throws Exception {
    this(tablePath, TestConfigurations.getDefaultConf(tablePath));
  }

  public BaseBucketWriteFunctionWrapper(String tablePath, Configuration conf) throws Exception {
