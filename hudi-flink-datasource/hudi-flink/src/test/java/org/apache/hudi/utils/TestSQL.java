...
public class TestSQL {
    ...
    public static final String INSERT_T1 =
    ...
    public static final String INSERT_SAME_KEY_T1 =
            "insert into t1 values\n"
    ...
    public static final String UPDATE_INSERT_T1 =
            "insert into t1 values\n"
    ...
    public static final String COMPLEX_TYPE_INSERT_T1 =
            "insert into t1 values\n"
    ...
    public static final String COMPLEX_NESTED_ROW_TYPE_INSERT_T1 =
            "insert into t1 values\n"
    ...
    public static final String NULL_CHILD_COLUMNS_ROW_TYPE_INSERT_T1 =
            "insert into t1 values\n"
                    + "(1, row(cast(null as int), 'abc1')),\n"
                    + "(2, row(2, cast(null as varchar))),\n"
                    + "(3, row(cast(null as int), cast(null as varchar)))";

    public static final String INSERT_DATE_PARTITION_T1 =
            "insert into t1 values\n"
