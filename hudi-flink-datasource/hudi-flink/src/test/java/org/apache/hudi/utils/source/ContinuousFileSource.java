...
/**
  ...
  * </pre>
  *
  * <p>If all the data are flushed out, it waits for the next checkpoint to finish and tear down the
  * source.
  *
  * <p>NOTE: this class is represented twice: in test utils and in quickstart. Don't forget to update
  * both files.
  */
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext scanContext) {
        return new DataStreamScanProviderAdapter() {
            ...
            public DataStream<RowData> produceDataStream(StreamExecutionEnvironment execEnv) {
                ...
                return execEnv
                        .addSource(new BoundedSourceFunction(path, conf.getInteger(CHECKPOINTS)))
