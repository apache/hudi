...
public class CompactFunctionWrapper {
    ...
    public CompactFunctionWrapper(
            Configuration conf, StreamTask<?, ?> streamTask, StreamConfig streamConfig) {
        this.conf = conf;
    ...
    public void openFunction() throws Exception {
        ...
        final NonThrownExecutor syncExecutor =
                new MockCoordinatorExecutor(new MockOperatorCoordinatorContext(new OperatorID(), 1));
