 ...
 * @param <I> Input type
 */
public abstract class BaseStreamWriteFunctionWrapper<I> implements TestFunctionWrapper<I> {
  ...
  public BaseStreamWriteFunctionWrapper(String tablePath) throws Exception {
    this(tablePath, TestConfigurations.getDefaultConf(tablePath));
  }

  public BaseStreamWriteFunctionWrapper(String tablePath, Configuration conf) throws Exception {
  ...
  public abstract Map<String, List<HoodieRecord>> getDataBuffer();
  ...
  protected abstract AbstractStreamWriteFunction createWriteFunction();
