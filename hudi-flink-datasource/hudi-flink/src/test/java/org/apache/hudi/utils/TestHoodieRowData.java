...
public class TestHoodieRowData {
    ...
    private static final DataType BASIC_DATA_TYPE =
            DataTypes.ROW(
    ...
    public void testGet() {
        ...
        HoodieRowData hoodieRowData =
                new HoodieRowData(
                        "commitTime", "commitSeqNo", "recordKey", "partitionPath", "fileName", rowData, true);
        assertValues(
                hoodieRowData,
                "commitTime",
                "commitSeqNo",
    ...
    private void assertValues(
        ...
        assertEquals(
                values[DECIMAL_INDEX], hoodieRowData.getDecimal(DECIMAL_INDEX + metaColumnsNum, 10, 4));
        ...
        assertEquals(
                values[ROW_INDEX], hoodieRowData.getRow(ROW_INDEX + metaColumnsNum, values.length));
    }
}
