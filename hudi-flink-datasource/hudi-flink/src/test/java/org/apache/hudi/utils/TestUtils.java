...
public class TestUtils {
    ...
    public static String getLastDeltaCompleteInstant(String basePath) {
        ...
        return metaClient
                ...
                .filterCompletedInstants()
                .filter(
                        hoodieInstant -> hoodieInstant.getAction().equals(HoodieTimeline.DELTA_COMMIT_ACTION))
                .lastInstant()
                .map(HoodieInstant::getTimestamp)
                .orElse(null);
    }
    ...
    public static StreamReadMonitoringFunction getMonitorFunc(Configuration conf) {
        ...
        return new StreamReadMonitoringFunction(
                conf, new Path(basePath), TestConfigurations.ROW_TYPE, 1024 * 1024L, null);
    }
    ...
    public static HoodieCommitMetadata deleteInstantFile(
            HoodieTableMetaClient metaClient, HoodieInstant instant) throws Exception {
    ...
    public static void saveInstantAsComplete(
            HoodieTableMetaClient metaClient, HoodieInstant instant, HoodieCommitMetadata metadata)
            throws Exception {
        metaClient
                .getActiveTimeline()
                .saveAsComplete(
    ...
    public static String amendCompletionTimeToLatest(
            HoodieTableMetaClient metaClient, java.nio.file.Path sourcePath, String instantTime)
            throws IOException {
