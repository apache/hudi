...
public class TestHoodieCatalogFactory {
    ...
    void testCreateCatalogThroughSQL() {
        ...
        RuntimeException exception =
                assertThrows(RuntimeException.class, () -> tableEnv.executeSql(catalogDDL));
    ...
    void testCreateHMSCatalog() {
        ...
        assertEquals(
                ((HoodieHiveCatalog) actualCatalog).getHiveConf().getVar(HiveConf.ConfVars.METASTOREURIS),
                "dummy-hms");
    ...
    void testCreateDFSCatalog() {
        ...
        HoodieCatalog expectedCatalog =
                new HoodieCatalog(catalogName, Configuration.fromMap(catalogOptions));
