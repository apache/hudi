...
public class TestConfigurations {
    ...
    public static final DataType ROW_DATA_TYPE_EVOLUTION_BEFORE =
            DataTypes.ROW(
    ...
    public static final RowType ROW_TYPE_EVOLUTION_BEFORE =
            (RowType) ROW_DATA_TYPE_EVOLUTION_BEFORE.getLogicalType();
    // f0 int, f2 int, f1 string, renamed_change_type bigint, f3 string, drop_add string
    public static final DataType ROW_DATA_TYPE_EVOLUTION_AFTER =
            DataTypes.ROW(
                            DataTypes.FIELD("uuid", DataTypes.VARCHAR(20)),
                            ...
                            DataTypes.FIELD(
                                    "f_struct",
                                    DataTypes.ROW(
                                            DataTypes.FIELD("f2", DataTypes.INT()), // new field added in the
                                            // middle of struct
                                            DataTypes.FIELD("f1", DataTypes.STRING()),
    ...
    public static final DataType ROW_DATA_TYPE_HOODIE_KEY_SPECIAL_DATA_TYPE =
            DataTypes.ROW(
    ...
    public static final RowType ROW_TYPE_EVOLUTION_AFTER =
            (RowType) ROW_DATA_TYPE_EVOLUTION_AFTER.getLogicalType();

    public static final DataType ROW_DATA_TYPE_BIGINT =
            DataTypes.ROW(
