...
public class TestHoodieTableSource {
  ...
  void testGetReadPaths() throws Exception {
    ...
    List<HoodieFileStatus> fileStatuses = tableSource.getReadFiles();
    assertNotNull(fileStatuses);
    assertThat(fileStatuses.size(), is(4));
    ...
    List<HoodieFileStatus> fileStatuses2 = tableSource2.getReadFiles();
    assertNotNull(fileStatuses2);
    assertThat(fileStatuses2.size(), is(1));
  }
  ...
  void testBucketPruning(boolean hiveStylePartitioning) throws Exception {
    ...
    List<HoodieFileStatus> fileStatuses = tableSource1.getReadFiles();
    assertThat("Files should be pruned by bucket id 1", fileStatuses.size(), CoreMatchers.is(2));
    ...
    List<HoodieFileStatus> fileStatuses2 = tableSource2.getReadFiles();
    assertThat("Files should be pruned by bucket id 3", fileStatuses2.size(), CoreMatchers.is(3));
    ...
    List<HoodieFileStatus> fileStatuses3 = tableSource3.getReadFiles();
    assertThat("Partial pk filtering does not prune any files", fileStatuses3.size(),
        CoreMatchers.is(7));
    ...
    List<HoodieFileStatus> fileStatuses4 = tableSource4.getReadFiles();
    assertThat("Files should be pruned by bucket id 1", fileStatuses4.size(), CoreMatchers.is(2));
  }
  ...
  void testBucketPruningSpecialKeyDataType(boolean logicalTimestamp) throws Exception {
    ...
    List<HoodieFileStatus> fileStatuses = tableSource1.getReadFiles();
    assertThat("Files should be pruned", fileStatuses.size(), CoreMatchers.is(1));
    ...
    List<HoodieFileStatus> fileStatuses2 = tableSource2.getReadFiles();
    assertThat("Files should be pruned", fileStatuses2.size(), CoreMatchers.is(1));
    ...
    List<HoodieFileStatus> fileStatuses3 = tableSource3.getReadFiles();
    assertThat("Files should be pruned", fileStatuses3.size(), CoreMatchers.is(1));
  }
