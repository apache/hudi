...
public class TestHoodieTableSource {
  ...
  void testGetReadPaths() throws Exception {
    ...
    List<StoragePathInfo> fileStatuses = tableSource.getReadFiles();
    ...
    List<StoragePathInfo> fileStatuses2 = tableSource2.getReadFiles();
  ...
  void testBucketPruning(boolean hiveStylePartitioning) throws Exception {
    ...
    List<StoragePathInfo> fileStatuses = tableSource1.getReadFiles();
    ...
    List<StoragePathInfo> fileStatuses3 = tableSource3.getReadFiles();
    ...
    List<StoragePathInfo> fileStatuses4 = tableSource4.getReadFiles();
