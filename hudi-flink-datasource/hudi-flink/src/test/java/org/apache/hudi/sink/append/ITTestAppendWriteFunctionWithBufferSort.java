...
public class ITTestAppendWriteFunctionWithBufferSort extends TestWriteBase {
  ...
  @Test
  public void testInvalidSortKeysConfiguration() {
    Configuration invalidConf = TestConfigurations.getDefaultConf(tempFile.getAbsolutePath());
    invalidConf.set(FlinkOptions.WRITE_BUFFER_SORT_ENABLED, true);
    invalidConf.set(FlinkOptions.OPERATION, "insert");
    invalidConf.removeKey(FlinkOptions.WRITE_BUFFER_SORT_KEYS.toString());

    assertThrows(IllegalArgumentException.class, () -> {
      TestWriteBase.TestHarness.instance()
          .preparePipeline(tempFile, invalidConf);
    });
  }
