...
import org.apache.hudi.source.split.DefaultSplitProvider;
...
/**
 * Test cases for {@link StaticHoodieEnumerator}.
 */
public class TestStaticHoodieEnumerator {
  private MockSplitEnumeratorContext context;
  private DefaultSplitProvider splitProvider;
  private StaticHoodieEnumerator enumerator;
  ...
  public void setUp() {
    ...
    splitProvider = new DefaultSplitProvider();
    enumerator = new StaticHoodieEnumerator(context, splitProvider);
