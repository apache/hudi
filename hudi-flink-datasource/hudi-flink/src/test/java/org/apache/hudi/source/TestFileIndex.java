...
public class TestFileIndex {
  ...
  void testFileListingUsingMetadata(boolean hiveStylePartitioning) throws Exception {
    ...
    List<StoragePathInfo> fielInfoList = fileIndex.getFilesInPartitions();
  ...
  void testFileListingUsingMetadataNonPartitionedTable() throws Exception {
    ...
    List<StoragePathInfo> fileInfoList = fileIndex.getFilesInPartitions();
    assertThat(fileInfoList.size(), is(1));
    assertTrue(fileInfoList.get(0).getPath().toString()
  ...
  void testFileListingEmptyTable(boolean enableMetadata) {
    ...
    List<StoragePathInfo> fileStatuses = fileIndex.getFilesInPartitions();
