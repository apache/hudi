...
public class TestFileIndex {
    ...
    void testFileListingUsingMetadata(boolean hiveStylePartitioning) throws Exception {
        ...
        List<Map<String, String>> partitions =
                fileIndex.getPartitions(
                        partitionKeys, PARTITION_DEFAULT_NAME.defaultValue(), hiveStylePartitioning);
    ...
    void testFileListingWithDataSkipping() throws Exception {
        Configuration conf =
                TestConfigurations.getDefaultConf(
                        tempFile.getAbsolutePath(), TestConfigurations.ROW_DATA_TYPE_BIGINT);
                                                ...
                                                new CallExpression(
                                                        ...
                                                        Arrays.asList(
                                                                ...
                                                                new ValueLiteralExpression(
                                                                        (byte) 5, DataTypes.TINYINT().notNull())),
                                                        DataTypes.BOOLEAN()))))
    ...
    private void writeBigintDataset(Configuration conf) throws Exception {
        List<RowData> dataset =
                Arrays.asList(
                        insertRow(
                                TestConfigurations.ROW_TYPE_BIGINT,
                                1L,
                        ...
                        insertRow(
                                TestConfigurations.ROW_TYPE_BIGINT,
                                5L,
                                StringData.fromString("Sophia"),
                                18,
                                TimestampData.fromEpochMillis(5),
                                StringData.fromString("par3")),
                        insertRow(
                                TestConfigurations.ROW_TYPE_BIGINT,
                                6L,
                                StringData.fromString("Emma"),
                                20,
                        ...
                        insertRow(
                                ...
                                StringData.fromString("par4")),
                        insertRow(
                                TestConfigurations.ROW_TYPE_BIGINT,
                                8L,
                                StringData.fromString("Han"),
                                56,
