...
public class TestTimelineBasedCkpMetadata extends TestCkpMetadata {
    ...
    public void testFailOver(String uniqueId) {
        ...
        // When timeline server is not responding, we can still read ckp metadata from file system
        // directly
        // test cleaning
    ...
    public void testRefreshEveryNCommits(String uniqueId) {
        ...
        writeClient
                .getConfig()
                .setValue(HoodieWriteConfig.INSTANT_STATE_TIMELINE_SERVER_BASED.key(), "false");
        CkpMetadata writeMetadata = getCkpMetadata(uniqueId);

        // Timeline-based reading
        writeClient
                .getConfig()
                .setValue(HoodieWriteConfig.INSTANT_STATE_TIMELINE_SERVER_BASED.key(), "true");
