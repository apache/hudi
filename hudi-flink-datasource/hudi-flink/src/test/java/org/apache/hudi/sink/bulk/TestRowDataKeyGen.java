...
public class TestRowDataKeyGen {
  ...
  void testSimpleKeyAndPartition() {
    ...
    final RowDataKeyGen keyGen1 = RowDataKeyGen.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE);
    ...
    final RowDataKeyGen keyGen2 = RowDataKeyGen.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE);
  ...
  void testComplexKeyAndPartition() {
    ...
    RowData rowData1 = insertRow(StringData.fromString("id1"), StringData.fromString("Danny"), 23,
        TimestampData.fromEpochMillis(1), StringData.fromString("par1"));
    RowDataKeyGen keyGen1 = RowDataKeyGen.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE);
  ...
  void testDateBasedKeyGenerator(String partitionFormat) {
    ...
    final RowDataKeyGen keyGen1 = RowDataKeyGen.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE_DATE);
    ...
    // hive style partitioning
    conf.set(FlinkOptions.HIVE_STYLE_PARTITIONING, true);
    final RowDataKeyGen keyGen2 = RowDataKeyGen.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE_DATE);
  ...
  void testPrimaryKeylessWrite() {
    ...
    final RowDataKeyGen keyGen1 = RowDataKeyGens.instance(StreamerUtil.flinkConf2TypedProperties(conf), TestConfigurations.ROW_TYPE, taskId, instantTime);
