...
public class ITTestConsistentBucketStreamWrite extends TestLogger {
    ...
    public void testBulkInsert() {
        ...
        assertThrows(HoodieException.class, () -> testWriteToHoodie(conf, "bulk_insert", 1, EXPECTED));
    }
    ...
    public void testOverwrite() {
        ...
        assertThrows(HoodieException.class, () -> testWriteToHoodie(conf, "overwrite", 1, EXPECTED));
    }

    private void testWriteToHoodie(
            Configuration conf, String jobName, int checkpoints, Map<String, String> expected)
            throws Exception {
