...
public class ITTestBucketStreamWrite {
    ...
    public void testBucketStreamWriteAfterRollbackFirstFileGroupCreation(boolean isCow)
            throws Exception {
        // this test is to ensure that the correct fileId can be fetched when recovering from a
        // rollover when a new
    ...
    private static void doDeleteCommit(String tablePath, boolean isCow) throws Exception {
        ...
        // rollback path structure:
        // tablePath/.hoodie/.temp/${commitInstant}/${partition}/${fileGroup}_${fileInstant}.parquet.marker.APPEND
                ...
                .forEach(
                        (fileId, relativePath) -> {
                            ...
                            try {
                                ...
                                FileCreateUtils.createMarkerFile(
                                        tablePath, partition, commitInstant, markerFileName);
                            } catch (IOException e) {
    ...
    private static void doWrite(String path, boolean isCow)
