...
public interface TestFunctionWrapper<I> {
    ...
    /**
      * Keep this interface for batch inline compaction job. The batch pipeline triggers the commit of
      * Hudi table with "endInput" events in the coordinator whereas there is no good chance to plug in
      * the compaction sub-pipeline.
      */
