...
public class ArrayColumnReader extends BaseVectorizedColumnReader {
    ...
    /**
      * Reads a single value from parquet page, puts it into lastValue. Returns a boolean indicating if
      * there is more values to read (true).
      *
      * @param category
      * @return boolean
      * @throws IOException
            ...
            case BOOLEAN:
                ...
                for (int i = 0; i < valueList.size(); i++) {
                    if (valueList.get(i) == null) {
                        ...
                        ((HeapBooleanVector) lcv.child).vector[i] = ((List<Boolean>) valueList).get(i);
                    }
                }
                break;
            case TINYINT:
            ...
            case DOUBLE:
                ...
                for (int i = 0; i < valueList.size(); i++) {
                    if (valueList.get(i) == null) {
                        ...
                        ((HeapDoubleVector) lcv.child).vector[i] = ((List<Double>) valueList).get(i);
                    }
                }
                break;
            case TIMESTAMP_WITHOUT_TIME_ZONE:
                    ...
                    case INT32:
                        ...
                        for (int i = 0; i < valueList.size(); i++) {
                            if (valueList.get(i) == null) {
                                ...
                                ((HeapIntVector) ((ParquetDecimalVector) lcv.child).vector).vector[i] =
                    ...
                    case INT64:
                        ...
                        for (int i = 0; i < valueList.size(); i++) {
                            if (valueList.get(i) == null) {
                                ...
                                ((HeapLongVector) ((ParquetDecimalVector) lcv.child).vector).vector[i] =
