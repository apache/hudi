...
class TestAwsGlueSyncTool {
    ...
    void setUp() throws IOException {
        ...
        awsGlueCatalogSyncTool =
                new MockAwsGlueCatalogSyncTool(glueSyncProps, GlueTestUtil.getHadoopConf());
    }
    ...
    void testShouldRecreateAndSyncTableOverride() {
        ...
        reinitGlueSyncTool();
        assertTrue(
                awsGlueCatalogSyncTool.shouldRecreateAndSyncTable(),
                "recreate_table_on_error should be true for glue");
    }
