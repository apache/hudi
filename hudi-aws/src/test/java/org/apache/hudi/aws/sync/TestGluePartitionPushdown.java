...
public class TestGluePartitionPushdown {
    ...
    public void testPushDownFilters() {
        ...
        assertEquals(
                "(((date = 2022-09-01 AND year = '2022') AND month = 9) AND day = 1)",
                partitionFilterGenerator.generatePushDownFilter(
                        writtenPartitions, partitionFieldSchemas, config));
    ...
    public void testPushDownFilterIfExceedLimit() {
        ...
        assertEquals(
                "(date >= 2022-09-01 AND date <= 2022-09-04)",
                partitionFilterGenerator.generatePushDownFilter(
                        writtenPartitions, partitionFieldSchemas, config));
