...
public class TestHoodieAWSCredentialsProviderFactory {
    ...
    public void testGetAWSCredentials() {
        ...
        AwsSessionCredentials credentials =
                (AwsSessionCredentials)
                        org.apache.hudi.aws.credentials.HoodieAWSCredentialsProviderFactory
    ...
    public void testGetAWSCredentialsWithInvalidAssumeRole() {
        // This test is to ensure that the AWS credentials provider factory fallbacks to default
        // credentials
