...
/**
  * Test for {@link DynamoDBBasedLockProvider}. Set it as integration test because it requires
...
public class ITTestDynamoDBBasedLockProvider {
    ...
    public static void setup() throws InterruptedException {
        ...
        properties.setProperty(
                DynamoDbBasedLockConfig.DYNAMODB_LOCK_BILLING_MODE.key(),
    ...
    public void testAcquireLock() {
        lockConfiguration
                .getConfig()
                .setProperty(
                        DynamoDbBasedLockConfig.DYNAMODB_LOCK_TABLE_NAME.key(),
                        TABLE_NAME_PREFIX + UUID.randomUUID());
        DynamoDBBasedLockProvider dynamoDbBasedLockProvider =
                new DynamoDBBasedLockProvider(lockConfiguration, null, dynamoDb);
        Assertions.assertTrue(
                dynamoDbBasedLockProvider.tryLock(
    ...
    private static AwsCredentialsProvider getCredentials() {
        return StaticCredentialsProvider.create(
                AwsBasicCredentials.create("random-access-key", "random-secret-key"));
    }
}
