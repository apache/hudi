...
@Immutable
@ConfigClassProperty(
        name = "Amazon Web Services Configs",
        groupName = ConfigGroups.Names.AWS,
        description =
                "Amazon Web Services configurations to access resources like Amazon DynamoDB (for locks),"
                        + " Amazon CloudWatch (metrics) and Amazon Glue (metadata).")
public class HoodieAWSConfig extends HoodieConfig {
    public static final ConfigProperty<String> AWS_ACCESS_KEY =
            ConfigProperty.key("hoodie.aws.access.key")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.10.0")
                    .withDocumentation("AWS access key id");

    public static final ConfigProperty<String> AWS_SECRET_KEY =
            ConfigProperty.key("hoodie.aws.secret.key")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.10.0")
                    .withDocumentation("AWS secret key");

    public static final ConfigProperty<String> AWS_SESSION_TOKEN =
            ConfigProperty.key("hoodie.aws.session.token")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.10.0")
    ...
    public static final ConfigProperty<String> AWS_ASSUME_ROLE_ARN =
            ConfigProperty.key("hoodie.aws.role.arn")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.15.0")
    ...
    public static final ConfigProperty<String> AWS_ASSUME_ROLE_SESSION_NAME =
            ConfigProperty.key("hoodie.aws.role.session.name")
                    .defaultValue("hoodie")
                    .markAdvanced()
                    .sinceVersion("0.15.0")
    ...
    public static final ConfigProperty<String> AWS_ASSUME_ROLE_EXTERNAL_ID =
            ConfigProperty.key("hoodie.aws.role.external.id")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation("External ID use when assuming the AWS Role");

    public static final ConfigProperty<String> AWS_GLUE_ENDPOINT =
            ConfigProperty.key("hoodie.aws.glue.endpoint")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation("Aws glue endpoint");

    public static final ConfigProperty<String> AWS_GLUE_REGION =
            ConfigProperty.key("hoodie.aws.glue.region")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.15.0")
                    .withDocumentation("Aws glue endpoint");
