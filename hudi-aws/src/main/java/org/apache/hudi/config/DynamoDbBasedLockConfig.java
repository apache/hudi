...
@ConfigClassProperty(
        ...
        description =
                "Configs that control DynamoDB based locking mechanisms required for concurrency control "
...
public class DynamoDbBasedLockConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> DYNAMODB_LOCK_TABLE_NAME =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "table")
    ...
    public static final ConfigProperty<String> DYNAMODB_LOCK_PARTITION_KEY =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "partition_key")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.10.0")
                    .withInferFunction(
                    ...
                    .withDocumentation(
                            "For DynamoDB based lock provider, the partition key for the DynamoDB lock table. "
    ...
    public static final ConfigProperty<String> DYNAMODB_LOCK_BILLING_MODE =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "billing_mode")
                    ...
                    .sinceVersion("0.10.0")
                    .withDocumentation(
                            "For DynamoDB based lock provider, by default it is `PAY_PER_REQUEST` mode. Alternative is `PROVISIONED`.");

    public static final ConfigProperty<String> DYNAMODB_LOCK_READ_CAPACITY =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "read_capacity")
                    .defaultValue("20")
                    .markAdvanced()
                    .sinceVersion("0.10.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> DYNAMODB_LOCK_WRITE_CAPACITY =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "write_capacity")
                    .defaultValue("10")
                    .markAdvanced()
                    .sinceVersion("0.10.0")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> DYNAMODB_LOCK_TABLE_CREATION_TIMEOUT =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "table_creation_timeout")
    ...
    public static final ConfigProperty<String> DYNAMODB_ENDPOINT_URL =
            ConfigProperty.key(DYNAMODB_BASED_LOCK_PROPERTY_PREFIX + "endpoint_url")
                    .noDefaultValue()
                    .markAdvanced()
                    .sinceVersion("0.10.1")
                    .withDocumentation(
                            "For DynamoDB based lock provider, the url endpoint used for Amazon DynamoDB service."
                                    + " Useful for development with a local dynamodb instance.");

    public static final ConfigProperty<Integer> LOCK_ACQUIRE_WAIT_TIMEOUT_MS_PROP_KEY =
            ConfigProperty.key(LockConfiguration.LOCK_ACQUIRE_WAIT_TIMEOUT_MS_PROP_KEY)
    ...
    public static class Builder {
        ...
        private void checkRequiredProps(final DynamoDbBasedLockConfig config) {
            ...
            ValidationUtils.checkArgument(
                    config.contains(DYNAMODB_LOCK_REGION.key()), errorMsg + DYNAMODB_LOCK_REGION.key());
            ValidationUtils.checkArgument(
