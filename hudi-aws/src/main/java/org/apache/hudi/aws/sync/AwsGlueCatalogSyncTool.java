...
public class AwsGlueCatalogSyncTool extends HiveSyncTool {
  ...
  private AwsGlueCatalogSyncTool(HiveSyncConfig hiveSyncConfig, HiveConf hiveConf, FileSystem fs) {
    super(new AWSGlueCatalogClient(hiveSyncConfig, fs), hiveSyncConfig, hiveConf, fs);
  }
  ...
  public static void main(String[] args) {
    ...
    new AwsGlueCatalogSyncTool(cfg, new HiveConf(hadoopConf, HiveConf.class), fs).syncHoodieTable();
  }
}
