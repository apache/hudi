...
/**
  * Currently Experimental. Utility class that implements syncing a Hudi Table with the AWS Glue Data
  * Catalog (https://docs.aws.amazon.com/glue/latest/dg/populate-data-catalog.html) to enable
  * querying via Glue ETLs, Athena etc.
  *
  * <p>Extends HiveSyncTool since most logic is similar to Hive syncing, expect using a different
  * client {@link AWSGlueCatalogSyncClient} that implements the necessary functionality using Glue
  * APIs. @Experimental
  */
public class AwsGlueCatalogSyncTool extends HiveSyncTool {
    ...
    public static void main(String[] args) {
        ...
        Configuration hadoopConf =
                HadoopFSUtils.getFs(props.getString(META_SYNC_BASE_PATH.key()), new Configuration())
                        .getConf();
