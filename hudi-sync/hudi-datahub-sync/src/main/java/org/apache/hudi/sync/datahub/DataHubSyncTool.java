...
/**
  * To sync with DataHub via REST APIs. @Experimental
  *
...
public class DataHubSyncTool extends HoodieSyncTool {
    ...
    /**
      ...
      *
      * @implNote DataHub sync is an experimental feature, which overwrites the DataHub Dataset's
      *     schema and last commit time sync'ed upon every invocation.
      */
    @Override
    ...
    public static void main(String[] args) {
        final DataHubSyncConfig.DataHubSyncConfigParams params =
                new DataHubSyncConfig.DataHubSyncConfigParams();
