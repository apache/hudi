...
/**
  * Base class to sync metadata with metastores to make Hudi table queryable through external
  * systems.
  */
public abstract class HoodieSyncTool implements AutoCloseable {
    ...
    public HoodieSyncTool(Properties props, Configuration hadoopConf) {
        ...
        this.metrics =
                new HoodieMetaSyncMetrics(
                        new HoodieSyncConfig(props, hadoopConf), getClass().getSimpleName());
    }
