...
@Immutable
@ConfigClassProperty(
        name = "Common Metadata Sync Configs",
...
public class HoodieSyncConfig extends HoodieConfig {
    ...
    public static final ConfigProperty<String> META_SYNC_BASE_PATH =
            ConfigProperty.key("hoodie.datasource.meta.sync.base.path")
                    .defaultValue("")
                    .markAdvanced()
                    .withDocumentation("Base path of the hoodie table to sync");

    public static final ConfigProperty<String> META_SYNC_ENABLED =
            ConfigProperty.key("hoodie.datasource.meta.sync.enable")
                    .defaultValue("false")
                    .withDocumentation(
    ...
    public static final ConfigProperty<String> META_SYNC_DATABASE_NAME =
            ConfigProperty.key("hoodie.datasource.hive_sync.database")
    ...
    public static final ConfigProperty<String> META_SYNC_TABLE_NAME =
            ConfigProperty.key("hoodie.datasource.hive_sync.table")
    ...
    public static final ConfigProperty<String> META_SYNC_BASE_FILE_FORMAT =
            ConfigProperty.key("hoodie.datasource.hive_sync.base_file_format")
    ...
    public static final ConfigProperty<String> META_SYNC_PARTITION_FIELDS =
            ConfigProperty.key("hoodie.datasource.hive_sync.partition_fields")
                    .defaultValue("")
                    .withInferFunction(
                            cfg ->
    ...
    public static final ConfigProperty<String> META_SYNC_PARTITION_EXTRACTOR_CLASS =
            ConfigProperty.key("hoodie.datasource.hive_sync.partition_extractor_class")
    ...
    public static final ConfigProperty<Boolean> META_SYNC_DECODE_PARTITION =
            ConfigProperty.key("hoodie.meta.sync.decode_partition")
                    ...
                    .markAdvanced()
                    .withDocumentation(
                            "If true, meta sync will url-decode the partition path, as it is deemed as url-encoded. Default to false.");

    public static final ConfigProperty<Boolean> META_SYNC_USE_FILE_LISTING_FROM_METADATA =
            ConfigProperty.key("hoodie.meta.sync.metadata_file_listing")
                    .defaultValue(DEFAULT_METADATA_ENABLE_FOR_READERS)
                    .withInferFunction(
                            cfg ->
                                    Option.of(
                                            cfg.getBooleanOrDefault(
                                                    HoodieMetadataConfig.ENABLE, DEFAULT_METADATA_ENABLE_FOR_READERS)))
                    .markAdvanced()
                    .withDocumentation(
                            "Enable the internal metadata table for file listing for syncing with metastores");

    public static final ConfigProperty<String> META_SYNC_CONDITIONAL_SYNC =
            ConfigProperty.key("hoodie.datasource.meta_sync.condition.sync")
                    .defaultValue("false")
                    .markAdvanced()
                    .withDocumentation(
                            "If true, only sync on conditions like schema change or partition change.");

    public static final ConfigProperty<String> META_SYNC_SPARK_VERSION =
            ConfigProperty.key("hoodie.meta_sync.spark.version")
                    .defaultValue("")
                    .markAdvanced()
    ...
    public static final ConfigProperty<String> META_SYNC_SNAPSHOT_WITH_TABLE_NAME =
            ConfigProperty.key("hoodie.meta.sync.sync_snapshot_with_table_name")
                    .defaultValue("true")
                    .markAdvanced()
                    .sinceVersion("0.14.0")
                    .withDocumentation("sync meta info to origin table if enable");

    public static final ConfigProperty<Boolean> META_SYNC_INCREMENTAL =
            ConfigProperty.key("hoodie.meta.sync.incremental")
                    .defaultValue(true)
                    .sinceVersion("0.14.0")
                    .markAdvanced()
                    .withDocumentation(
    ...
    public static final ConfigProperty<Boolean> META_SYNC_NO_PARTITION_METADATA =
            ConfigProperty.key("hoodie.meta.sync.no_partition_metadata")
                    .defaultValue(false)
                    .sinceVersion("1.0.0")
                    .markAdvanced()
                    .withDocumentation(
                            "If true, the partition metadata will not be synced to the metastore. "
    ...
    public static class HoodieSyncConfigParams {
        @Parameter(
                names = {"--database"},
                description = "name of the target database in meta store")
        public String databaseName;

        @Parameter(
                names = {"--table"},
                description = "name of the target table in meta store")
        public String tableName;

        @Parameter(
                names = {"--base-path"},
                description = "Base path of the hoodie table to sync",
                required = true)
        ...
        @Parameter(
                names = {"--conditional-sync"},
                description = "If true, only sync on conditions like schema change or partition change.")
        ...
        @Parameter(
                names = {"--sync-no-partition-metadata"},
                description = "do not sync partition metadata info to the catalog")
        public Boolean shouldNotSyncPartitionMetadata;
        ...
        public TypedProperties toProps() {
            ...
            props.setPropertyIfNonNull(
                    META_SYNC_PARTITION_FIELDS.key(), StringUtils.join(",", partitionFields));
            props.setPropertyIfNonNull(
                    META_SYNC_PARTITION_EXTRACTOR_CLASS.key(), partitionValueExtractorClass);
            props.setPropertyIfNonNull(META_SYNC_DECODE_PARTITION.key(), decodePartition);
            props.setPropertyIfNonNull(
                    META_SYNC_USE_FILE_LISTING_FROM_METADATA.key(), useFileListingFromMetadata);
            ...
            props.setPropertyIfNonNull(
                    META_SYNC_NO_PARTITION_METADATA.key(), shouldNotSyncPartitionMetadata);
            return props;
        }
    }
}
