...
public class SparkDataSourceTableUtils {
    ...
    public static Map<String, String> getSparkTableProperties(
        ...
        GroupType reOrderedType =
                new GroupType(originGroupType.getRepetition(), originGroupType.getName(), reOrderedFields);
    ...
    public static Map<String, String> getSparkSerdeProperties(
            boolean readAsOptimized, String basePath) {
