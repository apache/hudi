...
public class SparkDataSourceTableUtils {
  /**
   * Get Spark Sql related table properties with full Avro schema for nested comment support.
   ...
   * @param schema MessageType schema
   * @param avroSchema Full Avro schema with nested comments
  ...
  public static Map<String, String> getSparkTableProperties(List<String> partitionNames, String sparkVersion,
                                                            int schemaLengthThreshold, MessageType schema, Schema avroSchema) {
    ...
    String schemaString = Parquet2SparkSchemaUtils.convertToSparkSchemaJson(reOrderedType, avroSchema);
  ...
  /**
   * Get Spark Sql related table properties (original 4-parameter method for backward compatibility).
   * @param partitionNames List of partition field names
   * @param sparkVersion Spark version
   * @param schemaLengthThreshold Schema length threshold
   * @param schema MessageType schema
   * @return Map of Spark table properties without comments
   */
  public static Map<String, String> getSparkTableProperties(List<String> partitionNames, String sparkVersion,
                                                            int schemaLengthThreshold, MessageType schema) {
    return getSparkTableProperties(partitionNames, sparkVersion, schemaLengthThreshold, schema, Collections.emptyList());
  }

  /**
   * Get Spark Sql related table properties with flat comment support.
   * @param partitionNames List of partition field names
   * @param sparkVersion Spark version
   * @param schemaLengthThreshold Schema length threshold
   * @param schema MessageType schema
   * @param fieldSchemaForComments List of FieldSchema with flat comments
   * @return Map of Spark table properties with flat comments
   */
  public static Map<String, String> getSparkTableProperties(List<String> partitionNames, String sparkVersion,
