...
public class SparkDataSourceTableUtils {
  ...
  public static Map<String, String> getSparkTableProperties(List<String> partitionNames, String sparkVersion,
                                                            int schemaLengthThreshold, MessageType schema, List<FieldSchema> fromStorage) {
    ...
    String schemaString = Parquet2SparkSchemaUtils.convertToSparkSchemaJson(reOrderedType, fromStorage);
