...
class TestHoodieSyncConfig {
    ...
    void testInferPartitionFields() {
        ...
        assertEquals(
                "",
                config0.getStringOrDefault(META_SYNC_PARTITION_FIELDS),
                String.format(
                        "should get default value due to absence of both %s and %s",
        ...
        assertEquals(
                "foo,bar,baz",
                config1.getStringOrDefault(META_SYNC_PARTITION_FIELDS),
        ...
        assertEquals(
                "foo,bar",
                config2.getStringOrDefault(META_SYNC_PARTITION_FIELDS),
        ...
        assertEquals(
                "foo,bar,baz",
                config3.getStringOrDefault(META_SYNC_PARTITION_FIELDS),
                String.format(
    ...
    void testInferUseFileListingFromMetadata() {
        ...
        assertEquals(
                ...
                config1.getBoolean(META_SYNC_USE_FILE_LISTING_FROM_METADATA));
