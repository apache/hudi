...
public class HivePartitionUtil {
    ...
    public static String getPartitionClauseForDrop(
            String partition, PartitionValueExtractor partitionValueExtractor, HiveSyncConfig config) {
    ...
    public static Boolean partitionExists(
        ...
        try {
            ...
            newPartition =
                    client.getPartition(
                            config.getStringOrDefault(META_SYNC_DATABASE_NAME), tableName, partitionValues);
