...
/**
  ...
  * path.
  *
  * <p>This implementation extracts datestr=yyyy-mm-dd-HH from path of type /yyyy/mm/dd/HH
  */
    ...
    public List<String> extractPartitionValuesInPath(String partitionPath) {
        ...
        if (splits.length != 4) {
            throw new IllegalArgumentException(
                    "Partition path " + partitionPath + " is not in the form  yyyy/mm/dd/HH");
        }
        ...
        ZonedDateTime dateTime =
                ZonedDateTime.of(LocalDateTime.of(year, mm, dd, hh, 0), ZoneId.systemDefault());
