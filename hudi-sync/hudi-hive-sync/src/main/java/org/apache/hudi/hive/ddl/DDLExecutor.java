...
/**
  * DDLExecutor is the interface which defines the ddl functions for Hive. There are two main
  * implementations one is QueryBased other is based on HiveMetaStore QueryBasedDDLExecutor also has
  * two implementations namely HiveQL based and other JDBC based.
  */
