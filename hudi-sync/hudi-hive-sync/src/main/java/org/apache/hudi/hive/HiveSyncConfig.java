...
public class HiveSyncConfig extends HoodieSyncConfig {
    ...
    /*
      ...
      */
    public static final ConfigProperty<String> HIVE_SYNC_ENABLED =
            HiveSyncConfigHolder.HIVE_SYNC_ENABLED;
    ...
    public static final ConfigProperty<String> HIVE_AUTO_CREATE_DATABASE =
            HiveSyncConfigHolder.HIVE_AUTO_CREATE_DATABASE;
    public static final ConfigProperty<String> HIVE_IGNORE_EXCEPTIONS =
            HiveSyncConfigHolder.HIVE_IGNORE_EXCEPTIONS;
    public static final ConfigProperty<String> HIVE_SKIP_RO_SUFFIX_FOR_READ_OPTIMIZED_TABLE =
            HiveSyncConfigHolder.HIVE_SKIP_RO_SUFFIX_FOR_READ_OPTIMIZED_TABLE;
    public static final ConfigProperty<String> HIVE_SUPPORT_TIMESTAMP_TYPE =
            HiveSyncConfigHolder.HIVE_SUPPORT_TIMESTAMP_TYPE;
    public static final ConfigProperty<String> HIVE_TABLE_PROPERTIES =
            HiveSyncConfigHolder.HIVE_TABLE_PROPERTIES;
    public static final ConfigProperty<String> HIVE_TABLE_SERDE_PROPERTIES =
            HiveSyncConfigHolder.HIVE_TABLE_SERDE_PROPERTIES;
    public static final ConfigProperty<String> HIVE_SYNC_AS_DATA_SOURCE_TABLE =
            HiveSyncConfigHolder.HIVE_SYNC_AS_DATA_SOURCE_TABLE;
    public static final ConfigProperty<Integer> HIVE_SYNC_SCHEMA_STRING_LENGTH_THRESHOLD =
            HiveSyncConfigHolder.HIVE_SYNC_SCHEMA_STRING_LENGTH_THRESHOLD;
    public static final ConfigProperty<Boolean> HIVE_CREATE_MANAGED_TABLE =
    ...
    public static final ConfigProperty<String> HIVE_SYNC_TABLE_STRATEGY =
            HiveSyncConfigHolder.HIVE_SYNC_TABLE_STRATEGY;

    public static final ConfigProperty<Boolean> HIVE_SYNC_FILTER_PUSHDOWN_ENABLED =
            ConfigProperty.key("hoodie.datasource.hive_sync.filter_pushdown_enabled")
                    .defaultValue(false)
                    .markAdvanced()
                    .withDocumentation("Whether to enable push down partitions by filter");

    public static final ConfigProperty<Integer> HIVE_SYNC_FILTER_PUSHDOWN_MAX_SIZE =
            ConfigProperty.key("hoodie.datasource.hive_sync.filter_pushdown_max_size")
                    .defaultValue(1000)
                    .markAdvanced()
                    .withDocumentation(
                            "Max size limit to push down partition filters, if the estimate push down "
    ...
    public static final ConfigProperty<Boolean> RECREATE_HIVE_TABLE_ON_ERROR =
            ConfigProperty.key("hoodie.datasource.hive_sync.recreate_table_on_error")
                    .defaultValue(false)
                    .sinceVersion("0.14.0")
                    .markAdvanced()
                    .withDocumentation(
                            "Hive sync may fail if the Hive table exists with partitions differing from the Hoodie table or if schema evolution if not supported by Hive."
    ...
    public static class HiveSyncConfigParams {
        ...
        @Parameter(
                names = {"--metastore-uris"},
                description = "Hive metastore uris")
        public String metastoreUris;

        @Parameter(
                names = {"--sync-mode"},
                description = "Mode to choose for Hive ops. Valid values are hms,glue,jdbc and hiveql")
        ...
        @Parameter(
                names = {"--ignore-exceptions"},
                description = "Ignore hive exceptions")
        ...
        @Parameter(
                ...
                description = "Table properties to hive table")
        public String tableProperties;

        @Parameter(
                names = {"--serde-properties"},
                description = "Serde properties to hive table")
        ...
        @Parameter(
                names = {"--managed-table"},
                description = "Create a managed table")
        public Boolean createManagedTable;

        @Parameter(
                names = {"--omit-metafields"},
                description = "Omit metafields in schema")
        public Boolean omitMetaFields;

        @Parameter(
                names = {"--batch-sync-num"},
                description = "The number of partitions one batch when synchronous partitions to hive")
        ...
        @Parameter(
                names = {"--bucket-sync"},
                description = "use bucket sync")
        public Boolean bucketSync;

        @Parameter(
                names = {"--bucket-spec"},
                description = "bucket spec stored in metastore")
        public String bucketSpec;

        @Parameter(
                names = {"--sync-comment"},
                description = "synchronize table comments to hive")
        public Boolean syncComment;

        @Parameter(
                names = {"--sync-strategy"},
                description = "Hive table synchronization strategy. Available option: RO, RT, ALL")
        ...
        public TypedProperties toProps() {
            ...
            props.setPropertyIfNonNull(
                    HIVE_SYNC_SCHEMA_STRING_LENGTH_THRESHOLD.key(), sparkSchemaLengthThreshold);
    ...
    public void validateParameters() {
        ValidationUtils.checkArgument(
                getIntOrDefault(HIVE_BATCH_SYNC_PARTITION_NUM) > 0,
