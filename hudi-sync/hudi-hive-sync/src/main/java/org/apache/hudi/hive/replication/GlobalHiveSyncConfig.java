...
public class GlobalHiveSyncConfig extends HiveSyncConfig {
    ...
    public static final ConfigProperty<String> META_SYNC_GLOBAL_REPLICATE_TIMESTAMP =
            ConfigProperty.key("hoodie.meta_sync.global.replicate.timestamp")
                    .noDefaultValue()
                    .markAdvanced()
                    .withDocumentation("");
    ...
    public static class GlobalHiveSyncConfigParams {
        ...
        @Parameter(
                names = {"--replicated-timestamp"},
                description =
                        "Add globally replicated timestamp to enable consistent reads across clusters")
        ...
        public TypedProperties toProps() {
            ...
            props.setPropertyIfNonNull(
                    META_SYNC_GLOBAL_REPLICATE_TIMESTAMP.key(), globallyReplicatedTimeStamp);
            return props;
        }
    }
}
