...
public class TestParquet2SparkSchemaUtils {
    ...
    private static SparkSqlParser createSqlParser() {
        try {
            ...
            try { // For spark 3.1, there is no constructor with SQLConf, use the default
                // constructor
    ...
    public void testConvertPrimitiveType() {
        ...
        String sparkSchemaJson =
                Parquet2SparkSchemaUtils.convertToSparkSchemaJson(
        ...
        String sparkSchemaWithNullableJson =
                Parquet2SparkSchemaUtils.convertToSparkSchemaJson(
                        spark2ParquetConverter.convert(sparkSchemaWithNullable).asGroupType());
        StructType convertedSparkSchemaWithNullable =
                (StructType) StructType.fromJson(sparkSchemaWithNullableJson);
    ...
    public void testConvertComplexType() {
        ...
        StructField field0 =
                new StructField("f0", new ArrayType(StringType$.MODULE$, true), false, Metadata.empty());
        StructField field1 =
                new StructField(
                        "f1",
                        new MapType(StringType$.MODULE$, IntegerType$.MODULE$, true),
                        false,
                        Metadata.empty());
        StructType sparkSchemaWithNullable = new StructType(new StructField[] {field0, field1});
        String sparkSchemaWithNullableJson =
