...
public class HiveTestService {
    ...
    public static final String HS2_JDBC_URL =
            String.format("jdbc:hive2://%s:%s/", BIND_HOST, HS2_THRIFT_PORT);
    ...
    public HiveConf configureHive(Configuration hadoopConf, String localHiveLocation)
            throws IOException {
        ...
        final int hs2ThriftPort =
                hadoopConf.getInt(ConfVars.HIVE_SERVER2_THRIFT_PORT.varname, HS2_THRIFT_PORT);
        ...
        final int metastoreServerPort =
                hadoopConf.getInt(ConfVars.METASTORE_SERVER_PORT.varname, NetworkTestUtils.nextFreePort());
        ...
        conf.setVar(
                ConfVars.METASTORECONNECTURLKEY, "jdbc:derby:" + metastoreDbDir.getPath() + ";create=true");
    ...
    private static final class ChainedTTransportFactory extends TTransportFactory {
        ...
        private ChainedTTransportFactory(
                TTransportFactory parentTransFactory, TTransportFactory childTransFactory) {
    ...
    private TServer startMetaStore(HiveConf conf) throws IOException {
        try {
            ...
            if (conf.getBoolVar(ConfVars.METASTORE_EXECUTE_SET_UGI)) {
                transFactory =
                        useFramedTransport
                                ? new ChainedTTransportFactory(
                                        new TFramedTransport.Factory(), new TUGIContainingTransport.Factory())
