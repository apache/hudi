...
public class TestHiveSchemaUtil {
    ...
    /**
      ...
      *
      * <p>Refer to the Parquet-113 spec:
    ...
    public void testSchemaConvertArray() throws IOException {
        ...
        schema =
                Types.buildMessage()
                        ...
                        .required(PrimitiveType.PrimitiveTypeName.BINARY)
                        .named("str")
                        .named("one_tuple_list_tuple")
                        .named("one_tuple_list")
                        .named("ArrayOfOneTuples2");
    ...
    public void testSchemaConvertTimestamp(String type) throws IOException {
        MessageType schema =
                Types.buildMessage()
                        ...
                        .as(OriginalType.valueOf(type))
                        .named("my_element")
                        .named("my_timestamp");
        String schemaString = HiveSchemaUtil.generateSchemaString(schema);
        // verify backward compatibility - int64 converted to bigint type
        assertEquals("`my_element` bigint", schemaString);
        // verify new functionality - int64 converted to timestamp type when 'supportTimestamp' is
        // enabled
