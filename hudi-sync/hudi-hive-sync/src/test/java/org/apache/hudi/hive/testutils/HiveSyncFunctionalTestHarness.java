...
public class HiveSyncFunctionalTestHarness {
    ...
    public HiveSyncConfig hiveSyncConf() throws IOException {
        ...
        props.setProperty(
                META_SYNC_BASE_PATH.key(),
                Files.createDirectories(tempDir.resolve("hivesynctestcase-" + Instant.now().toEpochMilli()))
                        .toUri()
                        .toString());
    ...
    public HoodieHiveSyncClient hiveClient(HiveSyncConfig hiveSyncConfig) throws IOException {
        HoodieTableMetaClient.withPropertyBuilder()
                ...
                .initTable(
                        ...
                        hiveSyncConfig.getString(META_SYNC_BASE_PATH));
        return new HoodieHiveSyncClient(hiveSyncConfig);
    }

    public void dropTables(String database, String... tables)
        ...
        for (String table : tables) {
            ...
            new HiveQueryDDLExecutor(
                    ...
                    .runSQL("drop table if exists " + table);
        }
    }
