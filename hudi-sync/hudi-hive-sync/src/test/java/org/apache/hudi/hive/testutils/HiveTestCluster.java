...
public class HiveTestCluster
    ...
    public void setup() throws Exception {
        ...
        hadoopConf.setInt(
                HiveConf.ConfVars.HIVE_SERVER2_THRIFT_PORT.varname, NetworkTestUtils.nextFreePort());
        ...
        client =
                HiveMetaStoreClient.newSynchronizedClient(RetryingMetaStoreClient.getProxy(conf, true));
    }
    ...
    public void createCOWTable(
            String commitTime, int numberOfPartitions, String dbName, String tableName) throws Exception {
        ...
        HoodieCommitMetadata commitMetadata =
                createPartitions(numberOfPartitions, true, dateTime, commitTime, path.toString());
        createCommitFile(commitMetadata, commitTime, path.toString());
    }

    private void createCommitFile(
            HoodieCommitMetadata commitMetadata, String commitTime, String basePath) throws IOException {
    ...
    private HoodieCommitMetadata createPartitions(
        ...
        for (int i = 0; i < numberOfPartitions; i++) {
            ...
            List<HoodieWriteStat> writeStats =
                    createTestData(partPath, isParquetSchemaSimple, commitTime);
    ...
    private List<HoodieWriteStat> createTestData(
            Path partPath, boolean isParquetSchemaSimple, String commitTime)
            throws IOException, URISyntaxException {
    ...
    private void generateParquetData(Path filePath, boolean isParquetSchemaSimple)
        ...
        BloomFilter filter =
                BloomFilterFactory.createBloomFilter(1000, 0.0001, -1, BloomFilterTypeCode.SIMPLE.name());
        HoodieAvroWriteSupport writeSupport =
                new HoodieAvroWriteSupport(parquetSchema, schema, Option.of(filter), new Properties());
        ...
        List<IndexedRecord> testRecords =
                (isParquetSchemaSimple
