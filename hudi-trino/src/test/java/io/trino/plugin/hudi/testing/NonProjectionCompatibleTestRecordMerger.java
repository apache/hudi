 ...
 * <p>
 * The connector expands the read projection to the full table schema for such mergers (apache/hudi#19249),
 * so narrow queries still merge correctly instead of failing. This merger exists purely to exercise that
 * full-schema path; it shares {@link KeyBasedTestRecordMerger#MERGE_STRATEGY_ID} so it resolves against
 * the same test table.
 */
